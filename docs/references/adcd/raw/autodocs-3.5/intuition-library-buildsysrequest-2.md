# intuition.library/BuildSysRequest
    ...
    SYNOPSIS
	ReqWindow = BuildSysRequest( [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908), BodyText, PosText, NegText,
	D0                           A0      A1        A2       A3
		           IDCMPFlags, Width, Height )
			   D0          D1     D2

	struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) *BuildSysRequest( struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) *, struct [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655) *,
		struct [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655) *, struct [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655) *, ULONG, WORD, WORD );
	...
	[FreeSysRequest()](../Includes_and_Autodocs_3._guide/node03B3.html) procedure to remove the requester and free up
	any allocated memory.

	See the autodoc for [SysReqHandler()](../Includes_and_Autodocs_3._guide/node03FB.html) for more information on the
	...
	this function would try to call [DisplayAlert()](../Includes_and_Autodocs_3._guide/node03A3.html) with the same
	...
	pointer to an instance of the structure [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655).

	The BodyText argument should be used to describe the nature of
	the requester.  As usual with [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655) data, you may link several
	lines of text together, and the text may be placed in various
	locations in the requester.  This [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655) pointer will be stored
	...
	the [DisplayAlert()](../Includes_and_Autodocs_3._guide/node03A3.html) mechanism is used, this text will be rendered in
	...
	New for V36, linked lists of [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655) are not correctly supported
	for gadget labels.
	...
	PosText = pointer to an [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655) structure
	NegText = pointer to an [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655) structure
	...
	are some of the parameters of your [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655), so that Intuition
	...
	this routine might have called [DisplayAlert()](../Includes_and_Autodocs_3._guide/node03A3.html) before returning
	...
	call [DisplayAlert()](../Includes_and_Autodocs_3._guide/node03A3.html), or if it does, and there's not enough
	memory for the alert, the value of FALSE is returned.

    BUGS
	This procedure currently opens a window in the [Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) which
	...
	[DisplayAlert()](../Includes_and_Autodocs_3._guide/node03A3.html) is not called in version V36.

	It's almost impossible to make complete, correct account
	of different system fonts, window border dimensions, and
	screen resolution to get the layout of a System [Requester](../Includes_and_Autodocs_3._guide/node05E0.html#line143)
	just right using this routine.  For V36, we recommend the
	automatic layout implemented in [BuildEasyRequestArgs()](../Includes_and_Autodocs_3._guide/node0398.html) and
	[EasyRequestArgs()](../Includes_and_Autodocs_3._guide/node03AB.html).

    SEE ALSO
	[FreeSysRequest()](../Includes_and_Autodocs_3._guide/node03B3.html), [DisplayAlert()](../Includes_and_Autodocs_3._guide/node03A3.html), [ModifyIDCMP()](../Includes_and_Autodocs_3._guide/node03C5.html), [exec.library/Wait()](../Includes_and_Autodocs_3._guide/node0246.html),
	[Request()](../Includes_and_Autodocs_3._guide/node03E5.html), [AutoRequest()](../Includes_and_Autodocs_3._guide/node0396.html), [EasyRequestArgs()](../Includes_and_Autodocs_3._guide/node03AB.html), [BuildEasyRequestArgs()](../Includes_and_Autodocs_3._guide/node0398.html)
