...
```c
      ...
      void RethinkLayout( struct [Gadget](../Includes_and_Autodocs_3._guide/node05E0.html#line213) *, struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) *,
                              struct [Requester](../Includes_and_Autodocs_3._guide/node05E0.html#line143) *, [BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) )
```
  FUNCTION
...
```c
      ...
      that is finished. [Wait](../Includes_and_Autodocs_3._guide/node0246.html) for DTA_Sync, and then RefreshGList( layout,
      window, requester, 1 ).
```
  SEE ALSO

```c
      [intuition.library/RefreshGList()](../Includes_and_Autodocs_3._guide/node03DD.html), [intuition.library/SetGadgetAttrsA()](../Includes_and_Autodocs_3._guide/node03F1.html),
