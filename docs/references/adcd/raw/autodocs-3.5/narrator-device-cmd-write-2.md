# narrator.device/CMD_WRITE
   ...
   INPUTS
	User [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block (struct [narrator_rb](../Includes_and_Autodocs_3._guide/node0630.html#line93) as defined in .h file).
	The [OpenDevice](../Includes_and_Autodocs_3._guide/node0560.html) call will initialize the [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block to a
	"standard male" voice.  If you want to change any parms, do so
	after the [OpenDevice](../Includes_and_Autodocs_3._guide/node0560.html) call and before the [DoIO](../Includes_and_Autodocs_3._guide/node0204.html) (or SendIO/WaitIO).
	For a complete description of the [narrator_rb](../Includes_and_Autodocs_3._guide/node0630.html#line93) structure, see the
	narrator.h or .i include file.  Note that the [OpenDevice](../Includes_and_Autodocs_3._guide/node0560.html) call does
	not initialize all the fields needed by the narrator device.  The
	[IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) fields which must be set by the user before issuing the
	write request are:
	...
	requested by setting the mouths field of the [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block to a
	...
	of the [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block.  Note that word and syllable sync only work
   ...
   RESULTS
	...
	sets the io_Error field of the [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block to an appropriate
   ...
   SEE ALSO
	[Read](../Includes_and_Autodocs_3._guide/node01A0.html) command.
