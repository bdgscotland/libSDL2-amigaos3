# intuition.library/BeginRefresh
    ...
    SYNOPSIS
	BeginRefresh( [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) )
		      A0

	VOID BeginRefresh( struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) * );
	...
	library function [BeginUpdate()](../Includes_and_Autodocs_3._guide/node0418.html).  Its additional contribution is
	...
	parent [Layer_Info](../Includes_and_Autodocs_3._guide/node0625.html#line30) has been locked.  Also, the WFLG_WINDOWREFRESH
	flag is set in your window, for your information.

	The purpose of [BeginUpdate()](../Includes_and_Autodocs_3._guide/node0418.html), and hence BeginRefresh(), is to
	...
	[EndRefresh()](../Includes_and_Autodocs_3._guide/node03AC.html) to reset the state of the layer and the window.  Then you
	...
	call BeginRefresh() and [EndRefresh()](../Includes_and_Autodocs_3._guide/node03AC.html) to clear the refresh-needed
	...
	operations between BeginRefresh() and [EndRefresh()](../Includes_and_Autodocs_3._guide/node03AC.html).  These include
	any graphics.library drawing functions or the simple Intuition
	rendering functions (DrawImage(), [PrintIText()](../Includes_and_Autodocs_3._guide/node03D9.html), [DrawBorder()](../Includes_and_Autodocs_3._guide/node03A8.html), and
	so on).  In particular, do not call [RefreshGadgets()](../Includes_and_Autodocs_3._guide/node03DC.html), [RefreshGList()](../Includes_and_Autodocs_3._guide/node03DD.html),
	[RefreshWindowFrame()](../Includes_and_Autodocs_3._guide/node03DE.html), etc., since any of the complex Intuition
	...
	Intuition.  This means no calling [SetPointer()](../Includes_and_Autodocs_3._guide/node03F4.html), no calling
	[LockIBase()](../Includes_and_Autodocs_3._guide/node03C0.html), no dos.library functions (since an EasyRequest()
	...
	To avoid this, you must protect your session using [LockLayerInfo()](../Includes_and_Autodocs_3._guide/node0428.html)
	...
	You can, however, call [InstallClipRegion()](../Includes_and_Autodocs_3._guide/node0424.html) for the different
	...
	sharing, but the lower-level function [layers.library/BeginUpdate()](../Includes_and_Autodocs_3._guide/node0418.html)
	does not.  It isn't really supported to use [BeginUpdate()](../Includes_and_Autodocs_3._guide/node0418.html) on
    ...
    INPUTS
	[Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) = pointer to the window structure which needs refreshing
	...
	[layers.library/BeginUpdate()](../Includes_and_Autodocs_3._guide/node0418.html), and abort if that function fails.

```c
    SEE ALSO
       [EndRefresh()](../Includes_and_Autodocs_3._guide/node03AC.html), [layers.library/BeginUpdate()](../Includes_and_Autodocs_3._guide/node0418.html), [OpenWindow()](../Includes_and_Autodocs_3._guide/node03D5.html)
```
	[layer.library/InstallClipRegion()](../Includes_and_Autodocs_3._guide/node0424.html), [layers.library/LockLayerInfo()](../Includes_and_Autodocs_3._guide/node0428.html)
