# graphics.library/SetSoftStyle
   ...
   SYNOPSIS
	...
	ULONG SetSoftStyle(struct [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) *, ULONG, ULONG);
   ...
   INPUTS
	rp     - the [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) from which the font and style
	         are extracted.
	style  - the new font style to set, subject to enable.
	enable - those bits in style to be changed.  Any set bits here
	         that would not be set as a result of [AskSoftStyle](../Includes_and_Autodocs_3._guide/node02AD.html) will
   ...
   SEE ALSO
	[AskSoftStyle()](../Includes_and_Autodocs_3._guide/node02AD.html)  [graphics/text.h](../Includes_and_Autodocs_3._guide/node05EC.html)
