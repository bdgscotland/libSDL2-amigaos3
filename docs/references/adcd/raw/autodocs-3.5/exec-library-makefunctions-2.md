# exec.library/MakeFunctions
   ...
   SYNOPSIS
	...
	ULONG MakeFunctions(APTR,[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37),APTR);

   FUNCTION
	A low level function used by [MakeLibrary](../Includes_and_Autodocs_3._guide/node021B.html) to build jump tables of
