# exec.library/WaitPort
   ...
   SYNOPSIS
	...
	struct [Message](../Includes_and_Autodocs_3._guide/node062E.html#line46) *WaitPort(struct [MsgPort](../Includes_and_Autodocs_3._guide/node062E.html#line27) *);

   FUNCTION
	This function waits for the given port to become non-empty.  If
	necessary, the [Wait()](../Includes_and_Autodocs_3._guide/node0246.html) function will be called to wait for the port
   ...
   CAUTION
	...
	proper to call the [GetMsg()](../Includes_and_Autodocs_3._guide/node0214.html) function in a loop until all messages
	have been handled, then wait for more to arrive.

	To wait for more than one port, combine the signal bits from each
	port into one call to the [Wait()](../Includes_and_Autodocs_3._guide/node0246.html) function, then use a [GetMsg()](../Includes_and_Autodocs_3._guide/node0214.html) loop
