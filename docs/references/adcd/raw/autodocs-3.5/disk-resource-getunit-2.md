...
```c
       ...
       D0		      A1             A6
```
	struct [DiscResourceUnit](../Includes_and_Autodocs_3._guide/node0600.html#line40) *GetUnit(struct [DiscResourceUnit](../Includes_and_Autodocs_3._guide/node0600.html#line40) *);
   ...
   FUNCTION
	...
	[Remember](../Includes_and_Autodocs_3._guide/node05E0.html#line1429) however that there are four units to the disk; you are
	...
	When you are done, please leave the disk in the following state:
	    ...
	    [CIA](../Includes_and_Autodocs_3._guide/node05E5.html#line28) resource index interrupt -- DISABLED
	...
	NOTE: GetUnit() does NOT turn on the interrupts for you.
	      You must use [AbleICR](../Includes_and_Autodocs_3._guide/node00C8.html) (for the index interrupt) or intena
	      (for the diskbyte and diskblock interrupts) to turn them
	      on.  You should turn them off before calling [GiveUnit](../Includes_and_Autodocs_3._guide/node0130.html),
	      as stated above.
   ...
   SEE ALSO
	[GiveUnit()](../Includes_and_Autodocs_3._guide/node0130.html)
