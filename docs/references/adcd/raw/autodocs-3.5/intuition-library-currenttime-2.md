# intuition.library/CurrentTime
    ...
    INPUTS
	Seconds = pointer to a [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39) variable to receive the current seconds
	    value
	Micros = pointer to a [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39) variable for the current microseconds value
