# amiga.lib/CreateTask
   ...
   SYNOPSIS
	...
	struct [Task](../Includes_and_Autodocs_3._guide/node064B.html#line23) *CreateTask(STRPTR,[LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39),funcEntry,ULONG);
   ...
   FUNCTION
	...
	[dos.library/CreateProc()](../Includes_and_Autodocs_3._guide/node014D.html) or the [dos.library/CreateNewProc()](../Includes_and_Autodocs_3._guide/node014C.html)
   ...
   BUGS
	Under exec.library V37 or beyond, the [AddTask()](../Includes_and_Autodocs_3._guide/node01E2.html) function used
	...
	did not check for failure of [AddTask()](../Includes_and_Autodocs_3._guide/node01E2.html) and thus might return a
	...
	initial [AllocEntry()](../Includes_and_Autodocs_3._guide/node01E6.html) call would fail, but would use an inappropriate
	test condition.

   SEE ALSO
	[DeleteTask()](../Includes_and_Autodocs_3._guide/node0037.html), [exec/FindTask()](../Includes_and_Autodocs_3._guide/node020B.html)
