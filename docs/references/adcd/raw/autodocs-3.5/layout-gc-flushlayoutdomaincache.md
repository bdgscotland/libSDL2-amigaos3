...
```c
      FlushLayoutDomainCache -- [Flush](../Includes_and_Autodocs_3._guide/node016A.html) layout domain cache below a level.
```
  SYNOPSIS
...
```c
      ...
      void FlushLayoutDomainCache( struct [Gadget](../Includes_and_Autodocs_3._guide/node05E0.html#line213) * )
```
  FUNCTION
