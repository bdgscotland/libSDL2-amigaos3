# intuition.library/SysReqHandler
    ...
    SYNOPSIS
	num = SysReqHandler( [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908), IDCMPFlagsPtr, WaitInput )
	D0                   A0      A1             D0

	[LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39) SysReqHandler( struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) *, ULONG *, [BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) );

    FUNCTION
	Handles input for a window returned by either [BuildSysRequest()](../Includes_and_Autodocs_3._guide/node0399.html)
	or BuildEasyRequest().  These functions with SysReqHandler()
	you can perform an "asynchronous" EasyRequest() or [AutoRequest()](../Includes_and_Autodocs_3._guide/node0396.html).
	...
	(by calling [WaitPort()](../Includes_and_Autodocs_3._guide/node0248.html)) if there are no IDCMP messages.
	...
	Not only must you call [FreeSysRequest()](../Includes_and_Autodocs_3._guide/node03B3.html) to eliminate the request,
    ...
    EXAMPLE
	[Request](../Includes_and_Autodocs_3._guide/node03E5.html) a volume, but don't remove the requester when the
    ...
    INPUTS
	[Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) = [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) pointer returned from [BuildSysRequest()](../Includes_and_Autodocs_3._guide/node0399.html) or
	...
	IDCMPFlagsPtr = If you passed application specific IDCMP
		flags to [BuildSysRequest()](../Includes_and_Autodocs_3._guide/node0399.html) or BuildEasyRequest(),
    ...
    SEE ALSO
	[exec.library/WaitPort()](../Includes_and_Autodocs_3._guide/node0248.html)
