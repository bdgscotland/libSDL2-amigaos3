# dos.library/AddBuffers
   ...
   SYNOPSIS
	...
	[BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) AddBuffers(STRPTR, LONG)

   FUNCTION
	Adds buffers to a filesystem.  If it succeeds, the number of current
	buffers is returned in [IoErr()](../Includes_and_Autodocs_3._guide/node0182.html).  Note that "number" may be negative.
	...
	will be returned by [IoErr()](../Includes_and_Autodocs_3._guide/node0182.html).
   ...
   BUGS
	...
	0 (FALSE) failure, -1 (DOSTRUE) to mean that [IoErr()](../Includes_and_Autodocs_3._guide/node0182.html) will have the
