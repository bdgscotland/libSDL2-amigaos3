# trackdisk.device/TD_RAWREAD
   ...
   FUNCTION
	...
	[CMD_READ](../Includes_and_Autodocs_3._guide/node057F.html) and ETD_READ commands, anyone using TD_RAWREAD is
   ...
   SEE ALSO
	[TD_RAWWRITE](../Includes_and_Autodocs_3._guide/node058D.html)
