# colorwheel.gadget/colorwheel.gadget
   ...
   TAGS
	...
	WHEEL_HSB (struct [ColorWheelHSB](../Includes_and_Autodocs_3._guide/node05EE.html#line22) *) -- Set and get the hue, saturation,
		...
		When setting this tag, initialize a [ColorWheelHSB](../Includes_and_Autodocs_3._guide/node05EE.html#line22) structure,
		and provide a pointer to it. When getting this tag, pass a
		pointer to a [ColorWheelHSB](../Includes_and_Autodocs_3._guide/node05EE.html#line22) structure, and the color wheel
	...
	WHEEL_RGB (struct [ColorWheelRGB](../Includes_and_Autodocs_3._guide/node05EE.html#line30) *) -- Set and get the red, green,
		and brightness components of a color wheel. This is a buik
		version of the separate WHEEL_Red, WHEEL_Green, and
		WHEEL_Blue tags.

		When setting this tag, initialize a [ColorWheelRGB](../Includes_and_Autodocs_3._guide/node05EE.html#line30) structure,
		and provide a pointer to it. When getting this tag, pass a
		pointer to a [ColorWheelRGB](../Includes_and_Autodocs_3._guide/node05EE.html#line30) structure, and the color wheel
		object will fill it in with the current values.
	...
	WHEEL_Screen (struct [Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) *) - Indicate the screen the color
		wheel is to open on. This is a required tag and must be
		provided when the wheel is created via [NewObject()](../Includes_and_Autodocs_3._guide/node03CB.html).
	...
	WHEEL_Donation (UWORD *) - Specifies an array of pens donated by
		...
		option of the [graphics.library/ObtainPen()](../Includes_and_Autodocs_3._guide/node0307.html) function.
	...
	WHEEL_GradientSlider (struct [Gadget](../Includes_and_Autodocs_3._guide/node05E0.html#line213) *) - This tag lets you do simple
		linking of a gradient slider object to a color wheel object.
		You give this tag a pointer to a gradient slider object
		obtained previously from [NewObject()](../Includes_and_Autodocs_3._guide/node03CB.html). Once this is done,
   ...
   WARNING
	...
	object must be deleted using [DisposeObject()](../Includes_and_Autodocs_3._guide/node03A5.html) prior to closing the
