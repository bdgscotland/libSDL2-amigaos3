# dos.library/ReadArgs
   ...
   SYNOPSIS
	...
	struct [RDArgs](../Includes_and_Autodocs_3._guide/node05F5.html#line94) * ReadArgs(STRPTR, [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39) *, struct [RDArgs](../Includes_and_Autodocs_3._guide/node05F5.html#line94) *)

   FUNCTION
	Parses and argument string according to a template.  Normally gets
	the arguments by reading buffered IO from [Input()](../Includes_and_Autodocs_3._guide/node017F.html), but also can be
	made to parse a string.  MUST be matched by a call to [FreeArgs()](../Includes_and_Autodocs_3._guide/node016F.html).
	...
	ReadArgs() returns a struct [RDArgs](../Includes_and_Autodocs_3._guide/node05F5.html#line94) if it succeeds.  This serves as an
	"anchor" to allow [FreeArgs()](../Includes_and_Autodocs_3._guide/node016F.html) to free the associated memory.  You can
	also pass in a struct [RDArgs](../Includes_and_Autodocs_3._guide/node05F5.html#line94) to control the operation of ReadArgs()
	...
	storage, and extended help text.  See [<dos/rdargs.h>](../Includes_and_Autodocs_3._guide/node05F5.html) for more
	information on this.  Note: if you pass in a struct [RDArgs](../Includes_and_Autodocs_3._guide/node05F5.html#line94), you must
	still call [FreeArgs()](../Includes_and_Autodocs_3._guide/node016F.html) to release storage that gets attached to it,
	but you are responsible for freeing the [RDArgs](../Includes_and_Autodocs_3._guide/node05F5.html#line94) yourself.

	If you pass in a [RDArgs](../Includes_and_Autodocs_3._guide/node05F5.html#line94) structure, you MUST reset (clear or set)
	RDA_Buffer for each new call to [RDArgs](../Includes_and_Autodocs_3._guide/node05F5.html#line94).  The exact behavior if you
   ...
   INPUTS
	...
	rdargs   - optional rdargs structure for options.  [AllocDosObject](../Includes_and_Autodocs_3._guide/node013E.html)
		   should be used for allocating them if you pass one in.

   RESULT
	result   - a struct [RDArgs](../Includes_and_Autodocs_3._guide/node05F5.html#line94) or NULL for failure.
   ...
   SEE ALSO
	[FindArg()](../Includes_and_Autodocs_3._guide/node0165.html), [ReadItem()](../Includes_and_Autodocs_3._guide/node01A2.html), [FreeArgs()](../Includes_and_Autodocs_3._guide/node016F.html), [AllocDosObject()](../Includes_and_Autodocs_3._guide/node013E.html)
