# graphics.library/BltBitMap
   ...
   NAME
	BltBitMap -- [Move](../Includes_and_Autodocs_3._guide/node0301.html) a rectangular region of bits in a [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45).
   ...
   SYNOPSIS
	...
	ULONG BltBitMap(struct [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) *, WORD, WORD, struct [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) *,
	    WORD, WORD, WORD, WORD, [UBYTE](../Includes_and_Autodocs_3._guide/node0654.html#line50), [UBYTE](../Includes_and_Autodocs_3._guide/node0654.html#line50), [UWORD](../Includes_and_Autodocs_3._guide/node0654.html#line43) *);

   FUNCTION
	Perform non-destructive blits to move a rectangle from one
	area in a [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) to another area, which can be on a different
	[BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45).
	This blit is assumed to be friendly: no error conditions (e.g.
	a rectangle outside the [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) bounds) are tested or reported.
   ...
   INPUTS
	SrcBitMap, DstBitMap - the BitMap(s) containing the
	    ...
	    - the planes copied from the source to the destination are
	      ...
	      than the minimum Depth of either [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) and whose Mask
   ...
   SEE ALSO
	[ClipBlit()](../Includes_and_Autodocs_3._guide/node02C3.html)  [graphics/gfx.h](../Includes_and_Autodocs_3._guide/node05DC.html)  [hardware/blit.h](../Includes_and_Autodocs_3._guide/node05DF.html)
