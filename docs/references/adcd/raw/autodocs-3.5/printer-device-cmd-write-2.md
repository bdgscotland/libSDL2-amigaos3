...
```c
      ...
      not assume that the MARGINS or TABS can be set.  [Close](../Includes_and_Autodocs_3._guide/node0149.html) to half the
...
```c
       printer.h, parallel.device, serial.device, [Preferences](../Includes_and_Autodocs_3._guide/node063B.html#line57)
```
