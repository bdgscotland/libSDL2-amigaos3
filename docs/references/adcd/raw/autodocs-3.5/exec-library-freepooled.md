# exec.library/FreePooled
    ...
    FUNCTION
	Deallocates memory allocated by [AllocPooled()](../Includes_and_Autodocs_3._guide/node01E8.html).  The size of the
	allocation *MUST* match the size given to [AllocPooled()](../Includes_and_Autodocs_3._guide/node01E8.html).
	...
	Only memory allocated by [AllocPooled()](../Includes_and_Autodocs_3._guide/node01E8.html) may be freed with this
	function!

	Doing a [DeletePool()](../Includes_and_Autodocs_3._guide/node0202.html) on the pool will free all of the puddles
	and thus all of the allocations done with [AllocPooled()](../Includes_and_Autodocs_3._guide/node01E8.html) in that
