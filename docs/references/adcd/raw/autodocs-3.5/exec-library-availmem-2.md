# exec.library/AvailMem
   ...
   INPUTS
	requirements - a requirements mask as specified in [AllocMem](../Includes_and_Autodocs_3._guide/node01E7.html).  Any
		       of the [AllocMem](../Includes_and_Autodocs_3._guide/node01E7.html) bits are valid, as is MEMF_LARGEST
   ...
   NOTE
	...
	the memory list.  [Alert](../Includes_and_Autodocs_3._guide/node01E3.html) AN_MemoryInsane will be pulled if any mismatch
	is noted.
