# card.resource/OwnCard
   ...
   SYNOPSIS
	...
	struct [CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) *OwnCard( struct [CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) * );
   ...
   FUNCTION
	...
	device calls [ReleaseCard()](../Includes_and_Autodocs_3._guide/node009F.html), the machine will [RESET](../Includes_and_Autodocs_3._guide/node0253.html).

   INPUTS
	handle - pointer to a [CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) structure.

		struct [CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) {
		struct [Node](../Includes_and_Autodocs_3._guide/node062F.html#line21) 		 cah_CardNode;
		struct [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21)	*cah_CardRemoved;
		struct [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21)	*cah_CardInserted;
		struct [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21)	*cah_CardStatus;
		[UBYTE](../Includes_and_Autodocs_3._guide/node0654.html#line50)			 cah_CardFlags;
		};
	...
	cah_CardNode.ln_Pri -
		...
		See table below.  The [Node](../Includes_and_Autodocs_3._guide/node062F.html#line21) field is used by the resource to
		add your handle to a sorted list of [CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) structures.
	...
	cah_CardNode.ln_Type -
		...
		future to identify an extended [CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) structure.
	...
	cah_ CardInserted -
		...
		Pointer to an initialized interrupt structure.  Only the
		is_Data, and is_Code fields need to be initialized.  This
		is the code which will be called when your [CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) owns
		...
		[ReleaseCard()](../Includes_and_Autodocs_3._guide/node009F.html).
		...
		[ReleaseCard()](../Includes_and_Autodocs_3._guide/node009F.html) so that other devices will be given a chance to
	...
	cah_CardStatus -
		...
		definitions returned by [ReadCardStatus()](../Includes_and_Autodocs_3._guide/node009E.html).  Note that more
		than one bit may be set, and the mask only tells you what has
		changed, not the current state.

		Use [ReadCardStatus()](../Includes_and_Autodocs_3._guide/node009E.html) if you need to determine the current
		...
		[ReadCardStatus()](../Includes_and_Autodocs_3._guide/node009E.html) function.
	...
	cah_CardFlags -
		...
		If it is available, your [CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) structure will be added
		...
		other device owns the credit-card), your [CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) structure
	...
	[CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) (see [ReleaseCard()](../Includes_and_Autodocs_3._guide/node009F.html)), make the changes, and then call
	OwnCard() again.
   ...
   RESULTS
	...
	ptr - indicates failure.  Returns pointer to the [CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29)
	      structure which owns the credit card.

   NOTES
	This function should only be called from a task.

  	[CardHandle](../Includes_and_Autodocs_3._guide/node05E2.html#line29) interrupts are called with a pointer to your data
    ...
    SEE ALSO
	[ReleaseCard()](../Includes_and_Autodocs_3._guide/node009F.html), [ReadCardStatus()](../Includes_and_Autodocs_3._guide/node009E.html), resources/card.i, [resources/card.h](../Includes_and_Autodocs_3._guide/node05E2.html)
