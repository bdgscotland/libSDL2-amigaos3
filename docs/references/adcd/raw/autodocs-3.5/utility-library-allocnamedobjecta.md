# utility.library/AllocNamedObjectA
   ...
   SYNOPSIS
	...
	struct [NamedObject](../Includes_and_Autodocs_3._guide/node0631.html#line24) *AllocNamedObjectA(STRPTR, struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *);

	object = AllocNamedObject(name, Tag1, ...);

	struct [NamedObject](../Includes_and_Autodocs_3._guide/node0631.html#line24) *AllocNamedObject(STRPTR, ULONG, ...);

   FUNCTION
	Allocates a [NamedObject](../Includes_and_Autodocs_3._guide/node0631.html#line24) and initializes it as needed to the
	...
	remove it from the namespace you must do a [ReleaseNamedObject()](../Includes_and_Autodocs_3._guide/node05AB.html).
   ...
   TAGS
	ANO_NameSpace - [BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) tag, default FALSE.  If this tag is
	...
	ANO_Priority  - [BYTE](../Includes_and_Autodocs_3._guide/node0654.html#line48) tag, default 0.  This tag lets you pick
   ...
   SEE ALSO
	[FreeNamedObject()](../Includes_and_Autodocs_3._guide/node05A1.html), [<utility/name.h>](../Includes_and_Autodocs_3._guide/node0631.html)
