# exec.library/SetIntVector
   ...
   SYNOPSIS
	...
	struct [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) *SetIntVector(ULONG, struct [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) *);
   ...
   FUNCTION
	...
	The IS_CODE and IS_DATA pointers of the [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) structure will
	be copied into a private place by Exec.  A pointer to the previously
	installed [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) structure is returned.
   ...
   INPUTS
	intNum - the Paula interrupt bit number (0..14).  Only non-chained
		 interrupts should be set.  Use [AddIntServer()](../Includes_and_Autodocs_3._guide/node01DA.html) for server
		 chains.
	interrupt - a pointer to an [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) structure containing the
   ...
   SEE ALSO
	[AddIntServer()](../Includes_and_Autodocs_3._guide/node01DA.html),exec/interrupts.i,hardware/intbits.i
