...
```c
       ...
       d0		    d0
```
	struct [ColorMap](../Includes_and_Autodocs_3._guide/node05ED.html#line142) *GetColorMap( ULONG);
...
```c
       [SetRGB4()](../Includes_and_Autodocs_3._guide/node032A.html) [FreeColorMap()](../Includes_and_Autodocs_3._guide/node02D7.html)
```
