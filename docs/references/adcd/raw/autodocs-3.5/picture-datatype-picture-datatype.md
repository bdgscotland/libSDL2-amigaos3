# picture.datatype/picture.datatype
   ...
   METHODS
	...
	GM_RENDER -- [Cause](../Includes_and_Autodocs_3._guide/node01F4.html) the graphic to render.
	...
	DTM_WRITE -- [Write](../Includes_and_Autodocs_3._guide/node01D1.html) the selected area of the picture to a file as an
   ...
   TAGS
	...
	PDTA_ModeID (ULONG) -- Set and get the graphic mode id of the
	    picture (see [<graphics/modeid.h>](../Includes_and_Autodocs_3._guide/node0661.html)).

	    Applicability is (ISG).

	PDTA_BitMapHeader (struct [BitMapHeader](../Includes_and_Autodocs_3._guide/node05DD.html#line203) *) -- Get the
	    base information for the picture.  [BitMapHeader](../Includes_and_Autodocs_3._guide/node05DD.html#line203) is defined in
	    [<datatypes/pictureclass.h>](../Includes_and_Autodocs_3._guide/node05DD.html)

	    Applicability is (G).

	PDTA_BitMap (struct [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) *) -- Pointer to a class-allocated
	    bitmap, that will end up being freed by the picture class in the
	    OM_DISPOSE method.

	    Applicability is (ISG).

	PDTA_ColorRegisters (struct [ColorRegister](../Includes_and_Autodocs_3._guide/node05DD.html#line223) *) -- Color table; its
	    contents should match the colours in the PDTA_CRegs table.

	    Applicability is (G).

	PDTA_CRegs (ULONG *) -- Color table to use with [SetRGB32CM()](../Includes_and_Autodocs_3._guide/node0329.html).
	...
	PDTA_Screen (struct [Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) *) -- Pointer to the screen to remap
	...
	PDTA_DestBitMap (struct [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) *) -- Pointer to the remapped
	    bitmap.

	    Applicability is (G).

	PDTA_ClassBitMap (struct [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) *) -- Pointer to the [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45)
	...
	PDTA_DestMode (LONG) -- Used by application software writers only;
	    ...
	    examine the contents of the [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) you receive from
	    picture.datatype.

	    Applicability is (ISG). Defaults to PMODE_V43. (V43)

	PDTA_UseFriendBitMap (BOOL) -- If set to TRUE, all [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45)
	    allocations done by picture.datatype will be done with
	    a friend [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) as a reference (see graphics.library/AllocBitMap).

	    Applicability is (ISG). Defaults to TRUE. (V43)

	PDTA_MaskPlane (PLANEPTR) -- Pointer to a bit plane suitable
	    for use with [BltMaskBitMapRastPort()](../Includes_and_Autodocs_3._guide/node02B5.html), or NULL if the
	...
	PDTA_WhichPicture (ULONG) -- Index number of the picture to load.
	    ...
	    picture and also to count the number of pictures, like this:
	        ...
	        [Object](../Includes_and_Autodocs_3._guide/node0636.html#line18) * picture;
	        ULONG numPictures;
	        ...
	        if(numPictures != PDTANUMPICTURES_Unknown &&
	           numPictures > 1)
	        {
	            [Object](../Includes_and_Autodocs_3._guide/node0636.html#line18) * secondPicture;
