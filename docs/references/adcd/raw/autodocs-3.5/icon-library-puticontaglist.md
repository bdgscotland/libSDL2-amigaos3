# icon.library/PutIconTagList
   ...
   SYNOPSIS
	...
	[BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) PutIconTagList(STRPTR name,struct [DiskObject](../Includes_and_Autodocs_3._guide/node05D6.html#line64) *icon,
	                    struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *tags);

	success = PutIconTags(name,icon,tag1,...);

	[BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) PutIconTags(STRPTR name,struct [DiskObject](../Includes_and_Autodocs_3._guide/node05D6.html#line64) *icon,
...
```
   ...
   EXAMPLE
	...
	[BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) success;
   ...
   NOTES
	This function is a superset of [PutDefDiskObject()](../Includes_and_Autodocs_3._guide/node0355.html) and [PutDiskObject()](../Includes_and_Autodocs_3._guide/node0356.html).
