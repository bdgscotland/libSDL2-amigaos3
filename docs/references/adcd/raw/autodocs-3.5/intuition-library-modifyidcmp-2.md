# intuition.library/ModifyIDCMP
    ...
    SYNOPSIS
	Success = ModifyIDCMP( [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908), IDCMPFlags )
	D0 (V37)               A0      D0

	[BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) ModifyIDCMP( struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) *, ULONG );
	/* returns [BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) in V37 and greater */

    FUNCTION
	This routine modifies the state of your window's IDCMP (Intuition
	Direct Communication [Message](../Includes_and_Autodocs_3._guide/node062E.html#line46) Port).  The state is modified to reflect
...
```c
       ...
       - if there is currently no IDCMP in the given window, and any of the
         ...
         [Output](../Includes_and_Autodocs_3._guide/node0198.html) Methods" chapter of the Intuition Reference Manual for full
```
	  details
```c
...
```
	  or [OpenWindow()](../Includes_and_Autodocs_3._guide/node03D5.html) ).
...
```c
       - [OpenWindow()](../Includes_and_Autodocs_3._guide/node03D5.html) with IDCMPFlags equal to NULL (open no ports)
       ...
       - then, to clean up later, set UserPort equal to NULL before calling
         [CloseWindow()](../Includes_and_Autodocs_3._guide/node03A0.html) (leave IDCMPFlags alone)  BUT FIRST: you must make
```
	...
	see the description for [CloseWindow()](../Includes_and_Autodocs_3._guide/node03A0.html).


    INPUTS
	[Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) = pointer to the [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) structure containing the IDCMP ports
	IDCMPFlags = the flag bits describing the new desired state of
	    ...
	    - IDCMP_MENUVERIFY (see immediately below), specifies that you
	      ...
	      about to be blasted into your [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908).  If you're drawing
	    ...
	    - IDCMP_SIZEVERIFY means that you will be doing output to your
	      ...
	      Intuition will send you the IDCMP_SIZEVERIFY message and [Wait()](../Includes_and_Autodocs_3._guide/node0246.html)
	      until you reply that it's OK to proceed with the sizing. NOTE:
	      when we say that Intuition will [Wait()](../Includes_and_Autodocs_3._guide/node0246.html) until you reply, what
	      ...
	      IDCMP [Message](../Includes_and_Autodocs_3._guide/node062E.html#line46) you receive, reply to it promptly!  Then, after
	    ...
	    - IDCMP_NEWPREFS indicates you wish to be notified when the
	      system-wide [Preferences](../Includes_and_Autodocs_3._guide/node063B.html#line57) changes.  For V36, there is a new
	      environment mechanism to replace [Preferences](../Includes_and_Autodocs_3._guide/node063B.html#line57), which we
	    ...
	    - IDCMP_CHANGEWINDOW is a new class for V36 that will be sent
	      ...
	      by the user or the functions [SizeWindow()](../Includes_and_Autodocs_3._guide/node03FA.html), [MoveWindow()](../Includes_and_Autodocs_3._guide/node03C8.html),
	      [ChangeWindowBox()](../Includes_and_Autodocs_3._guide/node039B.html), or [ZipWindow()](../Includes_and_Autodocs_3._guide/node0407.html).
	    ...
	    - IDCMP_GADGETHELP is new for V39.  If you turn on
	      gadget help for your window (using the [HelpControl()](../Includes_and_Autodocs_3._guide/node03BB.html))
	      ...
	      [IntuiMessage](../Includes_and_Autodocs_3._guide/node05E0.html#line762) is sent.
    ...
    SEE ALSO
	[OpenWindowTagList()](../Includes_and_Autodocs_3._guide/node03D6.html), [OpenWindow()](../Includes_and_Autodocs_3._guide/node03D5.html), [CloseWindow()](../Includes_and_Autodocs_3._guide/node03A0.html)
