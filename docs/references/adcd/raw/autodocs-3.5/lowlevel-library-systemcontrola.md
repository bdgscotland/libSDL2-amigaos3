# lowlevel.library/SystemControlA
   ...
   SYNOPSIS
	...
	ULONG SystemControlA(struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *);
   ...
   TAGS
	SCON_TakeOverSys (BOOL)
		TRUE -	Takes over the CPU to ensure that a program gets every
			...
			completely to the program. [Task](../Includes_and_Autodocs_3._guide/node064B.html#line23) switching will be
			...
			during a [Wait()](../Includes_and_Autodocs_3._guide/node0246.html) on a signal, multitasking will
	...
	SCON_AddCreateKeys (ULONG) - Starts creating rawkey codes for the
	    ...
	    [intuition.library/OpenWindow()](../Includes_and_Autodocs_3._guide/node03D5.html) autodoc.
