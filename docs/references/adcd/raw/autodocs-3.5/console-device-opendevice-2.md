# console.device/OpenDevice
    ...
    SYNOPSIS
	error = OpenDevice("console.device", unit, [IOStdReq](../Includes_and_Autodocs_3._guide/node0621.html#line26), flags )
	d0		    a0               d0    a1        d1

    FUNCTION
	The open routine grants access to a device.  There are two
	fields in the [IOStdReq](../Includes_and_Autodocs_3._guide/node0621.html#line26) block that will be filled in: the
	...
	io_Data field of the [IOStdReq](../Includes_and_Autodocs_3._guide/node0621.html#line26) block.  This initialization
	...
	which is returned in the io_Device field of the [IOStdReq](../Includes_and_Autodocs_3._guide/node0621.html#line26)
	...
	each character written with the [CMD_WRITE](../Includes_and_Autodocs_3._guide/node0102.html) command.
    ...
    IO REQUEST
	io_Data		struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) *window
	...
	[IOStdReq](../Includes_and_Autodocs_3._guide/node0621.html#line26) - a pointer to a standard request block
	...
	RAW INPUT EVENTS).  [Text](../Includes_and_Autodocs_3._guide/node0332.html) pasted in this way appears in the
	...
	reasonable (e.g., no more than 1K characters per [CMD_WRITE](../Includes_and_Autodocs_3._guide/node0102.html), and
    ...
    SEE ALSO
	[exec/io.h](../Includes_and_Autodocs_3._guide/node0621.html), [intuition/intuition.h](../Includes_and_Autodocs_3._guide/node05E0.html)
