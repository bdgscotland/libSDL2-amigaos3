# exec.library/MakeLibrary
   ...
   SYNOPSIS
	...
	struct [Library](../Includes_and_Autodocs_3._guide/node0626.html#line33) *MakeLibrary
			      (APTR,struct [InitStruct](../Includes_and_Autodocs_3._guide/node0218.html) *,[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37),ULONG,BPTR);
   ...
   INPUTS
	...
	init -	If non-NULL, an entry point that will be called before adding
		the library to the system.  Registers are as follows:
			d0 = libAddr 	;Your [Library](../Includes_and_Autodocs_3._guide/node0626.html#line33) Address
			a0 = segList	;Your AmigaDOS segment list
			a6 = [ExecBase](../Includes_and_Autodocs_3._guide/node0609.html#line33)	;Address of exec.library
...
```
   ...
   SEE ALSO
	[InitStruct()](../Includes_and_Autodocs_3._guide/node0218.html), [InitResident()](../Includes_and_Autodocs_3._guide/node0216.html), exec/initializers.i
