# SAD/--Overview--
 ...
 CPU control functions work and that [ExecBase](../Includes_and_Autodocs_3._guide/node0609.html#line33) be valid.  Beyond that,
 ...
 [Read](../Includes_and_Autodocs_3._guide/node01A0.html) and [Write](../Includes_and_Autodocs_3._guide/node01D1.html) memory as byte, word, and longword.
 ...
 (A call to [CacheClearU()](../Includes_and_Autodocs_3._guide/node01F0.html) will be made after the write and before
 ...
 [Debug()](../Includes_and_Autodocs_3._guide/node01FF.html) and not the NMI hook, SAD will use $3F as the "heart beat"
 ...
 unstable state.  (NMI can happen in the middle of the [AllocMem](../Includes_and_Autodocs_3._guide/node01E7.html) routine
 or task switch, etc)
 ...
 that if you want to write a WORD or [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39) that the address will need to
 ...
 When entered via [Debug()](../Includes_and_Autodocs_3._guide/node01FF.html), you are now running as a "task" so you will
 ...
 state.  When $3F prompting, SAD will only do a [Forbid()](../Includes_and_Autodocs_3._guide/node020C.html).  It is possible
 for you to then disable interrupts as needed.  This is done such that it
 is possible to "run" the system from SAD when called with [Debug()](../Includes_and_Autodocs_3._guide/node01FF.html).
 ...
 See the entry for [GET_CONTEXT_FRAME](../Includes_and_Autodocs_3._guide/node024D.html) for more details

 ----------------------------------------------------------------------------
-

 BUGS
	In V39 EXEC, the [WRITE_BYTE](../Includes_and_Autodocs_3._guide/node0258.html) command was not connected and this
	caused all of the command numbers to be off-by-one.  For example,
	the [READ_WORD](../Includes_and_Autodocs_3._guide/node0252.html) command is listed as command $05 but in V39 is $04.
	However, the ACK of the commands are still correct.

	Also, in V39 EXEC, the [READ_WORD](../Includes_and_Autodocs_3._guide/node0252.html) command would return the wrong
	data.

	To determin if you are in V39 or V40 SAD, you can issue a simple
	SAD command at the start of the session.  By sending a [READ_WORD](../Includes_and_Autodocs_3._guide/node0252.html)
	command, you may either get a [READ_WORD](../Includes_and_Autodocs_3._guide/node0252.html) (V40) or a [READ_LONG](../Includes_and_Autodocs_3._guide/node0251.html) (V39)
	ACK'ed back.  So the data stream for a safe test would be:

	Send: $AF $05 $00 $F8 $00 $00               ; [Read](../Includes_and_Autodocs_3._guide/node01A0.html) start of ROM...
