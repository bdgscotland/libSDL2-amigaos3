# exec.library/AddMemHandler
   ...
   SYNOPSIS
	...
	VOID AddMemHandler(struct [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) *);

   FUNCTION
	This function adds a low memory handler to the system.  The handler
	is described in the [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) structure.  Due to multitasking
   ...
   EXAMPLE
	struct [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) *myInt;  /* Assume it is allocated */
	...
	_myhandler_code:
			...
			; We are passed a pointer to struct [MemHandlerData](../Includes_and_Autodocs_3._guide/node062D.html#line89)
			; in a0, the value of is_Data in a1 and
			; [ExecBase](../Includes_and_Autodocs_3._guide/node0609.html#line33) in a6.
   ...
   INPUTS
	memHandler - A pointer to a completely filled in [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) structure
   ...
   SEE ALSO
	[RemMemHandler()](../Includes_and_Autodocs_3._guide/node022E.html), exec/interrupts.i
