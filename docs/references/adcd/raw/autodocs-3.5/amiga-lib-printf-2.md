# amiga.lib/printf
   ...
   FUNCTION
	[Format](../Includes_and_Autodocs_3._guide/node016B.html) the output in accordance with specifications in the format
	string.
   ...
   NOTE
	...
	[dos.library/Output()](../Includes_and_Autodocs_3._guide/node0198.html) call returns). This code would set it up:
