# clipboard.device/CBD_POST
   ...
   FUNCTION
	...
	post's io_ClipID with that returned by the [CBD_CURRENTREADID](../Includes_and_Autodocs_3._guide/node00D5.html)
	...
	[CBD_CURRENTWRITEID](../Includes_and_Autodocs_3._guide/node00D6.html) command.  If the current write io_ClipID is
