# exec.library/Allocate
   ...
   SYNOPSIS
	...
	void *Allocate(struct [MemHeader](../Includes_and_Autodocs_3._guide/node062D.html#line27) *, ULONG);

   FUNCTION
	This function is used to allocate blocks of memory from a given
	private free memory pool (as specified by a [MemHeader](../Includes_and_Autodocs_3._guide/node062D.html#line27) and its
	...
	memory.  Note that no arbitration of the [MemHeader](../Includes_and_Autodocs_3._guide/node062D.html#line27) and associated
   ...
   EXAMPLE
	...
	#include [<exec/memory.h>](../Includes_and_Autodocs_3._guide/node062D.html)
	void *AllocMem();
	#define BLOCKSIZE 4096L /* Or whatever you want */

	void main()
	{
	struct [MemHeader](../Includes_and_Autodocs_3._guide/node062D.html#line27) *mh;
	struct [MemChunk](../Includes_and_Autodocs_3._guide/node062D.html#line19)  *mc;
	[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37)   block1;
	[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37)   block2;

	    /* Get the [MemHeader](../Includes_and_Autodocs_3._guide/node062D.html#line27) needed to keep track of our new block */
	    mh = (struct [MemHeader](../Includes_and_Autodocs_3._guide/node062D.html#line27) *)
		 AllocMem((long)sizeof(struct MemHeader), MEMF_CLEAR );
	    if( !mh )
		exit(10);

	    /* Get the actual block the above [MemHeader](../Includes_and_Autodocs_3._guide/node062D.html#line27) will manage */
	    mc = (struct [MemChunk](../Includes_and_Autodocs_3._guide/node062D.html#line19) *)AllocMem( BLOCKSIZE, 0L );
	    if( !mc )
		{
   ...
   SEE ALSO
	[Deallocate()](../Includes_and_Autodocs_3._guide/node01FE.html), [exec/memory.h](../Includes_and_Autodocs_3._guide/node062D.html)
