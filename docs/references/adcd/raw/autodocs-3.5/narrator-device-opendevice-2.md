# narrator.device/OpenDevice
   ...
   SYNOPSIS
	error = OpenDevice("narrator.device",  unit, [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17), flags);
	 D0                       A0            D0     A1         D1
   ...
   FUNCTION
	...
	fields in the user's [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block (see below).  If users wish
	...
	the device node pointer in the [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block and clears the
	delayed expunge bit.

	***** NEW FOR V37 NARRATOR *****

	Several new fields in the [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block have been added for V37
	...
	[IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block.  Note that NDB_NEWIORB is set in the [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17)
   ...
   INPUTS
	...
	unit       - 0
	[IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17)  - Pointer to the user's [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block
	flags	   - 0


   RESULTS
	The narrator device will initialize the [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block as follows
   ...
   SEE ALSO
	The include files contain the complete [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17) block definition,
