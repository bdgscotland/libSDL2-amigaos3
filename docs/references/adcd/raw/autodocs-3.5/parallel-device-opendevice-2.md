# parallel.device/OpenDevice
   ...
   NAME
	[Open](../Includes_and_Autodocs_3._guide/node0196.html) -- a request to open the parallel port
   ...
   FUNCTION
	...
	access [Open()](../Includes_and_Autodocs_3._guide/node0196.html).
	...
	modified using the [PDCMD_SETPARAMS](../Includes_and_Autodocs_3._guide/node04F6.html) command.

   INPUTS
	"parallel.device" - a pointer to literal string "parallel.device"
	unit - Must be zero for future compatibility
	ioExtPar - pointer to an IO [Request](../Includes_and_Autodocs_3._guide/node03E5.html) block of structure IOExtPar to
		   be initialized by the [Open()](../Includes_and_Autodocs_3._guide/node0196.html) function. The io_ParFlags
   ...
   SEE ALSO
	[exec/CloseDevice()](../Includes_and_Autodocs_3._guide/node0558.html)
