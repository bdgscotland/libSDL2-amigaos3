...
```c
       window_cl -- create Intuition [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) objects
```
   SUPERCLASS
...
```c
       ...
       Layout processing, etc. [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) class properly handles processing
       messages using shared window message ports as well as safely
       closing intuition windows. [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) class will also intialize
...
```c
       ...
       [WM_OPEN](../Includes_and_Autodocs_3._guide/node05CE.html) -- Locks default pub screen if needed, domains child layout
           group min/max size, opens window, attaches layout to window.

       [WM_CLOSE](../Includes_and_Autodocs_3._guide/node05CB.html) -- Closes the intuition window, but does not dispose
           the layout group.

       [WM_ICONIFY](../Includes_and_Autodocs_3._guide/node05CD.html) -- Create [AppIcon](../Includes_and_Autodocs_3._guide/node05D6.html#line162), and invokes [WM_CLOSE](../Includes_and_Autodocs_3._guide/node05CB.html).

       [WM_HANDLEINPUT](../Includes_and_Autodocs_3._guide/node05CC.html) -- Handles IDCMP input processing, defer layout
