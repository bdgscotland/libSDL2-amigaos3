# gadtools.library/CreateGadgetA
   ...
   SYNOPSIS
	...
	struct [Gadget](../Includes_and_Autodocs_3._guide/node05E0.html#line213) *CreateGadgetA(ULONG, struct [Gadget](../Includes_and_Autodocs_3._guide/node05E0.html#line213) *,
	                             struct [NewGadget](../Includes_and_Autodocs_3._guide/node062A.html#line82) *, struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *);

	gad = CreateGadget(kind, previous, newgad, firsttag, ...)

	struct [Gadget](../Includes_and_Autodocs_3._guide/node05E0.html#line213) *CreateGadget(ULONG, struct [Gadget](../Includes_and_Autodocs_3._guide/node05E0.html#line213) *,
	                            struct [NewGadget](../Includes_and_Autodocs_3._guide/node062A.html#line82) *, [Tag](../Includes_and_Autodocs_3._guide/node064C.html#line29), ...);

   FUNCTION
	CreateGadgetA() allocates and initializes a new gadget of the
	specified kind, and attaches it to the previous gadget.  The
	gadget is created based on the supplied kind, [NewGadget](../Includes_and_Autodocs_3._guide/node062A.html#line82) structure,
	and tags.

   INPUTS
	kind - kind of gadget is to be created, one of the XXX_KIND values
	       defined in [<libraries/gadtools.h>](../Includes_and_Autodocs_3._guide/node062A.html)
	previous - pointer to the previous gadget that this new gadget
	           is to be attached to. This function will fail if this value
		   is NULL
	newgad - a filled in [NewGadget](../Includes_and_Autodocs_3._guide/node062A.html#line82) structure describing the desired
   ...
   TAGS
	...
	GTIN_EditHook (struct [Hook](../Includes_and_Autodocs_3._guide/node0617.html#line27) *) - [Hook](../Includes_and_Autodocs_3._guide/node0617.html#line27) to use as a custom
	...
	GTLV_Labels (struct [List](../Includes_and_Autodocs_3._guide/node0628.html#line19) *) - [List](../Includes_and_Autodocs_3._guide/node0628.html#line19) of nodes whose ln_Name fields
	...
	GTLV_ShowSelected (struct [Gadget](../Includes_and_Autodocs_3._guide/node05E0.html#line213) *) - NULL to have the currently
	...
	GTLV_CallBack (struct [Hook](../Includes_and_Autodocs_3._guide/node0617.html#line27) *) - Callback hook for various listview
		...
		A1 - struct [LVDrawMsg](../Includes_and_Autodocs_3._guide/node062A.html#line444) *
		A2 - struct [Node](../Includes_and_Autodocs_3._guide/node062F.html#line21) *
	...
	GTNM_Format (STRPTR) - C-Style formatting string to apply on the number
	    ...
	    is processed using [exec.library/RawDoFmt()](../Includes_and_Autodocs_3._guide/node0227.html), so refer to that
	...
	GTSL_LevelPlace - One of PLACETEXT_LEFT, PLACETEXT_RIGHT,
	    ...
	    (V36)
	GTSL_DispFunc ( [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39) (*function)(struct [Gadget](../Includes_and_Autodocs_3._guide/node05E0.html#line213) *, WORD) ) - Function
	    ...
	    (a WORD) as the second, and return the result as a [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39). (V36)
	...
	GTST_EditHook (struct [Hook](../Includes_and_Autodocs_3._guide/node0617.html#line27) *) - [Hook](../Includes_and_Autodocs_3._guide/node0617.html#line27) to use as a custom string gadget
   ...
   NOTES
	...
	[NewGadget](../Includes_and_Autodocs_3._guide/node062A.html#line82) structure must be set to valid VisualInfo and
	[TextAttr](../Includes_and_Autodocs_3._guide/node05EC.html#line64) pointers, or this function will fail.
   ...
   SEE ALSO
	[FreeGadgets()](../Includes_and_Autodocs_3._guide/node0278.html), GT_SetGadgetAttrs(), GetVisualInfo(),
	[<libraries/gadtools.h>](../Includes_and_Autodocs_3._guide/node062A.html)
