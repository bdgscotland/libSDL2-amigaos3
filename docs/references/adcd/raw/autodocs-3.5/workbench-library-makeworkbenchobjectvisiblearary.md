# workbench.library/MakeWorkbenchObjectVisibleArary/MakeWorkbenchObjectVisibleA
   ...
   SYNOPSIS
	...
	[BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) MakeWorkbenchObjectVisibleA(STRPTR name,struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *tags);

	success = MakeWorkbenchObjectVisible(name,...);

	[BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) MakeWorkbenchObjectVisible(STRPTR name,...);
