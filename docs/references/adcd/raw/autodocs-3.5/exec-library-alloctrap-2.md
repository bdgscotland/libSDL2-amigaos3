# exec.library/AllocTrap
   ...
   SYNOPSIS
	...
	[LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39) AllocTrap(LONG);

   FUNCTION
	[Allocate](../Includes_and_Autodocs_3._guide/node01E5.html) a trap number from the current task's pool.  These trap
