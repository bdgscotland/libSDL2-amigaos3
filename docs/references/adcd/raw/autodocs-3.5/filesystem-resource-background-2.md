# FileSystem.resource/--background--
   ...
   CONTENTS
	...
	[resources/filesysres.h](../Includes_and_Autodocs_3._guide/node060C.html).  The nodes on it describe how to
	algorithmically convert the result of [MakeDosNode](../Includes_and_Autodocs_3._guide/node0266.html) (from the
	expansion.library) to a node appropriate for the dos type.

	[FileSysEntry](../Includes_and_Autodocs_3._guide/node060C.html#line30)
	    ...
	    fse_Startup		startup msg: [FileSysStartupMsg](../Includes_and_Autodocs_3._guide/node05FD.html#line80) for disks
