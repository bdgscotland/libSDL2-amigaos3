# console.device/CMD_WRITE
   ...
   NAME
	CMD_WRITE -- [Write](../Includes_and_Autodocs_3._guide/node01D1.html) ANSI text to the console display.

   FUNCTION
	[Write](../Includes_and_Autodocs_3._guide/node01D1.html) a text record to the display.  Interpret the ANSI
   ...
   ANSI CODES SUPPORTED
	...
	-----	---	----------------------------------------------
	00/ 7	BEL	BELL: actually an Intuition [DisplayBeep()](../Includes_and_Autodocs_3._guide/node03A4.html)
	00/ 8	BS	BACKSPACE
	...
	Esc   Name Definition
	----- ---- ---------------------------------------------------
	c     RIS  [RESET](../Includes_and_Autodocs_3._guide/node0253.html) TO INITIAL STATE: reset the console display.
	...
	R   2	CPR  CURSOR POSITION REPORT (in [Read](../Includes_and_Autodocs_3._guide/node01A0.html) stream only)
	S   1-	SU   SCROLL UP
	T   1-	SD   SCROLL DOWN
	...
	l   n	RM   [RESET](../Includes_and_Autodocs_3._guide/node0253.html) MODE: see modes below.
	...
	|   8	aIER  INPUT EVENT REPORT (private Amiga [Read](../Includes_and_Autodocs_3._guide/node01A0.html) sequence)
	}   n	aRRE  [RESET](../Includes_and_Autodocs_3._guide/node0253.html) RAW EVENTS (private Amiga sequence)
	~   1	aSKR  SPECIAL KEY REPORT (private Amiga [Read](../Includes_and_Autodocs_3._guide/node01A0.html) sequence)
	 p  1-	aSCR  SET CURSOR RENDITION (private Amiga sequence)
	 q  0	aWSR  WINDOW STATUS REQUEST (private Amiga sequence)
	 r  4	aWBR  WINDOW BOUNDS REPORT (private Amiga [Read](../Includes_and_Autodocs_3._guide/node01A0.html) sequence)
	 s  0	aSDSS SET DEFAULT SGR SETTINGS (private Amiga sequence-V39)
	 v  1	aRAV  RIGHT AMIGA V PRESS (private Amiga [Read](../Includes_and_Autodocs_3._guide/node01A0.html) sequence-V37)
	...
	console, the current Pen color, Cell color, [Text](../Includes_and_Autodocs_3._guide/node0332.html) style, and
    ...
    SEE ALSO
	ROM Kernel Manual (Volume 1), [exec/io.h](../Includes_and_Autodocs_3._guide/node0621.html)
