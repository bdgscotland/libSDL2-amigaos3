# intuition.library/OpenScreen
    ...
    NAME
	OpenScreen -- [Open](../Includes_and_Autodocs_3._guide/node0196.html) an Intuition screen.

    SYNOPSIS
	[Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) = OpenScreen( [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) )
	D0		     A0

	struct [Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) *OpenScreen( struct [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) * );

	or

	struct [Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) *OpenScreen( struct [ExtNewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line512) * );

    FUNCTION
	Opens an Intuition screen according to the specified parameters
	found in the [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) structure.
	...
	Intuition's [View](../Includes_and_Autodocs_3._guide/node05ED.html#line63) structure.

	Before you call OpenScreen(), you must initialize an instance of
	a [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) structure.  [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) is a structure that contains
	all of the arguments needed to open a screen.  The [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476)
	...
	To change this, you must call the routine [ShowTitle()](../Includes_and_Autodocs_3._guide/node03F9.html).

    INPUTS
	[NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) = pointer to an instance of a [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) structure.

	New for V36:
	In addition to the information contained in the [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) structure,
	Intuition now recognizes extended data passed in the form
	of an array of [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) structures (from [<utility/tagitem.h>](../Includes_and_Autodocs_3._guide/node064C.html)),
	commonly called a "tag list."

	There are two ways to provide this array.  The first is to
	use the new Intuition entry point [OpenScreenTagList()](../Includes_and_Autodocs_3._guide/node03D4.html) and
	...
	entry point, and an extension of the [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) structure named
	[ExtNewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line512).  See the documentation of the flag NS_EXTENDED,
	below.

	While we recommend that you use [OpenScreenTagList()](../Includes_and_Autodocs_3._guide/node03D4.html) rather than
	...
	[NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) is initialized with the following information:
	-------------------------------------------------------------
	...
	Width = the width for this screen's [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53)

	Height = the height for this screen's [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53), or the constant
		...
		screen [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) is to be the same dimensions as your
		...
		Furthermore, if you are using [OpenScreenTagList()](../Includes_and_Autodocs_3._guide/node03D4.html), and you
		specify STDSCREENWIDTH, and you DO NOT provide a [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476)
	...
	Type = screen type values
		...
		in the bitmap field of the [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) structure.  Intuition is
...
```
	    [For V36: The ViewModes field is superseded by a [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) with
	    tag value SA_DisplayID.]

	Font = pointer to the default [TextAttr](../Includes_and_Autodocs_3._guide/node05EC.html#line64) structure for text in this
	    screen and all windows that open in this screen.  [Text](../Includes_and_Autodocs_3._guide/node0332.html) that uses
	    this [TextAttr](../Includes_and_Autodocs_3._guide/node05EC.html#line64) includes title bars of both screen and windows,
	    string gadgets, and menu titles.  Of course, [IntuiText](../Includes_and_Autodocs_3._guide/node05E0.html#line655) that
	    specifies a NULL [TextAttr](../Includes_and_Autodocs_3._guide/node05EC.html#line64) field will use the screen/window default
	    fonts.  NOTE: Intuition will *NOT* call [OpenDiskFont()](../Includes_and_Autodocs_3._guide/node0137.html), so
	    the [TextAttr](../Includes_and_Autodocs_3._guide/node05EC.html#line64) you supply must be in memory.  The ways to ensure
	    that are to either use a ROM font (Topaz 8 or 9) or first
	    call [OpenDiskFont()](../Includes_and_Autodocs_3._guide/node0137.html) to load the font, and don't close it
	...
	CustomBitMap = if you're not supplying a custom bitmap, this value is
	    ...
	    the [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) structure that describes your display memory.  See the
           "Screens" chapter and the "Amiga ROM Kernel Manual" for more
           information about bitmaps.
	    [For V36: this is superseded by SA_BitMap.]

	[ All [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) extensions below are new for V36.]
	Extension = if NS_EXTENDED is set in NewScreen.Type, this pointer
	    should point to an array (or chain of arrays) of TagItems,
	    as defined in the include file [<utility/tagitem.h>](../Includes_and_Autodocs_3._guide/node064C.html).   This
	    field is only defined in the structure [ExtNewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line512).
	    The values to use for TagItem.ti_Tag are defined below.  We
	    recommend that V36-specific applications use the new Intuition
	    entry point [OpenScreenTagList()](../Includes_and_Autodocs_3._guide/node03D4.html), rather than using this field.
	    The [ExtNewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line512) structure is a convenient way to give V36
	    Intuition some information that V34 and earlier Intuition will
	    ignore.

	    Each [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) is an optional tagged data structure which identifies
	    ...
	    to familiar fields in [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476).  (Defaults only apply if
	    [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) == NULL).  They are:
	...
	SA_Height
	    ...
	    these tags are specified, and no [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) structure is
	    ...
	    non-zero.  If a [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) structure is supplied, then the
	    left/top/width/height come originally from there.  If no
	    [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) structure is supplied, but a non-default
	    ...
	    a [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476), you must supply correct values for SA_Left
	    ...
	    may use [QueryOverscan()](../Includes_and_Autodocs_3._guide/node03DB.html) to get a rectangle for that
	    overscan type.
	...
	SA_DisplayID: ti_Data is a 32-bit extended display mode ID, as
	  defined in the [<graphics/modeid.h>](../Includes_and_Autodocs_3._guide/node0661.html) include file (V39 and up)
	  or in [<graphics/displayinfo.h>](../Includes_and_Autodocs_3._guide/node05FF.html) (V37 and V38).
	...
	SA_Overscan: ti_Data contains a defined constant specifying
	    ...
	    OSCAN_TEXT - [Text](../Includes_and_Autodocs_3._guide/node0332.html) Overscan region.  A region which is completely
	    ...
	    and any DisplayClip or [Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) region within this rectangle
	    ...
	    [Remember](../Includes_and_Autodocs_3._guide/node05E0.html#line1429), using overscan drastically effects memory use and
	...
	SA_DClip: ti_Data is a pointer to a rectangle which explicitly
	    defines a DisplayClip region for this screen.  See [QueryOverscan()](../Includes_and_Autodocs_3._guide/node03DB.html)
	...
	SA_Pens: The ti_Data field (if non-NULL) points to a [UWORD](../Includes_and_Autodocs_3._guide/node0654.html#line43)
	    array of pen specification, as defined for struct [DrawInfo](../Includes_and_Autodocs_3._guide/node0602.html#line65).
	    ...
	    The way the [DrawInfo](../Includes_and_Autodocs_3._guide/node0602.html#line65) pens are determined is Intuition
	...
	SA_PubTask:  [Task](../Includes_and_Autodocs_3._guide/node064B.html#line23) to be signalled.  If absent (and SA_PubSig is
	    valid), use the task which called OpenScreen() or
	    [OpenScreenTagList()](../Includes_and_Autodocs_3._guide/node03D4.html)).

	SA_PubSig:  Data is a [UBYTE](../Includes_and_Autodocs_3._guide/node0654.html#line50) signal number (not flag) used to notify
	    a task when the last visitor window closes on a public screen.

	SA_Colors: ti_Data points to an array of [ColorSpec](../Includes_and_Autodocs_3._guide/node05E0.html#line1445) structures
	...
	SA_FullPalette: this is a Boolean attribute.  Prior to V36, there
	    ...
	    graphics [(graphics.library/GetColorMap()](../Includes_and_Autodocs_3._guide/node02E3.html)) then these
	...
	SA_ErrorCode: ti_Data points to a ULONG in which Intuition will
	    ...
	    values defined in [graphics.library/ModeNotAvailable()](../Includes_and_Autodocs_3._guide/node0300.html).
	...
	SA_SysFont: ti_Data selects one of the system standard fonts
	    ...
	    the window [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) will be initialized to the old-style
	...
	Attached screen tags:  V39 supports attached screens, where
	    ...
	    the V39 [ScreenDepth()](../Includes_and_Autodocs_3._guide/node03E8.html) call.  If a child screen is
	...
	SA_BackFill:  ti_Data is a pointer to a backfill hook for
	    the screen's [Layer_Info](../Includes_and_Autodocs_3._guide/node0625.html#line30).
	...
	SA_Draggable:  ti_Data is a boolean.  Set to FALSE if you
	    ...
	    [ScreenPosition()](../Includes_and_Autodocs_3._guide/node03E9.html).  (V39)
	...
	SA_Colors32:  [Tag](../Includes_and_Autodocs_3._guide/node064C.html#line29) to set the screen's initial palette colors
	    at 32 bits-per-gun.  ti_Data is a pointer to a table to be
	    passed to the [graphics.library/LoadRGB32()](../Includes_and_Autodocs_3._guide/node02FB.html) function.  This
	...
	SA_VideoControl:  ti_Data points to a taglist that will be
	    passed to [VideoControl()](../Includes_and_Autodocs_3._guide/node0338.html) after your screen is open.  You
	    might use this to turn on border-sprites, for example.
	    (V39).

	SA_ColorMapEntries:  ti_Data is the number of entries that
	    you wish Intuition to allocate for this screen's [ColorMap](../Includes_and_Autodocs_3._guide/node05ED.html#line142).
	    While Intuition allocates a suitable number for ordinary
	    use, certain graphics.library features require a
	    [ColorMap](../Includes_and_Autodocs_3._guide/node05ED.html#line142) which is larger than default.  (The default value is
	...
	SA_LikeWorkbench:  ti_Data is boolean.  Set to TRUE to get
	    ...
	    specified in the [NewScreen](../Includes_and_Autodocs_3._guide/node0602.html#line476) structure).  Attention
	    should be paid to hidden assumptions when doing this.  For
	    example, setting the depth to two makes assumptions about
	    the pen values in the [DrawInfo](../Includes_and_Autodocs_3._guide/node0602.html#line65) pens.  Note that this
 	...
 	SA_MinimizeISG:  ti_Data is boolean.  For compatibility,
	    ...
	    [VideoControl()](../Includes_and_Autodocs_3._guide/node0338.html) VC_NoColorPaletteLoad tag for your screen's
	    [ViewPort](../Includes_and_Autodocs_3._guide/node05ED.html#line46), you should also set this tag.  (V40)
	...
	#include "libraries/dosextens.h"
		...
	struct [Process](../Includes_and_Autodocs_3._guide/node05D9.html#line36)	*process;
	struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908)	*window;
	[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37)		temp;
		...
		process = (struct [Process](../Includes_and_Autodocs_3._guide/node05D9.html#line36) *) FindTask(NULL);
		...
		( restore value BEFORE [CloseWindow()](../Includes_and_Autodocs_3._guide/node03A0.html) )
		CloseWindow(window);
    ...
    SEE ALSO
	[OpenScreenTagList()](../Includes_and_Autodocs_3._guide/node03D4.html), [OpenWindow()](../Includes_and_Autodocs_3._guide/node03D5.html), [PrintIText()](../Includes_and_Autodocs_3._guide/node03D9.html), [CloseScreen()](../Includes_and_Autodocs_3._guide/node039F.html),
	[QueryOverscan()](../Includes_and_Autodocs_3._guide/node03DB.html) [PubScreenStatus()](../Includes_and_Autodocs_3._guide/node03DA.html), The Intuition Reference Manual,
	[utility/tagitem.h](../Includes_and_Autodocs_3._guide/node064C.html), [graphics.library/ModeNotAvailable()](../Includes_and_Autodocs_3._guide/node0300.html),
	[diskfont.library/OpenDiskFont()](../Includes_and_Autodocs_3._guide/node0137.html), [graphics.library/GetColorMap()](../Includes_and_Autodocs_3._guide/node02E3.html)
