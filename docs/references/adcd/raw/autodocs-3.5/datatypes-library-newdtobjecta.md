# datatypes.library/NewDTObjectA
	...
	[Object](../Includes_and_Autodocs_3._guide/node0636.html#line18) *NewDTObjectA (APTR, struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *);

	o = NewDTObject (name, tag1, ...);

	[Object](../Includes_and_Autodocs_3._guide/node0636.html#line18) *NewDTObject (APTR, [Tag](../Includes_and_Autodocs_3._guide/node064C.html#line29) tag1, ...);
	...
	object via a [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) list, and they are applied to the
	...
	DTA_Handle - Can optionally be used instead of the name field.
	    Must be a valid [FileHandle](../Includes_and_Autodocs_3._guide/node05D9.html#line88) if DTA_SourceType is DTST_FILE.
	    Must be a valid [IFFHandle](../Includes_and_Autodocs_3._guide/node05E8.html#line43) if DTA_SourceType is DTST_CLIPBOARD.
	    Will be ignored if DTA_SourceType is DTST_MEMORY.

	DTA_DataType - Specify the class of data.  Data is a pointer to a
	    valid [DataType](../Includes_and_Autodocs_3._guide/node05F7.html#line174).  This is only used when attempting to create
	    a new object that doesn't have any source data.

	DTA_GroupID - Specify that the object must be of this type, or
	    NewDTObject() will fail with [IoErr()](../Includes_and_Autodocs_3._guide/node0182.html) of
	...
	You eventually free the object using [DisposeDTObject()](../Includes_and_Autodocs_3._guide/node0109.html).
	...
	ERROR_OBJECT_WRONG_TYPE - [Object](../Includes_and_Autodocs_3._guide/node0636.html#line18) data type doesn't match
	    DTA_GroupID.
    ...
    EXAMPLE
	[STRPTR](../Includes_and_Autodocs_3._guide/node0654.html#line57) fileName = "s:startup-sequence"
	[Object](../Includes_and_Autodocs_3._guide/node0636.html#line18) *o;

	/* Simplest use is to just open an existing file */
	if (o = NewDTObject ((APTR)fileName, NULL))
	{
	    /* Free the object when we are done with it */
	    [DisposeDTObject](../Includes_and_Autodocs_3._guide/node0109.html) (o);
	}

    SEE ALSO
	[AddDTObject()](../Includes_and_Autodocs_3._guide/node0108.html), [DisposeDTObject()](../Includes_and_Autodocs_3._guide/node0109.html), [RemoveDTObject()](../Includes_and_Autodocs_3._guide/node0118.html),
