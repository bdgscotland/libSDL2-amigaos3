# intuition.library/OpenWindow
    ...
    NAME
	OpenWindow -- [Open](../Includes_and_Autodocs_3._guide/node0196.html) an Intuition window.

    SYNOPSIS
   	[Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) = OpenWindow( [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) )
	D0                   A0

	struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) *OpenWindow( struct [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) * );

    FUNCTION
	Opens an Intuition window of the given dimensions and position,
	with the properties specified in the [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) structure.
	...
	you can provide extensions to the [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) parameters using
	and array of [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) structures.  See the discussion below,
	and the documentation for the function [OpenScreenTagList()](../Includes_and_Autodocs_3._guide/node03D4.html).

	Before you call OpenWindow(), you must initialize an instance of
	a [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) structure.  [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) is a structure that contains
	all of the arguments needed to open a window.  The [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086)
	structure may be discarded immediately after it is used to open
	the window.

	If Type == CUSTOMSCREEN, you must have opened your own screen
	already via a call to [OpenScreen()](../Includes_and_Autodocs_3._guide/node03D3.html).  Then Intuition uses your screen
	...
	reasons, we could not add the 'Extension' field to the [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086)
	structure, so we have define a new structure [ExtNewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1156), which
	is identical to [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) with the addition of the Extension field.

	We recommend that rather than using ExtNewWindow.Extension, you
	use the new Intuition function [OpenWindowTagList()](../Includes_and_Autodocs_3._guide/node03D6.html) and its
	varargs equivalent OpenWindowTags().  We document the window
	attribute tag ID's (ti_Tag values) here, rather than in
	[OpenWindowTagList()](../Includes_and_Autodocs_3._guide/node03D6.html), so that you can find all the parameters
    ...
    INPUTS
	[NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) = pointer to an instance of a [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) structure.  That
...
```
	...
	Flags = specifiers for your requirements of this window, including:
	    ...
	    - WFLG_REPORTMOUSE for whether or not you want to "listen" to
	      ...
	      [ReportMouse()](../Includes_and_Autodocs_3._guide/node03E4.html).  Whether or not your window is listening to
	    ...
	    - WFLG_NOCAREREFRESH indicates that you do not wish to
	      be responsible for calling [BeginRefresh()](../Includes_and_Autodocs_3._guide/node0397.html) and [EndRefresh()](../Includes_and_Autodocs_3._guide/node03AC.html)
	    ...
	    - WFLG_NW_EXTENDED (V36) indicates that [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) in fact points
	      to an [ExtNewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1156) structure, and that the 'Extension'
	      field points to an array of [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) structures, with
	      meaning described below.

	    - WFLG_NEWLOOKMENUS (V39) Requests new-look menu treatment.
	      [Menu](../Includes_and_Autodocs_3._guide/node05E0.html#line59) colors are derived from the screen [DrawInfo](../Includes_and_Autodocs_3._guide/node0602.html#line65) BARDETAILPEN,
	      ...
	      [DrawInfo](../Includes_and_Autodocs_3._guide/node0602.html#line65) pens to color their [MenuItem](../Includes_and_Autodocs_3._guide/node05E0.html#line87) and SubItem imagery.
	      ...
	      new menu pens in the [DrawInfo](../Includes_and_Autodocs_3._guide/node0602.html#line65).  If this is not the case,
	      then an application requesting NewLookMenus will get the
	      scaled Amiga-key and checkmark but in V37-compatible colors.
	      Note that the screen's [DrawInfo](../Includes_and_Autodocs_3._guide/node0602.html#line65) will always contain valid
	...
	IDCMPFlags = IDCMP is the acronym for Intuition Direct Communications
	    [Message](../Includes_and_Autodocs_3._guide/node062E.html#line46) Port.  (It's Intuition's sole acronym.) If any of the
	    ...
	    [Output](../Includes_and_Autodocs_3._guide/node0198.html) Methods" chapter of the Intuition Reference Manual for
	    complete details.
	    ...
	    [ModifyIDCMP()](../Includes_and_Autodocs_3._guide/node03C5.html) autodoc.

	Gadgets = the pointer to the first of a linked list of the your own
	      Gadgets which you want attached to this [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908).  Can be NULL
	      if you have no Gadgets of your own

```c
       CheckMark = a pointer to an instance of the struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) where can
```
...
```c
       [Text](../Includes_and_Autodocs_3._guide/node0332.html) = a null-terminated line of text to appear on the title bar of
```
...
```c
       [Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) = if your type is one of Intuition's standard screens, then
```
	      this argument is ignored.  However, if Type == CUSTOMSCREEN,
	      this must point to the structure of your own screen

```c
       [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) = if you have specified WFLG_SUPER_BITMAP as the type of
```
...
```
	      ...
	      [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) is opened by calling the [WindowLimits()](../Includes_and_Autodocs_3._guide/node0404.html) routine.
	      ...
	      themselves to call [SizeWindow()](../Includes_and_Autodocs_3._guide/node03FA.html) (or [ChangeWindowBox()](../Includes_and_Autodocs_3._guide/node039B.html)) without
	      ...
	      See also the docs on the function [WindowLimits()](../Includes_and_Autodocs_3._guide/node0404.html) for more
	      information.
...
```
	    ...
	    TagItems in general are described in [utility/tagitem.h](../Includes_and_Autodocs_3._guide/node064C.html),
	    and the OpenWindow tags are defined in [intuition/intuition.h](../Includes_and_Autodocs_3._guide/node05E0.html)
	...
	(and [OpenWindowTagList()](../Includes_and_Autodocs_3._guide/node03D6.html)).

	Certain tags simply override equivalent values in [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086),
	and allow you to open a window using [OpenWindowTagList()](../Includes_and_Autodocs_3._guide/node03D6.html) without
	having a [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) structure at all.  In each case, cast
	...
	WA_Flags	- initial values for Flags before looking at other
			  Boolean component [Tag](../Includes_and_Autodocs_3._guide/node064C.html#line29) values
	WA_Gadgets
	WA_Title
	...
	WA_ScreenTitle - You can specify the screen title associated
	    with your window this way, and avoid a call to [SetWindowTitles()](../Includes_and_Autodocs_3._guide/node03F8.html)
	...
	WA_AutoAdjust - a Boolean attribute which says that it's OK
	    ...
	    if you call OpenWindowTags() or [OpenWindowTagList()](../Includes_and_Autodocs_3._guide/node03D6.html)
	    with a NULL [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086) pointer, this attribute defaults
	    to TRUE).
	...
	WA_PubScreen - [Open](../Includes_and_Autodocs_3._guide/node0196.html) as a visitor window on the public screen
	    whose address if provided as (struct [Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) *) ti_Data.
		...
		3) use [LockPubScreen()](../Includes_and_Autodocs_3._guide/node03C1.html)
	    Using [exec.library/Forbid()](../Includes_and_Autodocs_3._guide/node020C.html) is not sufficient.
	...
	WA_MouseQueue - This tag specifies a limit for the number
	    ...
	    limit after the window is open using [SetMouseQueue()](../Includes_and_Autodocs_3._guide/node03F3.html).
	...
	WA_BackFill - ti_Data is a pointer to a [Hook](../Includes_and_Autodocs_3._guide/node0617.html#line27) structure that
	    the Layers library will call when your window needs
	    "backfilling."  See [layers.library/InstallLayerHook()](../Includes_and_Autodocs_3._guide/node0425.html).
	...
	WA_Checkmark - (ti_Data is struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *) [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) to use as a
	...
	WA_AmigaKey - (ti_Data is struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *) [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) to use as
	...
	WA_Pointer - (APTR) The pointer you wish to associate with
	    ...
	    default pointer.  [Custom](../Includes_and_Autodocs_3._guide/node05F6.html#line24) pointers should be allocated by
	    performing a [NewObject()](../Includes_and_Autodocs_3._guide/node03CB.html) on "pointerclass".  (See
	    <intuition/pointerclass.h>).  Defaults to NULL.  This tag is
	    also recognized by [SetWindowPointerA()](../Includes_and_Autodocs_3._guide/node03F7.html).  (V39)
	...
	WA_BusyPointer (BOOL) - Set to TRUE to request the [Preferences](../Includes_and_Autodocs_3._guide/node063B.html#line57)
	    ...
	    recognized by [SetWindowPointerA()](../Includes_and_Autodocs_3._guide/node03F7.html).  (V39)
	...
	WA_PointerDelay - (BOOL) Set to TRUE to defer changing your
	    ...
	    This tag is also recognized by [SetWindowPointerA()](../Includes_and_Autodocs_3._guide/node03F7.html).  (V39)
	...
	WA_HelpGroup - (ULONG) Normally, only the active window can
	    ...
	    unique help ID with [utility.library/GetUniqueID()](../Includes_and_Autodocs_3._guide/node05A4.html), then
	    pass it as ti_Data of this tag to all your windows.  See
	    [HelpControl()](../Includes_and_Autodocs_3._guide/node03BB.html).  (V39)

	WA_HelpGroupWindow - (struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) *) Instead of using
	...
	WA_TabletMessages - (BOOL) Set to TRUE to request extended
	    ...
	    [ExtIntuiMessage](../Includes_and_Autodocs_3._guide/node05E0.html#line821) structure.  Defaults to FALSE.  (V39)

   NOTES
	Regarding Public Screens, you can specify a window to be a
	"visitor window" on a public screen in one of several ways.
	In each case, you must be sure not to specify a [NewWindow](../Includes_and_Autodocs_3._guide/node05E0.html#line1086)
	...
	you want a visitor window to be opened on:
	    ...
	    - Use [LockPubScreen()](../Includes_and_Autodocs_3._guide/node03C1.html) to prevent the screen from closing.
	    ...
	    [LockPubScreen()](../Includes_and_Autodocs_3._guide/node03C1.html)	- obtain a pointer and a promise
	    layout window	- adapt your window to the screen you will use
	    OpenWindow()	- using the pointer you specify
	    [UnlockPubScreen()](../Includes_and_Autodocs_3._guide/node03FE.html)	- once your window is open, you can let go
	...
	These windows should NOT be "visitor" windows.  [Open](../Includes_and_Autodocs_3._guide/node0196.html) them
	...
	You should call [UnlockPubScreen()](../Includes_and_Autodocs_3._guide/node03FE.html) after your visitor window is open.
    ...
    RESULT
	If all is well, returns the pointer to your new [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908)
	If anything goes wrong, returns NULL

    BUGS
	When you open a window, Intuition will set the font of
	the window's [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) to the font of the window's screen.
	This does not work right for GimmeZeroZero windows: the
	BorderRPort [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) has the font set correctly, but
	...
	default font of your window's [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) if the screen's
	font is "fancy."  See the SA_SysFont attribute described
	under [OpenScreen()](../Includes_and_Autodocs_3._guide/node03D3.html).
...
```c
    SEE ALSO
       [OpenWindowTagList()](../Includes_and_Autodocs_3._guide/node03D6.html), [OpenScreen()](../Includes_and_Autodocs_3._guide/node03D3.html), [ModifyIDCMP()](../Includes_and_Autodocs_3._guide/node03C5.html), [SetWindowTitles()](../Includes_and_Autodocs_3._guide/node03F8.html),
```
	[LockPubScreen()](../Includes_and_Autodocs_3._guide/node03C1.html), [SetDefaultPubScreen()](../Includes_and_Autodocs_3._guide/node03EE.html), [ZipWindow()](../Includes_and_Autodocs_3._guide/node0407.html),
	[layers.library/InstallLayerHook()](../Includes_and_Autodocs_3._guide/node0425.html), [SetPubScreenModes()](../Includes_and_Autodocs_3._guide/node03F6.html)
