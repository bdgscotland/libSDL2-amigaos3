# exec.library/AllocMem
   ...
   INPUTS
	...
	attributes -
		...
		MEMF_LOCAL:	This is memory that will not go away
				after the CPU [RESET](../Includes_and_Autodocs_3._guide/node0253.html) instruction.  Normally,
				autoconfig memory boards become unavailable
				after [RESET](../Includes_and_Autodocs_3._guide/node0253.html) while motherboard memory
		...
		MEMF_NO_EXPUNGE	This will prevent an expunge to happen on
				...
				any expunge operations.  (See [AddMemHandler()](../Includes_and_Autodocs_3._guide/node01DC.html))
   ...
   EXAMPLES
	AllocMem(64,0L)		- [Allocate](../Includes_and_Autodocs_3._guide/node01E5.html) the best available memory
	AllocMem(25,MEMF_CLEAR) - [Allocate](../Includes_and_Autodocs_3._guide/node01E5.html) the best available memory, and
				  clear it before returning.
	AllocMem(128,MEMF_CHIP) - [Allocate](../Includes_and_Autodocs_3._guide/node01E5.html) chip memory
	AllocMem(128,MEMF_CHIP|MEMF_CLEAR) - [Allocate](../Includes_and_Autodocs_3._guide/node01E5.html) cleared chip memory
	AllocMem(821,MEMF_CHIP|MEMF_PUBLIC|MEMF_CLEAR) - [Allocate](../Includes_and_Autodocs_3._guide/node01E5.html) cleared,
		public, chip memory.
