# expansion.library/MakeDosNode
   ...
   SYNOPSIS
	...
	struct [DeviceNode](../Includes_and_Autodocs_3._guide/node05FD.html#line95) * MakeDosNode( void * );

   FUNCTION
	This routine manufactures the data structures needed to enter
	a dos disk device into the system.  This consists of a [DeviceNode](../Includes_and_Autodocs_3._guide/node05FD.html#line95),
	a [FileSysStartupMsg](../Includes_and_Autodocs_3._guide/node05FD.html#line80), a disk environment vector, and up to two
	bcpl strings.  See the [libraries/dosextens.h](../Includes_and_Autodocs_3._guide/node065D.html) and
	[libraries/filehandler.h](../Includes_and_Autodocs_3._guide/node065E.html) include files for more information.
	...
	then call [AddDosNode()](../Includes_and_Autodocs_3._guide/node025E.html) to enter the new device into the dos
	tables.
   ...
   INPUTS
	parameterPkt - a longword array containing all the information
	    ...
	    5-n 	file handler environment (see [libraries/filehandler.h)](../Includes_and_Autodocs_3._guide/node065E.html)

   RESULTS
	deviceNode - pointer to initialize device node structure, or
	    null if there was not enough memory.  You may need to change
	    certain fields before passing the [DeviceNode](../Includes_and_Autodocs_3._guide/node05FD.html#line95) to [AddDosNode()](../Includes_and_Autodocs_3._guide/node025E.html).
   ...
   EXAMPLES
	...
	ULONG parmPkt[] = {
	    ...
	    (ULONG) execName,
	    1,			/* unit number */
	    0,			/* [OpenDevice](../Includes_and_Autodocs_3._guide/node0560.html) flags */
	...
	struct [Device](../Includes_and_Autodocs_3._guide/node05FB.html#line23) [Node](../Includes_and_Autodocs_3._guide/node062F.html#line21) *node, *MakeDosNode();

	node = MakeDosNode( parmPkt );


   SEE ALSO
	[AddDosNode()](../Includes_and_Autodocs_3._guide/node025E.html), [libraries/dosextens.h](../Includes_and_Autodocs_3._guide/node065D.html), [libraries/filehandler.h](../Includes_and_Autodocs_3._guide/node065E.html)
