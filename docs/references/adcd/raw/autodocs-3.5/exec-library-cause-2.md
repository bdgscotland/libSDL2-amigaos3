...
```c
       void Cause(struct [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) *);
```
   FUNCTION
   ...
   NOTE
	When setting up the [Interrupt](../Includes_and_Autodocs_3._guide/node061D.html#line21) structure, set the node type to
