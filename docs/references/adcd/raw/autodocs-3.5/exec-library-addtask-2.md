# exec.library/AddTask
   ...
   SYNOPSIS
	...
	[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37) AddTask(struct [Task](../Includes_and_Autodocs_3._guide/node064B.html#line23) *, [APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37), APTR);
   ...
   FUNCTION
	...
	the user to hold additional MemLists (as returned by [AllocEntry()](../Includes_and_Autodocs_3._guide/node01E6.html)).
	These will be automatically be deallocated at [RemTask()](../Includes_and_Autodocs_3._guide/node0234.html) time.
	If the code you have used to start the task has already added
	something to the MEMENTRY list, simply use [AddHead](../Includes_and_Autodocs_3._guide/node01D9.html) to add your
	new MemLists in.  If no initialization has been done, a [NewList](../Includes_and_Autodocs_3._guide/node0047.html) will
   ...
   WARNING
	...
	See the AmigaDOS [CreateProc()](../Includes_and_Autodocs_3._guide/node014D.html) for information on Processes.

   SEE ALSO
	[RemTask()](../Includes_and_Autodocs_3._guide/node0234.html), [FindTask()](../Includes_and_Autodocs_3._guide/node020B.html), [amiga.lib/CreateTask()](../Includes_and_Autodocs_3._guide/node002C.html), [dos/CreateProc()](../Includes_and_Autodocs_3._guide/node014D.html),
	[amiga.lib/NewList()](../Includes_and_Autodocs_3._guide/node0047.html)
