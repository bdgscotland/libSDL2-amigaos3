# exec.library/Disable
	...
	matching [Enable()](../Includes_and_Autodocs_3._guide/node0205.html) is executed.  Disable() implies [Forbid()](../Includes_and_Autodocs_3._guide/node020C.html).
	...
	a call to [Enable()](../Includes_and_Autodocs_3._guide/node0205.html) or is placed in a wait state.  Normal task
	...
	exactly one call to [Enable()](../Includes_and_Autodocs_3._guide/node0205.html) for every call to Disable().
...
```c
        Note: In the event of a task entering a [Wait()](../Includes_and_Autodocs_3._guide/node0246.html) after disabling
...
```
    ...
    SEE ALSO
	[Forbid()](../Includes_and_Autodocs_3._guide/node020C.html), [Permit()](../Includes_and_Autodocs_3._guide/node0224.html), [Enable()](../Includes_and_Autodocs_3._guide/node0205.html)
