# parallel.device/CMD_READ
   ...
   NAME
	[Read](../Includes_and_Autodocs_3._guide/node01A0.html) -- read input from parallel port
   ...
   RESULTS
	io_Error -- if the [Read](../Includes_and_Autodocs_3._guide/node01A0.html) succeded, then io_Error will be null.
	    If the [Read](../Includes_and_Autodocs_3._guide/node01A0.html) failed, then io_Error will contain an error code.
