# amiga.lib/sprintf
   ...
   FUNCTION
	Performs string formatting identical to [printf](../Includes_and_Autodocs_3._guide/node0048.html), but directs the output
	into a specific destination in memory. This uses the ROM version
	of [printf](../Includes_and_Autodocs_3._guide/node0048.html) [(exec.library/RawDoFmt()](../Includes_and_Autodocs_3._guide/node0227.html)), so it is very small.
   ...
   INPUTS
	...
	formatstring - pointer to a null terminated string describing the
	               desired output formatting (see [printf()](../Includes_and_Autodocs_3._guide/node0048.html) for a
		       description of this string).
	value(s) - numeric information to be formatted into the output
		   stream.

   SEE ALSO
	 [printf()](../Includes_and_Autodocs_3._guide/node0048.html), [exec.library/RawDoFmt()](../Includes_and_Autodocs_3._guide/node0227.html)
