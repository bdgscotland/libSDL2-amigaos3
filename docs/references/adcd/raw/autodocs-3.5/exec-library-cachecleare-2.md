# exec.library/CacheClearE
   ...
   FUNCTION
	[Flush](../Includes_and_Autodocs_3._guide/node016A.html) out the contents of the CPU instruction and/or data caches.
   ...
   NOTES
	...
	conflicts with the blitter or other custom chip DMA.  [Custom](../Includes_and_Autodocs_3._guide/node05F6.html#line24) chip
	...
	modify instructions, including [LoadSeg()](../Includes_and_Autodocs_3._guide/node0185.html), [MakeLibrary()](../Includes_and_Autodocs_3._guide/node021B.html) and
	[SetFunction()](../Includes_and_Autodocs_3._guide/node0238.html).

   SEE ALSO
	exec/execbase.i, [CacheControl()](../Includes_and_Autodocs_3._guide/node01F1.html), [CacheClearU()](../Includes_and_Autodocs_3._guide/node01F0.html)
