# parallel.device/PDCMD_SETPARAMS
   ...
   FUNCTION
	...
	set at [OpenDevice](../Includes_and_Autodocs_3._guide/node0560.html) time.
   ...
   IO REQUEST
	...
	io_Command      PDCMD_SETPARAMS (0A)
  			NOTE that the following fields of your [IORequest](../Includes_and_Autodocs_3._guide/node0621.html#line17)
	                are filled by [Open](../Includes_and_Autodocs_3._guide/node0196.html) to reflect the parallel device's
	...
	io_PTermArray   ASCII descending-ordered 8-byte array of
	                ...
	                This field is filled on [OpenDevice](../Includes_and_Autodocs_3._guide/node0560.html) only if the
	                EOFMODE bit is set.
