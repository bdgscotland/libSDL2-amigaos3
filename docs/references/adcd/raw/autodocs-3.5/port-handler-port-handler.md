   ...
   MOUNTLIST ENTRIES
	...
	and units. The form of these mount entries is:
	   ...
	   SER0:   EHandler  = L:Port-Handler
	           ...
	           StackSize = 800
	           GlobVec   = 1
	           [Device](../Includes_and_Autodocs_3._guide/node05FB.html#line23)    = serial.device
	           [Unit](../Includes_and_Autodocs_3._guide/node05FB.html#line30)      = 0
	           Flags     = 0
	           Control   = "8N1"
	           Baud      = 9600
	#
	...
	that the handler uses for [OpenDevice()](../Includes_and_Autodocs_3._guide/node0560.html). "Baud" and "Control"
