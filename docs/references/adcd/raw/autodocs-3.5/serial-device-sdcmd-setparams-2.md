...
```
  			NOTE that the following fields are filled in by [Open](../Includes_and_Autodocs_3._guide/node0196.html)
```c
...
```c
       ...
       io_ExtFlags     additional serial flags (bitdefs in [devices/serial.h)](../Includes_and_Autodocs_3._guide/node0668.html)
```
...
```c
       ...
       io_SerFlags     see [devices/serial.h](../Includes_and_Autodocs_3._guide/node0668.html) for bit equates, NOTE that x00
...
```
   ...
   SEE ALSO
	[exec/OpenDevice()](../Includes_and_Autodocs_3._guide/node0560.html)
