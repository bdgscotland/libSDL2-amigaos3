# exec.library/InitResident
   ...
   SYNOPSIS
	...
	[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37) InitResident(struct [Resident](../Includes_and_Autodocs_3._guide/node0643.html#line17) *,ULONG);
   ...
   FUNCTION
	...
	is jumped to  with the following registers:
		D0 = 0
		A0 = segList
	 	A6 = [ExecBase](../Includes_and_Autodocs_3._guide/node0609.html#line33)
   ...
   AUTOINIT FEATURE
	...
	Following that must be an initialized [Resident](../Includes_and_Autodocs_3._guide/node0643.html#line17) structure with
	...
	to MakeLibrary();
	    ...
	    - The size of your library/device base structure including initial
	      [Library](../Includes_and_Autodocs_3._guide/node0626.html#line33) or [Device](../Includes_and_Autodocs_3._guide/node05FB.html#line23) structure.
	    ...
	    - Pointer to data table in [exec/InitStruct](../Includes_and_Autodocs_3._guide/node0218.html) format for
	      initialization of [Library](../Includes_and_Autodocs_3._guide/node0626.html#line33) or [Device](../Includes_and_Autodocs_3._guide/node05FB.html#line23) structure.
   ...
   SEE ALSO
	exec/resident.i, [FindResident()](../Includes_and_Autodocs_3._guide/node0209.html)
