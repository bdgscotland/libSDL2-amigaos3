# locale.library/FormatString
   ...
   SYNOPSIS
	...
	[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37) FormatString(struct [Locale](../Includes_and_Autodocs_3._guide/node05E3.html#line117) *,[STRPTR](../Includes_and_Autodocs_3._guide/node0654.html#line57),[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37),struct [Hook](../Includes_and_Autodocs_3._guide/node0617.html#line27) *);
   ...
   FUNCTION
	...
	An extension to the standard C-language [printf()](../Includes_and_Autodocs_3._guide/node0048.html) conventions used
	...
	arguments provided remain the same. Using the C [printf()](../Includes_and_Autodocs_3._guide/node0048.html) call as an
	example:
   ...
   INPUTS
	...
	fmtTemplate - a C-language-like NULL-terminated format string,
	  ...
	  type    - supported types are:
	                  b - BSTR, data is 32-bit [BPTR](../Includes_and_Autodocs_3._guide/node05F8.html#line129) to byte count followed
	                      by a byte string. A NULL [BPTR](../Includes_and_Autodocs_3._guide/node05F8.html#line129) is treated as an
			      empty string.
	                  d - signed decimal
		      ...
		      [exec.library/RawDoFmt()](../Includes_and_Autodocs_3._guide/node0227.html).
