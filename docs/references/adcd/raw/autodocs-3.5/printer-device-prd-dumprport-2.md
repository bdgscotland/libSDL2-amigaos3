# printer.device/PRD_DUMPRPORT
   ...
   NAME
	PRD_DUMPRPORT -- dump the specified [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) to a graphics printer
   ...
   IO REQUEST
	...
	reasons) take effect.  [Remember](../Includes_and_Autodocs_3._guide/node05E0.html#line1429), these special rules are
 ...
 ---------------
	...
	#include [<devices/prtgfx.h>](../Includes_and_Autodocs_3._guide/node0665.html)
...
```
 ...
 [Preferences](../Includes_and_Autodocs_3._guide/node063B.html#line57)
 -----------
...
```
 ...
 generic
 -------
 1. [Text](../Includes_and_Autodocs_3._guide/node0332.html) only printer.
