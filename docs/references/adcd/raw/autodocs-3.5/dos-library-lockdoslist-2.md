# dos.library/LockDosList
   ...
   SYNOPSIS
	...
	struct [DosList](../Includes_and_Autodocs_3._guide/node05D9.html#line371) *LockDosList(ULONG)
   ...
   FUNCTION
	...
	for 1.3 compatibility, it also does a [Forbid()](../Includes_and_Autodocs_3._guide/node020C.html) - this will probably
	be removed at some future time.  The 1.3 [Forbid()](../Includes_and_Autodocs_3._guide/node020C.html) locking of this
	list had some race conditions.  The pointer returned by this is NOT
	an actual [DosList](../Includes_and_Autodocs_3._guide/node05D9.html#line371) pointer - you should use on of the other DosEntry
	calls to get actual pointers to [DosList](../Includes_and_Autodocs_3._guide/node05D9.html#line371) structures (such as
	[NextDosEntry()](../Includes_and_Autodocs_3._guide/node0195.html)), passing the value returned by LockDosList()
	as the dlist value.
	...
	and they're trying to send you a packet).  Use [AttemptLockDosList()](../Includes_and_Autodocs_3._guide/node0143.html)
	...
	1.3/2.0 way:
		...
		* must not use dl after this! *
		...
		struct [DosList](../Includes_and_Autodocs_3._guide/node05D9.html#line371) *
		yourfindentry (struct [DosList](../Includes_and_Autodocs_3._guide/node05D9.html#line371) *dl, STRPTRname, type)
		{
   ...
   SEE ALSO
	[AttemptLockDosList()](../Includes_and_Autodocs_3._guide/node0143.html), [UnLockDosList()](../Includes_and_Autodocs_3._guide/node01C9.html), [Forbid()](../Includes_and_Autodocs_3._guide/node020C.html), [NextDosEntry()](../Includes_and_Autodocs_3._guide/node0195.html)
