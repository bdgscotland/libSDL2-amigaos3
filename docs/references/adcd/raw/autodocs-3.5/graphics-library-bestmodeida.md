# graphics.library/BestModeIDA
   ...
   SYNOPSIS
	...
	ULONG BestModeIDA(struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *);
   ...
   TAGS
	...
	BIDTAG_ViewPort (struct [ViewPort](../Includes_and_Autodocs_3._guide/node05ED.html#line46) *) - [ViewPort](../Includes_and_Autodocs_3._guide/node05ED.html#line46) for which a best-fit
	       ModeID is sought.
	       Default - NULL
	...
	BIDTAG_NominalHeight (UWORD) - together make the aspect ratio.
	       ...
	       in the given [ViewPort](../Includes_and_Autodocs_3._guide/node05ED.html#line46).
	...
	BIDTAG_SourceID (ULONG) - Use this ModeID instead of a [ViewPort](../Includes_and_Autodocs_3._guide/node05ED.html#line46).
   ...
   NOTES
	...
	being matched to, and the source [ViewPort](../Includes_and_Autodocs_3._guide/node05ED.html#line46) or ModeID.
   ...
   EXAMPLE
	...
	monitor type as the Workbench [ViewPort](../Includes_and_Autodocs_3._guide/node05ED.html#line46).
   ...
   SEE ALSO
	[<graphics/modeid.h>](../Includes_and_Autodocs_3._guide/node0661.html) [<graphics/displayinfo.h>](../Includes_and_Autodocs_3._guide/node05FF.html)
