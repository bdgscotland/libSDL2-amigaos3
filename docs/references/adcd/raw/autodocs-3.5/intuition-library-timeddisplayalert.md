# intuition.library/TimedDisplayAlert
	...
	[BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73) TimedDisplayAlert( ULONG, [UBYTE](../Includes_and_Autodocs_3._guide/node0654.html#line50) *, [UWORD](../Includes_and_Autodocs_3._guide/node0654.html#line43), ULONG );

    FUNCTION
	This function is equivalent to [DisplayAlert()](../Includes_and_Autodocs_3._guide/node03A3.html), except that if
	the user fails to respond in a given time, the alert comes
	down automatically.  See the autodoc for [DisplayAlert()](../Includes_and_Autodocs_3._guide/node03A3.html) for
	full details.
