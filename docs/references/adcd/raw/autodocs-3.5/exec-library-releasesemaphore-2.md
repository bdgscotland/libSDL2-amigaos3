# exec.library/ReleaseSemaphore
   ...
   SYNOPSIS
	...
	void ReleaseSemaphore(struct [SignalSemaphore](../Includes_and_Autodocs_3._guide/node0647.html#line39) *);

   FUNCTION
	ReleaseSemaphore() is the inverse of [ObtainSemaphore()](../Includes_and_Autodocs_3._guide/node021D.html). It makes
	...
	Each [ObtainSemaphore()](../Includes_and_Autodocs_3._guide/node021D.html) call must be balanced by exactly one
   ...
   SEE ALSO
	[InitSemaphore()](../Includes_and_Autodocs_3._guide/node0217.html), [ObtainSemaphore()](../Includes_and_Autodocs_3._guide/node021D.html), [ObtainSemaphoreShared()](../Includes_and_Autodocs_3._guide/node021F.html)
