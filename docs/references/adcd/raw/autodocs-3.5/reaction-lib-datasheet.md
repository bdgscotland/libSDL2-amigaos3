...
```c
       ...
       programmer from having to [OpenLibrary()](../Includes_and_Autodocs_3._guide/node0222.html) the classes manually. It
       ...
       The version number to use for [OpenLibrary()](../Includes_and_Autodocs_3._guide/node0222.html) is contained in the
...
```c
       ...
       [gadgets/colorwheel.gadget](../Includes_and_Autodocs_3._guide/node00DC.html)
       [gadgets/gradientslider.gadget](../Includes_and_Autodocs_3._guide/node029A.html)
       images/led.image
