# graphics.library/TextExtent
   ...
   NAME
	[TextExtent](../Includes_and_Autodocs_3._guide/node05EC.html#line163) -- Determine raster extent of text data. (V36)

   SYNOPSIS
	TextExtent(rp, string, count, textExtent)
	           A1  A0      D0:16  A2

	void textExtent(struct [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) *, [STRPTR](../Includes_and_Autodocs_3._guide/node0654.html#line57), WORD,
	     struct [TextExtent](../Includes_and_Autodocs_3._guide/node05EC.html#line163) *);

   FUNCTION
	This function determines a more complete metric of the space
	that a text string would render into than the [TextLength()](../Includes_and_Autodocs_3._guide/node0335.html)
	function.
   ...
   RESULTS
	textExtent is filled in as follows:
	    te_Width  - same as [TextLength()](../Includes_and_Autodocs_3._guide/node0335.html) result: the rp_cp_x
   ...
   SEE ALSO
	[TextLength()](../Includes_and_Autodocs_3._guide/node0335.html)  [Text()](../Includes_and_Autodocs_3._guide/node0332.html)  [TextFit()](../Includes_and_Autodocs_3._guide/node0334.html)
