# exec.library/Deallocate
   ...
   SYNOPSIS
	...
	void Deallocate(struct [MemHeader](../Includes_and_Autodocs_3._guide/node062D.html#line27) *,[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37),ULONG);
   ...
   FUNCTION
	...
	existing [MemHeader](../Includes_and_Autodocs_3._guide/node062D.html#line27), however the extent pointers in the [MemHeader](../Includes_and_Autodocs_3._guide/node062D.html#line27)
	will no longer be valid.

	If memoryBlock is not on a block boundary (MEM_BLOCKSIZE) then it
	will be rounded down in a manner compatible with [Allocate()](../Includes_and_Autodocs_3._guide/node01E5.html).  Note
   ...
   SEE ALSO
	[Allocate()](../Includes_and_Autodocs_3._guide/node01E5.html), [exec/memory.h](../Includes_and_Autodocs_3._guide/node062D.html)
