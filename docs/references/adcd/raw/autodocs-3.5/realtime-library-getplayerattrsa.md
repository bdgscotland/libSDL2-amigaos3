# realtime.library/GetPlayerAttrsA
   ...
   SYNOPSIS
	...
	ULONG GetPlayerAttrsA(struct [Player](../Includes_and_Autodocs_3._guide/node05F0.html#line105) *, struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *);

	numProcessed = GetPlayerAttrs(player, firstTag, ...);

	ULONG GetPlayerAttrs(struct [Player](../Includes_and_Autodocs_3._guide/node05F0.html#line105) *, [Tag](../Includes_and_Autodocs_3._guide/node064C.html#line29), ...);
   ...
   TAGS
	...
	PLAYER_Hook (struct [Hook](../Includes_and_Autodocs_3._guide/node0617.html#line27) *) - returns a pointer to the current
	...
	PLAYER_AlarmSigTask (struct [Task](../Includes_and_Autodocs_3._guide/node064B.html#line23) *) - returns a pointer to the task to
   ...
   SEE ALSO
	[CreatePlayer()](../Includes_and_Autodocs_3._guide/node0533.html), [SetPlayerAttrs()](../Includes_and_Autodocs_3._guide/node053B.html)
