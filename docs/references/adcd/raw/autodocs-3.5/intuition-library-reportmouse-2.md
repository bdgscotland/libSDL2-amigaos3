# intuition.library/ReportMouse
    ...
    SYNOPSIS
	ReportMouse( Boolean, [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) )
		     D0       A0	<-note

	VOID ReportMouse( [BOOL](../Includes_and_Autodocs_3._guide/node0654.html#line73), struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) * );
	...
	From assembler the interface has always been:
		Boolean in D0, [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) in A0
	...
	an atomic operation when faced with:
			...
			Window->Flags &=~WFLG_REPORTMOUSE;
	or else bracket the operation between [Forbid()/Permit()](../Includes_and_Autodocs_3._guide/node0224.html).
	...
	The ReportMouse() function is first performed when [OpenWindow()](../Includes_and_Autodocs_3._guide/node03D5.html)
    ...
    INPUTS
	[Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) = pointer to a [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) structure associated with this request
    ...
    SEE ALSO
	The [Input](../Includes_and_Autodocs_3._guide/node017F.html) and [Output](../Includes_and_Autodocs_3._guide/node0198.html) section of the Intuition Reference Manual
