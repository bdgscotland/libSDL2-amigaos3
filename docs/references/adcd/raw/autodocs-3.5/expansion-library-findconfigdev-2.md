# expansion.library/FindConfigDev
   ...
   NAME
	FindConfigDev - find a matching [ConfigDev](../Includes_and_Autodocs_3._guide/node05F1.html#line31) entry
   ...
   FUNCTION
	This routine searches the list of existing [ConfigDev](../Includes_and_Autodocs_3._guide/node05F1.html#line31)
   ...
   INPUTS
	oldConfigDev - a valid [ConfigDev](../Includes_and_Autodocs_3._guide/node05F1.html#line31) structure, or NULL to start
   ...
   RESULTS
	configDev - the next [ConfigDev](../Includes_and_Autodocs_3._guide/node05F1.html#line31) entry that matches the
   ...
   EXAMPLES
	...
	struct [ConfigDev](../Includes_and_Autodocs_3._guide/node05F1.html#line31) *cd = NULL;

	while( cd = FindConfigDev( cd, MANUFACTURER, PRODUCT ) ) {
		/* do something with the returned [ConfigDev](../Includes_and_Autodocs_3._guide/node05F1.html#line31) */
	}
