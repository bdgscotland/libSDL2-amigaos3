# exec.library/RawDoFmt
   ...
   SYNOPSIS
	NextData = RawDoFmt(FormatString, DataStream, PutChProc, PutChData);
       ...
       d0                  a0            a1          a2         a3
	[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37) RawDoFmt(STRPTR,[APTR](../Includes_and_Autodocs_3._guide/node0654.html#line37),void (*)(),APTR);
   ...
   FUNCTION
	...
	found in the [FormatString](../Includes_and_Autodocs_3._guide/node0457.html), they will be replaced with the
   ...
   INPUTS
	[FormatString](../Includes_and_Autodocs_3._guide/node0457.html) - a "C"-language-like NULL terminated format string,
	...
	type   - supported types are:
			b - BSTR, data is 32-bit [BPTR](../Includes_and_Autodocs_3._guide/node05F8.html#line129) to byte count followed
			    ...
			    A NULL [BPTR](../Includes_and_Autodocs_3._guide/node05F8.html#line129) is treated as an empty string.
			    (Added in V36 exec)
			d - decimal
   ...
   EXAMPLE
	...
	_sprintf:	; ( ostring, format, {values} )
		...
		move.l	5*4(sp),a0       ;Get the [FormatString](../Includes_and_Autodocs_3._guide/node0457.html) pointer
