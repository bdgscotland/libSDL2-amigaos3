# utility.library/PackBoolTags
   ...
   SYNOPSIS
	...
	ULONG PackBoolTags(ULONG,struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *,struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *);
   ...
   INPUTS
	initialFlags - a starting set of bit-flags which will be changed
		       ...
		       in tagList.
	tagList	- a [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) list which may contain several tag items defined to
	...
	boolMap	- a tag list defining the boolean tags to be recognized, and
		  ...
		  or cleared when a boolean [Tag](../Includes_and_Autodocs_3._guide/node064C.html#line29) is found to be TRUE or FALSE in
		  tagList.
   ...
   EXAMPLE
	...
	/* this [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) list defines the correspondence between boolean tags
	 * and bit-flag values.
	 */
	struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) boolMap[] =
	{
	    {tag1,     0x0001},
	    {tag2,     0x0002},
	    {tag3,     0x0004},
	...
	struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) boolExample[] =
	{
	    {tag1,     TRUE},
	    {tag2,     FALSE},
	    {tag5,     Irrelevant},
   ...
   SEE ALSO
	[<utility/tagitem.h>](../Includes_and_Autodocs_3._guide/node064C.html), [GetTagData()](../Includes_and_Autodocs_3._guide/node05A3.html), [FindTagItem()](../Includes_and_Autodocs_3._guide/node05A0.html), [NextTagItem()](../Includes_and_Autodocs_3._guide/node05A7.html)
