# dos.library/GetVar
   ...
   SYNOPSIS
	...
	[LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39) GetVar( [STRPTR](../Includes_and_Autodocs_3._guide/node0654.html#line57), [STRPTR](../Includes_and_Autodocs_3._guide/node0654.html#line57), [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39), ULONG )
   ...
   RESULT
	len -   Size of environment variable.  -1 indicates that the
		variable was not defined (if [IoErr()](../Includes_and_Autodocs_3._guide/node0182.html) returns
		...
		(not including null termination), and [IoErr()](../Includes_and_Autodocs_3._guide/node0182.html) will return the
   ...
   BUGS
	...
	of the variable is put in [IoErr()](../Includes_and_Autodocs_3._guide/node0182.html).
	GVF_DONT_NULL_TERM only works for local variables under V37.  For
	V39, it also works for globals.

   SEE ALSO
	[SetVar()](../Includes_and_Autodocs_3._guide/node01BF.html), [DeleteVar()](../Includes_and_Autodocs_3._guide/node0153.html), [FindVar()](../Includes_and_Autodocs_3._guide/node0169.html), [<dos/var.h>](../Includes_and_Autodocs_3._guide/node0629.html)
