...
```c
     ...
     ATTRIBUTES
        ...
        LISTBROWSER_Selected (LONG)
            ...
            Applicability is (OM_NEW, OM_SET, OM_GET, OM_NOTIFY)
```
		LISTBROWSER_SelectedNode (struct [Node](../Includes_and_Autodocs_3._guide/node062F.html#line21) *)
...
```c
        ...
        LISTBROWSER_ColumnInfo (struct [ColumnInfo](../Includes_and_Autodocs_3._guide/node05EF.html#line284) *)
            Provides the column layout info for the list browser.  This is
            an array of struct [ColumnInfo](../Includes_and_Autodocs_3._guide/node05EF.html#line284).  The array must have one entry
            ...
            Passing NULL for the [ColumnInfo](../Includes_and_Autodocs_3._guide/node05EF.html#line284) means that you want a single
            column taking up the entire width of the gadget with no title.

            NOTES: [ColumnInfo](../Includes_and_Autodocs_3._guide/node05EF.html#line284) can NOT be shared amongst other list browsers
            ...
            again.  [List](../Includes_and_Autodocs_3._guide/node0628.html#line19) browser may modify the contents of this structure.
...
```c
        ...
        LISTBROWSER_ScrollRaster (BOOL)
            When this option is set, ListBrowser will use [ScrollRaster()](../Includes_and_Autodocs_3._guide/node031A.html) for
            ...
            using [ScrollRaster()](../Includes_and_Autodocs_3._guide/node031A.html) in a window that contains a ListBrowser,
            you MUST check the version of Intuition and use
            [ScrollWindowRaster()](../Includes_and_Autodocs_3._guide/node03EC.html) instead if the version is 39 or higher!
        ...
        LISTBROWSER_ShowImage (struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *)
        LISTBROWSER_HideImage (struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *)
        LISTBROWSER_LeafImage (struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *)
        ...
        LISTBROWSER_EditNode (LONG)
            ...
            [ActivateGadget()](../Includes_and_Autodocs_3._guide/node038F.html) (or [ActivateLayoutGadget()](../Includes_and_Autodocs_3._guide/node0439.html) if the listbrowser
        ...
        LISTBROWSER_CheckImage (struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *)  (V41)
        ...
        LISTBROWSER_UncheckedImage (struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *)  (V41)
            Provide a custom image for a checkbox node while that node is
        ...
        LISTBROWSER_MinNodeSize (LONG)  (V42)
            Minimum [Node](../Includes_and_Autodocs_3._guide/node062F.html#line21) size for MemPool optimization, useful when
        ...
        LISTBROWSER_CursorNode (struct [Node](../Includes_and_Autodocs_3._guide/node062F.html#line21) *)  (V42)
...
```c
    ...
    SEE ALSO
        [graphics.library/ScrollRaster()](../Includes_and_Autodocs_3._guide/node031A.html), [intuition.library/ActivateGadget()](../Includes_and_Autodocs_3._guide/node038F.html),
        [intuition.library/ScrollWindowRaster()](../Includes_and_Autodocs_3._guide/node03EC.html), layers.library,
        [layout.gadget/ActivateLayoutGadget()](../Includes_and_Autodocs_3._guide/node0439.html)
```
