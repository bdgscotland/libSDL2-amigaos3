# graphics.library/WriteChunkyPixels
   ...
   NAME
	...
	through to another x,y location within a certain [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53). (V40)

   SYNOPSIS
	WriteChunkyPixels(rp,xstart,ystart,xstop,ystop,array,bytesperrow)
	                  A0 D0     D1     D2    D3    A2     D4

	VOID WriteChunkyPixels(struct  [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) *, [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39), [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39),
	     [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39), [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39), [UBYTE](../Includes_and_Autodocs_3._guide/node0654.html#line50) *, LONG);
   ...
   the task using it has control of the blitter (via [OwnBlitter()](../Includes_and_Autodocs_3._guide/node030C.html)),
   ...
   This pointer is only present in [GfxBase](../Includes_and_Autodocs_3._guide/node0612.html#line25) in versions of graphics.library
