# workbench.library/AddAppMenuItemA
   ...
   INPUTS
	...
	msgport - pointer to message port Workbench will use to send you an
	          [AppMessage](../Includes_and_Autodocs_3._guide/node05D6.html#line115) message of type 'MTYPE_APPMENUITEM' when your
   ...
   RESULTS
	AppMenuItem - a pointer to an appmenuitem structure which you pass to
	              [RemoveAppMenuItem](../Includes_and_Autodocs_3._guide/node05C3.html) when you want to remove the menuitem
   ...
   SEE ALSO
	[workbench.library/RemoveAppMenuItem](../Includes_and_Autodocs_3._guide/node05C3.html)
