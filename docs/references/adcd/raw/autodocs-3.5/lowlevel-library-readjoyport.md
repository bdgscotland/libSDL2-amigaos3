# lowlevel.library/ReadJoyPort
   ...
   FUNCTION
	...
	is waiting for a transition to be returned use a [WaitTOF()](../Includes_and_Autodocs_3._guide/node033B.html) between
   ...
   RESULT
	portState - bit map that identifies the device and the current
	            ...
	            The following constants from [<libraries/lowlevel.h>](../Includes_and_Autodocs_3._guide/node0624.html)
