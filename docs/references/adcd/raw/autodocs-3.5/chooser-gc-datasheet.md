...
```c
    ...
    REQUIRES
     ...
     ATTRIBUTES
        ...
        CHOOSER_Labels (struct [List](../Includes_and_Autodocs_3._guide/node0628.html#line19) *)
            Exec [List](../Includes_and_Autodocs_3._guide/node0628.html#line19) of labels.  Each node must be allocated with the
            [AllocChooserNodeA()](../Includes_and_Autodocs_3._guide/node00C3.html) function.
