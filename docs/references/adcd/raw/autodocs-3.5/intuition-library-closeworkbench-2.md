# intuition.library/CloseWorkBench
	...
	[LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39) CloseWorkBench( VOID );
...
```c
       ...
       -   [Close](../Includes_and_Autodocs_3._guide/node0149.html) the Workbench screen
...
```
   ...
   NOTES
	...
	whether you should call [OpenWorkBench()](../Includes_and_Autodocs_3._guide/node03D7.html) when your program
