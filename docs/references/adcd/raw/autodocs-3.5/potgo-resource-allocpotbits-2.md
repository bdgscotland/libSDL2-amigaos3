# potgo.resource/AllocPotBits
   ...
   NAME
	AllocPotBits -- [Allocate](../Includes_and_Autodocs_3._guide/node01E5.html) bits in the potgo register.

   SYNOPSIS
	allocated = AllocPotBits(bits)
	D0                       D0

	[UWORD](../Includes_and_Autodocs_3._guide/node0654.html#line43) AllocPotBits( [UWORD](../Includes_and_Autodocs_3._guide/node0654.html#line43) );

   FUNCTION
	The AllocPotBits routine allocates bits in the hardware potgo
	register that the application wishes to manipulate via
	[WritePotgo](../Includes_and_Autodocs_3._guide/node0501.html).  The request may be for more than one bit.  A
