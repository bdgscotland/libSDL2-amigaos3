...
The keyboard device is accessible directly (see the [Keyboard Device](../Devices_Manual_guide/node00FC.html)
...
is covered in the [Gameport Device](../Devices_Manual_guide/node00AE.html) chapter of this manual.
...
[Timer Device](../Devices_Manual_guide/node00BD.html) chapter of this manual.
...
devices/[inputevent.h](../Includes_and_Autodocs_2._guide/node0051.html).  You can find more information about input events in
the [Gameport Device](../Devices_Manual_guide/node00AE.html) and [Console Device](../Devices_Manual_guide/node0080.html) chapters of this manual.
...
See the include file exec/[interrupts.h](../Includes_and_Autodocs_2._guide/node008C.html) for the complete structure
definition.
