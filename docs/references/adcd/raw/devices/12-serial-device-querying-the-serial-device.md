...
You query the serial device by passing an [IOExtSer](../Devices_Manual_guide/node009C.html#line7) to the device with
[SDCMD_QUERY](../Includes_and_Autodocs_2._guide/node04D6.html) set in io_Command.  The serial device will respond with the
