...
flags set in the io_SerFlags field of the [IOExtSer](../Devices_Manual_guide/node009C.html#line7) structure.  The default
state of all of these flags is zero. SERF_SHARED and SERF_7WIRE must
always be set before [OpenDevice()](../Includes_and_Autodocs_2._guide/node04D4.html). The flags are defined in the include
file [serial.h](../Includes_and_Autodocs_2._guide/node004B.html).
...
```c
                        ...
                        [IOExtSer](../Devices_Manual_guide/node009C.html#line7) without a call to [SDCMD_SETPARAMS](../Includes_and_Autodocs_2._guide/node04D7.html).
```
...
```c
                        ...
                        for exclusive access, your [OpenDevice()](../Includes_and_Autodocs_2._guide/node04D4.html) call will
...
```
   SERF_7WIRE           If set at [OpenDevice()](../Includes_and_Autodocs_2._guide/node04D4.html) time, the serial device
...
```c
                        see the SERF_MSPON bit described under [io_ExtFlags](../Devices_Manual_guide/node00A6.html#line33)
                        above.
```
