...
You query the printer device by passing an [IOStdReq](../Includes_and_Autodocs_2._guide/node0094.html#line28) to the device with
[PRD_QUERY](../Includes_and_Autodocs_2._guide/node051B.html) set in io_Command and a pointer to a structure to hold the
