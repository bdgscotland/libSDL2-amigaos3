...
XDotsInch
   The dot density in x (supplied by [SetDensity()](../Devices_Manual_guide/node005E.html), if it exists).

YDotsInch
   The dot density in y (supplied by [SetDensity()](../Devices_Manual_guide/node005E.html), if it exists).
