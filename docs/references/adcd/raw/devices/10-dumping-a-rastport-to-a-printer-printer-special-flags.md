...
The printer special flags (io_Flags) of the [IODRPReq](../Devices_Manual_guide/node0044.html#line23) provide a high degree
of control over the printing of a [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55).
...
```c
                        ...
                        [Preferences Settings](../Devices_Manual_guide/node004C.html)" if you want to change to
...
The flags are defined in the include file devices/[printer.h](../Includes_and_Autodocs_2._guide/node0052.html).
