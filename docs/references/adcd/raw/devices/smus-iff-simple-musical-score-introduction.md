...
stands for Simple MUsical Score.  "[EA IFF 85](../Devices_Manual_guide/node01C5.html)" is Electronic Arts' standard
for interchange format files.  A [FORM](../Devices_Manual_guide/node01C7.html#line51) or "data section") such as FORM SMUS
can be an IFF file or a part of one.  [See "[EA IFF 85](../Devices_Manual_guide/node01C5.html)" Electronic Arts
...
Section 2 gives important [background](../Devices_Manual_guide/node02AD.html) information.  Section 3 details the
SMUS components by defining the required property score header "[SHDR](../Devices_Manual_guide/node02B3.html)", the
...
and the track data chunk "[TRAK](../Devices_Manual_guide/node02B7.html)".  Section 4 defines some chunks for
particular programs to store [private information](../Devices_Manual_guide/node02C2.html).  These are "standard"
chunks; specialized chunks for future needs can be added later.  [Appendix](../Devices_Manual_guide/node02C3.html)
A is a quick-reference summary. [Appendix B](../Devices_Manual_guide/node02C6.html) is an example box diagram.
[Appendix C](../Devices_Manual_guide/node02C7.html) names the committee responsible for this standard.

 [References](../Devices_Manual_guide/node02AC.html) 
