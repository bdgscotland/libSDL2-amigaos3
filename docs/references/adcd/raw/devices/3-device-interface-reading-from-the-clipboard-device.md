...
You read from the clipboard device by passing an [IOClipReq](../Devices_Manual_guide/node0067.html#line5) to the device
...
from IFF may be necessary depending on your application.
   ...
   to read data from the clipboard. See the "[IFFParse Library](../Libraries_Manual_guide/node0427.html)"
