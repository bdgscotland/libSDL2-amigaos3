...
```
This structure is defined in the include file devices/[clipboard.h](../Includes_and_Autodocs_2._guide/node0048.html).
...
post request upon return with that returned by the [CBD_CURRENTREADID](../Includes_and_Autodocs_2._guide/node04DA.html)
command.
...
of the post I/O request with that of the [CBD_CURRENTWRITEID](../Includes_and_Autodocs_2._guide/node04DB.html) command. If
