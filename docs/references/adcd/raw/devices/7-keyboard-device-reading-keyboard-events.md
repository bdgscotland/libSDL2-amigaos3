...
console device are available for this.  See the chapter [Input Device](../Devices_Manual_guide/node00CA.html)
...
bytes in an [InputEvent](../Includes_and_Autodocs_2._guide/node0051.html#line199) (see example below).
...
```c
    ...
    keystrokes will be discarded.
     ...
     [Example Read Keyboard Event Program](../Devices_Manual_guide/node01A0.html) 
```
