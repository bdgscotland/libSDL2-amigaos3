...
provide. io_TermArray is used only when the [SERF_EOFMODE](../Devices_Manual_guide/node00A7.html#line13) flag is selected
(see the [Serial Flags](../Devices_Manual_guide/node00A7.html#line6) section below).
...
match is found, the [IOExtSer](../Devices_Manual_guide/node009C.html#line7) is terminated as complete, and the count of
...
```c
     [Terminate_Serial.c](../Devices_Manual_guide/node0194.html) 
```
