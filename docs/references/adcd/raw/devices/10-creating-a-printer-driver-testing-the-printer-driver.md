...
been put in [printertag.asm](../Devices_Manual_guide/node005F.html). If the height of the picture is off, the wrong
...
NumRows value in the [printertag.asm](../Devices_Manual_guide/node005F.html) file.
