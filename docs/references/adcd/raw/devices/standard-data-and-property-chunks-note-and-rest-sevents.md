...
The note and rest [SEvent](../Devices_Manual_guide/node02B7.html#line29)s SID_FirstNote through SID_Rest have the
...
fits into 16 bits like any other [SEvent](../Devices_Manual_guide/node02B7.html#line29).  Warning: Some compilers don't
...
the terminology of [SSSP reference](../Devices_Manual_guide/node02AC.html#line8) and GSCR, setting the chord bit to 1
...
Of course, the chord and tieOut fields don't apply to SID_Rest [SEvent](../Devices_Manual_guide/node02B7.html#line29)s.
...
[SEvent](../Devices_Manual_guide/node02B7.html#line29) to show the pitch, chord bit, and tieOut bit.
...
Corresponding SNote values in the [TRAK](../Devices_Manual_guide/node02B7.html) chunk:
...
Within a [TRAK](../Devices_Manual_guide/node02B7.html) chunk, note and rest events appear in time order.
...
Note: The remaining [SEvent](../Devices_Manual_guide/node02B7.html#line29) types are optional.  A writer program doesn't
