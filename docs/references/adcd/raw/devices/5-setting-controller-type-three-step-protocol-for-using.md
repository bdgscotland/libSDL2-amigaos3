...
```c
    Send [GPD_ASKCTYPE](../Devices_Manual_guide/node00B9.html) to the device and check for a GPCT_NOCONTROLLER
    return. Never issue [GPD_SETCTYPE](../Includes_and_Autodocs_2._guide/node04BD.html) without checking whether the desired
