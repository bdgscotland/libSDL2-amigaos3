...
signals within each 3-minute span. Therefore, the  [timeval](../Devices_Manual_guide/node00BF.html#line25) you would have
...
```c
      ...
      time elapsed.)
```
   5. Calculate a new value for the time interval ( [timeval](../Devices_Manual_guide/node00BF.html#line25)); that is, one
...
specified period of time can become precisely what you have designed.
   ...
   -----------------------------------
   The arithmetic functions are not designed to operate on [EClockVal](../Devices_Manual_guide/node00BF.html#line31)s.
