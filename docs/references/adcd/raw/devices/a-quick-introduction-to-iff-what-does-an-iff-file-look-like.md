...
example, an [ILBM](../Devices_Manual_guide/node01AC.html) picture has a [BMHD](../Devices_Manual_guide/node01AF.html) bitmap header chunk (a structure)
and a [BODY](../Devices_Manual_guide/node01B7.html) raster body chunk (an array).

To construct an IFF file, just put a file type ID (like [ILBM](../Devices_Manual_guide/node01AC.html)) into a
...
case "[ILBM](../Devices_Manual_guide/node01AC.html)") followed by any number of data chunk.  In this example, the
FORM type is "ILBM", which stands for "InterLeaved BitMap".  ([ILBM](../Devices_Manual_guide/node01AC.html) is an
IFF standard for bitplane raster pictures.)  This example has 3 chunks.
Note the pad byte after the odd length chunk.

Within FORMs [ILBM](../Devices_Manual_guide/node01AC.html), [BMHD](../Devices_Manual_guide/node01AF.html) identifies a bitmap header chunk, [CMAP](../Devices_Manual_guide/node01B0.html) a color
map, and [BODY](../Devices_Manual_guide/node01B7.html) a raster body.  In general, the chunk IDs in a FORM are
local to the FORM type ID.  The  exceptions are the 4 global chunk IDs
"FORM", [LIST](../Devices_Manual_guide/node01CA.html#line49), [CAT](../Devices_Manual_guide/node01CA.html#line2) , and [PROP](../Devices_Manual_guide/node01CA.html#line49).  (A FORM may contain other FORM
