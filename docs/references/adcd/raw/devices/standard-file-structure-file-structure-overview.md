...
An IFF file is just a single [chunk](../Devices_Manual_guide/node01DD.html) of type [FORM](../Devices_Manual_guide/node01C7.html#line52), [LIST](../Devices_Manual_guide/node01CA.html#line49), or [CAT](../Devices_Manual_guide/node01CA.html#line2) .  Therefore
an IFF file can be recognized by its first 4 bytes: "FORM", "LIST", or
"[CAT](../Devices_Manual_guide/node01CA.html#line2) ". Any file contents after the chunk's end are to be ignored.  (Some
...
The first 4 bytes indicate this is a "[FORM](../Devices_Manual_guide/node01C7.html#line52)"; the most common IFF top level
structure.  The following 4 bytes indicate that the contents totals 26
bytes. The form type is listed as "SNAP".

Our form "SNAP" contains only one [chunk](../Devices_Manual_guide/node01DD.html) at the moment; a chunk of type
...
a [LIST](../Devices_Manual_guide/node01CA.html#line49) or [CAT](../Devices_Manual_guide/node01CA.html#line2) .  A graphics editor, for example, could process a list of
...
also prints an outline of the [chunk](../Devices_Manual_guide/node01DD.html)s in the file, showing the ckID and
...
files into a single [CAT](../Devices_Manual_guide/node01CA.html#line2)  group.  It "unwraps" each input file that is a CAT
...
like directories for [LIST](../Devices_Manual_guide/node01CA.html#line49) contents.  On huge storage systems, IFF files
