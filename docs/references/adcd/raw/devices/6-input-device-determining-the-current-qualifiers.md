...
current qualifiers, you call the input device function [PeekQualifier()](../Includes_and_Autodocs_2._guide/node04E9.html).

[PeekQualifier()](../Includes_and_Autodocs_2._guide/node04E9.html) returns what the input device considers to be the current
...
[PeekQualifier()](../Includes_and_Autodocs_2._guide/node04E9.html) returns an unsigned word with bits set according to the
