...
though when printing a non-displayed [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55).  One way to get a corrected
...
correct calculation you could build your [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) dimensions in two ways:
...
```c
      ...
      example if your [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) dimensions were 1280 x 800 (an even multiple
      of 640 x 400) you would set io_Modes to LACE | HIRES. Setting the
      [SPECIAL_ASPECT](../Devices_Manual_guide/node0050.html#line3) flag would enable the printer device to properly
      calculate the aspect ratio of the image.
```
   2. When using an arbitrary sized [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55), you can supply the ModeID of
...
```c
      ...
      as ticks-per-pixel in the Resolution field of the [DisplayInfo](../Includes_and_Autodocs_2._guide/node00BD.html#line50)
      ...
      device.  See the "[Graphics Library](../Libraries_Manual_guide/node0004.html)" chapters of the  Amiga ROM
      Kernel Reference Manual: Libraries for general information on the
      graphics system.
```
The following example will dump a [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) to the printer and wait for
either the printer to finish or the user to cancel the dump and act
accordingly.


```c
     [Demo_Dump.c](../Devices_Manual_guide/node0165.html) 
```
