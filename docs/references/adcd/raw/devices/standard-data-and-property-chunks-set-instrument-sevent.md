...
in turn points to an instrument.  (See "[Instrument Registers](../Devices_Manual_guide/node02B0.html)", in section
...
The [SEvent](../Devices_Manual_guide/node02B7.html#line29) SID_Instrument changes the instrument number for a track, that
