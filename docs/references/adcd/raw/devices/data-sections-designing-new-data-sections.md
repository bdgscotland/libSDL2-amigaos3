...
needs to specify the object's purpose, its [FORM](../Devices_Manual_guide/node01C7.html#line52) type ID, the IDs and
formats of standard local [chunk](../Devices_Manual_guide/node01DD.html)s, and rules for generating and
interpreting the data. It's a good idea to supply typedefs and an example
source program that accesses the new object.  See "[ILBM](../Devices_Manual_guide/node01AC.html)" IFF Interleaved
Bitmap for such an example.

Anyone can pick a new [FORM](../Devices_Manual_guide/node01C7.html#line52) type ID but should reserve it with Commodore
Applications and Technical Support ([CAT](../Devices_Manual_guide/node01CA.html#line2) ) at their earliest convenience.
...
section, its [FORM](../Devices_Manual_guide/node01C7.html#line52) type ID will serve as a version number (Cf. Type IDs).
...
In a new [FORM](../Devices_Manual_guide/node01C7.html#line52) type, the rules for primitive data types and word-alignment
(Cf. Primitive Data Types) may be overridden for the contents of its local
[chunk](../Devices_Manual_guide/node01DD.html)s - but not for the chunk structure itself - if your documentation
...
In designing a [FORM](../Devices_Manual_guide/node01C7.html#line52) type, encapsulate all the data that other programs
...
the property [chunk](../Devices_Manual_guide/node01DD.html)s manageably short - let's say <= 256 bytes.
...
It must be OK to copy a [LIST](../Devices_Manual_guide/node01CA.html#line49) or [FORM](../Devices_Manual_guide/node01C7.html#line52) or [CAT](../Devices_Manual_guide/node01CA.html#line2)  intact, e.g., to incorporate
...
the containing FORM, relative from the referencing [chunk](../Devices_Manual_guide/node01DD.html), or a sequence
number into a collection.

With composite [FORM](../Devices_Manual_guide/node01C7.html#line52)s, you leverage on existing programs that create and
