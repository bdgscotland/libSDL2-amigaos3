...
cleared by the [DoSpecial()](../Devices_Manual_guide/node0057.html) function. Depending on the status of the flag
...
In [DoSpecial()](../Devices_Manual_guide/node0057.html) the flagbits could be set or cleared, with code like the
following:
