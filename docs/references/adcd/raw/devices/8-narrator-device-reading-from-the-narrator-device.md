...
write request.  This is done by copying the [narrator_rb](../Devices_Manual_guide/node0115.html#line17) structure used in
the [OpenDevice()](../Includes_and_Autodocs_2._guide/node04C8.html) call into the voice field of the [mouth_rb](../Devices_Manual_guide/node0115.html#line47) I/O request
...
the [narrator_rb](../Devices_Manual_guide/node0115.html#line17) I/O request structure (the write request) to a non-zero
...
using the [mouth_rb](../Devices_Manual_guide/node0115.html#line47) I/O request structure.  When the mouth shape has
changed, the device will return the read request to the user with bit 0
set in the sync field of the [mouth_rb](../Devices_Manual_guide/node0115.html#line47).  The fields width and height of the
...
the flags field of the write request ([narrator_rb](../Devices_Manual_guide/node0115.html#line17) structure).  The bits
...
field of the [mouth_rb](../Devices_Manual_guide/node0115.html#line47) structure will contain flags indicating which events
...
field of the [mouth_rb](../Devices_Manual_guide/node0115.html#line47) structure to tell when the speech has completed (an
...
```c
    ...
    will include an extension to the [mouth_rb](../Devices_Manual_guide/node0115.html#line47) I/O request structure which
...
the narrator device.  For a more complete example, see the [sample program](../Devices_Manual_guide/node01A9.html)
...
```
/*
 * (3) Set up the read IORequest. Do this after the call to [OpenDevice()](../Includes_and_Autodocs_2._guide/node04C8.html).
...
```
/*
 * (4) Set the flags field of the [narrator_rb](../Devices_Manual_guide/node0115.html#line17) write request to return the
