...
available. This would allow, for example, a [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) to be printed at a
...
For an aspect-ratio-corrected image, the [SPECIAL_NOPRINT](../Devices_Manual_guide/node0050.html#line15) flag will have
...
The following is a strip printing procedure for a [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) which is 200
lines high.

First strip

   * copy source line 0 through 50 (51 lines) to strip [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) lines 0
```c
     through 50 (51 lines).
```
...
Second strip
   ...
   * copy source line 49 through 100 (52 lines) to strip [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) lines 0
```c
     through 51 (52 lines).
```
...
```c
     ...
     dump (since there is a 52 line [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) and only 50 lines are dumped).
```
Third strip

   * copy source line 99 through 150 (52 lines) to strip [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) lines 0
```c
     through 51 (52 lines).
```
   * io_SrcY = 1, io_Height = 50.
...
Fourth strip
   ...
   * copy source line 149 through 199 (51 lines) to strip [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) lines 0
```c
     through 50 (51 lines).
```
   * io_SrcY = 1, io_Height = 50.
...
```c
     ...
     dump (since there is a 51 line [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) and only 50 lines are dumped).
```
