...
The [KBD_READMATRIX](../Includes_and_Autodocs_2._guide/node050F.html) command returns the current state of every key in the
...
```c
     [Figure 7-1 - Keyboard Layout](../Devices_Manual_guide/node019D.html) 
```
...
```c
     [Read_Keyboard_Matrix.c](../Devices_Manual_guide/node019E.html) 
```
