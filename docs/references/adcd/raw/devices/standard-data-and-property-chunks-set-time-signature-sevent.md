...
The [SEvent](../Devices_Manual_guide/node02B7.html#line29) SID_TimeSig sets the time signature for the track.  A "time
signature" SEvent has the following structure overlaid on the [SEvent](../Devices_Manual_guide/node02B7.html#line29)
structure:
...
STimeSig fits into 16 bits like any other [SEvent](../Devices_Manual_guide/node02B7.html#line29).  Warning: Some compilers
...
The field type contains the value SID_TimeSig, indicating that this [SEvent](../Devices_Manual_guide/node02B7.html#line29)
...
beginning of each [TRAK](../Devices_Manual_guide/node02B7.html) when creating a FORM [SMUS](../Devices_Manual_guide/node02AB.html) because music editors
need them.
