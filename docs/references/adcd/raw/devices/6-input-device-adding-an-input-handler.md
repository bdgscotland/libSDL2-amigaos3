...
You add an input-stream handler to the input chain by passing an [IOStdReq](../Devices_Manual_guide/node00CC.html#line12)
to the device with [IND_ADDHANDLER](../Includes_and_Autodocs_2._guide/node04E1.html) set in io_Command and a pointer to an
...
list-node part of the interrupt data structure you pass to this routine.
 ...
 [Rules For Input Device Handlers](../Devices_Manual_guide/node00D3.html) 
 [Removing An Input Handler](../Devices_Manual_guide/node00D4.html) 
