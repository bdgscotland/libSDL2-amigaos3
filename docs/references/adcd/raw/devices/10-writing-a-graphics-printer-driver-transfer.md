...
it by the [Render()](../Devices_Manual_guide/node005C.html) function. When Transfer() gets called, it is passed 5
parameters:
...
```c
                ...
                Color           Test the black value against the dither
                                ...
                                value to see if you should render a yellow
                                pixel.  Repeat this process for magenta and
                                cyan. (See the [EpsonX_transfer.c](../Devices_Manual_guide/node0175.html) file)
```
