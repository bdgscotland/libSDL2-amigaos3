...
console device without a window, you call [OpenDevice()](../Includes_and_Autodocs_2._guide/node0509.html) with the console
unit CONU_LIBRARY.

The console device functions are [CDInputHandler()](../Includes_and_Autodocs_2._guide/node0505.html) and [RawKeyConvert()](../Includes_and_Autodocs_2._guide/node050A.html);
they may only be used with the CONU_LIBRARY console unit.  The console
device commands which do not require a window are [CD_ASKDEFAULTKEYMAP](../Includes_and_Autodocs_2._guide/node0501.html)
and [CD_SETDEFAULTKEYMAP](../Includes_and_Autodocs_2._guide/node0503.html); they be used with any console unit.  The
...
To use the functions requires the following steps:
   ...
   *  Declare the console device base address variable ConsoleDevice in the
      ...
      global data area.
   *  Declare storage for an I/O request of type [IOStdReq](../Devices_Manual_guide/node0082.html#line7).
...
device function, see the [rawkey.c](../Devices_Manual_guide/node0191.html) code example in the
"[Intuition: Mouse and Keyboard](../Libraries_Manual_guide/node01E4.html)" chapter of the Amiga ROM Kernel Reference
Manual: Libraries.  The example uses the [RawKeyConvert()](../Includes_and_Autodocs_2._guide/node050A.html) function.

To use the commands with the CONU_LIBRARY console unit, you follow the
same steps that were outlined in the [Opening the Console Device](../Devices_Manual_guide/node0084.html) section of
this chapter.
