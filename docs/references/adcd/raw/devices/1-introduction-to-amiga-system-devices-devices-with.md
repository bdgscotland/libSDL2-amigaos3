...
Manual: [Includes and Autodocs](../Includes_and_Autodocs_2._guide/node0000.html) and the device chapters of this manual.
...
(See the [Exec Libraries](../Libraries_Manual_guide/node0003.html)" chapter of the Amiga ROM Kernel Reference
Manual: Libraries.)
...
The procedure for accessing a device's functions is as follows:
   ...
   *  Call [OpenDevice()](../Includes_and_Autodocs_2._guide/node0366.html), passing the I/O request if you haven't already
