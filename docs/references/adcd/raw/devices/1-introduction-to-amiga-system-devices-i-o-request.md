...
the include file exec/[errors.h](../Includes_and_Autodocs_2._guide/node008F.html); device specific errors are defined in the
...
[DoIO()](../Includes_and_Autodocs_2._guide/node034B.html) or [SendIO()](../Includes_and_Autodocs_2._guide/node037A.html).   In both cases, io_Error will be set when the I/O
request is returned, but in the case of [DoIO()](../Includes_and_Autodocs_2._guide/node034B.html), the [DoIO()](../Includes_and_Autodocs_2._guide/node034B.html) function itself
...
by [SendIO()](../Includes_and_Autodocs_2._guide/node037A.html) can be checked.
