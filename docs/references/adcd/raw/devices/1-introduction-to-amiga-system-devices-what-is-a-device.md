...
addition, the Amiga ROM Kernel Reference Manual: [Includes and Autodocs](../Includes_and_Autodocs_2._guide/node0000.html)
...
chapters on [Exec](../Libraries_Manual_guide/node0003.html).  The command explanations list the data, flags, and
