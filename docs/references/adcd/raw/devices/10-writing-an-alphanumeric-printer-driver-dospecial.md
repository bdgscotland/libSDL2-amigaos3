...
the dummy [Close()](../Includes_and_Autodocs_2._guide/node028A.html) routine from the init.asm file would be replaced by a
...
```c
      points to the command number. The devices/[printer.h](../Includes_and_Autodocs_2._guide/node0052.html) file contains the
...
Certain functions are implemented both in the [CommandTable](../Devices_Manual_guide/node0056.html) and in the
