...
[SDCMD_SETPARAMS](../Includes_and_Autodocs_2._guide/node04D7.html) command.  The flags are defined in the include file
devices/[serial.h](../Includes_and_Autodocs_2._guide/node004B.html).


```c
                   SERIAL DEVICE PARAMETERS ([IOExtSer](../Devices_Manual_guide/node009C.html#line7))
```
   IOExtSer
...
```c
                ...
                When you do an [SDCMD_SETPARAMS](../Includes_and_Autodocs_2._guide/node04D7.html) command, the driver senses
...
```c
                ...
                commands until modified by another [SDCMD_SETPARAMS](../Includes_and_Autodocs_2._guide/node04D7.html).
```
...
```c
                ...
                above "[Ending a Read Or Write Using Termination Characters](../Devices_Manual_guide/node00A4.html)"
                and the [SDCMD_SETPARAMS](../Includes_and_Autodocs_2._guide/node04D7.html) summary page in the Autodocs.
```
...
```
 io_SerFlags    See the "[Serial Flags](../Devices_Manual_guide/node00A7.html)" section below.

 io_Status      Contains status information filled in by the [SDCMD_QUERY](../Includes_and_Autodocs_2._guide/node04D6.html)

                command.  Break status is cleared by the execution of
                SDCMD_QUERY.
You set the serial parameters by passing an [IOExtSer](../Devices_Manual_guide/node009C.html#line7) to the device with
[SDCMD_SETPARAMS](../Includes_and_Autodocs_2._guide/node04D7.html) set in io_Command and with the flags and parameters set to
the values you want.
...
[SDCMD_SETPARAMS](../Includes_and_Autodocs_2._guide/node04D7.html) command will fail.  You are responsible for checking the
error code and informing the user.
   ...
   [SDCMD_SETPARAMS](../Includes_and_Autodocs_2._guide/node04D7.html) only when you have no serial I/O requests pending.

 [Serial Flags (Bit Definitions For io_SerFlags)](../Devices_Manual_guide/node00A7.html)  
