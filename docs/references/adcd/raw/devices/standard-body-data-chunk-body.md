...
The source raster  is stored in a "BODY" chunk.  This one [chunk](../Devices_Manual_guide/node01DD.html) holds all
bitplanes and the optional mask, interleaved by row.

The BitMapHeader, in a [BMHD](../Devices_Manual_guide/node01AF.html) property chunk, specifies the raster's
