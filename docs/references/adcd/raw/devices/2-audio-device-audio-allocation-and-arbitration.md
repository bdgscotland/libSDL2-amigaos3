...
[ADCMD_ALLOCATE](../Devices_Manual_guide/node002A.html).  You can do this when you open the device, or at a later
time.  You specify the channels you want in the ioa_Data field of the
[IOAudio](../Devices_Manual_guide/node001E.html#line8) block. If the allocation succeeds, the audio device will return
the channels that you now own in the lower four bits of the
ioa_Request.io_Unit field of your [IOAudio](../Devices_Manual_guide/node001E.html#line9) block. For instance, if the
...
When you send the [ADCMD_ALLOCATE](../Devices_Manual_guide/node002A.html) command, the audio device will also
return a unique allocation key in the ioa_AllocKey of the [IOAudio](../Devices_Manual_guide/node001E.html#line9) block.
...
When you request a channel with [ADCMD_ALLOCATE](../Devices_Manual_guide/node002A.html), you specify a precedence
...
precedence to 127 with the [ADCMD_SETPREC](../Devices_Manual_guide/node0030.html) command, no other tasks can steal
a channel from you. When you have finished with a channel, you must
relinquish it with the [ADCMD_FREE](../Devices_Manual_guide/node002F.html) command to make it available for other
users.
...
chance to stop your sound gracefully, then you should use the [ADCMD_LOCK](../Devices_Manual_guide/node0031.html)
...
[ADCMD_LOCK](../Devices_Manual_guide/node0031.html), see the section below.
