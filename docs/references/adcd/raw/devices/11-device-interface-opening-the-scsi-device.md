...
Three primary steps are required to open the SCSI device:
   ...
   *  Create an I/O request structure of type [IOStdReq](../Devices_Manual_guide/node0075.html#line13). The IOStdReq

```c
      structure is created by the [CreateExtIO()](../Includes_and_Autodocs_2._guide/node0147.html) function. [CreateExtIO](../Includes_and_Autodocs_2._guide/node0147.html) will
      initialize your IOStdReq to point to your reply port.
```
   *  Open the SCSI device.  Call [OpenDevice()](../Includes_and_Autodocs_2._guide/node0366.html) passing it the I/O request
