...
structural information in a document [FORM](../Devices_Manual_guide/node01C7.html#line51) that uses [FORMs FTXT](../Devices_Manual_guide/node0168.html) for the
leaf nodes.  This amounts to stripping a document down to a stream of
plain text. It would do this by skipping over all chunks except FTXT.[CHRS](../Devices_Manual_guide/node016D.html)
(CHRS chunks found inside a [FORM FTXT](../Devices_Manual_guide/node0168.html)) and within the FTXT.CHRS chunks
skipping all control characters and control sequences.  ([Appendix C](../Devices_Manual_guide/node0174.html)
diagrams this text scanner.) It may also read FTXT.[FONS](../Devices_Manual_guide/node016E.html) chunks to find a
description for font 1.

Here's a Pascal-ish program for an [FTXT](../Devices_Manual_guide/node0168.html) stripper.  Given a [FORM](../Devices_Manual_guide/node01C7.html#line51) (a
document of some kind), it scans for all FTXT.[CHRS](../Devices_Manual_guide/node016D.html) chunks.  This would
...
to read a document [FORM](../Devices_Manual_guide/node01C7.html#line51) and its nested FORMs, [LIST](../Devices_Manual_guide/node01CA.html#line49)s, and [CAT](../Devices_Manual_guide/node01CA.html) s without a
...
than [FORM FTXT](../Devices_Manual_guide/node0168.html) it just continues reading.  This amounts to reading all the
