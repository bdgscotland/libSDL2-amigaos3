...
ETD_FORMAT and [TD_FORMAT](../Includes_and_Autodocs_2._guide/node0527.html) are used to write data to a track that either has
...
possible to use the [TD_FORMAT](../Includes_and_Autodocs_2._guide/node0527.html) command to reformat the track as part of
your error recovery process. ETD_FORMAT will write the sector label area
if the iotd_SecLabel is non-NULL.

You format a track by passing an [IOExtTD](../Devices_Manual_guide/node00DE.html#line12) to the device with TD_FORMAT or
