...
ETD_MOTOR and [TD_MOTOR](../Includes_and_Autodocs_2._guide/node052B.html) give you control of the motor. When the trackdisk
...
You control the drive motor by passing an [IOExtTD](../Devices_Manual_guide/node00DE.html#line12) to the device with
