...
The [ADCMD_FINISH](../Includes_and_Autodocs_2._guide/node04A7.html) command aborts (calls [AbortIO()](../Includes_and_Autodocs_2._guide/node04A5.html) ) the current write
...
[ADCMD_FINISH](../Includes_and_Autodocs_2._guide/node04A7.html) has a flag you can set (ADIOF_SYNCCYCLE) that allows the
