...
concepts. See the [Appendix A](../Devices_Manual_guide/node0129.html) in this manual for a complete description of
...
The [IFFParse.Library](../Libraries_Manual_guide/node0427.html) also contains functions which simplify reading and
writing of IFF data to the clipboard device.  See the "[IFFParse Library](../Libraries_Manual_guide/node0427.html)"
