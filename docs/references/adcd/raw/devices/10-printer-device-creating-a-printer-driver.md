...
described in devices/[prtbase.h](../Includes_and_Autodocs_2._guide/node005A.html#line161) (this is pointed to by the BPTR returned by
the [LoadSeg()](../Includes_and_Autodocs_2._guide/node02C5.html) of the object file). The PrinterSegment contains the
[PrinterExtendedData](../Includes_and_Autodocs_2._guide/node005A.html#line134) (PED) structures (also described in devices/prtbase.h)
...
```c
     [printertag.asm](../Devices_Manual_guide/node0166.html) 
```
...
```c
      This is called in the process of an [OpenDevice()](../Includes_and_Autodocs_2._guide/node0366.html) call, after the
...
```c
      This is called in the process of a [CloseDevice()](../Includes_and_Autodocs_2._guide/node033F.html) call to allow the
...
pointer to the [PrinterData](../Includes_and_Autodocs_2._guide/node005A.html#line65) structure described in devices/prtbase.h. This
...
alphanumeric data waiting for a formfeed.
 ...
 [Writing Alphanumeric Printer Drivers](../Devices_Manual_guide/node0055.html) 
 [Writing A Graphics Printer Driver](../Devices_Manual_guide/node005B.html) 
 [Testing The Printer Driver](../Devices_Manual_guide/node0060.html) 
