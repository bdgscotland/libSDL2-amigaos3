...
and diagramed in [Appendix C](../Devices_Manual_guide/node0174.html).
...
current [FTXT](../Devices_Manual_guide/node0168.html) reader programs.
...
[FTXT](../Devices_Manual_guide/node0168.html) uses "CSI-Seq" control sequences to store character formatting (font
...
(hex 40 through hex 7E).  These sequences may be skipped by a minimal [FTXT](../Devices_Manual_guide/node0168.html)
reader, i.e., one that ignores formatting information.

Note: A future [FTXT](../Devices_Manual_guide/node0168.html) standardization document will explain the uses of
...
are reserved for future use and should be skipped by current [FTXT](../Devices_Manual_guide/node0168.html) reader
programs.
