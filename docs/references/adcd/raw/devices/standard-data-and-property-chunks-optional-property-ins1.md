...
The "INS1" chunks in a FORM [SMUS](../Devices_Manual_guide/node02AB.html) identify the instruments to use for this
...
data.  [See "[Instrument Registers](../Devices_Manual_guide/node02B0.html)" in section 2, above.]
...
most scores will need only a few [instrument registers](../Devices_Manual_guide/node02B0.html).
