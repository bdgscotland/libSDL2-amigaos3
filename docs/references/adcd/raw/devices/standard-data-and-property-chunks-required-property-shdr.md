...
information for the score.  It must appear before the [TRAK](../Devices_Manual_guide/node02B7.html)s in a FORM [SMUS](../Devices_Manual_guide/node02AB.html).
...
the main IFF document and in the source file [IFF.h](../Devices_Manual_guide/node02E5.html).]
...
there are any "set tempo" [SEvent](../Devices_Manual_guide/node02B7.html#line29)s inside the score (see [TRAK](../Devices_Manual_guide/node02B7.html), below).  Or
...
current programs.  [See [More SEvents To Be Defined](../Devices_Manual_guide/node02C1.html), below.]
...
Actually, this global volume level could be scaled by dynamic-mark [SEvent](../Devices_Manual_guide/node02B7.html#line29)s
inside the score (see [TRAK](../Devices_Manual_guide/node02B7.html), below).

The field ctTrack holds the count of tracks, i.e., the number of [TRAK](../Devices_Manual_guide/node02B7.html)
chunks in the FORM [SMUS](../Devices_Manual_guide/node02AB.html) (see below).  This information helps the reader
...
[SHDR](../Devices_Manual_guide/node02B3.html)  chunk.
