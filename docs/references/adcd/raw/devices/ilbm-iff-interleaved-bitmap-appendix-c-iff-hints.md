...
There's a better way to read a [BODY](../Devices_Manual_guide/node01B7.html) than the example IFF code.  The
...
Different hardware display devices have different color resolutions:
    ...
    IBM VGA       6:6:6             63
    Mac II        8:8:8            255
An ILBM [CMAP](../Devices_Manual_guide/node01B0.html) defines 8 bits of Red, Green and Blue (i.e., 8:8:8 bits of
...
converted to ILBM white (255), not to ILBM gray (128).
 ...
 [CGA and EGA subtleties](../Devices_Manual_guide/node01BE.html) 
 [24-bit ILBMs](../Devices_Manual_guide/node01BF.html) 
