...
found using the [TD_GETNUMTRACKS](../Includes_and_Autodocs_2._guide/node052A.html) command.

For V36 and higher systems, the NUMSECS in some drives may be variable and
may change when a disk is inserted.  Use [TD_GETGEOMETRY](../Includes_and_Autodocs_2._guide/node0529.html) to determine the
