...
You write to the clipboard device by passing an [IOClipReq](../Devices_Manual_guide/node0067.html#line5) to the device
...
chapter for the proper method of error checking.
   ...
   Iffparse That Data!
   -------------------
   Keep in mind that the functions in the [iffparse.library](../Libraries_Manual_guide/node0427.html) can be used
   to write data to the clipboard. See the "[IFFParse Library](../Libraries_Manual_guide/node0427.html)" chapter
