...
```
 [DESC sub-sub-chunks](../Devices_Manual_guide/node02A3.html) 
 [DESC notes](../Devices_Manual_guide/node02A4.html) 
 [INFO sub-chunks](../Devices_Manual_guide/node02A5.html) 
 [EXTR sub-sub-chunks](../Devices_Manual_guide/node02A6.html) 
