...
passing an [IOStdReq](../Devices_Manual_guide/node00CC.html#line12) to the device with [IND_SETMPORT](../Includes_and_Autodocs_2._guide/node04E3.html) set in io_Command and
...
```
 ...
 [Setting The Conditions For A Mouse Port Report](../Devices_Manual_guide/node00D1.html) 
