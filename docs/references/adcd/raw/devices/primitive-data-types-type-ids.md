...
IDs are compared using a simple 32-bit case-dependent equality test.  [FORM](../Devices_Manual_guide/node01C7.html#line52)
...
the [IFF Registry](../Devices_Manual_guide/node01FD.html) document for more information.
...
whose IDs they don't recognize (see [Chunks](../Devices_Manual_guide/node01C7.html), below), the new IDs keep old
...
the ID "XY" would be "XY1" and "XY2".  Revisions of "[CMAP](../Devices_Manual_guide/node01B0.html)" would be "CMA1"
and "CMA2".
