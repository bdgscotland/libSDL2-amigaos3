...
[FORM FTXT](../Devices_Manual_guide/node0168.html) uses the core of the 8-bit character set defined by the ISO/ANSI
standards cited at the start of this document.  (See [Appendix A](../Devices_Manual_guide/node0172.html) for a
...
ISO/ANSI standard control sequences.  (See "[Control Sequences](../Devices_Manual_guide/node016C.html)", below.)
...
* C1 is the group of extended control characters in the range hex 80
  ...
  sequence starting with CSI (hex 9B) is used for [FTXT](../Devices_Manual_guide/node0168.html) formatting.  All
