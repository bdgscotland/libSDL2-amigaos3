...
the end of this article, [ISpy](../AmigaMail_Vol2_guide/node018E.html).  ISpy uses a semaphore to gain access to
...
calling the debugger entries, ISpy uses a little [assembler stub](../AmigaMail_Vol2_guide/node018F.html) to load a4
