...
Example 2, [Pub.c](../AmigaMail_Vol2_guide/node019B.html), shows how to open a public screen, make it the
...
later on, lock and copy the list again. [Lockpub.c](../AmigaMail_Vol2_guide/node019C.html) is a small example
