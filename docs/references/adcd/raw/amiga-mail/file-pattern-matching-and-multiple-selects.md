...
The example [FilePat.c](../AmigaMail_Vol2_guide/node0167.html) illustrates multiple selection.

[FilePat.c](../AmigaMail_Vol2_guide/node0167.html) also introduces a new function and a new tag.
...
```
[FilePat.c](../AmigaMail_Vol2_guide/node0167.html) uses AllocAslRequestTags() instead of AllocAslRequest() to
