...
an OS friendly manner.  The C program [4play.c](../AmigaMail_Vol2_guide/node01FE.html) is a simple example that
demonstrates how to access the assembly functions.  The assembly
language program [read34.asm](../AmigaMail_Vol2_guide/node01FF.html) properly allocates the parallel port and any
...
the raw data.
   ...
   [lmkfile](../AmigaMail_Vol2_guide/node0200.html) 
