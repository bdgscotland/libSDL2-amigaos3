...
```c
    o   [Basic Input/Output](../AmigaMail_Vol2_guide/node005F.html)
```
...
```c
    o   [File/Directory Manipulation/Information](../AmigaMail_Vol2_guide/node0060.html)
```
...
```c
    o   [Volume Manipulation/Information](../AmigaMail_Vol2_guide/node0061.html)
```
...
```c
    o   [Handler Maintenance and Control](../AmigaMail_Vol2_guide/node0062.html)
```
...
```c
    o   [Handler Internal](../AmigaMail_Vol2_guide/node0063.html)
```
...
```c
    o   [Obsolete Packets](../AmigaMail_Vol2_guide/node0064.html)
```
...
```c
    o   [Console Only Packets](../AmigaMail_Vol2_guide/node0065.html)
```
