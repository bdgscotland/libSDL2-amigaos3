...
The code example [ListDir.c](../AmigaMail_Vol2_guide/node0174.html) at the end of this article is a simple example
of how to use ExAll().  The example [ListDir2.c](../AmigaMail_Vol2_guide/node0175.html) is a more complicated
