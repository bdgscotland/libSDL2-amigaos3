...
structure.  The C code example [SimpleFR.c](../AmigaMail_Vol2_guide/node0165.html) at the end of this article uses
...
[SimpleFR.c](../AmigaMail_Vol2_guide/node0165.html) looks at the FileRequester's rf_File and rf_Dir fields to get
...
directory.
   ...
   [Figure 1 - The SimpleFR.c file requester](../AmigaMail_Vol2_guide/node0166.html) 

The [simpleFR.c](../AmigaMail_Vol2_guide/node0165.html) example (and the rest of the ASL examples for that matter)
