...
[SignalNotification.c](../AmigaMail_Vol2_guide/node016E.html) implements signal notification on a single target.
[MessageNotification.c](../AmigaMail_Vol2_guide/node016F.html) shows how to start message notification on multiple
