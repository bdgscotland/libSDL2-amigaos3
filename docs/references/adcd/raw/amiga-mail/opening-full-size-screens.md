...
information.  The article "[An Introduction to V36 Screens and Windows](../AmigaMail_Vol2_guide/node008E.html)"
from the September/October 1990 issue of Amiga Mail contains the
example [CloneWB.c](../AmigaMail_Vol2_guide/node019A.html) which illustrates cloning the Workbench screen
