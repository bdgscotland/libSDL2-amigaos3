...
they want.
   ...
   [Figure 2 - The FontReq.c font requester](../AmigaMail_Vol2_guide/node0168.html) 
...
The [FontReq.c](../AmigaMail_Vol2_guide/node0169.html) example illustrates how to use a font requester.
