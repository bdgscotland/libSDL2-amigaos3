...
these functions should only be used as of V37.  [ListPattern.c](../AmigaMail_Vol2_guide/node0177.html) is a simple
...
The [DirComp.c](../AmigaMail_Vol2_guide/node0178.html) example is a more complex example of using
