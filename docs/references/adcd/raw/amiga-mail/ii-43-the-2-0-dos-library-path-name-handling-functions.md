...
These functions are used in subsequent examples.  The [Part.c](../AmigaMail_Vol2_guide/node0172.html) example lets
...
The [Split.c](../AmigaMail_Vol2_guide/node0173.html) example shows the behavior of this function.  The example
