...
imagery appears outside of the hit box.
 ...
 [Figure 1 - String Gadget without Bounding Box](../AmigaMail_Vol2_guide/node01BE.html) 
...
Y can scroll a portion of window Y out from underneath window X:
 ...
 [Figure 2 - Damage from a Scrolling Operation](../AmigaMail_Vol2_guide/node01BF.html) 
...
```c
    ...
    standard purpose.
```
 [Figure 3 - Frameiclass Frame Types](../AmigaMail_Vol2_guide/node01C0.html) 
...
<intuition/imageclass.h>):
 ...
 [Figure 4 - Menu Check Mark and Amiga Key Images](../AmigaMail_Vol2_guide/node01C1.html) 
...
the help message and printf()s the results.
 ...
 [relative.c](../AmigaMail_Vol2_guide/node01C2.html) 
