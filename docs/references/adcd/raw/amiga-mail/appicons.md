...
The C source code example [AppIcon.c](../AmigaMail_Vol2_guide/node01B3.html) at the end of this article is a simple
example of how to create an AppIcon.

   [AppIcon.h](../AmigaMail_Vol2_guide/node01B4.html) 
