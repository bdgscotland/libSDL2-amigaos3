...
processing loop.  The example [Broker.c](../AmigaMail_Vol2_guide/node0202.html) receives input from one source,
...
Notice that [Broker.c](../AmigaMail_Vol2_guide/node0202.html) uses Ctrl-C as a break key.  This is a change
...
are ghosted in [Broker.c](../AmigaMail_Vol2_guide/node0202.html) because it has no window (It doesn't make
