...
user from freely positioning the screen.  See the "[Intuition Screens](../Libraries_Manual_guide/node00DB.html)"
...
"[Intuition Windows](../Libraries_Manual_guide/node0100.html)" chapter for more information on the positioning and
