...
certain events such as [IDCMP_SIZEVERIFY](../Libraries_Manual_guide/node01E0.html#line28) may time-out if the application
...
regardless of the number, each time [Wait()](../Libraries_Manual_guide/node02D4.html) returns.
...
returning to [Wait()](../Libraries_Manual_guide/node02D4.html), the second message gets handled with the signal bit
