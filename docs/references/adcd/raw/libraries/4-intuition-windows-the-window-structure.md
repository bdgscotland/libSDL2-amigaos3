...
The [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) structure is the main Intuition data structure used to
...
```c
    ...
    [GimmeZeroZero](../Libraries_Manual_guide/node0116.html) windows, the GZZ variables reflect the position
...
```c
    ...
    [IDCMP_REQSET](../Libraries_Manual_guide/node01DF.html) and [IDCMP_REQCLEAR](../Libraries_Manual_guide/node01DF.html#line4) to indirectly determine the number of
    open requesters in the window.
```
WScreen

```c
    A pointer to the [Screen](../Libraries_Manual_guide/node00DE.html#line6) structure of the screen on which this window
    was opened.
```
RPort

```c
    A pointer to this window's [RastPort](../Libraries_Manual_guide/node0102.html#line8) structure.  Use this RastPort
...
```c
    With [GimmeZeroZero](../Libraries_Manual_guide/node0116.html) windows, this variable points to the [RastPort](../Libraries_Manual_guide/node0102.html#line8) for
...
UserData
    ...
    to the data.
For a commented listing of the [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) structure see
<intuition/[intuition.h](../Includes_and_Autodocs_2._guide/node00D4.html)> in the Amiga ROM Kernel Reference Manual: Includes
and Autodocs.
