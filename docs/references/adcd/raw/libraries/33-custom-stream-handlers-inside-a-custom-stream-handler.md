...
the [Hook](../Libraries_Manual_guide/node04A3.html) structure (hook in the example used here), a pointer to the
[IFFHandle](../Libraries_Manual_guide/node042C.html) (iff), and a pointer to an [IFFStreamCmd](../Includes_and_Autodocs_2._guide/node010B.html#line51) structure (actionpkt).
Your stream pointer may be found in iff->[iff_Stream](../Libraries_Manual_guide/node042E.html) where you previously
...
for a stream which was opened with a compiler's [fopen()](../Libraries_Manual_guide/node0455.html) buffered file I/O
function:
