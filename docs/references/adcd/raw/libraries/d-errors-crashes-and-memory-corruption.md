...
arguments to a system call (for example [SetAPen](../Includes_and_Autodocs_2._guide/node0475.html)(3) or SetAPen(win,3),
...
may become zero).  If corruption is occurring during exit, use [printf()](../Includes_and_Autodocs_2._guide/node0162.html)
(or [KPrintF()](../Includes_and_Autodocs_2._guide/node0178.html), etc.) with [Delay](../Includes_and_Autodocs_2._guide/node0292.html)(n) to slow down your cleanup and broadcast
...
result.  See <exec/[alerts.h](../Includes_and_Autodocs_2._guide/node007F.html#line90)> for Amiga-specific alert numbers. Also see
"[Crashes--After Exit](../Libraries_Manual_guide/node053C.html)" below.
