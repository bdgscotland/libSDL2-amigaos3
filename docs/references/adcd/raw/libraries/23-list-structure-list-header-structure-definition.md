...
```c
    defines the type of nodes within the list (see <exec/[nodes.h](../Includes_and_Autodocs_2._guide/node0091.html#line43)>).
```
lh_pad
...
```
The lh_Head and lh_Tail fields of the list header act like the [ln_Succ](../Libraries_Manual_guide/node02D9.html#line13) and
...
the [ln_Succ](../Libraries_Manual_guide/node02D9.html#line13) and lh_Pred fields of a node. Here the NULL lh_Tail indicates
