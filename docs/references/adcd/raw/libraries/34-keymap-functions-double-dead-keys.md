...
Double-dead keys are an extension of the [dead-class keys](../Libraries_Manual_guide/node0477.html) explained above.
Unlike normal dead keys wherein one dead key of type [DPF_DEAD](../Includes_and_Autodocs_2._guide/node003A.html#line66) can modify a
second of type [DPF_MOD](../Includes_and_Autodocs_2._guide/node003A.html#line66), double-dead keys employ two consecutive keys of
...
translation.  If they are both of type [DPF_DEAD](../Includes_and_Autodocs_2._guide/node003A.html#line66) and the key immediately
following is [DPF_MOD](../Includes_and_Autodocs_2._guide/node003A.html#line66) then the two are used to form an index into the
(third) key's translation table as follows:

In addition to the index found after the [DPF_DEAD](../Includes_and_Autodocs_2._guide/node003A.html#line66) qualifier in a normal
...
When a key of type [DPF_MOD](../Includes_and_Autodocs_2._guide/node003A.html#line66) is pressed, the system checks the two key codes
which preceded the current one.  If they were both [DPF_DEAD](../Includes_and_Autodocs_2._guide/node003A.html#line66) then the most
...
the current, [DPF_MOD](../Includes_and_Autodocs_2._guide/node003A.html#line66), key.

The translation table of all deadable ([DPF_MOD](../Includes_and_Autodocs_2._guide/node003A.html#line66)) keys has [number of dead
...
with a circumflex (^) accent. The mechanics are as follows:
  ...
  * When key0C is pressed alone the [DPF_DEAD](../Includes_and_Autodocs_2._guide/node003A.html#line66) of the first byte pair in
...
```c
    the [DPF_DEAD](../Includes_and_Autodocs_2._guide/node003A.html#line66) of the second byte pair (recall that the second pair is
