...
Like Smalltalk, Boopsi also has a universal root catagory, [rootclass](../Libraries_Manual_guide/node04BB.html).
Currently, Intuition defines three immediate subclasses of rootclass.  The
first, [gadgetclass](../Libraries_Manual_guide/node020A.html), is the class of Boopsi gadgets.  The second class,
[imageclass](../Libraries_Manual_guide/node0209.html), makes up the class of Boopsi images.

Unlike [gadgetclass](../Libraries_Manual_guide/node020A.html) and [imageclass](../Libraries_Manual_guide/node0209.html), the remaining subclass, [icclass](../Libraries_Manual_guide/node04C6.html), does
...
```c
     [Figure 12-2: Simple Boopsi Diagram](../Libraries_Manual_guide/node05DD.html) 
```
...
that class.  An example of a Boopsi method is the [imageclass](../Libraries_Manual_guide/node0209.html) method
[IM_DRAW](../Libraries_Manual_guide/node04D2.html).  This method tells a Boopsi image to draw itself.  All Boopsi
...
of the attributes of its superclass.  For example, the [IA_Height](../Libraries_Manual_guide/node04DC.html) attribute
is defined by [imageclass](../Libraries_Manual_guide/node0209.html).  All instances of the subclasses of imageclass
...
the application that created the private class.
 ...
 [Using Boopsi](../Libraries_Manual_guide/node0201.html) 
 [The Public Classes](../Libraries_Manual_guide/node0208.html) 
 [Making Gadget Objects Talk to Each Other](../Libraries_Manual_guide/node020B.html) 
 [Making Gadgets Talk to an Application](../Libraries_Manual_guide/node020C.html) 
 [The Interconnection Classes](../Libraries_Manual_guide/node020D.html) 
