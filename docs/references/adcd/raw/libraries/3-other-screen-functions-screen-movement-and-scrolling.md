...
The [MoveScreen()](../Includes_and_Autodocs_2._guide/node022B.html) function moves the screen origin by the number of pixels
...
```
Calls to [MoveScreen()](../Includes_and_Autodocs_2._guide/node022B.html) are asynchronous; the screen is not necessarily
...
the function one time for each [IDCMP_INTUITICKS](../Libraries_Manual_guide/node01E1.html#line80) event.
