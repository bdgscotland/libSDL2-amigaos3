...
are also performed by the Intuition software.  See the [Intuition](../Libraries_Manual_guide/node0002.html) chapters
...
```
  ...
  * Use a template (predefined shape) to draw an object into a
    ...
    drawing area.
 [Components of a Display](../Libraries_Manual_guide/node0312.html) 
 [Introduction To Raster Displays](../Libraries_Manual_guide/node0313.html) 
 [Interlaced and Non-Interlaced Modes](../Libraries_Manual_guide/node0316.html) 
 [Low, High and Super-High Resolution Modes](../Libraries_Manual_guide/node0317.html) 
 [About ECS](../Libraries_Manual_guide/node0319.html) 
 [Forming an Image](../Libraries_Manual_guide/node031E.html) 
 [Role of the Copper (Coprocessor)](../Libraries_Manual_guide/node031F.html) 
