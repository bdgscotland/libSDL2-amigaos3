...
The [RefreshGList()](../Libraries_Manual_guide/node0146.html) function was designed to draw gadgets from scratch, and
...
[boolean](../Libraries_Manual_guide/node014C.html) gadget, whose imagery is a surrounding [Border](../Libraries_Manual_guide/node01C1.html) and whose label is
an [IntuiText](../Libraries_Manual_guide/node01C7.html).  Attempting to visually unselect such a gadget by clearing
its [GFLG_SELECTED](../Libraries_Manual_guide/node014A.html#line63) flag and refreshing it will leave incorrect imagery
because [RefreshGList()](../Libraries_Manual_guide/node0146.html) just redraws the border and text, and never knows
...
([GadgetRender](../Libraries_Manual_guide/node0149.html#line91)) should be an [Image](../Libraries_Manual_guide/node01BA.html) structure which fully covers the select
box.  Such a gadget may be highlighted with color complementing
([GFLG_GADGHCOMP](../Libraries_Manual_guide/node014A.html#line8)), or with an alternate image ([GFLG_GADGHIMAGE](../Libraries_Manual_guide/node014A.html#line16)) for its
[SelectRender](../Libraries_Manual_guide/node0149.html#line102).  Or, for a gadget which will never be disabled but needs to
be deselected programmatically, you may also use a [Border](../Libraries_Manual_guide/node01C1.html) structure for
...
rectangle of the gadget's select area, change the [GFLG_SELECTED](../Libraries_Manual_guide/node014A.html#line63) or the
[GFLG_DISABLED](../Libraries_Manual_guide/node014A.html#line73) flag, add the gadget back, and refresh it.
...
[RemoveGList()](../Libraries_Manual_guide/node0133.html#line27) and the call to [RectFill()](../Libraries_Manual_guide/node035F.html).  To ensure this, the application
should set [IDCMP_SIZEVERIFY](../Libraries_Manual_guide/node01E0.html#line28) so that Intuition will first notify you before
