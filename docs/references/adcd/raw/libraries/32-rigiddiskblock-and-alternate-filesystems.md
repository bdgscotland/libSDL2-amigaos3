...
```c
                           ...
                           creator of this block.  (see [rdb_HostID](../Libraries_Manual_guide/node0420.html#line8)
                           discussion)
```
...
```c
                           ...
                           [de_DosType](../Libraries_Manual_guide/node0422.html#line88) entry.
```
   ...
   fhb_SegListBlocks       first of linked list of [LoadSegBlocks](../Libraries_Manual_guide/node0424.html):
