...
```c
    ...
    the console.device.  These merely demonstrate [CD_ASKKEYMAP](../Libraries_Manual_guide/node0469.html#line13) and
    [CD_SETKEYMAP](../Libraries_Manual_guide/node0469.html#line13) which are console.device commands.
```
