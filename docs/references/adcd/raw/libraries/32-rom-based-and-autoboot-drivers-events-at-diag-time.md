...
initialization routine, its [ExpansionRom](../Includes_and_Autodocs_2._guide/node00F6.html#line45) structure is copied into the
ExpansionRom subfield of a [ConfigDev](../Libraries_Manual_guide/node0416.html#line6) structure.  This ConfigDev structure
will be linked to the expansion.library's private list of configured
boards.

After the board is configured, the er_Type field of its [ExpansionRom](../Includes_and_Autodocs_2._guide/node00F6.html#line45)
...
```
Now expansion knows that there is a [DiagArea](../Includes_and_Autodocs_2._guide/node00F6.html#line236), and knows where it is.
...
also include the da_DiagPoint ROM/diagnostic routine, a [Resident](../Libraries_Manual_guide/node0298.html) structure
...
addition, the [BootNode](../Libraries_Manual_guide/node041D.html#line22) and parameter packet for [MakeDosNode()](../Libraries_Manual_guide/node041A.html) may be
...
```c
     [Diag.asm](../Libraries_Manual_guide/node0594.html) 
```
...
to board's [ConfigDev](../Libraries_Manual_guide/node0416.html#line6) structure, the expansion module is free to configure
...
become $C0, you should use the #defines in <libraries/[configregs.h](../Includes_and_Autodocs_2._guide/node00F6.html#line150)> to
interpret it.
...
[Resident](../Libraries_Manual_guide/node0298.html) structure (romtag) directly follows its DiagArea structure.
