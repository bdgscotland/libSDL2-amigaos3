...
[ExecBase->Quantum](../Includes_and_Autodocs_2._guide/node009E.html#line64) field had little effect because of the bugs.

For 2.0, a task runs until either its [Quantum](../Includes_and_Autodocs_2._guide/node009E.html#line64) is up, or a higher priority
...
that use two tasks of equal priority, one busy-waiting and one [Wait()](../Libraries_Manual_guide/node02D4.html)ing
