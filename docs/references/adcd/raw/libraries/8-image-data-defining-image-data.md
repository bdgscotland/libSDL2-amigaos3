...
```c
    ...
    of the last word of the [ImageData](../Libraries_Manual_guide/node01BA.html#line47) should be set to zero.
```
...
the section "[Image Example](../Libraries_Manual_guide/node01BF.html)".
...
```c
    ...
    ************************········    F F F F    F F 0 0
     ...
     [simpleimage.c](../Libraries_Manual_guide/node05AC.html) 
```
