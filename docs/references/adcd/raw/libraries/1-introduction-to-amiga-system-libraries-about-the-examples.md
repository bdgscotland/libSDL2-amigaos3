...
```c
      ...
      [interrupt servers](../Libraries_Manual_guide/node030B.html), [subtasks](../Libraries_Manual_guide/node02C0.html#line29), [handlers](../Libraries_Manual_guide/node0309.html) and [callback hook](../Libraries_Manual_guide/node04A2.html) functions.
```
