...
The menu numbers Intuition provides in the [IDCMP_MENUPICK](../Libraries_Manual_guide/node01DE.html) messages,
...
```c
    ...
    [IDCMP_MENUHELP](../Libraries_Manual_guide/node01DE.html#line21) messages.  Using menu help, a user can select any
    component of a menu, including the menu header itself.
```
 [How Menu Numbers Really Work](../Libraries_Manual_guide/node0189.html) 
