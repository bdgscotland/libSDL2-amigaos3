...
Reference Manual: [Includes and Autodocs](../Includes_and_Autodocs_2._guide/node000E.html).  The functions which are new are
...
[Exit gracefully](../Libraries_Manual_guide/node0334.html#line14) and informatively if the required library version is not
available.

 [About Release 2](../Libraries_Manual_guide/node0015.html) 
