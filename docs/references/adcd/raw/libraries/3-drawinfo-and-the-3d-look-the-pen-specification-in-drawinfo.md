...
The drawing pen specification in [DrawInfo.dri_Pens](../Libraries_Manual_guide/node00EB.html#line8) allows applications to
...
compatibility mode for screens that do not specify the [SA_Pens](../Libraries_Manual_guide/node00E5.html#line82) tag.
...
```c
    [Custom screens](../Libraries_Manual_guide/node00DF.html) that do not provide the [SA_Pens](../Libraries_Manual_guide/node00E5.html#line82) tag are assumed to
    have no knowledge of the pen array.  They are rendered in a special
    version of the monochrome new look, which uses the screen's [DetailPen](../Libraries_Manual_guide/node00E5.html#line91)
    and [BlockPen](../Libraries_Manual_guide/node00E5.html#line99) to get its colors.  This is provided for compatibility
    with V34 and older [versions](../Libraries_Manual_guide/node0014.html) of the operating system.
```
...
technique is demonstrated in the first two examples ([newlookscreen.c](../Libraries_Manual_guide/node05D0.html#line25) and
[screen34to37.c](../Libraries_Manual_guide/node05D1.html#line23))listed earlier in this chapter.
...
[SA_Pens](../Libraries_Manual_guide/node00E5.html#line82) tag and a pointer to a pen array.  Currently, Intuition uses nine
...
Using the pen specification of an existing [public screen](../Libraries_Manual_guide/node00E6.html) is a bit more
involved.  First, the application must get a pointer to the screen
structure of the public screen using the [LockPubScreen()](../Libraries_Manual_guide/node00E6.html#line34) call.  A copy of
the screen's [DrawInfo](../Libraries_Manual_guide/node00DE.html#line6) structure may then be obtained by calling
[GetScreenDrawInfo()](../Libraries_Manual_guide/node00EE.html#line16).  The DrawInfo structure contains a copy of the pen
specification for the screen that can be used in the [OpenScreenTagList()](../Libraries_Manual_guide/node00DF.html#line6)
call with the [SA_Pens](../Libraries_Manual_guide/node00E5.html#line82) tag.  The pen array is copied to the data structures
of the new screen (it is not kept as a pointer to the information passed),
so the application may immediately call [FreeScreenDrawInfo()](../Libraries_Manual_guide/node00FD.html#line21) and
[UnlockPubScreen()](../Libraries_Manual_guide/node00E6.html#line34) after the new screen is open.


```c
     [publicscreen.c](../Libraries_Manual_guide/node05B6.html) 
```
...
the pen array from the Workbench screen and use this copy with the [SA_Pens](../Libraries_Manual_guide/node00E5.html#line82)
...
a [DrawInfo](../Libraries_Manual_guide/node00DE.html#line6) structure and PENNAME is taken from the list below:
