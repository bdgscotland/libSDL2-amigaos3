...
```c
    Like [GTMX_Labels](../Libraries_Manual_guide/node0263.html#line15), this tag is associated with a
    NULL-pointer-terminated array of strings which are the choices that
    this gadget allows.  This array must be supplied to [CreateGadget()](../Libraries_Manual_guide/node025A.html),
...
receive an [IDCMP_GADGETUP](../Libraries_Manual_guide/node01DD.html#line6) IntuiMessage.  Look in the [Code](../Libraries_Manual_guide/node01D9.html#line33) field of the
[IntuiMessage](../Libraries_Manual_guide/node01D9.html) for the ordinal number of the new active selection.
