...
```
The [IntuiMessage](../Libraries_Manual_guide/node01D9.html)s received for a scroller gadget are the same in nature as
...
to actually change. The [Code](../Libraries_Manual_guide/node01D9.html#line33) field of the IntuiMessage will contain the
