...
observed at all times:
 ...
 1) All tasks using shared data that is protected by a semaphore must
    ...
    to the data.
 2) A deadlock will occur if a task that owns an [exclusive](../Libraries_Manual_guide/node02FA.html) semaphore on
...
```c
    ...
    (Prentice-Hall).
```
 [Semaphore Functions](../Libraries_Manual_guide/node02F6.html)    [Function Reference](../Libraries_Manual_guide/node0300.html) 
