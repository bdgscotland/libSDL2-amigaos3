...
To specify the priorities of the Bobs, use the [Before](../Libraries_Manual_guide/node0398.html#line8) and [After](../Libraries_Manual_guide/node0398.html#line8) pointers.
...
```c
    ...
    cannot be changed.  The system does not draw the Bobs on the [Before](../Libraries_Manual_guide/node0398.html#line8)
    list first, it draws the Bobs on the [After](../Libraries_Manual_guide/node0398.html#line8) list first. Next, it draws
...
[Before](../Libraries_Manual_guide/node0398.html#line8) and [After](../Libraries_Manual_guide/node0398.html#line8) pointers must be initialized so that the system will
...
```
As the system goes through the [GelsInfo](../Libraries_Manual_guide/node0377.html#line6) list, it checks the Bob's [After](../Libraries_Manual_guide/node0398.html#line8)
pointer.  If this is not NULL, it follows the After pointer until it hits
a NULL.  Then it starts rendering the Bobs, going back up the [Before](../Libraries_Manual_guide/node0398.html#line8)
...
```c
    ...
    the [Before](../Libraries_Manual_guide/node0398.html#line8) and [After](../Libraries_Manual_guide/node0398.html#line8) order for Bobs that are not in the same
