...
Zorro II and Zorro III expansion hardware, see the "[Zorro Expansion Bus](../Hardware_Manual_guide/node028B.html)"
...
Support ([CATS](../Libraries_Manual_guide/node002A.html)), West Chester, Pennsylvania.
...
```c
    Note:
    -----
    A unique Hardware Manufacturer number assigned by [CATS](../Libraries_Manual_guide/node002A.html) is not the
