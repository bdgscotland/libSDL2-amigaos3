...
To go to sleep, a task calls a system function called [Wait()](../Libraries_Manual_guide/node02D4.html). This
...
```
[Wait()](../Libraries_Manual_guide/node02D4.html) puts the task to sleep and will not return until some other task
...
signal or signals occurred.
 ...
 [Looking for Break Keys](../Libraries_Manual_guide/node028A.html)    [Processing Signals Without Wait()ing](../Libraries_Manual_guide/node028B.html) 
