...
filtering them.  A filter [CxObject](../Libraries_Manual_guide/node0401.html) compares the [CxMessages](../Libraries_Manual_guide/node0403.html) it receives to
...
```
The C macro [CxFilter()](../Includes_and_Autodocs_2._guide/node014D.html) (defined in <libraries/[commodities.h](../Includes_and_Autodocs_2._guide/node00F0.html#line19)>) returns a
pointer to a filter [CxObject](../Libraries_Manual_guide/node0401.html).  The macro has only one argument, a pointer
...
string ([CX_POPKEY](../Libraries_Manual_guide/node0406.html) uses the same description string format):
...
<devices/[inputevent.h](../Includes_and_Autodocs_2._guide/node0051.html#line20)>.  Commodities Exchange will assume the class is
...
<devices/[inputevent.h](../Includes_and_Autodocs_2._guide/node0051.html#line161)>).  A dash preceding the qualifier string tells the
...
to a synonym identifier as defined in <libraries/[commodities.h](../Includes_and_Autodocs_2._guide/node00F0.html#line184)>.  A dash
