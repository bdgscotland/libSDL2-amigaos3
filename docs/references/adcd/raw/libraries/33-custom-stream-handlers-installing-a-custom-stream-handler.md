...
To initialize your [IFFHandle](../Libraries_Manual_guide/node042C.html) to point to your custom stream and stream
handler, you must open your stream and place a pointer to the stream in
your IFFHandle's [iff_Stream](../Libraries_Manual_guide/node042E.html) field.  This pointer could be the return from
[fopen()](../Libraries_Manual_guide/node0430.html), or an Exec device I/O request, or any other type of pointer which
...
stream handler, you must first set up a [Hook](../Libraries_Manual_guide/node04A3.html) structure (<utility/[hooks.h](../Includes_and_Autodocs_2._guide/node012D.html#line22)>)
to point to your stream handling function.  Then use [InitIFF()](../Libraries_Manual_guide/node042E.html#line29) to install
...
hook, A2 is a pointer to your [IFFHandle](../Libraries_Manual_guide/node042C.html), and A1 is a pointer to a command
...
registerized C function entry as the [h_Entry](../Libraries_Manual_guide/node04A3.html#line14) hook entry point:
...
```
Alternately, you could initialize your [Hook](../Libraries_Manual_guide/node04A3.html) structure's [h_Entry](../Libraries_Manual_guide/node04A3.html#line14) to point
...
must store the address of your C function in the [h_SubEntry](../Libraries_Manual_guide/node04A3.html#line27) field of the
