...
As with a file requester, the font requester is specified with a [TagItem](../Libraries_Manual_guide/node0497.html)
list.  There are several tags that are specific to the font requester:
  ...
  Tag Name        Used For
  --------------  --------
  ASL_FontName    Default font ([fo_Attr](../Libraries_Manual_guide/node0281.html#line5).ta_Name)
  ASL_FontHeight  Default font size ([fo_Attr](../Libraries_Manual_guide/node0281.html#line5).ta_YSize)
  ASL_FontStyles  Default font style ([fo_Attr](../Libraries_Manual_guide/node0281.html#line5).ta_Style)
  ASL_FontFlags   Default font flags ([fo_Attr](../Libraries_Manual_guide/node0281.html#line5).ta_Flags)
  ASL_FrontPen    Default font color ([fo_FrontPen](../Libraries_Manual_guide/node0281.html#line5))
  ASL_BackPen     Default font background color ([fo_BackPen](../Libraries_Manual_guide/node0281.html#line5))
...
requester are defined in <libraries/[asl.h](../Includes_and_Autodocs_2._guide/node00EA.html#line156)>:
...
setting in the [FontRequester](../Libraries_Manual_guide/node0281.html)'s fo_FrontPen and fo_BackPen fields.
...
[fo_Attr](../Libraries_Manual_guide/node0281.html#line5).ta_Style bit field according to the style flags defined in
<graphics/[text.h](../Includes_and_Autodocs_2._guide/node00A8.html#line26)>.  FONF_FIXEDWIDTH limits the font name display to fixed
...
[fo_DrawMode](../Libraries_Manual_guide/node0281.html#line5) field.  The number stored there corresponds to the draw mode's
