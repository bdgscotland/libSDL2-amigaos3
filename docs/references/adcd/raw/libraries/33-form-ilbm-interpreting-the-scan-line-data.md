...
If the [ILBM](../Libraries_Manual_guide/node045D.html#line8) is not HAM or HALFBRITE, then after parsing and uncompacting
...
The RGB value for each color register is stored in the [CMAP](../Libraries_Manual_guide/node0461.html#line16) chunk of the
[ILBM](../Libraries_Manual_guide/node045D.html#line8), starting with register 0, with each register's RGB value stored as
...
properly saved a [CAMG](../Libraries_Manual_guide/node0461.html#line7) chunk (look at a hex dump of your file with ASCII
...
HAM pictures will have the 0x800 bit set in [CAMG](../Libraries_Manual_guide/node0461.html#line7) chunk ViewModes. HALBRITE
pictures will have the 0x80 bit set.  See the [graphics library](../Libraries_Manual_guide/node0004.html) chapters or
the Amiga [Hardware](../Hardware_Manual_guide/node0000.html) Reference Manual for more information on HAM and
HALFBRITE modes.
