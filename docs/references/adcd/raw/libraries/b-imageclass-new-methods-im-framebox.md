...
fit into a rectangular bounds.  For example, to draw an [frameiclass](../Libraries_Manual_guide/node04DF.html) image
...
<intuition/[intuition.h](../Includes_and_Autodocs_2._guide/node00D4.html#line784)>) describing the dimensions and position of the
...
The [imageclass](../Libraries_Manual_guide/node04D1.html) dispatcher does not support this method.  It returns zero.
