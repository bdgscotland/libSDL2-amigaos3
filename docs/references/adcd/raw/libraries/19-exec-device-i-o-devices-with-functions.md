...
ROM Kernel Reference Manual: [Includes and Autodocs](../Includes_and_Autodocs_2._guide/node0000.html), and in the [Devices](../Devices_Manual_guide/node0000.html)
...
See the "[Exec Libraries](../Libraries_Manual_guide/node0296.html)" chapter for more information.
...
The procedure for accessing a device's functions is as follows:
  ...
  * Call [OpenDevice()](../Libraries_Manual_guide/node029E.html), passing the I/O request.  If OpenDevice() is
...
```c
    [io_Device](../Includes_and_Autodocs_2._guide/node0094.html#line28) field.
```
...
#include <devices/[timer.h](../Includes_and_Autodocs_2._guide/node0053.html)>
