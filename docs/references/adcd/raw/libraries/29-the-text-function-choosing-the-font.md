...
The graphics.library function [SetFont()](../Includes_and_Autodocs_2._guide/node0479.html) changes the rastport's current
font:
...
```
The parameter mytf is a pointer to an open, valid [TextFont](../Libraries_Manual_guide/node03DE.html) structure.  The
system uses the TextFont structure to keep track of fonts (The TextFont
structure is discussed in detail later in this chapter).  The [OpenFont()](../Includes_and_Autodocs_2._guide/node0462.html)
(from graphics.library) and [OpenDiskFont()](../Includes_and_Autodocs_2._guide/node01F7.html) (from diskfont.library)
...
requested font.  The TextAttr structure (from <graphics/[text.h](../Includes_and_Autodocs_2._guide/node00A8.html#line65)>) looks
like this:
...
the system list, [OpenDiskFont()](../Includes_and_Autodocs_2._guide/node01F7.html) will look in the FONTS: directory for the
...
(although this is discouraged).  [OpenFont()](../Includes_and_Autodocs_2._guide/node0462.html) and OpenDiskFont() try to find
...
The font styles for ta_Style (from <graphics/[text.h](../Includes_and_Autodocs_2._guide/node00A8.html#line26)>) are:
...
The flags for ta_Flags (from <graphics/[text.h](../Includes_and_Autodocs_2._guide/node00A8.html#line42)>) are:
...
```c
     [pseudotext.c](../Libraries_Manual_guide/node05BB.html) 
```
The example above uses the graphics.library's [SetFont()](../Includes_and_Autodocs_2._guide/node0479.html) function to change
...
"[Preferences](../Libraries_Manual_guide/node0221.html)" chapter of this manual for more information on how to find
user preferences.
