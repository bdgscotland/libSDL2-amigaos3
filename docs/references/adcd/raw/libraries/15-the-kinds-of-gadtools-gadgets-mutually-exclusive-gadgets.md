...
```c
    ...
    supplied to [CreateGadget()](../Libraries_Manual_guide/node025A.html) and may not be changed.  The strings
...
gadgets, the program will receive an [IDCMP_GADGETDOWN](../Libraries_Manual_guide/node01DD.html) IntuiMessage. Look
in the [IntuiMessage](../Libraries_Manual_guide/node01D9.html)'s [Code](../Libraries_Manual_guide/node01D9.html#line33) field for the ordinal number of the new active
selection.

The [ng_GadgetText](../Libraries_Manual_guide/node0259.html#line27) field of the [NewGadget](../Libraries_Manual_guide/node0259.html) structure is ignored for mutually
exclusive gadgets.  The text position specified in [ng_Flags](../Libraries_Manual_guide/node0259.html#line38)  determines
...
the dimensions supplied in the [NewGadget](../Libraries_Manual_guide/node0259.html) structure are ignored.  If in the
