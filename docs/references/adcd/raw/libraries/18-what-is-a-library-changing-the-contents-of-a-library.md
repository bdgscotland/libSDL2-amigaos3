...
function to do this: [SetFunction()](../Includes_and_Autodocs_2._guide/node037C.html).  The SetFunction() routine redirects a
...
The format of the [SetFunction()](../Includes_and_Autodocs_2._guide/node037C.html) routine is as follows:
...
replace it with.  The [SetFunction()](../Includes_and_Autodocs_2._guide/node037C.html) routine replaces the entry in the
...
legitimate use for [SetFunction()](../Includes_and_Autodocs_2._guide/node037C.html) is in a debugger utility.  Using
...
```c
    [SetFunction()](../Includes_and_Autodocs_2._guide/node037C.html) is for Advanced Users Only.
    -----------------------------------------
...
```
Although useful, performing [SetFunction()](../Includes_and_Autodocs_2._guide/node037C.html) on a library routines poses
