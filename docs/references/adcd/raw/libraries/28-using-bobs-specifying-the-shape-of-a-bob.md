...
Bob images are set up for easy blitter manipulation.  The [ImageData](../Includes_and_Autodocs_2._guide/node00C3.html#line109)
...
```c
    Note:
    -----
    As with all image data, a Bob's [ImageData](../Includes_and_Autodocs_2._guide/node00C3.html#line102) must be in Chip memory
    for access by the blitter.
```
The sample image below shows the same image defined as a VSprite in the
"[Using Virtual Sprites](../Libraries_Manual_guide/node0387.html)" section above.  The data here, however, is laid
