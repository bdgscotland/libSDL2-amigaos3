...
instances of the [IntuiText](../Includes_and_Autodocs_2._guide/node00D4.html#line568) structure:
...
```c
    ...
    The base position for text rendered with [PrintIText()](../Libraries_Manual_guide/node01C8.html) is taken from
