...
The system default keymap can be set with the [SetKeyMapDefault()](../Includes_and_Autodocs_2._guide/node0316.html) function.
...
own Intuition window (see the [Devices](../Devices_Manual_guide/node0080.html) volume), and use the console.device
command [CD_SETKEYMAP](../Libraries_Manual_guide/node0469.html#line13) to set a keymap only for their own console.
