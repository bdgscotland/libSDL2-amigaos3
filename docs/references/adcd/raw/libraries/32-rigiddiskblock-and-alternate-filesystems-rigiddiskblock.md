...
```c
                           ...
                           [PartitionBlock](../Libraries_Manual_guide/node0422.html)
```
...
```c
                           A singly linked list of blocks of type
                           [FileSysHeaderBlock](../Libraries_Manual_guide/node0423.html)
```
   rdb_DriveInit           optional drive-specific init code

```c
                           A singly linked list of blocks of type
                           [LoadSegBlock](../Libraries_Manual_guide/node0424.html) containing initialization code.
