...
Use the function [InstallClipRegion()](../Includes_and_Autodocs_2._guide/node0399.html) to install the region.
...
with a second call to [InstallClipRegion()](../Includes_and_Autodocs_2._guide/node0399.html) before removing the layer.
