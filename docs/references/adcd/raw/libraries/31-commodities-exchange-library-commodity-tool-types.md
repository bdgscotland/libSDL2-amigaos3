...
("[Filter Objects and the Input Description String](../Libraries_Manual_guide/node0407.html)").
...
```c
    ...
    tooltypevalue = LONG  *ArgInt(UBYTE **tooltypearray,
                                  ...
                                  LONG defaultvalue);
```
[ArgArrayInit()](../Includes_and_Autodocs_2._guide/node013D.html) initializes a Tool Type array of strings which it creates
...
[ArgArrayInit()](../Includes_and_Autodocs_2._guide/node013D.html) also uses some resources that must be returned to the
system when the commodity is done.  [ArgArrayDone()](../Includes_and_Autodocs_2._guide/node013C.html) performs this clean up.
...
by [ArgArrayInit()](../Includes_and_Autodocs_2._guide/node013D.html), [ArgString()](../Includes_and_Autodocs_2._guide/node013F.html) and [ArgInt()](../Includes_and_Autodocs_2._guide/node013E.html).  ArgString() scans the Tool
