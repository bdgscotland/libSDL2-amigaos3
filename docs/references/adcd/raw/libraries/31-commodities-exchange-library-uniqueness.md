...
When a commodity opens its [broker](../Libraries_Manual_guide/node0402.html), it can ask Commodities Exchange not to
launch another broker with the same name ([nb_Name](../Libraries_Manual_guide/node0402.html#line22)).  The purpose of the
...
certain bits in the [nb_Unique field](../Includes_and_Autodocs_2._guide/node00F0.html#line59) of the [NewBroker](../Libraries_Manual_guide/node0402.html#line20) structure it sends to
[CxBroker()](../Libraries_Manual_guide/node0402.html#line14):
...
[CXM_COMMAND CxMessage](../Libraries_Manual_guide/node0403.html) with an ID of [CXCMD_UNIQUE](../Includes_and_Autodocs_2._guide/node00F0.html#line127) when someone tries to
...
When [HotKey.c](../Libraries_Manual_guide/node0587.html) gets a [CXCMD_UNIQUE](../Includes_and_Autodocs_2._guide/node00F0.html#line127) [CxMessage](../Libraries_Manual_guide/node0403.html), it shuts itself down.
