...
array is found in the [do_ToolTypes](../Libraries_Manual_guide/node0241.html#line66) field of the icon's [DiskObject](../Libraries_Manual_guide/node0241.html)
structure.
...
the icon's [.info](../Libraries_Manual_guide/node0238.html) file.  Users can enter and change a selected icon's Tool
...
[FindToolType()](../Includes_and_Autodocs_2._guide/node0186.html) returns the value of a Tool Type element.  Using the above
example, if you are looking for FILETYPE, the string "PaintProgram|ILBM"
will be returned.  [MatchToolValue()](../Includes_and_Autodocs_2._guide/node018C.html) returns nonzero if the specified
