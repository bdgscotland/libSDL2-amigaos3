...
```c
    WARNING:
    --------
    This hex dump is shown only to help the reader understand how [IFF](../Libraries_Manual_guide/node0428.html)
    chunks appear in a file.  You cannot ever depend on any particular
    [ILBM](../Libraries_Manual_guide/node045D.html#line8) chunk being at any particular offset into the file.  IFF files
    are composed, in their simplest form, of chunks within a [FORM](../Libraries_Manual_guide/node042A.html#line7).  Each
    ...
    listed in the Amiga ROM Kernel Reference Manual: [Devices](../Devices_Manual_guide/node0129.html) for
