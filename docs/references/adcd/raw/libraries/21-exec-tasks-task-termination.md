...
Task termination may occur as the result of a number of situations:
  ...
  * A program returning from its [initialPC](../Libraries_Manual_guide/node02BC.html#line35) routine and dropping into its

```c
    [finalPC](../Libraries_Manual_guide/node02BC.html#line35) routine or the system default finalizer.
```
  ...
  * An explicit call to Exec [RemTask()](../Libraries_Manual_guide/node02D0.html#line5) or amiga.lib [DeleteTask()](../Libraries_Manual_guide/node02BD.html#line6).
...
you must make sure it is in a safe state such as [Wait](../Libraries_Manual_guide/node02D4.html)(0L) and not still
