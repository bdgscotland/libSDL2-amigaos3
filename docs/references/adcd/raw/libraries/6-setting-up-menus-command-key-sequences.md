...
[COMMSEQ](../Libraries_Manual_guide/node019B.html#line20) flag in the [Flags](../Libraries_Manual_guide/node019A.html#line35) variable of the [MenuItem](../Libraries_Manual_guide/node019A.html) structure and by
placing the ASCII character (upper or lower case) that is to be associated
with the sequence into the [Command](../Libraries_Manual_guide/node019A.html#line72) variable of the MenuItem structure.
...
```c
     [Figure 6-4: Menu Items with Command Key Shortcuts](../Libraries_Manual_guide/node05D8.html) 
```
