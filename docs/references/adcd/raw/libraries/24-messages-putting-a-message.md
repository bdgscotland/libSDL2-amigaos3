...
A message is delivered to a given destination port with the [PutMsg()](../Includes_and_Autodocs_2._guide/node036B.html)
...
required, the [mn_ReplyPort](../Libraries_Manual_guide/node02EF.html#line14) field must be set up prior to the call to
PutMsg().

Here is a code fragment for putting a message to a public port.  A
[complete example](../Libraries_Manual_guide/node05E7.html) is printed at the end of the chapter.
