...
You use the routine [BltTemplate()](../Includes_and_Autodocs_2._guide/node0424.html) to extract a rectangular area from a
...
[BltTemplate()](../Includes_and_Autodocs_2._guide/node0424.html) takes the following arguments:
...
The data from the source rectangle is copied into the destination [RastPort](../Libraries_Manual_guide/node034A.html)
...
[BltTemplate()](../Includes_and_Autodocs_2._guide/node0424.html) uses [FgPen](../Libraries_Manual_guide/node0350.html#line3), [BgPen](../Libraries_Manual_guide/node0350.html#line6), [DrawMode](../Libraries_Manual_guide/node0351.html) and [Mask](../Libraries_Manual_guide/node034F.html) to place the template
into the destination area. This routine differs from [BltPattern()](../Libraries_Manual_guide/node0364.html) in that
