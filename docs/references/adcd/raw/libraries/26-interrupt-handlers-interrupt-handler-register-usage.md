...
Here are the register conventions for interrupt handlers.
 ...
 D1 Contains the 4703 [INTENAR](../Hardware_Manual_guide/node0164.html#line8) and [INTREQR](../Hardware_Manual_guide/node0164.html#line17) registers values AND'ed
...
[SetIntVector()](../Includes_and_Autodocs_2._guide/node037D.html), your initialized [Interrupt](../Libraries_Manual_guide/node0307.html) structure, and the 4703
...
defined in <hardware/[intbits.h](../Includes_and_Autodocs_2._guide/node00CE.html)>.  The second argument is the address of an
[interrupt server node](../Libraries_Manual_guide/node0307.html) as described earlier in this chapter.  Keep in mind
...
assembler interrupt handler.  See the "[Resources](../Devices_Manual_guide/node0108.html)" chapter for more
information on allocating resources, and the "[Serial Device](../Devices_Manual_guide/node009A.html)" chapter in
the Amiga ROM Kernel Reference Manual: Devices for the more common method
of serial communications.


```c
     [rbf.c](../Libraries_Manual_guide/node05E9.html) 
```
...
```c
     [rbfhandler.asm](../Libraries_Manual_guide/node05EA.html) 

    NOTE.
    -----
    The data structure containing the signal to use, task address
    pointer, and buffers is allocated and initialized in main(), and
    passed to the handler via the [is_Data](../Libraries_Manual_guide/node0307.html) pointer of the [Interrupt](../Libraries_Manual_guide/node0307.html)
    structure.
```
