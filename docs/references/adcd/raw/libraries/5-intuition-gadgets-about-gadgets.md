...
through Intuition's [custom](../Libraries_Manual_guide/node0176.html) gadget and BOOPSI facilities.  Application
...
There are four basic types of application gadgets:
  ...
  * [Boolean](../Libraries_Manual_guide/node014C.html) (or button) gadgets elicit true/false or yes/no kinds of

    answers from the user.
  * [Proportional](../Libraries_Manual_guide/node0153.html) gadgets allow the user to select from a continuous range

    of options, such as volume or speed.
  * [String](../Libraries_Manual_guide/node0164.html) gadgets are used to get or display character based information

```c
    (a special class of string gadget allows entry of numeric data.)
```
  * [Custom](../Libraries_Manual_guide/node0176.html) gadgets, a new, generalized form of gadget, provide

    flexibility to perform any type of function.
The way a gadget is used varies according to the type of gadget.  For a
[boolean](../Libraries_Manual_guide/node014C.html) gadget, the user operates the gadget by simply clicking the mouse
select button.  For a [string](../Libraries_Manual_guide/node0164.html) gadget, a cursor appears, allowing the user
to enter data from the keyboard.  For a [proportional](../Libraries_Manual_guide/node0153.html) gadget, the user can
either drag the [knob](../Libraries_Manual_guide/node015A.html) with the mouse or click in the gadget [container](../Libraries_Manual_guide/node0159.html) to
...
```c
     [Figure 5-1: System and Application Gadgets](../Libraries_Manual_guide/node05D4.html) 
```
...
redrawn by first removing the gadget from the system.
 ...
 [System Gadgets](../Libraries_Manual_guide/node0131.html)         [Adding and Removing Gadgets](../Libraries_Manual_guide/node0133.html) 
 [Application Gadgets](../Libraries_Manual_guide/node0132.html) 
