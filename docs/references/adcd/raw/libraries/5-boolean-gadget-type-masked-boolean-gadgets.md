...
Imagery for [boolean](../Libraries_Manual_guide/node014C.html) gadgets is rectangular by default, but non-rectangular
...
With masked [boolean](../Libraries_Manual_guide/node014C.html) gadgets, if the gadget has highlight type
[GFLG_GADGHCOMP](../Libraries_Manual_guide/node014A.html#line8) then the complement rendering is restricted to the mask.
This allows for non-rectangular shapes, such as an oval gadget which
highlights only within the oval.

There are some shortcomings to non-rectangular [boolean](../Libraries_Manual_guide/node014C.html) gadgets.  For
...
To use a masked [boolean](../Libraries_Manual_guide/node014C.html) gadget, fill out an instance of the [BoolInfo](../Libraries_Manual_guide/node014E.html)
structure.  This structure contains a pointer to the mask plane data.  The
application must also set the [GACT_BOOLEXTEND](../Libraries_Manual_guide/node014B.html#line102) flag in the gadget's
[Activation](../Libraries_Manual_guide/node0149.html#line53) field.
