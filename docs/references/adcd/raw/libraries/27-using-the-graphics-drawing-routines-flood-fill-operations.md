...
combination of the drawing mode, [FgPen](../Libraries_Manual_guide/node0350.html#line3), [BgPen](../Libraries_Manual_guide/node0350.html#line6) and the area pattern.

Flood-fill requires a [TmpRas](../Libraries_Manual_guide/node034D.html#line32) structure at least as large as the [RastPort](../Libraries_Manual_guide/node034A.html)
...
You use the [Flood()](../Includes_and_Autodocs_2._guide/node043C.html) routine for flood fill. The syntax for this routine is
as follows:
...
```
The rastPort argument specifies the [RastPort](../Libraries_Manual_guide/node034A.html) you want to draw into.  The x
and y arguments specify the starting coordinate within the [BitMap](../Libraries_Manual_guide/node032B.html#line74).  The
...
```c
    ...
    is the same as that specified in the area outline pen ([AOlPen](../Libraries_Manual_guide/node0350.html#line9)).  All
    ...
    [Flood()](../Includes_and_Autodocs_2._guide/node043C.html) is set to a 0.
```
Color Mode
...
```c
    ...
    argument ot [Flood()](../Includes_and_Autodocs_2._guide/node043C.html) is set to a one.
```
...
```
This example saves the current [FgPen](../Libraries_Manual_guide/node0350.html#line3) value and draws the shape in the same
color as [AOlPen](../Libraries_Manual_guide/node0350.html#line9). Then FgPen is restored to its original color so that
FgPen, [BgPen](../Libraries_Manual_guide/node0350.html#line6), [DrawMode](../Libraries_Manual_guide/node0351.html), and [AreaPtrn](../Libraries_Manual_guide/node034A.html#line9) can be used to define the fill within
the outline.
