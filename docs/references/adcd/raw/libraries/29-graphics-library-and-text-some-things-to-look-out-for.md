...
One misleading thing about the [TA_DeviceDPI](../Libraries_Manual_guide/node03DB.html#line65) tag is that its name implies
...
stores in the font's [TextFontExtension](../Libraries_Manual_guide/node03DB.html#line44) are identical to the X and Y DPI
values passed in the [TA_DeviceDPI](../Libraries_Manual_guide/node03DB.html#line65) tag.  This means the system can
...
[TA_DeviceDPI](../Libraries_Manual_guide/node03DB.html#line65) tag.  It does this because the Amiga thinks of a font size as
...
[TTextAttr](../Libraries_Manual_guide/node03DB.html#line108).
...
will not put a [TA_DeviceDPI](../Libraries_Manual_guide/node03DB.html#line65) tag in the font's [TextFontExtension](../Libraries_Manual_guide/node03DB.html#line44): the font
...
aspect ratio of 2:1, [OpenDiskFont()](../Libraries_Manual_guide/node03D6.html#line5) first looks through the system list to
...
an aspect ratio, [OpenDiskFont()](../Libraries_Manual_guide/node03D6.html#line5) will not consider the aspect ratios of
...
return the font already in the system rather than creating a new one.
 ...
 [Font Aspect Ratio Example](../Libraries_Manual_guide/node05B9.html) }
