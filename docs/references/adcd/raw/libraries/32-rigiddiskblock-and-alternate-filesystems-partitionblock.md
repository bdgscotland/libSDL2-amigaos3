...
```c
                           ...
                           of this partition.  (see [rdb_HostID](../Libraries_Manual_guide/node0420.html#line8) discussion)
```
...
expansion.library function [MakeDosNode()](../Libraries_Manual_guide/node041A.html).
