...
```c
    ...
    its box and can be one of [GACT_STRINGLEFT](../Libraries_Manual_guide/node014B.html#line87), [GACT_STRINGRIGHT](../Libraries_Manual_guide/node014B.html#line83) or
    [GACT_STRINGCENTER](../Libraries_Manual_guide/node014B.html#line79).  The default is GACT_STRINGLEFT.  (Create only.)
```
...
```c
    ...
    program will receive an [IDCMP_GADGETUP](../Libraries_Manual_guide/node01DD.html#line6) message having a [Code](../Libraries_Manual_guide/node01D9.html#line33) value of
...
```c
    ...
    [IDCMP_GADGETUP](../Libraries_Manual_guide/node01DD.html#line6) message with the code field set to 0x09, the ASCII
...
```c
    ...
    for this string or integer gadget.  See the "[Intuition Gadgets](../Libraries_Manual_guide/node016E.html)"
    chapter for more information on string gadget edit-hooks.
```
As with all Intuition string gadgets, the program will receive an
[IDCMP_GADGETUP](../Libraries_Manual_guide/node01DD.html#line6) message only when the user presses Enter, Return, Help, Tab
...
a requester or opening a file, if the [IDCMP_GADGETUP](../Libraries_Manual_guide/node01DD.html#line6) message has a
non-zero [Code](../Libraries_Manual_guide/node01D9.html#line33) field; the program will want to handle the Tab and Help
cases intelligently.

To read the string gadget's buffer, look at the [Gadget](../Libraries_Manual_guide/node0149.html)'s [StringInfo](../Libraries_Manual_guide/node016B.html) [Buffer](../Libraries_Manual_guide/node016B.html#line19):


```c
    ((struct StringInfo *)gad->SpecialInfo)->Buffer
```
To determine the value of an integer gadget, look at the [Gadget](../Libraries_Manual_guide/node0149.html)'s
[StringInfo](../Libraries_Manual_guide/node016B.html) [LongInt](../Libraries_Manual_guide/node016B.html#line80) in the same way.

Always use the GTST_String or GTIN_Number tags to set these values.  Never
write to the [StringInfo->Buffer](../Libraries_Manual_guide/node016B.html#line19) or [StringInfo->LongInt](../Libraries_Manual_guide/node016B.html#line80) fields directly.
...
[IDCMP_GADGETDOWN](../Libraries_Manual_guide/node01DD.html) event when such a gadget is first selected).  However,
...
```c
    ...
    of [CreateGadgetA()](../Libraries_Manual_guide/node025A.html) and [GT_SetGadgetAttrsA()](../Libraries_Manual_guide/node025E.html).  Directly modifying
...
[CreateGadgetA()](../Libraries_Manual_guide/node025A.html).  Even though this tag is ignored for string and integer
...
[GACT_IMMEDIATE](../Libraries_Manual_guide/node014B.html#line9) flag in the gadget's [Activation](../Libraries_Manual_guide/node0149.html#line53) field:
