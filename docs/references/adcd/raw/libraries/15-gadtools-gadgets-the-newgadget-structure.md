...
gadgets are specified as tags sent to the [CreateGadget()](../Libraries_Manual_guide/node025A.html) function
(described below).

The NewGadget structure is defined in <libraries/[gadtools.h](../Includes_and_Autodocs_2._guide/node0106.html#line93)> as:
...
```c
    These user fields are copied into the resulting [Gadget](../Libraries_Manual_guide/node0149.html) structure.
```
ng_VisualInfo

```c
    This field must contain a pointer to an instance of the [VisualInfo](../Libraries_Manual_guide/node026C.html#line12)
