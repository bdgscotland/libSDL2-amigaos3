...
on "[Determining Chip Versions](../Libraries_Manual_guide/node031D.html)" explains how to find out which Agnus is
installed.
...
terms are RHeight, RWidth, [RyOffset,](../Includes_and_Autodocs_2._guide/node00B8.html#line106) [RxOffset,](../Includes_and_Autodocs_2._guide/node00B8.html#line106) [DHeight](../Libraries_Manual_guide/node0324.html), [DWidth](../Libraries_Manual_guide/node0325.html), [DyOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line40)
and [DxOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line40).


```c
     [Figure 27-16: ViewPort Data Area Parameters](../Libraries_Manual_guide/node05F1.html)
```
...
ViewPort.  The variables that control that placement are [RyOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line106) and
[RxOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line106).

To compute [RyOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line106) and [RxOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line106), you need RHeight, RWidth, [DHeight](../Libraries_Manual_guide/node0324.html), and
[DWidth](../Libraries_Manual_guide/node0325.html).  The DHeight and DWidth variables define the height and width in
...
Normal values for [RyOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line106) and [RxOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line106) are defined by the formulas:
...
[DyOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line40) and [DxOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line40).  These are offsets relative to the [View.DxOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line57)
and [DyOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line57). Possible NTSC values for DyOffset range from -23 to +217
...
data structures:
  ...
  * [View](../Includes_and_Autodocs_2._guide/node00B8.html#line57) (information about the whole display) includes the variables
    ...
    defined.
  * [ViewPort](../Includes_and_Autodocs_2._guide/node00B8.html#line40) (information about this segment of the display) includes the
...
```
  * [RasInfo](../Includes_and_Autodocs_2._guide/node00B8.html#line106) (information about the raster) contains the variables

```c
    [RxOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line106) and [RyOffset](../Includes_and_Autodocs_2._guide/node00B8.html#line106). It also contains pointers to the BitMap
    structure and to a companion RasInfo structure if this is a dual
    playfield.
```
  * [BitMap](../Includes_and_Autodocs_2._guide/node00A6.html#line47) (information about memory usage) tells the system where to
...
the display.  See "[Advanced Topics](../Libraries_Manual_guide/node0346.html)" below for an explanation of the steps
...
memory allocation for display rasters.  See the <graphics/[gfx.h](../Includes_and_Autodocs_2._guide/node00A6.html#line57)> include
