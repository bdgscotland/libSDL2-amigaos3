...
identical to [OM_SET](../Libraries_Manual_guide/node04C3.html).  Because the methods are so similar, When a typical
...
message about changes to its [PGA_Top](../Libraries_Manual_guide/node050F.html) value (the integer value of the prop
