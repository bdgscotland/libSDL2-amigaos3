...
The system software for defining [ViewPort](../Libraries_Manual_guide/node032B.html#line59)s allows only vertically stacked
...
```
A [ViewPort](../Libraries_Manual_guide/node032B.html#line59) is related to the custom screen option of Intuition. In a
