...
the Amiga is a [multitasking](../Libraries_Manual_guide/node0015.html) computer, many programs can reside in memory
...
On a [multitasking](../Libraries_Manual_guide/node0015.html) computer like the Amiga, the user interface design must
