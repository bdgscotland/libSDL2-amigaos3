...
custom classes, use the intuition.library function [NewObject()](../Libraries_Manual_guide/node0203.html#line25):
...
<intuition/[classusr.h](../Includes_and_Autodocs_2._guide/node00E2.html#line76)>):
...
object pointer (newobject from the [dispatchRKMModel()](../Libraries_Manual_guide/node0211.html) prototype above)
...
using the amiga.lib function [DoSuperMethodA()](../Libraries_Manual_guide/node0212.html#line27):
...
requires.  The [rootclass](../Libraries_Manual_guide/node04BB.html) dispatcher's OM_NEW method looks at the object's
...
When the [rootclass](../Libraries_Manual_guide/node04BB.html) dispatcher returns, the subclass dispatcher regains
control from [DoSuperMethodA()](../Libraries_Manual_guide/node0212.html#line27).  DoSuperMethodA() will return either a
...
INST_DATA() macro (defined in <intuition/[classes.h](../Includes_and_Autodocs_2._guide/node00DA.html#line46)>).
...
in the [OM_DISPOSE](../Libraries_Manual_guide/node04BD.html) method.
