...
[OpenDiskFont()](../Libraries_Manual_guide/node03D6.html#line5) to open a font can have scalable fonts available to it.
...
[OpenDiskFont()](../Libraries_Manual_guide/node03D6.html#line5).  A font glyph is the graphical representations associated
...
to the [TextFont](../Libraries_Manual_guide/node03DE.html) structure called (oddly enough) [TextFontExtension](../Includes_and_Autodocs_2._guide/node00A8.html#line120).  Under
Release 2, when the system opens a new font (and there is sufficient
memory), it creates this extension.

A font's [TextFont](../Libraries_Manual_guide/node03DE.html) structure contains a pointer to its associated
[TextFontExtension](../Includes_and_Autodocs_2._guide/node00A8.html#line120).  While the font is opened, the TextFont's
tf_Message.mn_ReplyPort field points to a font's TextFontExtension.  The
<graphics/[text.h](../Includes_and_Autodocs_2._guide/node00A8.html#line113)> include file #defines tf_Message.mn_ReplyPort as
tf_Extension.

The [TextFontExtension](../Includes_and_Autodocs_2._guide/node00A8.html#line120) structure contains only one field of interest: a
...
font has a corresponding [TextFontExtension](../Includes_and_Autodocs_2._guide/node00A8.html#line120).  The [ExtendFont()](../Includes_and_Autodocs_2._guide/node043A.html) function
...
[FontContentsHeader](../Libraries_Manual_guide/node03E0.html#line7) structure in the "[Composition of a Bitmap Font on Disk](../Libraries_Manual_guide/node03E0.html#line7)"
...
When an application opens a font with [OpenDiskFont()](../Libraries_Manual_guide/node03D6.html#line5), it can supply the
...
pass OpenDiskFont() an extended version of the [TextAttr](../Libraries_Manual_guide/node03D6.html#line21) structure called
the [TTextAttr](../Includes_and_Autodocs_2._guide/node00A8.html#line73):
...
```
The [TextAttr](../Libraries_Manual_guide/node03D6.html#line21) and the TTextAttr are identical except that the tta_Tags
field points to a tag list where you place your TA_DeviceDPI tag.  To tell
[OpenDiskFont()](../Libraries_Manual_guide/node03D6.html#line5) that it has a TTextAttr structure rather than a TextAttr
