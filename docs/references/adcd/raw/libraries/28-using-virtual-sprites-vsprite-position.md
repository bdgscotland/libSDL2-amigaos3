...
To control the position of a VSprite, the x and y variables in the [VSprite](../Libraries_Manual_guide/node0381.html)
...
See the "[Graphics Primitives](../Libraries_Manual_guide/node032B.html)" chapter for more information on display
coordinates and display size.  See the Amiga [Hardware](../Hardware_Manual_guide/node00AE.html) Reference Manual for
