...
GEL types use the [VSprite](../Libraries_Manual_guide/node0381.html) structure as their root data structure.  The
system uses pointers to link the VSprite, [Bob](../Libraries_Manual_guide/node0398.html) and [AnimComp](../Libraries_Manual_guide/node03B9.html#line3) structures,
...
change the underlying playfield [BitMap](../Libraries_Manual_guide/node00F1.html#line4).  The BitMap area where the GEL is
