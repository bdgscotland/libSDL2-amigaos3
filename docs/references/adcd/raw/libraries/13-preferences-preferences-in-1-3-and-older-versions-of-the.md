...
```c
    ...
    double-click timeout, see the description of the [DoubleClick()](../Libraries_Manual_guide/node01EA.html)
    function in the Amiga ROM Kernel Reference Manual:
    [Includes and Autodocs](../Includes_and_Autodocs_2._guide/node020E.html).
```
...
```c
    ...
    mode).  The first variable in the [Preferences](../Libraries_Manual_guide/node0224.html) structure is
...
```
  ...
  * Print characteristics - the user can select paper size, right and
    ...
    dump, etc.
 [Reading 1.3 Preferences](../Libraries_Manual_guide/node0223.html)         [Setting 1.3 Preferences](../Libraries_Manual_guide/node0225.html) 
 [Preferences Structure in 1.3](../Libraries_Manual_guide/node0224.html)    [Alternatives to SetPrefs](../Libraries_Manual_guide/node0226.html) 
