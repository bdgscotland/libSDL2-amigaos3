...
```c
    ...
    The [Code](../Libraries_Manual_guide/node01D9.html#line93) field contains information on the specific mouse button
    ...
    [WA_RMBTrap](../Libraries_Manual_guide/node0125.html#line95) attribute for its window.  See the "[Intuition  Windows](../Libraries_Manual_guide/node0125.html#line95)"
...
```c
    ...
    events are sent whenever a gadget with [GACT_FOLLOWMOUSE](../Libraries_Manual_guide/node014B.html#line40) gadget is
    active, or for any window that has the [WA_ReportMouse](../Libraries_Manual_guide/node0125.html#line33) attribute set.
    This window attribute can be set or cleared by the application at
    will.  See the "[Intuition Windows](../Libraries_Manual_guide/node0125.html#line33)" chapter for full details.
    ...
    consider using [IDCMP_INTUITICKS](../Libraries_Manual_guide/node01E1.html#line80).  While IDCMP_MOUSEMOVE events are
    generated by changes in the mouse's position, IDCMP_INTUITICKS
    [IntuiMessage](../Libraries_Manual_guide/node01D9.html)s are based on a timer.  Since they contain mouse
