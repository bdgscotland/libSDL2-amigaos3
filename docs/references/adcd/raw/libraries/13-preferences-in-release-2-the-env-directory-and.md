...
saved in [Screenmode.prefs](../Libraries_Manual_guide/node0228.html#line11) in the ENV:sys directory.  IPrefs sets up
...
```c
     [prefnotify.c](../Libraries_Manual_guide/node0589.html) 
```
