...
hook function whenever it receives an [IntuiMessage](../Libraries_Manual_guide/node01D9.html) that it cannot use at
the IDCMP port that it shares with your window.  (See the section on
"[ASL Requesters and Custom Screens](../Libraries_Manual_guide/node027E.html)" earlier in this chapter for more
...
will take care of replying to the message.
 ...
 [Parameters Passed to Custom Hook Functions](../Libraries_Manual_guide/node0284.html) 
 [Example ASL Requester with Custom Hook Function](../Libraries_Manual_guide/node057C.html) 
