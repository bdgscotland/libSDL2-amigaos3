...
events will be blocked (unless the requester's [NOISYREQ](../Libraries_Manual_guide/node01AB.html#line127) flag is set; see
"[Requester Structure](../Libraries_Manual_guide/node01AB.html)" below).  Mouse movement events, if enabled in the
parent window (with [WFLG_REPORTMOUSE](../Libraries_Manual_guide/node0125.html#line44)), are not blocked.
...
([Window.UserPort](../Libraries_Manual_guide/node01D6.html#line16)).  Since the window's menus and application gadgets are
...
given window.  See "[IDCMP Requester Features](../Libraries_Manual_guide/node01AA.html)" below.
...
[GimmeZeroZero](../Libraries_Manual_guide/node0116.html) windows use a second layer for the border rendering.  This
...
flash the screen instead with Intuition's [DisplayBeep()](../Libraries_Manual_guide/node00FC.html) function.  This
...
the "[Intuition Screens](../Libraries_Manual_guide/node00FC.html)" chapter.
