...
The [WA_RptQueue](../Libraries_Manual_guide/node0124.html#line159) tag allows setting an initial value for the repeat key
backlog limit for the window.  There is no function to change this value
as of V37.  The default value for WA_RptQueue is 3.

The [WA_MouseQueue](../Libraries_Manual_guide/node0124.html#line154) tag allows setting an initial value for the mouse
message backlog limit for the window.  The default value for WA_MouseQueue
is 5.  The number may later be changed with a call to [SetMouseQueue()](../Includes_and_Autodocs_2._guide/node0254.html):
...
"[Intuition Mouse and Keyboard](../Libraries_Manual_guide/node01E9.html)" for more information.
