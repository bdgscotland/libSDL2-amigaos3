...
a little later.  Every loaded font, including color fonts, has a [TextFont](../Includes_and_Autodocs_2._guide/node00A8.html#line89)
...
```
The first field in this structure is a [Message](../Libraries_Manual_guide/node02EF.html) structure.  The node in
...
name.  The other fields in the [TextFont](../Includes_and_Autodocs_2._guide/node00A8.html#line89) structure are as follows:
...
```c
    ...
    <graphics/[text.h](../Includes_and_Autodocs_2._guide/node00A8.html#line26)>.  These include the same style bits that were
    mentioned in the discussion of the [TextAttr](../Libraries_Manual_guide/node03D6.html#line21) structure in the
    "[Choosing the Font](../Libraries_Manual_guide/node03D6.html#line32)" section of this chapter.  In addition to those
    bits, there is also the FSF_COLORFONT bit, which identifies this as a
    special kind of TextFont structure called a [ColorTextFont](../Libraries_Manual_guide/node03DF.html) structure.
...
```c
    ...
    bits in the section, "[Choosing the Font](../Libraries_Manual_guide/node03D6.html#line32)".
```
tf_XSize
...
```c
    ...
    ([suits8](../Libraries_Manual_guide/node05BA.html) is the complete, disk-based bitmap font example used later
    in this chapter):
...
```c
    ...
    current horizontal position (usually [RastPort.cp_X](../Libraries_Manual_guide/node0353.html)).  For reverse
...
to the TextFont structure called the [TextFontExtension](../Includes_and_Autodocs_2._guide/node00A8.html#line120).  This extension is
important because it contains a pointer to the font's tag list, which is
where the system keeps the font's [TA_DeviceDPI](../Libraries_Manual_guide/node03DB.html#line65) values.  The TextFont's
tf_Message.mn_ReplyPort field contains a pointer to the TextFontExtension
structure (the <graphics/[text.h](../Includes_and_Autodocs_2._guide/node00A8.html#line113)> include file #defines
...
[TextFontExtension](../Includes_and_Autodocs_2._guide/node00A8.html#line120).  The [ExtendFont()](../Includes_and_Autodocs_2._guide/node043A.html) function will return a value of TRUE
