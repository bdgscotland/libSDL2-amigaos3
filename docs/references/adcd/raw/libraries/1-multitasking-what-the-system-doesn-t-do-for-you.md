...
[multitasking](../Libraries_Manual_guide/node0287.html), but this does not mean that applications don't have to worry
...
memory pointer can cause the machine to [crash](../Libraries_Manual_guide/node053B.html) (debugging utilities such as
...
are responsible for this, the system will not do it for you automatically.
 ...
 | ----------------------------------------                             |
 | The Amiga is a [multitasking](../Libraries_Manual_guide/node0287.html) computer.  Keep in mind that other       |
