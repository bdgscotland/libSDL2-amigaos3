...
```c
     [Figure 27-1: How the Video Display Picture Is Produced](../Libraries_Manual_guide/node05EE.html) 
```
The diagonal lines in the figure show how the video beam returns to the
start of each horizontal line.

 [Effect of Display Overscan on the Viewing Area](../Libraries_Manual_guide/node0314.html) 
 [Color Information for the Video Lines](../Libraries_Manual_guide/node0315.html) 
