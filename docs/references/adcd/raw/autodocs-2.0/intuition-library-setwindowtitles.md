...
```c
    SetWindowTitles( [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797), WindowTitle, ScreenTitle )
                     A0      A1           A2

    VOID SetWindowTitles( struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) *, UBYTE *, UBYTE * );
```
FUNCTION

```c
    Allows you to set the text which appears in the [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) and/or [Screen](../Includes_and_Autodocs_2._guide/node00DD.html#line97)
    title bars.
    ...
    screen, as set using [OpenScreen()](../Includes_and_Autodocs_2._guide/node0237.html).
    ...
    in the newer versions.  The function [RefreshWindowFrame()](../Includes_and_Autodocs_2._guide/node0242.html) is provided
    to do this kind of thing for you.
```
INPUTS

```c
    [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) = pointer to your window structure
...
```c
    [OpenWindow()](../Includes_and_Autodocs_2._guide/node0239.html), [RefreshWindowFrame()](../Includes_and_Autodocs_2._guide/node0242.html), [OpenScreen()](../Includes_and_Autodocs_2._guide/node0237.html)
```
