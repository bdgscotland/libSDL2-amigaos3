...
```c
    ...
    gadget is created based on the supplied kind, [NewGadget](../Includes_and_Autodocs_2._guide/node0106.html#line93) structure,
    and tags.
```
INPUTS
...
```c
    ...
    newgad - a filled in [NewGadget](../Includes_and_Autodocs_2._guide/node0106.html#line93) structure describing the desired
...
```c
    ...
    [NewGadget](../Includes_and_Autodocs_2._guide/node0106.html#line93) structure must be set to valid VisualInfo and
    [TextAttr](../Includes_and_Autodocs_2._guide/node00A8.html#line66) pointers, or this function will fail.
...
```c
    [FreeGadgets()](../Includes_and_Autodocs_2._guide/node03EB.html), GT_SetGadgetAttrs(), GetVisualInfo().
```
