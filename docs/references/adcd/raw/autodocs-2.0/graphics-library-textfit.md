...
```c
    ...
    -   the [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) rp's rp_TxSpacing sign and magnitude is so
...
```c
    [TextExtent()](../Includes_and_Autodocs_2._guide/node0483.html)  [TextLength()](../Includes_and_Autodocs_2._guide/node0485.html)  [Text()](../Includes_and_Autodocs_2._guide/node0482.html)
