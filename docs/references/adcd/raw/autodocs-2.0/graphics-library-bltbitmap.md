...
```c
    BltBitMap -- Move a rectangular region of bits in a [BitMap](../Includes_and_Autodocs_2._guide/node00A6.html#line47).
```
SYNOPSIS
...
```c
    ...
    area in a [BitMap](../Includes_and_Autodocs_2._guide/node00A6.html#line47) to another area, which can be on a different
    [BitMap](../Includes_and_Autodocs_2._guide/node00A6.html#line47).
    This blit is assumed to be friendly: no error conditions (e.g.
    a rectangle outside the [BitMap](../Includes_and_Autodocs_2._guide/node00A6.html#line47) bounds) are tested or reported.
```
INPUTS
...
```c
    [ClipBlit()](../Includes_and_Autodocs_2._guide/node042D.html)  [graphics/gfx.h](../Includes_and_Autodocs_2._guide/node00A6.html)  [hardware/blit.h](../Includes_and_Autodocs_2._guide/node00CC.html)
```
