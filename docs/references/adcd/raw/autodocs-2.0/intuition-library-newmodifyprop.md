...
```c
    NewModifyProp -- [ModifyProp()](../Includes_and_Autodocs_2._guide/node022A.html), but with selective refresh.
```
SYNOPSIS

```c
    NewModifyProp( [Gadget](../Includes_and_Autodocs_2._guide/node00D4.html#line215), [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797), [Requester](../Includes_and_Autodocs_2._guide/node00D4.html#line145), Flags,
                   A0      A1      A2         D0
            HorizPot, VertPot, HorizBody, VertBody, NumGad )
            D1        D2       D3         D4        D5

    VOID NewModifyProp( struct [Gadget](../Includes_and_Autodocs_2._guide/node00D4.html#line215) *, struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) *,
            struct [Requester](../Includes_and_Autodocs_2._guide/node00D4.html#line145) *, UWORD, UWORD, UWORD, UWORD, UWORD, WORD );
```
FUNCTION

```c
    Performs the function of [ModifyProp()](../Includes_and_Autodocs_2._guide/node022A.html), but refreshes
    gadgets in the list as specified by the NumGad parameter.
    With NumGad = -1, this function is identical to [ModifyProp()](../Includes_and_Autodocs_2._guide/node022A.html).
...
```c
    [ModifyProp()](../Includes_and_Autodocs_2._guide/node022A.html)
