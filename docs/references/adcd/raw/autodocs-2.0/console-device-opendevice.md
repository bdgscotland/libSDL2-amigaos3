...
```c
    error = OpenDevice("console.device", unit, [IOStdReq](../Includes_and_Autodocs_2._guide/node0094.html#line28), flags )
    d0                  a0               d0    a1        d1
```
FUNCTION
...
IO REQUEST
```c
    io_Data         struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) *window
...
```c
    ...
    [IOStdReq](../Includes_and_Autodocs_2._guide/node0094.html#line28) - a pointer to a standard request block
...
```c
    ...
    reasonable (e.g., no more than 1K characters per [CMD_WRITE](../Includes_and_Autodocs_2._guide/node0508.html), and
...
```c
    [exec/io.h](../Includes_and_Autodocs_2._guide/node0094.html), [intuition/intuition.h](../Includes_and_Autodocs_2._guide/node00D4.html)
```
