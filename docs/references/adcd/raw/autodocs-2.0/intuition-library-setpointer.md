...
```c
    SetPointer( [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797), Pointer, Height, Width, XOffset, YOffset )
                A0      A1       D0      D1     D2       D3

    VOID SetPointer( struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) *, UWORD *, WORD, WORD, WORD, WORD );
```
FUNCTION
...
```c
    [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) = pointer to the window to receive this pointer definition
...
```c
    [ClearPointer()](../Includes_and_Autodocs_2._guide/node0206.html), Intuition Reference Manual or Amiga Rom
    Kernel Manual
```
