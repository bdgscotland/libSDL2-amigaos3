...
```c
    ...
    VOID StackSwap(struct [StackSwapStruct](../Includes_and_Autodocs_2._guide/node008E.html#line53) *);
```
FUNCTION
...
```c
    ...
    The [StackSwapStruct](../Includes_and_Autodocs_2._guide/node008E.html#line53) structure will then contain the values
...
```c
    [AddTask](../Includes_and_Autodocs_2._guide/node032D.html), [RemTask](../Includes_and_Autodocs_2._guide/node0378.html), [exec/tasks.h](../Includes_and_Autodocs_2._guide/node008E.html)
```
