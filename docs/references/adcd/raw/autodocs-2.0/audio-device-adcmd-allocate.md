...
```c
    ...
    to allocate again whenever [ADCMD_FREE](../Includes_and_Autodocs_2._guide/node04A8.html) frees channels or [ADCMD_SETPREC](../Includes_and_Autodocs_2._guide/node04AB.html)
...
```c
    ...
    io_Device   - pointer to device node, must be set by (or copied from
                  I/O block set by) [OpenDevice](../Includes_and_Autodocs_2._guide/node04B8.html) function
    ...
    ioa_AllocKey- allocation key, zero to generate new key; otherwise,
                  ...
                  [OpenDevice](../Includes_and_Autodocs_2._guide/node04B8.html) function or previous ADCMD_ALLOCATE command
