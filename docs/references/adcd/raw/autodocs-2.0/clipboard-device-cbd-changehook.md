...
```c
    ...
    io_Data -       struct [Hook](../Includes_and_Autodocs_2._guide/node012D.html#line23) *, the clip change hook
```
HOOK ENVIRONMENT
   hook message - a [ClipHookMsg](../Includes_and_Autodocs_2._guide/node0048.html#line64), as defined in [devices/clipboard.h](../Includes_and_Autodocs_2._guide/node0048.html)
