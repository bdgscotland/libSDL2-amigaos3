...
```c
    ...
    [CMD_READ](../Includes_and_Autodocs_2._guide/node0520.html) and ETD_READ commands, anyone using TD_RAWREAD is
...
```c
    [TD_RAWWRITE](../Includes_and_Autodocs_2._guide/node052E.html)
```
