...
```c
    A time request is a non standard IO Request.  It has an [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19)
    followed by a [timeval](../Includes_and_Autodocs_2._guide/node0053.html#line26) structure or an eclockval structure.
```
TIMEVAL

```c
    A [timeval](../Includes_and_Autodocs_2._guide/node0053.html#line26) structure consists of two longwords.  The first is
...
```c
    ...
    [ReadEClock()](../Includes_and_Autodocs_2._guide/node04FB.html) library like call.
```
UNITS
...
```c
    ...
    uses a [timeval](../Includes_and_Autodocs_2._guide/node0053.html#line26) in its [timerequest](../Includes_and_Autodocs_2._guide/node0053.html#line36).
```
UNIT_VBLANK
...
```c
    ...
    (typically 1/2 second or more).  This unit uses a [timeval](../Includes_and_Autodocs_2._guide/node0053.html#line26) in its
    [timerequest](../Includes_and_Autodocs_2._guide/node0053.html#line36).
```
UNIT_ECLOCK

```c
    This unit is exacly the same as UNIT_MICROHZ except that it uses
    an eclockval instead of a [timeval](../Includes_and_Autodocs_2._guide/node0053.html#line26) in its [timerequest](../Includes_and_Autodocs_2._guide/node0053.html#line36).
```
UNIT_WAITUNTIL

```c
    This unit waits until the systime is greater than or equal to the
    time in the [timeval](../Includes_and_Autodocs_2._guide/node0053.html#line26) in the [timerequest](../Includes_and_Autodocs_2._guide/node0053.html#line36).  This unit has the same
    resolution and accuracy as that of UNIT_VBLANK.
```
UNIT_WAITECLOCK

```c
    This unit waits until the E-Clock value as returned by [ReadEClock()](../Includes_and_Autodocs_2._guide/node04FB.html)
    is greater than or equal to the eclockval in the [timerequest](../Includes_and_Autodocs_2._guide/node0053.html#line36). This
