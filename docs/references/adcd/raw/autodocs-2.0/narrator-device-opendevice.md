...
```c
    error = OpenDevice("narrator.device",  unit, [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19), flags);
     D0                       A0            D0     A1         D1
```
FUNCTION
...
```c
    ...
    unit       - 0
    [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19)  - Pointer to the user's [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19) block
    flags      - 0
```
RESULTS
...
```c
    The include files contain the complete [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19) block definition,
