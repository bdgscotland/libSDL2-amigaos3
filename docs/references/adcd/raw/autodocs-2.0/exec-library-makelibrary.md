...
```c
    ...
    struct [Library](../Includes_and_Autodocs_2._guide/node009C.html#line34) *MakeLibrary
                          (APTR,struct [InitStruct](../Includes_and_Autodocs_2._guide/node035E.html) *,APTR,ULONG,BPTR);
```
FUNCTION
...
```c
    [InitStruct](../Includes_and_Autodocs_2._guide/node035E.html), [InitResident](../Includes_and_Autodocs_2._guide/node035C.html), exec/initializers.i
```
