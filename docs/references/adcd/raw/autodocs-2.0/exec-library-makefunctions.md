...
```c
    A low level function used by [MakeLibrary](../Includes_and_Autodocs_2._guide/node0361.html) to build jump tables of
...
```c
    [exec/MakeLibrary](../Includes_and_Autodocs_2._guide/node0361.html)
```
