...
```c
    InitIFF -- Initialize an [IFFHandle](../Includes_and_Autodocs_2._guide/node010B.html#line34) struct as a user stream.
```
SYNOPSIS
...
```c
    ...
    LONG             flags;
    struct [Hook](../Includes_and_Autodocs_2._guide/node012D.html#line23)     *streamhook;
```
FUNCTION
...
```c
    iff     - pointer to [IFFHandle](../Includes_and_Autodocs_2._guide/node010B.html#line34) structure to initialize.
    flags   - stream I/O flags for the [IFFHandle](../Includes_and_Autodocs_2._guide/node010B.html#line34).
