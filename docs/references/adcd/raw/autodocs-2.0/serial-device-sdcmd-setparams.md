...
```c
    ...
    io_ExtFlags     additional serial flags (bitdefs in [devices/serial.h)](../Includes_and_Autodocs_2._guide/node004B.html)
    ...
    io_SerFlags     see [devices/serial.h](../Includes_and_Autodocs_2._guide/node004B.html) for bit equates, NOTE that x00
...
```c
    [exec/OpenDevice](../Includes_and_Autodocs_2._guide/node04D4.html)
```
