...
```c
    ...
    struct [MsgPort](../Includes_and_Autodocs_2._guide/node0099.html#line29) *CreateProc(STRPTR, LONG, BPTR, LONG)
```
FUNCTION
...
```c
    [CreateNewProc()](../Includes_and_Autodocs_2._guide/node028D.html), [LoadSeg()](../Includes_and_Autodocs_2._guide/node02C5.html), [UnLoadSeg()](../Includes_and_Autodocs_2._guide/node0306.html)
```
