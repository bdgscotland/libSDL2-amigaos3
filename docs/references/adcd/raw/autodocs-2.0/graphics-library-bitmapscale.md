...
```c
    ...
    void BitMapScale(struct [BitScaleArgs](../Includes_and_Autodocs_2._guide/node00BF.html#line18) *);
```
FUNCTION
...
```c
    ...
    o   No check is made to ensure destBitMap is big enough: use
        [ScalerDiv](../Includes_and_Autodocs_2._guide/node0472.html) to calculate a destination dimension.
```
BUGS
...
```c
    [ScalerDiv()](../Includes_and_Autodocs_2._guide/node0472.html)  [graphics/scale.h](../Includes_and_Autodocs_2._guide/node00BF.html)
```
