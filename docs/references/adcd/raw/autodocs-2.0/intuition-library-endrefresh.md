...
```c
    EndRefresh( [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797), Complete )
                A0      D0

    VOID EndRefresh( struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) *, BOOL );
```
FUNCTION

```c
    This function gets you out of the special refresh state of your
    window.  It is called following a call to [BeginRefresh()](../Includes_and_Autodocs_2._guide/node0200.html), which
    ...
    [BeginRefresh()](../Includes_and_Autodocs_2._guide/node0200.html).

    For your information, this routine calls the Layers library function
    [EndUpdate()](../Includes_and_Autodocs_2._guide/node0396.html), unlocks your layers (calls [UnlockLayerRom()](../Includes_and_Autodocs_2._guide/node0486.html)), clears
    the LAYERREFRESH bit in your [Layer](../Includes_and_Autodocs_2._guide/node00A1.html#line33) Flags, and clears the
    WFLG_WINDOWREFRESH bit in your window Flags.
```
INPUTS

```c
    [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) = pointer to the window currently in optimized-refresh mode
...
```c
    [BeginRefresh()](../Includes_and_Autodocs_2._guide/node0200.html), [layers.library/EndUpdate()](../Includes_and_Autodocs_2._guide/node0396.html),
    [graphics.library/UnlockLayerRom()](../Includes_and_Autodocs_2._guide/node0486.html)
```
