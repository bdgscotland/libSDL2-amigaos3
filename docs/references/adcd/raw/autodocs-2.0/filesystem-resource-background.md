...
```c
    ...
    [resources/filesysres.h](../Includes_and_Autodocs_2._guide/node011D.html).  The nodes on it describe how to
    algorithmically convert the result of [MakeDosNode](../Includes_and_Autodocs_2._guide/node03B8.html) (from the
    expansion.library) to a node appropriate for the dos type.

    [FileSysEntry](../Includes_and_Autodocs_2._guide/node011D.html#line32)
        ...
        fse_Startup         startup msg: [FileSysStartupMsg](../Includes_and_Autodocs_2._guide/node0066.html#line85) for disks
