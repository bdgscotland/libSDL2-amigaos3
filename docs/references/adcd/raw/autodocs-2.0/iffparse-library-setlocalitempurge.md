...
```c
    ...
    struct [Hook](../Includes_and_Autodocs_2._guide/node012D.html#line23)            *purgehook;
```
FUNCTION
...
```c
    ...
    purgehook - pointer to a [Hook](../Includes_and_Autodocs_2._guide/node012D.html#line23) structure.
```
RESULT
...
```c
    [AllocLocalItem()](../Includes_and_Autodocs_2._guide/node01B9.html), [FreeLocalItem()](../Includes_and_Autodocs_2._guide/node01C6.html), [utility/hooks.h](../Includes_and_Autodocs_2._guide/node012D.html)
```
