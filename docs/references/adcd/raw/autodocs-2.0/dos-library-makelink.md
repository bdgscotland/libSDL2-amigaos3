...
```c
    [ReadLink()](../Includes_and_Autodocs_2._guide/node02E3.html), [Open()](../Includes_and_Autodocs_2._guide/node02D6.html), [Lock()](../Includes_and_Autodocs_2._guide/node02C6.html)
```
