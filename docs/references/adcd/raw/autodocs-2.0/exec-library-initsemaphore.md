...
```c
    ...
    void InitSemaphore(struct [SignalSemaphore](../Includes_and_Autodocs_2._guide/node0082.html#line40) *);
```
FUNCTION
...
```c
    [ObtainSemaphore()](../Includes_and_Autodocs_2._guide/node0362.html), [ObtainSemaphoreShared()](../Includes_and_Autodocs_2._guide/node0364.html), [AttemptSemaphore()](../Includes_and_Autodocs_2._guide/node0336.html),
    [ReleaseSemaphore()](../Includes_and_Autodocs_2._guide/node036D.html), [exec/semaphores.h](../Includes_and_Autodocs_2._guide/node0082.html)
```
