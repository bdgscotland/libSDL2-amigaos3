...
```c
    ScalerDiv -- Get the scaling result that [BitMapScale](../Includes_and_Autodocs_2._guide/node041E.html) would. (V36)
```
SYNOPSIS
...
```c
    ...
    result of [BitMapScale](../Includes_and_Autodocs_2._guide/node041E.html) when the factor here is the width of
    the source, and the numerator and denominator are the
    XDestFactor and XSrcFactor for [BitMapScale](../Includes_and_Autodocs_2._guide/node041E.html).
```
INPUTS
