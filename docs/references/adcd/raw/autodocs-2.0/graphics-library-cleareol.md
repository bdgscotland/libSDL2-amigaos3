...
```c
    ...
    void ClearEOL(struct [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) *);
```
FUNCTION
...
```c
    [Text()](../Includes_and_Autodocs_2._guide/node0482.html)  [ClearScreen()](../Includes_and_Autodocs_2._guide/node042C.html)  [SetRast()](../Includes_and_Autodocs_2._guide/node047B.html)
