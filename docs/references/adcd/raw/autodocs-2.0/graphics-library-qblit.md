...
```c
    ...
    void QBlit( struct [bltnode](../Includes_and_Autodocs_2._guide/node00CC.html#line89) * );
```
FUNCTION
...
```c
    ...
    put in front of those who use the blitter via [OwnBlitter](../Includes_and_Autodocs_2._guide/node0466.html) and
    [DisownBlitter](../Includes_and_Autodocs_2._guide/node0433.html). However for small blits there is more overhead
...
```c
    [QBSBlit()](../Includes_and_Autodocs_2._guide/node0469.html) [hardware/blit.h](../Includes_and_Autodocs_2._guide/node00CC.html)
```
