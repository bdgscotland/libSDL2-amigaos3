...
```c
    ...
    void QBSBlit( struct [bltnode](../Includes_and_Autodocs_2._guide/node00CC.html#line89) * );
```
FUNCTION

```c
    Call a user routine for use of the blitter, enqueued separately from
    the [QBlit](../Includes_and_Autodocs_2._guide/node0468.html) queue.  Calls the user routine contained in the blit
...
```c
    [QBlit()](../Includes_and_Autodocs_2._guide/node0468.html) [hardware/blit.h](../Includes_and_Autodocs_2._guide/node00CC.html)
```
