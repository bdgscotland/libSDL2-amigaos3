...
```c
    [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) = OpenWindow( [NewWindow](../Includes_and_Autodocs_2._guide/node00D4.html#line976) )
    D0                   A0

    struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) *OpenWindow( struct [NewWindow](../Includes_and_Autodocs_2._guide/node00D4.html#line976) * );
```
FUNCTION
...
INPUTS
```c
    [NewWindow](../Includes_and_Autodocs_2._guide/node00D4.html#line976) = pointer to an instance of a [NewWindow](../Includes_and_Autodocs_2._guide/node00D4.html#line976) structure.  That
...
```
   CheckMark = a pointer to an instance of the struct [Image](../Includes_and_Autodocs_2._guide/node00D4.html#line621) where can
...
```
   [Screen](../Includes_and_Autodocs_2._guide/node00DD.html#line97) = if your type is one of Intuition's standard screens, then

```c
          this argument is ignored.  However, if Type == CUSTOMSCREEN,
          this must point to the structure of your own screen
```
   [BitMap](../Includes_and_Autodocs_2._guide/node00A6.html#line47) = if you have specified WFLG_SUPER_BITMAP as the type of
...
```c
          ...
          [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) is opened by calling the [WindowLimits()](../Includes_and_Autodocs_2._guide/node0263.html) routine.
          ...
          themselves to call [SizeWindow()](../Includes_and_Autodocs_2._guide/node025A.html) (or [ChangeWindowBox()](../Includes_and_Autodocs_2._guide/node0203.html)) without
          ...
          See also the docs on the function [WindowLimits()](../Includes_and_Autodocs_2._guide/node0263.html) for more
          information.
```
...
```c
        ...
        TagItems in general are described in [utility/tagitem.h](../Includes_and_Autodocs_2._guide/node012E.html),
        and the OpenWindow tags are defined in [intuition/intuition.h](../Includes_and_Autodocs_2._guide/node00D4.html)
    ...
    (and [OpenWindowTagList()](../Includes_and_Autodocs_2._guide/node023A.html)).

    Certain tags simply override equivalent values in [NewWindow](../Includes_and_Autodocs_2._guide/node00D4.html#line976),
    and allow you to open a window using [OpenWindowTagList()](../Includes_and_Autodocs_2._guide/node023A.html) without
    having a [NewWindow](../Includes_and_Autodocs_2._guide/node00D4.html#line976) structure at all.  In each case, cast
    ...
    WA_ScreenTitle - You can specify the screen title associated
        with your window this way, and avoid a call to [SetWindowTitles()](../Includes_and_Autodocs_2._guide/node0258.html)
    ...
    WA_AutoAdjust - a Boolean attribute which says that it's OK
        ...
        if you call OpenWindowTags() or [OpenWindowTagList()](../Includes_and_Autodocs_2._guide/node023A.html)
        with a NULL [NewWindow](../Includes_and_Autodocs_2._guide/node00D4.html#line976) pointer, this attribute defaults
        to TRUE).
    ...
    WA_PubScreen - Open as a visitor window on the public screen
        whose address if provided as (struct [Screen](../Includes_and_Autodocs_2._guide/node00DD.html#line97) *) ti_Data.
        ...
        must either:
            ...
            3) use [LockPubScreen()](../Includes_and_Autodocs_2._guide/node0225.html)
        Using [exec.library/Forbid()](../Includes_and_Autodocs_2._guide/node0353.html) is not sufficient.
    ...
    WA_MouseQueue - This tag specifies a limit for the number
        ...
        limit after the window is open using [SetMouseQueue()](../Includes_and_Autodocs_2._guide/node0254.html).
    ...
    WA_BackFill - ti_Data is a pointer to a [Hook](../Includes_and_Autodocs_2._guide/node012D.html#line23) structure that
        the Layers library will call when your window needs
        "backfilling."  See [layers.library/InstallLayerHook()](../Includes_and_Autodocs_2._guide/node039A.html).
...
```c
    ...
    In each case, you must be sure not to specify a [NewWindow](../Includes_and_Autodocs_2._guide/node00D4.html#line976)
    ...
    you want a visitor window to be opened on:
        ...
        - Use [LockPubScreen()](../Includes_and_Autodocs_2._guide/node0225.html) to prevent the screen from closing.
        ...
        [LockPubScreen()](../Includes_and_Autodocs_2._guide/node0225.html) - obtain a pointer and a promise
        layout window       - adapt your window to the screen you will use
        OpenWindow()        - using the pointer you specify
        [UnlockPubScreen()](../Includes_and_Autodocs_2._guide/node025D.html)     - once your window is open, you can let go
    ...
    You should call [UnlockPubScreen()](../Includes_and_Autodocs_2._guide/node025D.html) after your visitor window is open.
...
```c
    If all is well, returns the pointer to your new [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797)
...
```c
    ...
    the window's [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) to the font of the window's screen.
    This does not work right for GimmeZeroZero windows: the
    BorderRPort [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) has the font set correctly, but
    ...
    default font of your window's [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) if the screen's
    font is "fancy."  See the SA_SysFont attribute described
    under [OpenScreen()](../Includes_and_Autodocs_2._guide/node0237.html).
...
```
SEE ALSO
   [OpenWindowTagList()](../Includes_and_Autodocs_2._guide/node023A.html), [OpenScreen()](../Includes_and_Autodocs_2._guide/node0237.html), [ModifyIDCMP()](../Includes_and_Autodocs_2._guide/node0229.html), [SetWindowTitles()](../Includes_and_Autodocs_2._guide/node0258.html),

```c
    [LockPubScreen()](../Includes_and_Autodocs_2._guide/node0225.html), [SetDefaultPubScreen()](../Includes_and_Autodocs_2._guide/node024F.html), [ZipWindow()](../Includes_and_Autodocs_2._guide/node0266.html),
    [layers.library/InstallLayerHook()](../Includes_and_Autodocs_2._guide/node039A.html), [SetPubScreenModes()](../Includes_and_Autodocs_2._guide/node0257.html)
```
