...
```c
    ...
    void Deallocate(struct [MemHeader](../Includes_and_Autodocs_2._guide/node0089.html#line29) *,APTR,ULONG);
```
FUNCTION
...
```c
    Allocate, [exec/memory.h](../Includes_and_Autodocs_2._guide/node0089.html)
```
