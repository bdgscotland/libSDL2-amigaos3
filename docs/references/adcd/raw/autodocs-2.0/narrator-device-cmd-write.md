...
```c
    User [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19) block (struct [narrator_rb](../Includes_and_Autodocs_2._guide/node0042.html#line95) as defined in .h file).
    The [OpenDevice](../Includes_and_Autodocs_2._guide/node04C8.html) call will initialize the [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19) block to a
    "standard male" voice.  If you want to change any parms, do so
    after the [OpenDevice](../Includes_and_Autodocs_2._guide/node04C8.html) call and before the [DoIO](../Includes_and_Autodocs_2._guide/node034B.html) (or SendIO/WaitIO).
    For a complete description of the [narrator_rb](../Includes_and_Autodocs_2._guide/node0042.html#line95) structure, see the
    narrator.h or .i include file.  Note that the [OpenDevice](../Includes_and_Autodocs_2._guide/node04C8.html) call does
    not initialize all the fields needed by the narrator device.  The
    [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19) fields which must be set by the user before issuing the
    write request are:
    ...
    requested by setting the mouths field of the [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19) block to a
    ...
    of the [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19) block.  Note that word and syllable sync only work
