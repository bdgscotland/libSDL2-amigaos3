...
```c
    [SetVar()](../Includes_and_Autodocs_2._guide/node02FE.html), [DeleteVar()](../Includes_and_Autodocs_2._guide/node0294.html), [FindVar()](../Includes_and_Autodocs_2._guide/node02A9.html), [<dos/var.h>](../Includes_and_Autodocs_2._guide/node0073.html)
```
