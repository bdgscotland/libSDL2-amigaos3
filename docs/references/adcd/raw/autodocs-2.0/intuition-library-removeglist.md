...
```c
    Position = RemoveGList( [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797), [Gadget](../Includes_and_Autodocs_2._guide/node00D4.html#line215), Numgad )
    D0                      A0      A1      D0

    UWORD RemoveGList( struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) *, struct [Gadget](../Includes_and_Autodocs_2._guide/node00D4.html#line215) *, WORD );
```
FUNCTION
...
```c
    ...
    Otherwise identical to [RemoveGadget()](../Includes_and_Autodocs_2._guide/node0246.html).
```
NOTE
...
```c
    [RemoveGadget()](../Includes_and_Autodocs_2._guide/node0246.html), [AddGadget()](../Includes_and_Autodocs_2._guide/node01FC.html), [AddGList()](../Includes_and_Autodocs_2._guide/node01FD.html)
```
