...
```c
    ...
    LONG DoPkt(struct [MsgPort](../Includes_and_Autodocs_2._guide/node0099.html#line29) *,LONG,LONG,LONG,LONG,LONG,LONG)
```
FUNCTION
...
```c
    ...
    result2 - Available from [IoErr()](../Includes_and_Autodocs_2._guide/node02C2.html) AND in register D1.
```
BUGS

```c
    Using DoPkt() from tasks doesn't work in V36. Use [AllocDosObject()](../Includes_and_Autodocs_2._guide/node027F.html),
    [PutMsg()](../Includes_and_Autodocs_2._guide/node036B.html), and [WaitPort()/GetMsg()](../Includes_and_Autodocs_2._guide/node035A.html) for a workaround, or you can call
    [CreateNewProc()](../Includes_and_Autodocs_2._guide/node028D.html) to start a process to do Dos I/O for you.  In V37,
    DoPkt() will allocate, use, and free the [MsgPort](../Includes_and_Autodocs_2._guide/node0099.html#line29) required.
```
NOTES
...
```c
    [AllocDosObject()](../Includes_and_Autodocs_2._guide/node027F.html), [FreeDosObject()](../Includes_and_Autodocs_2._guide/node02B2.html), [SendPkt()](../Includes_and_Autodocs_2._guide/node02F0.html), [WaitPkt()](../Includes_and_Autodocs_2._guide/node030F.html),
    [CreateNewProc()](../Includes_and_Autodocs_2._guide/node028D.html), [AbortPkt()](../Includes_and_Autodocs_2._guide/node027A.html)
```
