...
```c
    EntryHandler -- Add an entry handler to the [IFFHandle](../Includes_and_Autodocs_2._guide/node010B.html#line34) context.
```
SYNOPSIS
...
```c
    [ExitHandler()](../Includes_and_Autodocs_2._guide/node01C0.html), [StoreLocalItem()](../Includes_and_Autodocs_2._guide/node01DD.html), [StoreItemInContext()](../Includes_and_Autodocs_2._guide/node01DC.html),
