...
```c
    num = SysReqHandler( [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797), IDCMPFlagsPtr, WaitInput )
    D0                   A0      A1             D0

    LONG SysReqHandler( struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) *, ULONG *, BOOL );
```
FUNCTION
...
```c
    [exec.library/WaitPort()](../Includes_and_Autodocs_2._guide/node038C.html)
```
