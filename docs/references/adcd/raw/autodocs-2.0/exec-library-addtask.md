...
```c
    ...
    APTR AddTask(struct [Task](../Includes_and_Autodocs_2._guide/node008E.html#line25) *, APTR, APTR);
```
FUNCTION
...
```c
    ...
    See the AmigaDOS [CreateProc()](../Includes_and_Autodocs_2._guide/node028E.html) for information on Processes.
```
SEE ALSO

```c
    [RemTask](../Includes_and_Autodocs_2._guide/node0378.html), [FindTask](../Includes_and_Autodocs_2._guide/node0352.html), [amiga.lib/CreateTask](../Includes_and_Autodocs_2._guide/node014A.html), [dos/CreateProc](../Includes_and_Autodocs_2._guide/node028E.html),
    [amiga.lib/NewList](../Includes_and_Autodocs_2._guide/node0161.html)
```
