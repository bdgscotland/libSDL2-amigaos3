...
```c
    ...
    matching [Enable()](../Includes_and_Autodocs_2._guide/node034C.html) is executed.  Disable() implies [Forbid()](../Includes_and_Autodocs_2._guide/node0353.html).
...
```c
    ...
    a call to [Enable()](../Includes_and_Autodocs_2._guide/node034C.html) or is placed in a wait state.  Normal task
    ...
    exactly one call to [Enable()](../Includes_and_Autodocs_2._guide/node034C.html) for every call to Disable().
    ...
    Note: In the event of a task entering a [Wait()](../Includes_and_Autodocs_2._guide/node038A.html) after disabling
