...
```c
    ...
    [CMD_WRITE](../Includes_and_Autodocs_2._guide/node0522.html) and ETD_WRITE commands, anyone using TD_RAWWRITE is
...
```c
    [TD_RAWREAD](../Includes_and_Autodocs_2._guide/node052D.html)
```
