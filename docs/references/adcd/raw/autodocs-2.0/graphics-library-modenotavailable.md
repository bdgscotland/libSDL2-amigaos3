...
```c
    ...
    DisplayInfo.NotAvailable field (defined in [graphics/displayinfo.h)](../Includes_and_Autodocs_2._guide/node00BD.html).
```
BUGS
...
```c
    [graphics/displayinfo.h](../Includes_and_Autodocs_2._guide/node00BD.html), [GetVPModeID()](../Includes_and_Autodocs_2._guide/node044A.html)
```
