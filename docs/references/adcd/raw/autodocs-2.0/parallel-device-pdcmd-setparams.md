...
```c
    ...
    set at [OpenDevice](../Includes_and_Autodocs_2._guide/node04F2.html) time.
```
IO REQUEST

```c
    io_Message      mn_ReplyPort initialized
    io_Device       preset by [OpenDevice](../Includes_and_Autodocs_2._guide/node04F2.html)
    io_Unit         preset by [OpenDevice](../Includes_and_Autodocs_2._guide/node04F2.html)
    io_Command      PDCMD_SETPARAMS (0A)
                    NOTE that the following fields of your [IORequest](../Includes_and_Autodocs_2._guide/node0094.html#line19)
    ...
    io_PTermArray   ASCII descending-ordered 8-byte array of
                    ...
                    This field is filled on [OpenDevice](../Includes_and_Autodocs_2._guide/node04F2.html) only if the
                    EOFMODE bit is set.
```
RESULTS
