...
```c
    ...
    void ReplyMsg(struct [Message](../Includes_and_Autodocs_2._guide/node0099.html#line48) *);
```
FUNCTION
...
```c
    [GetMsg](../Includes_and_Autodocs_2._guide/node035A.html), [PutMsg](../Includes_and_Autodocs_2._guide/node036B.html), [exec/ports.h](../Includes_and_Autodocs_2._guide/node0099.html)
```
