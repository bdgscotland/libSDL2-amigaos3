...
```c
    ...
    struct [Task](../Includes_and_Autodocs_2._guide/node008E.html#line25) *CreateTask(STRPTR,LONG,funcEntry,ULONG);
```
FUNCTION
...
```c
    [DeleteTask()](../Includes_and_Autodocs_2._guide/node0155.html), [exec/FindTask()](../Includes_and_Autodocs_2._guide/node0352.html)
```
