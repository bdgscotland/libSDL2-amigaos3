...
```c
    ...
    struct [Resident](../Includes_and_Autodocs_2._guide/node00A0.html#line19) *FindResident(STRPTR);
```
FUNCTION
...
```c
    [exec/resident.h](../Includes_and_Autodocs_2._guide/node00A0.html), [InitResident](../Includes_and_Autodocs_2._guide/node035C.html)
```
