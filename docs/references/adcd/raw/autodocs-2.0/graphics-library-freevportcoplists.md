...
```c
    ...
    void FreeVPortCopLists(struct [ViewPort](../Includes_and_Autodocs_2._guide/node00B8.html#line40) *);
```
FUNCTION

```c
    Search display, color, sprite, and user copper
    lists and call [FreeMem()](../Includes_and_Autodocs_2._guide/node0355.html) to deallocate them from memory
```
INPUTS
