...
```c
    [FGetC()](../Includes_and_Autodocs_2._guide/node02A2.html), [FWrite()](../Includes_and_Autodocs_2._guide/node02B3.html), [FGets()](../Includes_and_Autodocs_2._guide/node02A3.html)
```
