...
```c
    CloseWindow( [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) )
                 A0

    VOID CloseWindow( struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) * );
```
FUNCTION
...
```c
    ...
    NOTE:  If you have added a [Menu](../Includes_and_Autodocs_2._guide/node00D4.html#line61) strip to this [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) (via
    a call to [SetMenuStrip()](../Includes_and_Autodocs_2._guide/node0253.html)) you must be sure to remove that [Menu](../Includes_and_Autodocs_2._guide/node00D4.html#line61) strip
    (via a call to [ClearMenuStrip()](../Includes_and_Autodocs_2._guide/node0205.html)) before closing your [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797).
...
```c
    [OpenWindow()](../Includes_and_Autodocs_2._guide/node0239.html), [OpenScreen()](../Includes_and_Autodocs_2._guide/node0237.html), [CloseScreen()](../Includes_and_Autodocs_2._guide/node0207.html)
```
EXAMPLE
/*  CloseWindowSafely */
