...
```c
    ...
    PosText = pointer to an [IntuiText](../Includes_and_Autodocs_2._guide/node00D4.html#line572) structure
    NegText = pointer to an [IntuiText](../Includes_and_Autodocs_2._guide/node00D4.html#line572) structure
    ...
    are some of the parameters of your [IntuiText](../Includes_and_Autodocs_2._guide/node00D4.html#line572), so that Intuition
...
```c
    This procedure currently opens a window in the [Screen](../Includes_and_Autodocs_2._guide/node00DD.html#line97) which
    ...
    [DisplayAlert()](../Includes_and_Autodocs_2._guide/node020B.html) is not called in version V36.

    It's almost impossible to make complete, correct account
    of different system fonts, window border dimensions, and
    screen resolution to get the layout of a System [Requester](../Includes_and_Autodocs_2._guide/node00D4.html#line145)
...
```c
    [FreeSysRequest()](../Includes_and_Autodocs_2._guide/node0219.html), [DisplayAlert()](../Includes_and_Autodocs_2._guide/node020B.html), [ModifyIDCMP()](../Includes_and_Autodocs_2._guide/node0229.html), [exec.library/Wait()](../Includes_and_Autodocs_2._guide/node038A.html),
    [Request()](../Includes_and_Autodocs_2._guide/node0249.html), [AutoRequest()](../Includes_and_Autodocs_2._guide/node01FF.html), EasyRequest(), [BuildEasyRequestArgs()](../Includes_and_Autodocs_2._guide/node0201.html)
```
