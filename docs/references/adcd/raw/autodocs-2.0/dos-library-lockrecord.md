...
```c
    [LockRecords()](../Includes_and_Autodocs_2._guide/node02C9.html), [UnLockRecord()](../Includes_and_Autodocs_2._guide/node0309.html), [UnLockRecords()](../Includes_and_Autodocs_2._guide/node030A.html)
```
