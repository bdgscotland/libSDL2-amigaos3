...
```c
    ...
    void EndUpdate( struct [Layer](../Includes_and_Autodocs_2._guide/node00A1.html#line33) *, UWORD);
```
FUNCTION
...
```c
    ...
    Note: use flag = FALSE if you are only making a partial update.
        ...
        [OrRectRegion](../Includes_and_Autodocs_2._guide/node0464.html), [AndRectRegion](../Includes_and_Autodocs_2._guide/node0413.html), and [XorRectRegion](../Includes_and_Autodocs_2._guide/node0490.html) ) to clip adjust
...
```c
    [BeginUpdate](../Includes_and_Autodocs_2._guide/node038E.html), [graphics/layers.h](../Includes_and_Autodocs_2._guide/node00C4.html), [graphics/clip.h](../Includes_and_Autodocs_2._guide/node00A1.html)
```
