...
```c
    FreeClass -- Frees a boopsi class created by [MakeClass()](../Includes_and_Autodocs_2._guide/node0227.html). (V36)
```
SYNOPSIS
...
```c
    ...
    Tries to free a boopsi class created by [MakeClass()](../Includes_and_Autodocs_2._guide/node0227.html).  This
    ...
    the class (see [RemoveClass()](../Includes_and_Autodocs_2._guide/node0245.html) ) making it unavailable, whether
    it succeeds or not.
...
```c
    ClassPtr - pointer to a class created by [MakeClass()](../Includes_and_Autodocs_2._guide/node0227.html).
```
RESULT
...
```c
    ...
    Calls [RemoveClass()](../Includes_and_Autodocs_2._guide/node0245.html) for the class in either case.
```
EXAMPLE
...
```c
    [MakeClass()](../Includes_and_Autodocs_2._guide/node0227.html),
