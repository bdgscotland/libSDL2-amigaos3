...
SYNOPSIS
   Cause(interrupt)
         ...
         A1
   void Cause(struct [Interrupt](../Includes_and_Autodocs_2._guide/node008C.html#line23) *);
...
```c
    When setting up the [Interrupt](../Includes_and_Autodocs_2._guide/node008C.html#line23) structure, set the node type to
