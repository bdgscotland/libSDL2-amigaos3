...
```c
    ...
    struct [DosList](../Includes_and_Autodocs_2._guide/node0078.html#line369) *LockDosList(ULONG)
```
FUNCTION
...
```c
    [AttemptLockDosList()](../Includes_and_Autodocs_2._guide/node0284.html), [UnLockDosList()](../Includes_and_Autodocs_2._guide/node0308.html), [Forbid()](../Includes_and_Autodocs_2._guide/node0353.html), [NextDosEntry()](../Includes_and_Autodocs_2._guide/node02D5.html)
```
