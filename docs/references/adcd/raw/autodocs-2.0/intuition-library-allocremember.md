...
```c
    AllocRemember -- [AllocMem()](../Includes_and_Autodocs_2._guide/node0332.html) with tracking to make freeing easy.
```
SYNOPSIS
...
```c
    ...
    APTR AllocRemember( struct [Remember](../Includes_and_Autodocs_2._guide/node00D4.html#line1233) **, ULONG, ULONG );
```
FUNCTION
```c
    This routine calls the Exec [AllocMem()](../Includes_and_Autodocs_2._guide/node0332.html) function for you, but also links
    the parameters of the allocation into a master list, so that
    you can simply call the Intuition routine [FreeRemember()](../Includes_and_Autodocs_2._guide/node0217.html) at a later
...
```c
       ...
       simple call to [FreeRemember()](../Includes_and_Autodocs_2._guide/node0217.html).

    You create the "anchor" for the allocation master list by creating
    a variable that's a pointer to struct [Remember](../Includes_and_Autodocs_2._guide/node00D4.html#line1233), and initializing
    ...
    of a [Remember](../Includes_and_Autodocs_2._guide/node00D4.html#line1233) structure.  The [Remember](../Includes_and_Autodocs_2._guide/node00D4.html#line1233) structure is filled in
    ...
    call [FreeRemember()](../Includes_and_Autodocs_2._guide/node0217.html) with your RememberKey.

    Please read the [FreeRemember()](../Includes_and_Autodocs_2._guide/node0217.html) function description, too.  As you will
...
```c
    RememberKey = the address of a pointer to struct [Remember](../Includes_and_Autodocs_2._guide/node00D4.html#line1233).  Before the
    ...
    Size = the size in bytes of the memory allocation.  Please refer to the
        [exec.library/AllocMem()](../Includes_and_Autodocs_2._guide/node0332.html) function for details.
    Flags = the specifications for the memory allocation.  Please refer to
        the [exec.library/AllocMem()](../Includes_and_Autodocs_2._guide/node0332.html) function for details.
```
EXAMPLE
...
```c
    ...
    at least for the [Remember](../Includes_and_Autodocs_2._guide/node00D4.html#line1233) headers.
```
SEE ALSO

```c
    [FreeRemember()](../Includes_and_Autodocs_2._guide/node0217.html), [exec.library/AllocMem()](../Includes_and_Autodocs_2._guide/node0332.html)
```
