...
```c
    ...
    LONG QueryOverscan( ULONG, struct [Rectangle](../Includes_and_Autodocs_2._guide/node00A6.html#line28) *, WORD );
```
FUNCTION
...
```c
    0 (FALSE) if the [MonitorSpec](../Includes_and_Autodocs_2._guide/node00A7.html#line26) your [NewScreen](../Includes_and_Autodocs_2._guide/node00DD.html#line309) requests
