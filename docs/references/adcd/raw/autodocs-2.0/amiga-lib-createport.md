...
```c
    ...
    struct [MsgPort](../Includes_and_Autodocs_2._guide/node0099.html#line29) *CreatePort(STRPTR,LONG);
```
FUNCTION
...
```c
    ...
    You *must* use [DeletePort()](../Includes_and_Autodocs_2._guide/node0153.html) to delete ports created with
    CreatePort()!
```
INPUTS
...
```c
    port - a new [MsgPort](../Includes_and_Autodocs_2._guide/node0099.html#line29) structure ready for use, or NULL if the port
...
```c
    [DeletePort()](../Includes_and_Autodocs_2._guide/node0153.html), [exec.library/FindPort()](../Includes_and_Autodocs_2._guide/node034F.html), [<exec/ports.h>](../Includes_and_Autodocs_2._guide/node0099.html),
    [exec.library/CreateMsgPort()](../Includes_and_Autodocs_2._guide/node0345.html)
```
