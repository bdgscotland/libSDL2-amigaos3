...
```c
    ReportMouse( Boolean, [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) )
                 D0       A0        <-note

    VOID ReportMouse( BOOL, struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) * );
```
SPECIAL NOTE
...
```c
    [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) = pointer to a [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) structure associated with this request
