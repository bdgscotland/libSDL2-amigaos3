...
```c
    [Success =] ModifyIDCMP( [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797), IDCMPFlags )
    [D0]                     A0      D0

    [BOOL] ModifyIDCMP( struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) *, ULONG );
...
```c
    ...
    Direct Communication [Message](../Includes_and_Autodocs_2._guide/node0099.html#line48) Port).  The state is modified to reflect
...
```c
     ...
     when this signal bit was allocated (either by ModifyIDCMP()
      or [OpenWindow()](../Includes_and_Autodocs_2._guide/node0239.html) ).
```
...
```c
    [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) = pointer to the [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) structure containing the IDCMP ports
...
```c
    [OpenWindow()](../Includes_and_Autodocs_2._guide/node0239.html), [CloseWindow()](../Includes_and_Autodocs_2._guide/node0208.html)
```
