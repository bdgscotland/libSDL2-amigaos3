...
```c
    ...
    struct [MemList](../Includes_and_Autodocs_2._guide/node0089.html#line57) *AllocEntry(struct [MemList](../Includes_and_Autodocs_2._guide/node0089.html#line57) *);
```
FUNCTION

```c
    This function takes a memList structure and allocates enough memory
    to hold the required memory as well as a [MemList](../Includes_and_Autodocs_2._guide/node0089.html#line57) structure to keep
    track of it.

    These [MemList](../Includes_and_Autodocs_2._guide/node0089.html#line57) structures may be linked together in a task control
...
```c
    memList -- A [MemList](../Includes_and_Autodocs_2._guide/node0089.html#line57) structure filled in with [MemEntry](../Includes_and_Autodocs_2._guide/node0089.html#line41) structures.
```
RESULTS

```c
    memList -- A different [MemList](../Includes_and_Autodocs_2._guide/node0089.html#line57) filled in with the actual memory
