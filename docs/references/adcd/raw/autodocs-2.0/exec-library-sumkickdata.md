...
```c
    ...
    as [Resident](../Includes_and_Autodocs_2._guide/node00A0.html#line19) structures, defined in [exec/resident.h)](../Includes_and_Autodocs_2._guide/node00A0.html).  These tags tell
    ...
    field of [ExecBase](../Includes_and_Autodocs_2._guide/node009E.html#line35).  By default this list contains any ROMTags found
    ...
    Three variables in [ExecBase](../Includes_and_Autodocs_2._guide/node009E.html#line35) are used in changing the ROMTag array:
    KickMemPtr, KickTagPtr, and KickCheckSum. KickMemPtr points to a
    linked list of [MemEntry](../Includes_and_Autodocs_2._guide/node0089.html#line41) structures. The memory that these [MemEntry](../Includes_and_Autodocs_2._guide/node0089.html#line41)
    structures reference will be allocated (via AllocAbs) at boot time.
    The [MemEntry](../Includes_and_Autodocs_2._guide/node0089.html#line41) structure itself must also be in the list.
    ...
    that your ROMTag code, [MemEntry](../Includes_and_Autodocs_2._guide/node0089.html#line41) structures, and resident arrays
    ...
    [Remember](../Includes_and_Autodocs_2._guide/node00D4.html#line1233) that changing an existing ROMTag entry falls into the
...
```c
    ...
    A call to [CacheClearU](../Includes_and_Autodocs_2._guide/node0339.html) will do fine.
```
SEE ALSO

```c
    [InitResident](../Includes_and_Autodocs_2._guide/node035C.html), [FindResident](../Includes_and_Autodocs_2._guide/node0350.html)
```
