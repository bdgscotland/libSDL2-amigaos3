...
```c
    ...
    void ScrollRaster
         (struct [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) *, WORD, WORD, WORD, WORD, WORD, WORD);
```
FUNCTION
...
```c
    ...
    If you are dealing with a SimpleRefresh layered [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) you
...
```c
    ...
    right, and there is no [TmpRas](../Includes_and_Autodocs_2._guide/node00AF.html#line33) attached to the [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55), the system
    ...
    1.2/1.3 is to attach a valid [TmpRas](../Includes_and_Autodocs_2._guide/node00AF.html#line33) of size at least
    MAXBYTESPERROW to the [RastPort](../Includes_and_Autodocs_2._guide/node00AF.html#line55) before the call.
