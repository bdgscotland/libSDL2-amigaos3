...
```c
    ...
    BOOL ReadLink( struct [MsgPort](../Includes_and_Autodocs_2._guide/node0099.html#line29) *, BPTR, STRPTR, STRPTR, ULONG)
```
FUNCTION
...
```c
    [MakeLink()](../Includes_and_Autodocs_2._guide/node02CB.html), [Open()](../Includes_and_Autodocs_2._guide/node02D6.html), [Lock()](../Includes_and_Autodocs_2._guide/node02C6.html), [GetDeviceProc()](../Includes_and_Autodocs_2._guide/node02B7.html)
```
