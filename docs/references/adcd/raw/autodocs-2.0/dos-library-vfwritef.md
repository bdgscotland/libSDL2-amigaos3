...
```c
    [VFPrintf()](../Includes_and_Autodocs_2._guide/node030B.html), [VFPrintf()](../Includes_and_Autodocs_2._guide/node030B.html), [FPutC()](../Includes_and_Autodocs_2._guide/node02AC.html)
```
