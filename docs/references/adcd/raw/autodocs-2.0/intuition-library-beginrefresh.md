...
```c
    BeginRefresh( [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) )
                  A0

    VOID BeginRefresh( struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) * );
```
FUNCTION
...
```c
    [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) = pointer to the window structure which needs refreshing
```
RESULT
...
```c
    ...
    [layers.library/BeginUpdate()](../Includes_and_Autodocs_2._guide/node038E.html), and abort if that function fails.
```
SEE ALSO
   [EndRefresh()](../Includes_and_Autodocs_2._guide/node0213.html), [layers.library/BeginUpdate()](../Includes_and_Autodocs_2._guide/node038E.html), [OpenWindow()](../Includes_and_Autodocs_2._guide/node0239.html)

```c
    [layer.library/InstallClipRegion()](../Includes_and_Autodocs_2._guide/node0399.html), [graphics.library/LockLayerInfo()](../Includes_and_Autodocs_2._guide/node039C.html)
