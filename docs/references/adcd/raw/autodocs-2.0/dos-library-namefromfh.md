...
```c
    ...
    name will be null-terminated.  See [NameFromLock()](../Includes_and_Autodocs_2._guide/node02D3.html) for more information.
```
INPUTS
...
```c
    [NameFromLock()](../Includes_and_Autodocs_2._guide/node02D3.html)
```
