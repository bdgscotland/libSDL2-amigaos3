...
```c
    ...
    conflicts with the blitter or other custom chip DMA.  [Custom](../Includes_and_Autodocs_2._guide/node00CD.html#line26) chip
    ...
    modify instructions, including [LoadSeg()](../Includes_and_Autodocs_2._guide/node02C5.html), [MakeLibrary()](../Includes_and_Autodocs_2._guide/node0361.html) and
    [SetFunction()](../Includes_and_Autodocs_2._guide/node037C.html).
```
SEE ALSO

```c
    exec/execbase.i, [CacheControl](../Includes_and_Autodocs_2._guide/node033A.html), [CacheClearU](../Includes_and_Autodocs_2._guide/node0339.html)
```
