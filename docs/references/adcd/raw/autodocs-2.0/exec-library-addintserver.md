...
```c
    ...
    void AddIntServer(ULONG, struct [Interrupt](../Includes_and_Autodocs_2._guide/node008C.html#line23) *);
```
FUNCTION
...
```c
    ...
    interrupt - pointer to an [Interrupt](../Includes_and_Autodocs_2._guide/node008C.html#line23) structure.
...
```c
    [RemIntServer](../Includes_and_Autodocs_2._guide/node0371.html), [SetIntVector](../Includes_and_Autodocs_2._guide/node037D.html), hardware/intbits.i,exec/interrupts.i
```
