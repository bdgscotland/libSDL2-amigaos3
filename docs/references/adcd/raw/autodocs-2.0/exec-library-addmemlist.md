...
```c
    ...
    bytes will be used to hold the [MemHeader](../Includes_and_Autodocs_2._guide/node0089.html#line29) structure.  The remainder
...
```c
    [AllocMem](../Includes_and_Autodocs_2._guide/node0332.html), [exec/memory.h](../Includes_and_Autodocs_2._guide/node0089.html)
```
