...
```c
    ...
    BOOL AddBootNode( BYTE,ULONG,struct [DeviceNode](../Includes_and_Autodocs_2._guide/node0066.html#line100) *,struct [ConfigDev](../Includes_and_Autodocs_2._guide/node00FC.html#line33) * );
```
FUNCTION
...
```c
    ...
    the card's [ConfigDev](../Includes_and_Autodocs_2._guide/node00FC.html#line33) structure.

    Pass a NULL [ConfigDev](../Includes_and_Autodocs_2._guide/node00FC.html#line33) pointer to create a non-bootable node.
```
INPUTS
...
```c
    ...
    deviceNode -- a legal DOS device node, properly initialized.
            Typically this will be the result of a [MakeDosNode()](../Includes_and_Autodocs_2._guide/node03B8.html).
            Special cases may require a custom-built device node.

    configDev -- a valid board's [ConfigDev](../Includes_and_Autodocs_2._guide/node00FC.html#line33) stucture.  This is required
...
```c
    This function eliminates the need to manually [Enqueue](../Includes_and_Autodocs_2._guide/node034D.html) a BOOTNODE
...
```c
    [AddDosNode](../Includes_and_Autodocs_2._guide/node03B0.html)
```
