...
```c
    ...
    BOOL ErrorReport(LONG, LONG, ULONG, struct [MsgPort](../Includes_and_Autodocs_2._guide/node0099.html#line29) *)
```
FUNCTION
...
```c
    [Fault()](../Includes_and_Autodocs_2._guide/node02A1.html), [IoErr()](../Includes_and_Autodocs_2._guide/node02C2.html)
```
