...
```c
    ...
    void MapTags(struct [TagItem](../Includes_and_Autodocs_2._guide/node012E.html#line31) *tagList, struct [TagItem](../Includes_and_Autodocs_2._guide/node012E.html#line31) mapList,
                 LONG includeMiss);
```
FUNCTION
