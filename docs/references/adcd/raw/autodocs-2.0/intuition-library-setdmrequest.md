...
```c
    success = SetDMRequest( [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797), DMRequest )
    D0                      A0      A1

    BOOL SetDMRequest( struct [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) *, struct [Requester](../Includes_and_Autodocs_2._guide/node00D4.html#line145) * );
```
FUNCTION
...
```c
    [Window](../Includes_and_Autodocs_2._guide/node00D4.html#line797) = pointer to the window from which the DMRequest is to be set
...
```c
    [ClearDMRequest()](../Includes_and_Autodocs_2._guide/node0204.html), [Request()](../Includes_and_Autodocs_2._guide/node0249.html)
```
