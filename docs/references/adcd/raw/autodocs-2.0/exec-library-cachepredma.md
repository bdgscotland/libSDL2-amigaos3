...
```c
    exec/execbase.i, [CachePostDMA](../Includes_and_Autodocs_2._guide/node033B.html), [CacheClearU](../Includes_and_Autodocs_2._guide/node0339.html), [CacheClearE](../Includes_and_Autodocs_2._guide/node0338.html)
```
