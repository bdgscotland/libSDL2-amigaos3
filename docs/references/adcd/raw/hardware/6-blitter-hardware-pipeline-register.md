...
The blitter performs many operations in each cycle --  [shifting](../Hardware_Manual_guide/node011F.html)  and
 [masking](../Hardware_Manual_guide/node011F.html#line42)  source words, logical combination of sources, and  [area fill](../Hardware_Manual_guide/node0122.html) 
...
before the first destination is written.  This allows you to  [shift](../Hardware_Manual_guide/node011F.html)  a
...
```c
    USE Code
       in        Active
    [BLTCON0](../Hardware_Manual_guide/node001A.html)     Channels             Cycle Sequence
```
   ---------    --------             --------------
...
*  Typical operation involves fetching all sources twice before the
   ...
   processor, bitplanes, and other  [DMA channels](../Hardware_Manual_guide/node011B.html) ; and other factors.
