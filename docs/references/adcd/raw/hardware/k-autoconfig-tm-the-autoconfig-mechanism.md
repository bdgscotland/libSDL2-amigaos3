...
this point, the most important signals in the system are  [/CFGINn](../Hardware_Manual_guide/node02B2.html#line17)  and
 [/CFGOUTn](../Hardware_Manual_guide/node02B2.html#line17) .  As long as a card's  [/CFGINn](../Hardware_Manual_guide/node02B2.html#line17)  line is negated, that card sits
...
concern the bus may take place after  [/RESET](../Hardware_Manual_guide/node02B1.html#line40)  is negated). As part of the
unconfigured state,  [/CFGOUTn](../Hardware_Manual_guide/node02B2.html#line17)  is negated by the PIC immediately on reset.

The configuration process begins when a card's  [/CFGINn](../Hardware_Manual_guide/node02B2.html#line17)  line is asserted,
...
only one unconfigured card will see an asserted  [/CFGINn](../Hardware_Manual_guide/node02B2.html#line17)  at one time.  An
unconfigured card that sees its  [/CFGINn](../Hardware_Manual_guide/node02B2.html#line17)  line asserted will respond to a
...
to assert its  [/CFGOUTn](../Hardware_Manual_guide/node02B2.html#line17) , enabling the next board in the configuration
chain.
...
cycles (PICs need only decode  [A31-A24](../Hardware_Manual_guide/node02B4.html#line13)  during configuration).  A Zorro III
...
return only the top 4 bits of data, on  [D31-D28](../Hardware_Manual_guide/node02B5.html#line10)  for either bus mode. Write
