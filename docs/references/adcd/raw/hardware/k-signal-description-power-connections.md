...
The Zorro III expansion bus provides several different  [voltages](../Hardware_Manual_guide/node02AF.html)  designed
...
Main Supply (+5VDC)
   ...
   drawing up to  [4.0 Amps](../Hardware_Manual_guide/node029A.html)  @ +5VDC is no longer supported.
