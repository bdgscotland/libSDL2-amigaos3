...
1 is as shown in Figure 3-15.
 ...
 |                                                                       |
 |                                                               /|\     |
 |                       Screen data fetch stops ( [DDFSTOP](../Hardware_Manual_guide/node0072.html#line31) ) for  |      |
...
```
At this point,  [BPLxPTH and BPLxPTL](../Hardware_Manual_guide/node0072.html#line59)  contain the value START+40. The
...
To display the right half of the big picture, you set up
 [vertical blanking](../Hardware_Manual_guide/node0169.html)  routine to start the bitplane pointers at location
