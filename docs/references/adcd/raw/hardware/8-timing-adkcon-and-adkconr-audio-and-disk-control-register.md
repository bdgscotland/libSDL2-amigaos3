...
```c
     ...
     10      WORDSYNC   Value of 1 enables synchronizing and starting of
                        ...
                        synchronize must be written into the  [DSKSYNC](../Hardware_Manual_guide/node0195.html) 
     ...
     [7-0](../Hardware_Manual_guide/node00E7.html#line84)                These bits are used by the audio subsystem for
