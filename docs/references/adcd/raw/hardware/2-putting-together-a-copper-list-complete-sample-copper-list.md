...
the  [color registers](../Hardware_Manual_guide/node0067.html)  are loaded with the following values:
          ...
          COLOR02         green
          COLOR03         blue
At line 150 on the screen, the  [color registers](../Hardware_Manual_guide/node0067.html)  are reloaded:
...
```
For more information about  [color registers](../Hardware_Manual_guide/node0067.html) , see Chapter 3, "Playfield
Hardware."
