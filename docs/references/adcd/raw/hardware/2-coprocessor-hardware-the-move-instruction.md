...
register. This procedure is shown in detail in the section called
 [Summary of Copper Instructions](../Hardware_Manual_guide/node005F.html) .
...
```c
      ...
      register,  [COPCON](../Hardware_Manual_guide/node0052.html) , which is described in the "Control Register"
      section.
```
   *  The Copper cannot write into any register whose address is lower

      than $10.
 [Appendix B](../Hardware_Manual_guide/node0060.html)  contains all of the machine register addresses.
...
file (see  [Appendix I](../Hardware_Manual_guide/node01AC.html) ) that defines all of the hardware register names
