...
```c
     ...
     -------------   --------                -------
       [COLOR00](../Hardware_Manual_guide/node006D.html)        12 bits        User-defined color for the
...
```
 [COLOR00](../Hardware_Manual_guide/node006D.html)  is always reserved for the background color. The background color
...
area.
   ...
   ---------------------------------
   If you are using the optional genlock board for  [video input](../Hardware_Manual_guide/node0091.html)  from a
...
resulting colors. At the end of the chapter is a more extensive
 [Color Register list](../Hardware_Manual_guide/node0094.html) .
