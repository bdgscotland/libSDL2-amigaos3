...
```
BLTSIZV    05C      W      A( [E](../Hardware_Manual_guide/node00AA.html#line13) ) Blitter V size (for 15 bit vertical size)
BLTSIZH    05E      W      A( [E](../Hardware_Manual_guide/node00AA.html#line13) ) Blitter H size and start (for 11 bit
