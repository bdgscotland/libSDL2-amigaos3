...
number represents one of the colors in the sprite's  [color registers](../Hardware_Manual_guide/node00D0.html) . For
...
See  [Figure 4-7](../Hardware_Manual_guide/node00B9.html#line57) .

Each of the binary numbers formed by the combination of the two data words
for each line refers to a specific  [color register](../Hardware_Manual_guide/node00D0.html)  in that particular
...
corresponding to the  [color registers](../Hardware_Manual_guide/node00D0.html)  for sprite  [DMA channel](../Hardware_Manual_guide/node00BF.html) 0 are shown
in Table 4-2.
