...
start of 4.5  [color clocks](../Hardware_Manual_guide/node012B.html#line29).
...
The bitplane address pointers ( [BPLxPTH and BPLxPTL](../Hardware_Manual_guide/node006B.html#line32) ) are used by the
...
After the first line is fetched, the bitplane pointers
 [BPLxPTH and BPLxPTL](../Hardware_Manual_guide/node006B.html#line32)  contain the value START+40. The modulo (in this
...
modulos for each playfield in  [dual-playfield mode](../Hardware_Manual_guide/node0078.html) . For normal
...
```
 [Data Fetch in High resolution Mode](../Hardware_Manual_guide/node0073.html) 
 [Modulo in Interlaced Mode](../Hardware_Manual_guide/node0074.html) 
