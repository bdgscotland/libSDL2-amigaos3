...
components and gives a brief overview of its graphics and sound features.
 ...
 [Components of the Amiga](../Hardware_Manual_guide/node0003.html)          [Applications & Technical Support (CATS)](../Hardware_Manual_guide/node000F.html) 
 [About the Examples](../Hardware_Manual_guide/node000A.html)               [Error Reports](../Hardware_Manual_guide/node0010.html) 
 [General Development Guidelines](../Hardware_Manual_guide/node000B.html) 
