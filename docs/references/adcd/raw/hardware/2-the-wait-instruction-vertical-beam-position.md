...
```c
     [Copper Instruction](../Hardware_Manual_guide/node0049.html)           Explanation
    --------------------          -----------
     [WAIT](../Hardware_Manual_guide/node004B.html)  for position (0,255)   At this point, the vertical
                                  counter appears to wrap to 0
                                  because the comparison works
                                  on the least significant bits
                                  of the vertical count

     [WAIT](../Hardware_Manual_guide/node004B.html)  for any horizontal       Thus the total of 256 + 6 = 262
    position with vertical        lines of video beam travel during
    position 0 through 5,         which  [Copper instructions](../Hardware_Manual_guide/node0049.html)  can be
    covering the last 6 lines     executed
    of the scan before
     [vertical blanking](../Hardware_Manual_guide/node0169.html)  occurs.
