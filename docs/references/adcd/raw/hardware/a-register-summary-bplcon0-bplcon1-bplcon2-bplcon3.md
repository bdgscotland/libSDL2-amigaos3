...
-------- -------  -----   -------       --------
BPLCON0    100      W     A D( [E](../Hardware_Manual_guide/node00A3.html) ) Bitplane control register (misc.
```c
                                       control bits)
```
...
```
BPLCON2    104      W       D( [E](../Hardware_Manual_guide/node00A9.html) ) Bitplane control register
...
```
BPLCON3    106      W      D( [E](../Hardware_Manual_guide/node00A9.html) ) Bitplane control (enhanced features)
