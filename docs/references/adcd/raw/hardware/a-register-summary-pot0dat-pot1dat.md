...
-------- -------  -----   -------       --------
POT0DAT    012      R      P( [E](../Hardware_Manual_guide/node00AC.html) ) Pot counter data left pair (vert,horiz.)
POT1DAT    014      R      P( [E](../Hardware_Manual_guide/node00AC.html) ) Pot counter data right pair (vert,horiz.)
