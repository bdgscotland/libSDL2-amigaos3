...
Hardware Bus Error/Interrupt (/BERR)
   ...
   drive with an  [open collector](../Hardware_Manual_guide/node02BE.html)  or similar device, and any device that
...
```c
    [open-collector](../Hardware_Manual_guide/node02BE.html)  output, or the equivalent, and pulled up by a
```
   backplane resistor.
...
System Interrupts
   ...
   each line must be driven by an  [open-collector](../Hardware_Manual_guide/node02BE.html)  or equivalent output
   ...
   the  [quick interrupt](../Hardware_Manual_guide/node02AC.html)  protocol described in the Bus Architecture
