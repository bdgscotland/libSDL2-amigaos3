...
```c
    15      SET/CLR    The set/reset control bit. See
                        [description of bit 15](../Hardware_Manual_guide/node0166.html) .


    14      [BBUSY](../Hardware_Manual_guide/node0123.html#line5)      Blitter busy status - read-only

    13      [BZERO](../Hardware_Manual_guide/node0126.html)      Blitter zero status - read-only. Remains 1 if,
                       during a blitter operation, the blitter output
                       was always zero.

    12, 11             Unassigned

    10      [BLTPRI](../Hardware_Manual_guide/node012B.html#line146)     Blitter priority.  Also known as "blitter-nasty."
    ...
    8       [BPLEN](../Hardware_Manual_guide/node0075.html)      Bitplane DMA enable

    7       [COPEN](../Hardware_Manual_guide/node0057.html#line9)      Coprocessor DMA enable

    6       BLTEN      Blitter DMA enable

    5       SPREN      Sprite DMA enable

    4       DSKEN       [Disk DMA enable](../Hardware_Manual_guide/node0192.html#line14) 

    3-0     [AUDxEN](../Hardware_Manual_guide/node00E0.html#line7)     Audio DMA enable for channels 3-0 (x = 3 - 0).
