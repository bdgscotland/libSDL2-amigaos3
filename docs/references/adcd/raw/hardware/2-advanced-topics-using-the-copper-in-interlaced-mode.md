...
together). This is accomplished by having a separate
 [Copper instruction list](../Hardware_Manual_guide/node0053.html)  for each field to manage displaying the data.
...
executed, you change the contents of the  [COP1LC](../Hardware_Manual_guide/node0050.html)  location register to
point to the second list. Then, during the  [vertical blanking](../Hardware_Manual_guide/node0169.html)  interval,
 [COP1LC](../Hardware_Manual_guide/node0050.html)  will be automatically reset to point to the original list.

For more information about  [interlaced displays](../Hardware_Manual_guide/node0069.html#line16) , see Chapter 3,
"Playfield Hardware."
