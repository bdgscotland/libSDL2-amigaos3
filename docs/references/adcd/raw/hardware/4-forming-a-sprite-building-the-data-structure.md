...
descriptions. To create a sprite's data structure, you need to:
   ...
   *  Write the  [horizontal](../Hardware_Manual_guide/node00B2.html)  and  [vertical position](../Hardware_Manual_guide/node00B3.html)  of the sprite into
...
Figure 4-7 shows how the data structure relates to the sprite.
 ...
 [Sprite Control Word 1 : SPRxPOS](../Hardware_Manual_guide/node00BA.html)      [Sprite Color Descriptor Words](../Hardware_Manual_guide/node00BC.html) 
 [Sprite Control Word 2 : SPRxCTL](../Hardware_Manual_guide/node00BB.html)      [End-of-data Words](../Hardware_Manual_guide/node00BD.html) 
