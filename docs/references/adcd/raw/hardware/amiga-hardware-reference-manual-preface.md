...
```c
       [Chapter 1, Introduction](../Hardware_Manual_guide/node0002.html) . An overview of the hardware and
      survey of the Amiga's graphics and audio features.

       [Chapter 2, Coprocessor Hardware](../Hardware_Manual_guide/node0002.html) . Using the Copper coprocessor
      ...
      register changes during the time between displays.
       ...
       [Chapter 3, Playfield Hardware](../Hardware_Manual_guide/node0002.html) . Creating, displaying and
      scrolling the playfields, one of the basic display elements of
      the Amiga; how the Amiga produces multi-color, bitmapped
      displays.

       [Chapter 4, Sprite Hardware](../Hardware_Manual_guide/node0002.html) . Using the eight sprite direct
      ...
      reusing the DMA channels.
       ...
       [Chapter 5, Audio Hardware](../Hardware_Manual_guide/node0002.html) . Overview of sampled sound; how to
      produce quality sound, simple and complex sounds, and modulated
      sounds.

       [Chapter 6, Blitter Hardware](../Hardware_Manual_guide/node0002.html) . Using the blitter DMA channel to
      create animation effects and draw lines into playfields.

       [Chapter 7, System Control Hardware](../Hardware_Manual_guide/node0002.html) . Using the control
      ...
      memory access, and control interrupts.
       ...
       [Chapter 8, Interface Hardware](../Hardware_Manual_guide/node0002.html) . How the Amiga talks to the
...
system include files, the Amiga ROM Kernel Reference Manual: [Libraries](../Libraries_Manual_guide/node0000.html) 
and the Amiga ROM Kernel Reference Manual: [Devices](../Devices_Manual_guide/node0000.html)  with tutorial-style
