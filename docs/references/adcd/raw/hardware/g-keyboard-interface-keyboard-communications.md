...
reason for this is to transmit the  [up/down flag](../Hardware_Manual_guide/node0174.html)  last, in order to cause
a key-up code to be transmitted in case the keyboard is forced to restore
 [lost sync](../Hardware_Manual_guide/node0176.html)  (explained in more detail below).
