...
```c
     ...
     Bits 15 - 8      [Vertical beam position](../Hardware_Manual_guide/node004D.html)  (called VP).

     Bits 7 - 1       [Horizontal beam position](../Hardware_Manual_guide/node004C.html)  (called HP).
     ...
     Bit 15          The  [blitter-finished-disable bit](../Hardware_Manual_guide/node005D.html) .  Normally, this
...
until the next  [vertical blanking](../Hardware_Manual_guide/node0169.html)  interval begins.
...
the WAIT instruction and to the  [SKIP](../Hardware_Manual_guide/node0059.html) . instruction. The  [SKIP](../Hardware_Manual_guide/node0059.html)  instruction
is described below in the  [Advanced Topics](../Hardware_Manual_guide/node0058.html)  section.

 [Horizontal Beam Position](../Hardware_Manual_guide/node004C.html) 
 [Vertical Beam Position](../Hardware_Manual_guide/node004D.html) 
 [The Comparison Enable Bits](../Hardware_Manual_guide/node004E.html) 
