...
```
   ...
   are also available in  [POTGO and POTGOR](../Hardware_Manual_guide/node018B.html)  registers.  It is recommended
...
-------------------------------------------
   ...
   1    XBUT      Extra Button
   2    Unused
   3     LBUT*    Left button              See  [Digital Joystick](../Hardware_Manual_guide/node010B.html) 
   4     RBUT*    Right button             See  [Digital Joystick](../Hardware_Manual_guide/node010D.html#line44) 
