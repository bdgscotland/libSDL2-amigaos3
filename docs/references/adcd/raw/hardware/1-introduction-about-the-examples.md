...
Most of the examples in this book use the hw_examples.i file (see
 [Appendix I](../Hardware_Manual_guide/node01AC.html) ) to define the chip register names.  Hw_examples.i
...
*  Examples of how to define the correct register offset can be found in
   the hw_examples.i file listed in  [Appendix I](../Hardware_Manual_guide/node01AC.html) .
