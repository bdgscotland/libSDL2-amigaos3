...
```c
    [collision control register](../Hardware_Manual_guide/node015D.html)  described below lets you either ignore or
```
...
bitplanes. The  [collision control register](../Hardware_Manual_guide/node015D.html)  specifies how to handle the
