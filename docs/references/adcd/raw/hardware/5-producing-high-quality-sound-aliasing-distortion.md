...
the range of the  [low-pass filter](../Hardware_Manual_guide/node00EE.html) , cutting off the undesirable
frequencies. Figure 5-5 shows a frequency domain plot of the anti-aliasing
 [low-pass filter](../Hardware_Manual_guide/node00EE.html)  used in the system.
...
that the beat frequency will be above the cutoff range of the
 [anti-aliasing filter](../Hardware_Manual_guide/node00EE.html) :
