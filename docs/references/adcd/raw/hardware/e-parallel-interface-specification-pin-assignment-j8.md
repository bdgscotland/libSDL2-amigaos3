...
```c
                 ...
                 (similar to ACK* in output mode).  See  [timing diagrams](../Hardware_Manual_guide/node0103.html) 
...
```c
                 ...
                 See  [timing diagrams](../Hardware_Manual_guide/node0103.html) .  The 8520 can be programmed to
