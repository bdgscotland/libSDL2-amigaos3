...
The register  [DIWSTOP](../Hardware_Manual_guide/node0084.html)  (for Display Window Stop) controls the display window
...
NTSC, ($2C) for PAL.
   ...
   The normal NTSC  [DIWSTRT](../Hardware_Manual_guide/node0070.html)  is ($2C81).
   The normal NTSC DIWSTOP is ($F4C1).

   The normal PAL  [DIWSTRT](../Hardware_Manual_guide/node0070.html)  is ($2C81).
...
```c
            Table 3-9:  [DIWSTRT](../Hardware_Manual_guide/node0070.html)  and DIWSTOP Summary
                 ...
                 NTSC          PAL          MIN          MAX
                 ----          ---          ---          ---
    [DIWSTRT](../Hardware_Manual_guide/node0070.html) :
```
   ----------
...
Appendix C, Enhanced Chip Set for more information about the
 [display window registers](../Hardware_Manual_guide/node00A8.html) .
