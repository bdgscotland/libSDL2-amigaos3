...
To set horizontal resolution mode, you write to bit 15, HIRES, in register
 [BPLCON0](../Hardware_Manual_guide/node0092.html) :
...
register  [BPLCON0](../Hardware_Manual_guide/node0092.html) :

   Interlaced mode -- write 1 to bit 2.
   Non-interlaced mode -- write 0 to bit 2.

As explained above in  [Setting the Number of Bitplanes](../Hardware_Manual_guide/node0068.html) , bits in
 [BPLCON0](../Hardware_Manual_guide/node0092.html)  are not independently settable.
...
```c
        MOVE.W  #$A204,[BPLCON0](../Hardware_Manual_guide/node0092.html)+CUSTOM   ; Write to it
```
The example above also sets the following parameters that are also
controlled through register  [BPLCON0](../Hardware_Manual_guide/node0092.html) :

   [*](../Hardware_Manual_guide/node0069.html#line7)   High resolution mode is enabled.
   [*](../Hardware_Manual_guide/node0068.html#line4)   Two bitplanes are used.
   [*](../Hardware_Manual_guide/node008F.html#line51)   Hold-and-modify mode is disabled.
   [*](../Hardware_Manual_guide/node007C.html)   Single-playfield mode is enabled.
   [*](../Hardware_Manual_guide/node0076.html)   Composite video color is enabled.
   ...
   [*](../Hardware_Manual_guide/node0069.html#line94)   Interlaced mode is enabled.
   [*](../Hardware_Manual_guide/node0092.html#line11)   External resynchronization is disabled.
