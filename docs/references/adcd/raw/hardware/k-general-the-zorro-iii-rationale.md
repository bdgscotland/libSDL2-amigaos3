...
the Zorro III design, which supports the following features:
   ...
   *   [Compatibility](../Hardware_Manual_guide/node0290.html)  with all Zorro II devices.
   *  Full  [32-bit address](../Hardware_Manual_guide/node02A4.html)  path for new devices.
   *  Full  [32-bit data](../Hardware_Manual_guide/node02A4.html)  path for new devices.
   *   [Bus speed independent](../Hardware_Manual_guide/node0291.html)  of host system CPU speed.
   *   [High speed](../Hardware_Manual_guide/node02AA.html#line11)  bus block transfer mode.
   *   [Bus locking](../Hardware_Manual_guide/node02A8.html)  for multiprocessor support.
   *   [Cache disable](../Hardware_Manual_guide/node02A9.html)  for simple cache support.
   *   [Fair arbitration](../Hardware_Manual_guide/node0296.html)  for all bus masters.
   *   [Cycle-by-cycle](../Hardware_Manual_guide/node02AB.html)  bus arbitration mode.
   *   [High speed interrupt](../Hardware_Manual_guide/node02AC.html)  mode.

Some of the advanced features, such as  [burst modes](../Hardware_Manual_guide/node02B5.html) , are designed in such
...
The Zorro III bus is physically based on the same  [100-pin](../Hardware_Manual_guide/node02C9.html)  single piece
...
Space. The  [memory map](../Hardware_Manual_guide/node00D4.html) , in Figure K-1 shows how these three spaces are
