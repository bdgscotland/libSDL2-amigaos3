...
This register is normally used only by the sprite  [DMA channel](../Hardware_Manual_guide/node00BF.html) . It
...
```c
      ...
      During attach mode, the  [attached sprites](../Hardware_Manual_guide/node00C6.html)  are normally moved
