...
to use.  Actually, you can display larger playfields; the
 [maximum dimensions](../Hardware_Manual_guide/node0085.html)  are given in the section called
 [Bitplanes and Playfields of All Sizes](../Hardware_Manual_guide/node007E.html) . Also, the dimensions of the
...
section called  [Moving (Scrolling) Playfields](../Hardware_Manual_guide/node0086.html) .
...
of eight different colors. This is called  [dual-playfield mode](../Hardware_Manual_guide/node0078.html) .
