...
The system includes a low-pass filter that eliminates
 [aliasing distortion](../Hardware_Manual_guide/node00ED.html)  as described above. This filter becomes active
...
should select a sampling rate no less than 14 KHz, which corresponds to a
 [sampling period](../Hardware_Manual_guide/node00DD.html)  in the range 124 to 256.

At a  [sampling period](../Hardware_Manual_guide/node00DD.html)  around 320, you begin to lose the higher frequency
...
This control bit is the same output bit of the  [8520 CIA](../Hardware_Manual_guide/node012E.html)  that controls
