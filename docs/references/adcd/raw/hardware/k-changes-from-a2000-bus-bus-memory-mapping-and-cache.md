...
Another change to the Zorro II implementation is that the  [bus mapping](../Hardware_Manual_guide/node00D4.html) 
...
The reason for the two distinct mapping regions is for  [cache support](../Hardware_Manual_guide/node02A9.html)  of
