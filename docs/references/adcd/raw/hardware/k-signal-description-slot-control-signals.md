...
Slave (/SLAVEn)
   ...
   output within 35ns of  [/AS](../Hardware_Manual_guide/node02A2.html#line18)  asserted. The /SLAVE output must be negated
   at the end of a cycle within 50ns of  [/AS](../Hardware_Manual_guide/node02A2.html#line18)  negated.  Late /SLAVE
...
```c
    [/BERR](../Hardware_Manual_guide/node029F.html#line4)  being asserted.
```
Configuration Chain (/CFGINn, /CFGOUTn)
   ...
   During the  [AUTOCONFIG](../Hardware_Manual_guide/node02C7.html)  process, an unconfigured Zorro PIC responds to
