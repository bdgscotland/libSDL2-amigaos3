...
Bits labeled  [PA](../Hardware_Manual_guide/node014A.html#line15)  are input bits in CIAAPRA ($BFE001).  Bits labeled
 [PB](../Hardware_Manual_guide/node014A.html#line39)  are output bits located in CIAAPRB ($BFD100).  More information on
...
```c
                   ...
                   acceptable.  See  [Appendix F](../Hardware_Manual_guide/node012E.html)  for a better solution.
...
```c
                   create a level 6  [interrupt](../Hardware_Manual_guide/node0196.html) .  See  [Appendix F](../Hardware_Manual_guide/node012E.html)  for
                   details.
```
