...
Here is the sequence you should follow:
   ...
   1. Enable disk DMA in the  [DMACON](../Hardware_Manual_guide/node0170.html)  register (See Chapter 7 for more
```c
      information)
```
...
into a buffer and then search for the sector(s) that you want. Using the
 [DSKSYNC](../Hardware_Manual_guide/node0195.html)  register (described below) will guarantee word alignment of the
