...
priority level.  Display DMA has  [priority](../Hardware_Manual_guide/node0155.html)  over sprite DMA under certain
...
except during horizontal and  [vertical blanking](../Hardware_Manual_guide/node0169.html) .
...
time. If you want to  [scroll a playfield](../Hardware_Manual_guide/node0086.html) , one extra data word per line must
be fetched from the memory.

 [Display size](../Hardware_Manual_guide/node006F.html)  is adjustable (see Chapter 3, "Playfield Hardware"), and
bitplane DMA takes precedence over sprite DMA.  As shown in  [Figure 6-9](../Hardware_Manual_guide/node02D4.html) 
...
in register  [DMACON](../Hardware_Manual_guide/node0170.html) .
