...
```c
                ...
                * NOTE BFD=Blitter finished disable. When this bit
                 ...
                 There are two indirect jump registers,  [COP1LC](../Hardware_Manual_guide/node0028.html)  and
                  [COP2LC](../Hardware_Manual_guide/node0028.html) .  These are 18-bit pointer registers whose
                 ...
                 the program counter whenever strobe addresses
                  [COPJMP1](../Hardware_Manual_guide/node002B.html)  or  [COPJMP2](../Hardware_Manual_guide/node002B.html)  are written.  In addition,
                  [COP1LC](../Hardware_Manual_guide/node0028.html)  is automatically used at the beginning of
