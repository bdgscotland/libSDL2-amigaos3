...
The  [sampling period](../Hardware_Manual_guide/node00DD.html)  is limited by the number of DMA cycles allocated to
...
per sample (1/28,867 = .000034642). The formula for calculating the
 [sampling period](../Hardware_Manual_guide/node00DD.html)  is:
...
Therefore, a value of at least 124 must be written into the
 [period register](../Hardware_Manual_guide/node00DF.html#line34)  to assure that the audio system DMA will be able to
...
written into the  [period register](../Hardware_Manual_guide/node00DF.html#line34) .
