...
have  [shift registers](../Hardware_Manual_guide/node011F.html#line23) , and one has a first and last word  [mask register](../Hardware_Manual_guide/node011F.html#line61) .
...
( [BLTCON0](../Hardware_Manual_guide/node001A.html) ).
...
transfer is complete, the blitter will signal the processor with a  [flag](../Hardware_Manual_guide/node0125.html) 
and an interrupt.
...
However,  [shifting](../Hardware_Manual_guide/node011F.html)  and  [masking](../Hardware_Manual_guide/node011F.html#line42)  operations may require an extra word be
...
BLTxPTL).
   ...
   ECS version of the custom chips, up to  [32K by 32K pixel blits](../Hardware_Manual_guide/node00AA.html)  are
