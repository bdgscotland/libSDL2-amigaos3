---
title: 5 Audio Hardware / The Equal-tempered Musical Scale
manual: hardware
chapter: hardware
section: 5-audio-hardware-the-equal-tempered-musical-scale
functions: []
libraries: []
---
...
octave when the sample size is 16 bytes.  The " [Period](hardware/5-forming-and-playing-a-sound-selecting-the-data-output-rate.md) " column gives the
period count you enter into the  [period register](hardware/5-selecting-the-data-output-rate-specifying-the-period-value.md) . The length register
 [AUDxLEN](hardware/5-forming-and-playing-a-sound-telling-the-system-about-the.md)  should be set to 8  (16 bytes = 8 words). The sample should
...
The table above shows the  [period values](hardware/5-selecting-the-data-output-rate-specifying-the-period-value.md)  to use with a 16 byte sample to
...
When you double the  [period](hardware/5-forming-and-playing-a-sound-selecting-the-data-output-rate.md) , the time between each sample is doubled so
...
Thus, if you play a C with a  [period value](hardware/5-selecting-the-data-output-rate-specifying-the-period-value.md)  of 214, then playing the same
sample with a  [period value](hardware/5-forming-and-playing-a-sound-selecting-the-data-output-rate.md)  of 428 will play a C in the next lower octave.
...
of a note.  To avoid  [aliasing distortion](hardware/5-producing-high-quality-sound-aliasing-distortion.md)  with these samples you should
use  [period values](hardware/5-selecting-the-data-output-rate-specifying-the-period-value.md)  in the range 124-256 only.   [Periods](hardware/5-forming-and-playing-a-sound-selecting-the-data-output-rate.md)  from 124-256
correspond to playback rates in the range 14-28K samples per second which
makes the most effective use of the Amiga's 7 KHz  [cut-off filter](hardware/5-producing-high-quality-sound-low-pass-filter.md)  to
...
to adjust the  [period value](hardware/5-forming-and-playing-a-sound-selecting-the-data-output-rate.md)  over its full range 124-65536.  This is
easier for the programmer but can produce undesirable high-frequency noise
in the resulting tone.  Read the section called  [Aliasing Distortion](hardware/5-producing-high-quality-sound-aliasing-distortion.md)  for
more about this.

The values in Table 5-7 were generated using the formula shown below.  To
calculate the tone generated with a given sample size and  [period](hardware/5-forming-and-playing-a-sound-selecting-the-data-output-rate.md)  use:
...
values were derived using the formula above.  Notice that in each octave
 [period values](hardware/5-selecting-the-data-output-rate-specifying-the-period-value.md)  are the same but the sample size is halved.  The samples
...
```c
        ...
        ------  ------   ----   --------- -----------  ----------
         ...
         135     133      G#     103.82     103.57      104.17
               ...
               Sample size = 256 bytes,  [AUDxLEN](hardware/5-forming-and-playing-a-sound-telling-the-system-about-the.md)  = 128
         ...
         135     133      G#     207.65     207.15      208.35
               ...
               Sample size = 128 bytes,  [AUDxLEN](hardware/5-forming-and-playing-a-sound-telling-the-system-about-the.md)  = 64
         ...
         135     133      G#     415.30     414.30      416.70
                ...
                Sample size = 64 bytes,  [AUDxLEN](hardware/5-forming-and-playing-a-sound-telling-the-system-about-the.md)  = 32
         ...
         135     133      G#     830.61     828.60      833.39
                ...
                Sample size = 32 bytes,  [AUDxLEN](hardware/5-forming-and-playing-a-sound-telling-the-system-about-the.md)  = 16
         ...
         135     133      G#     1661.2    1657.2      1666.8
                ...
                Sample size = 16 bytes,  [AUDxLEN](hardware/5-forming-and-playing-a-sound-telling-the-system-about-the.md)  = 8
