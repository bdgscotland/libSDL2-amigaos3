---
title: A Register Summary / BLTCON0, BLTCON1
manual: hardware
chapter: hardware
section: a-register-summary-bltcon0-bltcon1
functions: []
libraries: []
---
...
BLTCON1    042      W      A( [E](hardware/c-ecs-hardware-and-the-graphics-library-other-ecs.md) )  Blitter control register 1
