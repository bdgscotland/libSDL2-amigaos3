...
manual: hardware
chapter: hardware
section: k-signal-description-system-control-signals-2
functions: []
libraries: []
---
...
Hardware Bus Error/Interrupt (/BERR)
   ...
   drive with an  [open collector](hardware/k-expansion-bus-loading-open-collector-signals.md)  or similar device, and any device that
...
```c
    [open-collector](hardware/k-expansion-bus-loading-open-collector-signals.md)  output, or the equivalent, and pulled up by a
```
   backplane resistor.
...
System Interrupts
   ...
   each line must be driven by an  [open-collector](hardware/k-expansion-bus-loading-open-collector-signals.md)  or equivalent output
   ...
   the  [quick interrupt](hardware/k-zorro-iii-bus-architecture-quick-interrupts.md)  protocol described in the Bus Architecture
