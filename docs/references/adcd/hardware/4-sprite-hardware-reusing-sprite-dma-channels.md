---
title: 4 Sprite Hardware / Reusing Sprite DMA Channels
manual: hardware
chapter: hardware
section: 4-sprite-hardware-reusing-sprite-dma-channels
functions: []
libraries: []
---
...
Each of the eight sprite  [DMA channels](hardware/4-displaying-sprite-selecting-dma-channel-and-setting.md)  can produce more than one
...
because you have  [attached](hardware/4-sprite-hardware-attached-sprites.md)  some of the sprites to produce more colors or
larger objects or  [overlapped](hardware/4-sprite-hardware-overlapped-sprites.md)  some to produce more complex images. You
can reuse each sprite  [DMA channel](hardware/4-displaying-sprite-selecting-dma-channel-and-setting.md)  several times within the same display
...
In single-sprite usage, two all-zero words are placed at the end of the
 [data structure](hardware/4-forming-a-sprite-building-the-data-structure.md)  to stop the DMA channel from retrieving any more data for
...
you replace this pair of zero words with another complete sprite
 [data structure](hardware/4-forming-a-sprite-building-the-data-structure.md) , which describes the reuse of the DMA channel at a
position lower on the screen than the first use. You place the two
all-zero words at the end of the  [data structure](hardware/4-forming-a-sprite-building-the-data-structure.md)  that contains the
information for all usages of the DMA channel. For example, Figure 4-10
shows the  [data structure](hardware/4-forming-a-sprite-building-the-data-structure.md)  that describes the picture above.
...
needs the time during the blank line to fetch the  [control word](hardware/4-forming-a-sprite-building-the-data-structure.md) 
...
data list is shown here. However, the sprite looks best with the
 [color registers](hardware/4-sprite-hardware-summary-of-sprite-color-registers.md)  set as shown in the example.
