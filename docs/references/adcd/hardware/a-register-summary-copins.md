---
title: A Register Summary / COPINS
manual: hardware
chapter: hardware
section: a-register-summary-copins
functions: []
libraries: []
---
...
```c
                ...
                * NOTE BFD=Blitter finished disable. When this bit
                 ...
                 There are two indirect jump registers,  [COP1LC](hardware/a-register-summary-cop1lch-cop1lcl-cop2lch-cop2lcl.md)  and
                  [COP2LC](hardware/a-register-summary-cop1lch-cop1lcl-cop2lch-cop2lcl.md) .  These are 18-bit pointer registers whose
                 ...
                 the program counter whenever strobe addresses
                  [COPJMP1](hardware/a-register-summary-copjmp1-copjmp2.md)  or  [COPJMP2](hardware/a-register-summary-copjmp1-copjmp2.md)  are written.  In addition,
                  [COP1LC](hardware/a-register-summary-cop1lch-cop1lcl-cop2lch-cop2lcl.md)  is automatically used at the beginning of
