---
title: Includes/libraries/commodities.i
manual: autodocs-2.0
chapter: autodocs-2.0
section: includes-libraries-commodities-i
functions: [BrokerCommand, CxBroker, CxObjError]
...
- [BrokerCommand — commodities.library](../autodocs/commodities.library.md#brokercommand)
