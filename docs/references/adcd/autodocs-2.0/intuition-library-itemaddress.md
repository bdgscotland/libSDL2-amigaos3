...
section: intuition-library-itemaddress
functions: []
libraries: []
---
...
```c
    ItemAddress -- Returns the address of the specified [MenuItem](autodocs-2.0/includes-intuition-intuition-h.md).
```
SYNOPSIS
...
```c
    ...
    struct [MenuItem](autodocs-2.0/includes-intuition-intuition-h.md) *ItemAddress( struct [Menu](autodocs-2.0/includes-intuition-intuition-h.md) *, UWORD );
```
FUNCTION
