...
section: graphics-library-getsprite
...
```c
    ...
    SHORT GetSprite( struct [SimpleSprite](autodocs-2.0/includes-graphics-sprite-h.md) *, SHORT );
```
FUNCTION
...
```c
    sprite - ptr to programmers [SimpleSprite](autodocs-2.0/includes-graphics-sprite-h.md) structure.
...
```c
    ...
    of [SimpleSprite](autodocs-2.0/includes-graphics-sprite-h.md) structure.
    If the sprite is available for allocation, mark it allocated
    and fill in the 'num' entry of the [SimpleSprite](autodocs-2.0/includes-graphics-sprite-h.md) structure.
...
```c
    [FreeSprite()](autodocs-2.0/graphics-library-freesprite.md) [ChangeSprite()](autodocs-2.0/graphics-library-changesprite.md) [MoveSprite()](autodocs-2.0/graphics-library-movesprite.md) GetSprite() [graphics/sprite.h](autodocs-2.0/includes-graphics-sprite-h.md)
```
