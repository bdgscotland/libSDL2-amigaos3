---
title: Text_Autodocs/icon.doc
manual: autodocs-2.0
chapter: autodocs-2.0
section: text-autodocs-icon-doc
functions: [AddFreeList, DeleteDiskObject, FindToolType, FreeDiskObject, FreeEntry, FreeFreeList, GetDiskObject, GetDiskObjectNew, IoErr, MatchToolValue, PutDiskObject]
