---
title: References/Function.offs
manual: autodocs-2.0
chapter: autodocs-2.0
section: references-function-offs
functions: [AllocFileRequest, AllocIFF, AskKeyMapDefault, CacheClearU, Cli, CloseWorkBench, ColdReboot, CreateMsgPort, Disable, DisownBlitter, Enable, Forbid, GetArgStr, GetCC, GetProgramDir, Input, IoErr, LockPubScreenList, MaxCli, NewLayerInfo, NewRegion, OpenWorkBench, Output, OwnBlitter, PeekQualifier, Permit, RemakeDisplay, RethinkDisplay, SumKickData, SuperState, UnlockPubScreenList, VBeamPos, ViewAddress, WBenchToBack, WBenchToFront, WaitBlit, WaitPkt, WaitTOF]
libraries: [asl.library, dos.library, exec.library, graphics.library, iffparse.library, input.device, intuition.library, keymap.library, layers.library]
---
