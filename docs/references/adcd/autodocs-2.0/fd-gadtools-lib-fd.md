---
title: FD/gadtools_lib.fd
manual: autodocs-2.0
chapter: autodocs-2.0
section: fd-gadtools-lib-fd
functions: []
libraries: []
---
...
* Menu functions
*
CreateMenusA(newmenu,taglist)(a0/a1)
FreeMenus(menu)(a0)
...
GT_FilterIMsg(imsg)(a1)
GT_PostFilterIMsg(imsg)(a1)
CreateContext(glistptr)(a0)
*
* Rendering Functions
*
