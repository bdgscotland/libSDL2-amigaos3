...
section: graphics-library-mrgcop
functions: [InitVPort, LoadView, MakeVPort, RethinkDisplay]
...
```c
    MrgCop( [View](autodocs-2.0/includes-graphics-view-h.md) )
            A1

    void MrgCop( struct [View](autodocs-2.0/includes-graphics-view-h.md) * );
```
FUNCTION
...
```c
    [View](autodocs-2.0/includes-graphics-view-h.md) - a pointer to the view structure whose coprocessor
...
```c
    ...
    this new instruction stream through the instruction [LoadView()](autodocs-2.0/graphics-library-loadview.md).
```
BUGS
...
```c
    [InitVPort()](autodocs-2.0/graphics-library-initvport.md) [MakeVPort()](autodocs-2.0/graphics-library-makevport.md) [LoadView()](autodocs-2.0/graphics-library-loadview.md) [graphics/view.h](autodocs-2.0/includes-graphics-view-h.md)
