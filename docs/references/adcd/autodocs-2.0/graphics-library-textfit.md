...
```c
    ...
    ULONG TextFit(struct [RastPort](autodocs-2.0/includes-graphics-rastport-h.md) *, STRPTR, UWORD,
        struct [TextExtent](autodocs-2.0/includes-graphics-text-h.md) *, struct [TextExtent](autodocs-2.0/includes-graphics-text-h.md) *, WORD, UWORD, UWORD);
```
FUNCTION
...
```c
    ...
    -   the [RastPort](autodocs-2.0/includes-graphics-rastport-h.md) rp's rp_TxSpacing sign and magnitude is so
...
```c
    [TextExtent()](autodocs-2.0/graphics-library-textextent.md)  [TextLength()](autodocs-2.0/graphics-library-textlength.md)  [Text()](autodocs-2.0/graphics-library-text.md)
