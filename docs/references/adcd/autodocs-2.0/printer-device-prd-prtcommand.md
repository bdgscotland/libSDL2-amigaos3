...
section: printer-device-prd-prtcommand
functions: []
libraries: []
---
...
IO REQUEST [IOPrtCmdReq](autodocs-2.0/includes-devices-printer-h.md)
...
```c
    printer.device/Write printer.h, parallel.device, [Preferences](autodocs-2.0/includes-intuition-preferences-h.md)
```
