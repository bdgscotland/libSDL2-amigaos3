...
section: intuition-library-setwindowtitles
...
```c
    SetWindowTitles( [Window](autodocs-2.0/includes-intuition-intuition-h.md), WindowTitle, ScreenTitle )
                     A0      A1           A2

    VOID SetWindowTitles( struct [Window](autodocs-2.0/includes-intuition-intuition-h.md) *, UBYTE *, UBYTE * );
```
FUNCTION

```c
    Allows you to set the text which appears in the [Window](autodocs-2.0/includes-intuition-intuition-h.md) and/or [Screen](autodocs-2.0/includes-intuition-screens-h.md)
    title bars.
    ...
    screen, as set using [OpenScreen()](autodocs-2.0/intuition-library-openscreen.md).
    ...
    in the newer versions.  The function [RefreshWindowFrame()](autodocs-2.0/intuition-library-refreshwindowframe.md) is provided
    to do this kind of thing for you.
```
INPUTS

```c
    [Window](autodocs-2.0/includes-intuition-intuition-h.md) = pointer to your window structure
...
```c
    [OpenWindow()](autodocs-2.0/intuition-library-openwindow.md), [RefreshWindowFrame()](autodocs-2.0/intuition-library-refreshwindowframe.md), [OpenScreen()](autodocs-2.0/intuition-library-openscreen.md)
```
