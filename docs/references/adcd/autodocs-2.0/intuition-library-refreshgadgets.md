...
```c
    RefreshGadgets( Gadgets, [Window](autodocs-2.0/includes-intuition-intuition-h.md), [Requester](autodocs-2.0/includes-intuition-intuition-h.md) )
                    A0       A1      A2

    VOID RefreshGadgets( struct [Gadget](autodocs-2.0/includes-intuition-intuition-h.md) *, struct [Window](autodocs-2.0/includes-intuition-intuition-h.md) *,
...
```c
    ...
    The Pointer argument points to a [Window](autodocs-2.0/includes-intuition-intuition-h.md) structure.
    ...
    that gadget from the window's gadget list, using [RemoveGadget()](autodocs-2.0/intuition-library-removegadget.md) (or
    ...
    (using [AddGadget()](autodocs-2.0/intuition-library-addgadget.md) or [AddGList()](autodocs-2.0/intuition-library-addglist.md)).  Adding gadgets does not cause
    them to be displayed (refreshed), so this function, or [RefreshGList()](autodocs-2.0/intuition-library-refreshglist.md)
    is typically called.
    ...
    this and be completely proper, you must [RemoveGadget()](autodocs-2.0/intuition-library-removegadget.md), change the
    GFLG_SELECTED flag, [AddGadget()](autodocs-2.0/intuition-library-addgadget.md), and RefreshGadgets(), or the
    equivalent.

    The gadgets argument can be a copy of the FirstGadget variable in
    the [Window](autodocs-2.0/includes-intuition-intuition-h.md) structure that you want refreshed:
    ...
    Even more control is available using the [RefreshGList()](autodocs-2.0/intuition-library-refreshglist.md) routine which
...
```c
    ...
    [Requester](autodocs-2.0/includes-intuition-intuition-h.md) = pointer to a requester (ignored if gadget is not attached
        to a requester).
```
RESULT
...
```c
    [RefreshGList()](autodocs-2.0/intuition-library-refreshglist.md), [RemoveGadget()](autodocs-2.0/intuition-library-removegadget.md), [RemoveGList()](autodocs-2.0/intuition-library-removeglist.md), [AddGadget()](autodocs-2.0/intuition-library-addgadget.md), [AddGList()](autodocs-2.0/intuition-library-addglist.md)
```
