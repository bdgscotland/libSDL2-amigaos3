---
title: Text_Autodocs/intuition.doc
manual: autodocs-2.0
chapter: autodocs-2.0
section: text-autodocs-intuition-doc
functions: [ActivateGadget, AddClass, AddGList, AddGadget, Alert, AllocMem, AllocRemember, AutoRequest, BeginRefresh, BeginUpdate, BuildEasyRequestArgs, BuildSysRequest, ChangeWindowBox, ClearDMRequest, ClearMenuStrip, ClearPointer, CloseScreen, CloseWindow, CloseWorkBench, CurrentTime, DisplayAlert, DisplayBeep, DisposeObject, DrawImage, DrawImageState, EasyRequestArgs, EndRefresh, EndUpdate, EraseImage, EraseRect, Forbid, FreeClass, FreeMem, FreeRemember, FreeScreenDrawInfo, FreeSysRequest, GetAttr, GetColorMap, GetDefPrefs, GetPrefs, GetScreenData, GetScreenDrawInfo, GetVPModeID, InstallClipRegion, InstallLayerHook, LoadView, LockIBase, LockLayerInfo, LockPubScreen, LockPubScreenList, MakeClass, MakeScreen, MakeVPort, ModeNotAvailable, ModifyIDCMP, ModifyProp, MoveLayerInFrontOf, MoveSizeLayer, MoveWindow, MoveWindowInFrontOf, MrgCop, NewModifyProp, NewObject, NextObject, ObtainGIRPort, ObtainSemaphore, OffMenu, OnMenu, OpenDiskFont, OpenScreen, OpenScreenTagList, OpenWindow, OpenWindowTagList, OpenWorkBench, Permit, PrintIText, PubScreenStatus, QueryOverscan, RawDoFmt, RefreshGList, RefreshGadgets, RefreshWindowFrame, ReleaseGIRPort, RemakeDisplay, RemoveClass, RemoveGList, RemoveGadget, ReportMouse, Request, ResetMenuStrip, RethinkDisplay, ScreenToBack, ScreenToFront, SetAttrsA, SetDMRequest, SetDefaultPubScreen, SetFunction, SetGadgetAttrsA, SetMenuStrip, SetMouseQueue, SetPointer, SetPrefs, SetPubScreenModes, SetWindowTitles, ShowTitle, SizeWindow, SysReqHandler, UnlockIBase, UnlockLayerRom, UnlockPubScreen, UnlockPubScreenList, ViewAddress, WBenchToBack, WBenchToFront, Wait, WaitPort, WindowLimits, WindowToBack, WindowToFront, ZipWindow]
libraries: [diskfont.library, exec.library, graphics.library, intuition.library, layers.library]
---
