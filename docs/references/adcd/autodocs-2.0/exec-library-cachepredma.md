...
section: exec-library-cachepredma
functions: []
libraries: []
---
...
```c
    exec/execbase.i, [CachePostDMA](autodocs-2.0/exec-library-cachepostdma.md), [CacheClearU](autodocs-2.0/exec-library-cacheclearu.md), [CacheClearE](autodocs-2.0/exec-library-cachecleare.md)
```
