---
title: Text_Autodocs/graphics.doc
manual: autodocs-2.0
chapter: autodocs-2.0
section: text-autodocs-graphics-doc
functions: [AddAnimOb, AddFont, AddVSprite, Alert, AllocRaster, AndRectRegion, AndRegionRegion, Animate, AreaCircle, AreaDraw, AreaEllipse, AreaEnd, AreaMove, AskSoftStyle, BltBitMap, BltBitMapRastPort, BltMaskBitMapRastPort, ChangeSprite, ClearEOL, ClearScreen, ClipBlit, CloseFont, CloseMonitor, CopySBitMap, DisownBlitter, DisplayBeep, DoCollision, Draw, DrawGList, FindDisplayInfo, Flood, FreeColorMap, FreeGBuffers, FreeMem, FreeRaster, FreeSprite, GetColorMap, GetDisplayInfoData, GetGBuffers, GetRGB4, GetSprite, GetVPModeID, GfxAssociate, GfxFree, GfxLookUp, GfxNew, InitArea, InitGels, InitMasks, InitTmpRas, InitVPort, LoadRGB4, LoadView, LockLayer, LockLayerRom, MakeScreen, MakeVPort, ModeNotAvailable, Move, MoveSprite, MrgCop, NewRegion, NextDisplayInfo, OpenDiskFont, OpenFont, OpenMonitor, OrRectRegion, OrRegionRegion, OwnBlitter, QBSBlit, QBlit, ReadPixel, ReadPixelLine8, RectFill, RemFont, RemIBob, RemVSprite, RemakeDisplay, RethinkDisplay, ScalerDiv, SetAPen, SetBPen, SetFont, SetRGB4, SetRast, SetSoftStyle, Signal, SortGList, StripFont, SyncSBitMap, Text, TextExtent, TextFit, TextLength, UnlockLayer, UnlockLayerRom, VBeamPos, Wait, WaitBlit, WaitTOF, Write, WritePixel]
libraries: [diskfont.library, dos.library, exec.library, graphics.library, intuition.library, layers.library]
---
