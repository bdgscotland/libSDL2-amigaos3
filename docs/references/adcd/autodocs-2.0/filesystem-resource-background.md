...
section: filesystem-resource-background
functions: []
libraries: []
---
...
```c
    ...
    [resources/filesysres.h](autodocs-2.0/includes-resources-filesysres-h.md).  The nodes on it describe how to
    algorithmically convert the result of [MakeDosNode](autodocs-2.0/expansion-library-makedosnode.md) (from the
    expansion.library) to a node appropriate for the dos type.

    [FileSysEntry](autodocs-2.0/includes-resources-filesysres-h.md)
        ...
        fse_Startup         startup msg: [FileSysStartupMsg](autodocs-2.0/includes-dos-filehandler-h.md) for disks
