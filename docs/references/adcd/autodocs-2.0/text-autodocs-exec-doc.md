---
title: Text_Autodocs/exec.doc
manual: autodocs-2.0
chapter: autodocs-2.0
section: text-autodocs-exec-doc
functions: [AbortIO, AddIntServer, AddPort, Alert, AllocMem, AllocVec, Allocate, AttemptSemaphore, CacheClearE, CacheClearU, CheckIO, CloseDevice, ColdReboot, CreateIORequest, CreateMsgPort, DeleteIORequest, DeleteMsgPort, Disable, DoIO, Enable, FindPort, FindTask, Forbid, GetCC, GetMsg, InitResident, InitSemaphore, LoadSeg, ObtainSemaphore, ObtainSemaphoreList, ObtainSemaphoreShared, OpenDevice, Permit, Procure, RawDoFmt, ReleaseSemaphore, ReleaseSemaphoreList, RemPort, RemTask, Remove, ReplyMsg, SetFunction, SumKickData, SumLibrary, SuperState, Supervisor, Vacate, Wait, WaitIO, WaitPort]
libraries: [dos.library, exec.library, timer.device]
---
