...
```c
    ...
    LONG GetRexxVar(struct [RexxMsg](autodocs-2.0/includes-rexx-storage-h.md) *,char *,char **);
```
FUNCTION
...
```c
    ...
    This routine does a [CheckRexxMsg()](autodocs-2.0/amiga-lib-checkrexxmsg.md) on the message.
```
EXAMPLE
...
```c
    [SetRexxVar()](autodocs-2.0/amiga-lib-setrexxvar.md), [CheckRexxMsg()](autodocs-2.0/amiga-lib-checkrexxmsg.md)
```
