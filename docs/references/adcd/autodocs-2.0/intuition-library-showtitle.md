...
section: intuition-library-showtitle
functions: []
libraries: []
---
...
```c
    ShowTitle( [Screen](autodocs-2.0/includes-intuition-screens-h.md), ShowIt )
               A0      D0

    VOID ShowTitle( struct [Screen](autodocs-2.0/includes-intuition-screens-h.md) *, BOOL );
```
FUNCTION
