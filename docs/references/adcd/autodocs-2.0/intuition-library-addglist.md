...
section: intuition-library-addglist
...
```c
    RealPosition = AddGList( [Window](autodocs-2.0/includes-intuition-intuition-h.md), [Gadget](autodocs-2.0/includes-intuition-intuition-h.md), Position, Numgad, [Requester](autodocs-2.0/includes-intuition-intuition-h.md) )
    D0                       A0      A1      D0        D1      A2

    UWORD AddGList( struct [Window](autodocs-2.0/includes-intuition-intuition-h.md) *, struct [Gadget](autodocs-2.0/includes-intuition-intuition-h.md) *, UWORD, WORD,
...
```c
    ...
    See [AddGadget()](autodocs-2.0/intuition-library-addgadget.md) for more information about gadget list position,
...
```c
    ...
    [Gadget](autodocs-2.0/includes-intuition-intuition-h.md) = pointer to the first gadget to be added
    ...
    [Requester](autodocs-2.0/includes-intuition-intuition-h.md) = the requester the gadgets will be added to if the
...
```c
    [AddGadget()](autodocs-2.0/intuition-library-addgadget.md), [RemoveGadget()](autodocs-2.0/intuition-library-removegadget.md), [RemoveGList()](autodocs-2.0/intuition-library-removeglist.md)
```
