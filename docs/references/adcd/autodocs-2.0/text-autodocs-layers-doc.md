---
title: Text_Autodocs/layers.doc
manual: autodocs-2.0
chapter: autodocs-2.0
section: text-autodocs-layers-doc
functions: [CloseWindow, DeleteLayer, DisposeLayerInfo, LockLayerInfo, NewLayerInfo, UnlockLayer, UnlockLayerInfo, WaitBlit]
