---
title: Text_Autodocs/commodities.doc
manual: autodocs-2.0
chapter: autodocs-2.0
section: text-autodocs-commodities-doc
functions: [ActivateCxObj, AttachCxObj, ClearCxObjError, CreateCxObj, CxBroker, CxObjError, DeleteCxObj, DeleteCxObjAll, DivertCxMsg, EnqueueCxObj, InsertCxObj, MapANSI, RouteCxMsg, SetCxObjPri, SetFilter, SetFilterIX]
libraries: [commodities.library, keymap.library]
---
