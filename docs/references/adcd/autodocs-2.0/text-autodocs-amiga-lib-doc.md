---
title: Text_Autodocs/amiga_lib.doc
manual: autodocs-2.0
chapter: autodocs-2.0
section: text-autodocs-amiga-lib-doc
functions: [AllocSignal, CallHookPkt, CreateCxObj, CreateIORequest, CreateMsgPort, CreateNewProc, CxMsgID, CxObjError, DoIO, FindPort, FindTask, FindToolType, GetDiskObject, Open, Output, ParseIX, PutMsg, RawDoFmt, RemTask, ReplyMsg, SendIO, SetFilter, SetFilterIX, SetTranslate, Signal, WaitIO]
libraries: [commodities.library, dos.library, exec.library, icon.library, utility.library]
---
