---
title: exec.library/AllocEntry
manual: autodocs-2.0
chapter: autodocs-2.0
section: exec-library-allocentry
functions: []
libraries: []
---
...
```c
    ...
    struct [MemList](autodocs-2.0/includes-exec-memory-h.md) *AllocEntry(struct [MemList](autodocs-2.0/includes-exec-memory-h.md) *);
```
FUNCTION

```c
    This function takes a memList structure and allocates enough memory
    to hold the required memory as well as a [MemList](autodocs-2.0/includes-exec-memory-h.md) structure to keep
    track of it.

    These [MemList](autodocs-2.0/includes-exec-memory-h.md) structures may be linked together in a task control
...
```c
    memList -- A [MemList](autodocs-2.0/includes-exec-memory-h.md) structure filled in with [MemEntry](autodocs-2.0/includes-exec-memory-h.md) structures.
```
RESULTS

```c
    memList -- A different [MemList](autodocs-2.0/includes-exec-memory-h.md) filled in with the actual memory
