...
```c
    ...
    void ObtainSemaphore(struct [SignalSemaphore](autodocs-2.0/includes-exec-semaphores-h.md) *);
```
FUNCTION

```c
    [Signal](autodocs-2.0/exec-library-signal.md) semaphores are used to gain exclusive access to an object.
    ...
    [ReleaseSemaphore()](autodocs-2.0/exec-library-releasesemaphore.md) is called.  When the counter returns to zero the
    ...
    [Signal](autodocs-2.0/exec-library-signal.md) Semaphores are different than [Procure()/Vacate()](autodocs-2.0/exec-library-vacate.md) semaphores.
...
```c
    [ObtainSemaphoreShared()](autodocs-2.0/exec-library-obtainsemaphoreshared.md), [InitSemaphore()](autodocs-2.0/exec-library-initsemaphore.md), [ReleaseSemaphore()](autodocs-2.0/exec-library-releasesemaphore.md),
    [AttemptSemaphore()](autodocs-2.0/exec-library-attemptsemaphore.md), [ObtainSemaphoreList()](autodocs-2.0/exec-library-obtainsemaphorelist.md)
```
