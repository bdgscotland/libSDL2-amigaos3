...
```c
    ...
    to [SystemTagList()](autodocs-2.0/dos-library-systemtaglist.md)).
...
```c
    [SystemTagList()](autodocs-2.0/dos-library-systemtaglist.md), NewShell, EndCLI, Run
```
