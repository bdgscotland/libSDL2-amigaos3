...
section: audio-device-adcmd-allocate
functions: []
libraries: []
---
...
```c
    ...
    to allocate again whenever [ADCMD_FREE](autodocs-2.0/audio-device-adcmd-free.md) frees channels or [ADCMD_SETPREC](autodocs-2.0/audio-device-adcmd-setprec.md)
...
```c
    ...
    ioa_AllocKey- allocation key, zero to generate new key; otherwise,
                  ...
                  [OpenDevice](autodocs-2.0/audio-device-opendevice.md) function or previous ADCMD_ALLOCATE command
