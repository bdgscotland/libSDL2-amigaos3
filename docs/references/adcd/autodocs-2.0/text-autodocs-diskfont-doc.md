---
title: Text_Autodocs/diskfont.doc
manual: autodocs-2.0
chapter: autodocs-2.0
section: text-autodocs-diskfont-doc
functions: [AvailFonts, OpenDiskFont, StripFont, UnLoadSeg]
libraries: [diskfont.library, dos.library, graphics.library]
---
