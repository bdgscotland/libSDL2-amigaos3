...
functions: [BeginRefresh, ChangeWindowBox, CloseWindow, EndRefresh, Forbid, InstallLayerHook, LockPubScreen, ModifyIDCMP, MoveWindow, OpenScreen, OpenScreenTagList, OpenWindow, OpenWindowTagList, ReportMouse, SetDefaultPubScreen, SetMouseQueue, SetPubScreenModes, SetWindowTitles, SizeWindow, UnlockPubScreen, Wait, WindowLimits, ZipWindow]
...
```c
    [Window](autodocs-2.0/includes-intuition-intuition-h.md) = OpenWindow( [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) )
    D0                   A0

    struct [Window](autodocs-2.0/includes-intuition-intuition-h.md) *OpenWindow( struct [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) * );
```
FUNCTION

```c
    Opens an Intuition window of the given dimensions and position,
    with the properties specified in the [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) structure.
    ...
    you can provide extensions to the [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) parameters using
    and array of [TagItem](autodocs-2.0/includes-utility-tagitem-h.md) structures.  See the discussion below,
    and the documentation for the function [OpenScreenTagList()](autodocs-2.0/intuition-library-openscreentaglist.md).

    Before you call OpenWindow(), you must initialize an instance of
    a [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) structure.  [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) is a structure that contains
    all of the arguments needed to open a window.  The [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md)
    structure may be discarded immediately after it is used to open
    the window.

    If Type == CUSTOMSCREEN, you must have opened your own screen
    already via a call to [OpenScreen()](autodocs-2.0/intuition-library-openscreen.md).  Then Intuition uses your screen
    ...
    [SetPubScreenModes()](autodocs-2.0/intuition-library-setpubscreenmodes.md).
    ...
    reasons, we could not add the 'Extension' field to the [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md)
    structure, so we have define a new structure [ExtNewWindow](autodocs-2.0/includes-intuition-intuition-h.md), which
    is identical to [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) with the addition of the Extension field.

    We recommend that rather than using ExtNewWindow.Extension, you
    use the new Intuition function [OpenWindowTagList()](autodocs-2.0/intuition-library-openwindowtaglist.md) and its
    varargs equivalent OpenWindowTags().  We document the window
    attribute tag ID's (ti_Tag values) here, rather than in
    [OpenWindowTagList()](autodocs-2.0/intuition-library-openwindowtaglist.md), so that you can find all the parameters
...
INPUTS
```c
    [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) = pointer to an instance of a [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) structure.  That
...
```c
    ...
    Flags = specifiers for your requirements of this window, including:
        ...
        - WFLG_REPORTMOUSE for whether or not you want to "listen" to
          ...
          [ReportMouse()](autodocs-2.0/intuition-library-reportmouse.md).  Whether or not your window is listening to
        ...
        - WFLG_NOCAREREFRESH indicates that you do not wish to
          be responsible for calling [BeginRefresh()](autodocs-2.0/intuition-library-beginrefresh.md) and [EndRefresh()](autodocs-2.0/intuition-library-endrefresh.md)
        ...
        - WFLG_NW_EXTENDED (V36) indicates that [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) in fact points
          to an [ExtNewWindow](autodocs-2.0/includes-intuition-intuition-h.md) structure, and that the 'Extension'
          field points to an array of [TagItem](autodocs-2.0/includes-utility-tagitem-h.md) structures, with
          meaning described below.

    IDCMPFlags = IDCMP is the acronym for Intuition Direct Communications
        [Message](autodocs-2.0/includes-exec-ports-h.md) Port.  (It's Intuition's sole acronym.) If any of the
        ...
        - IDCMP_MENUVERIFY (see immediately below), specifies that you
          ...
          about to be blasted into your [Window](autodocs-2.0/includes-intuition-intuition-h.md).  If you're drawing
        ...
        - IDCMP_SIZEVERIFY means that you will be doing output to your
          ...
          Intuition will send you the IDCMP_SIZEVERIFY message and [Wait()](autodocs-2.0/exec-library-wait.md)
          until you reply that it's OK to proceed with the sizing. NOTE:
          when we say that Intuition will [Wait()](autodocs-2.0/exec-library-wait.md) until you reply, what
          ...
          IDCMP [Message](autodocs-2.0/includes-exec-ports-h.md) you receive, reply to it promptly!  Then, after
        ...
        lockup.  USE [ModifyIDCMP()](autodocs-2.0/intuition-library-modifyidcmp.md) TO TURN OFF ANY VERIFY MESSAGES
        ...
        - IDCMP_NEWPREFS indicates you wish to be notified when the
          system-wide [Preferences](autodocs-2.0/includes-intuition-preferences-h.md) changes.  For V36, there is a new
          environment mechanism to replace [Preferences](autodocs-2.0/includes-intuition-preferences-h.md), which we
        ...
        - IDCMP_CHANGEWINDOW is a new class for V36 that will be sent
          ...
          by the user or the functions [SizeWindow()](autodocs-2.0/intuition-library-sizewindow.md), [MoveWindow()](autodocs-2.0/intuition-library-movewindow.md),
          [ChangeWindowBox()](autodocs-2.0/intuition-library-changewindowbox.md), or [ZipWindow()](autodocs-2.0/intuition-library-zipwindow.md).
    ...
    Gadgets = the pointer to the first of a linked list of the your own
          Gadgets which you want attached to this [Window](autodocs-2.0/includes-intuition-intuition-h.md).  Can be NULL
          if you have no Gadgets of your own
```
   CheckMark = a pointer to an instance of the struct [Image](autodocs-2.0/includes-intuition-intuition-h.md) where can
...
```
   [Screen](autodocs-2.0/includes-intuition-screens-h.md) = if your type is one of Intuition's standard screens, then

```c
          this argument is ignored.  However, if Type == CUSTOMSCREEN,
          this must point to the structure of your own screen
```
   [BitMap](autodocs-2.0/includes-graphics-gfx-h.md) = if you have specified WFLG_SUPER_BITMAP as the type of
...
```c
          ...
          [Window](autodocs-2.0/includes-intuition-intuition-h.md) is opened by calling the [WindowLimits()](autodocs-2.0/intuition-library-windowlimits.md) routine.
          ...
          themselves to call [SizeWindow()](autodocs-2.0/intuition-library-sizewindow.md) (or [ChangeWindowBox()](autodocs-2.0/intuition-library-changewindowbox.md)) without
          ...
          See also the docs on the function [WindowLimits()](autodocs-2.0/intuition-library-windowlimits.md) for more
          information.
```
...
```c
        ...
        TagItems in general are described in [utility/tagitem.h](autodocs-2.0/includes-utility-tagitem-h.md),
        and the OpenWindow tags are defined in [intuition/intuition.h](autodocs-2.0/includes-intuition-intuition-h.md)
    ...
    (and [OpenWindowTagList()](autodocs-2.0/intuition-library-openwindowtaglist.md)).

    Certain tags simply override equivalent values in [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md),
    and allow you to open a window using [OpenWindowTagList()](autodocs-2.0/intuition-library-openwindowtaglist.md) without
    having a [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) structure at all.  In each case, cast
    ...
    WA_ScreenTitle - You can specify the screen title associated
        with your window this way, and avoid a call to [SetWindowTitles()](autodocs-2.0/intuition-library-setwindowtitles.md)
    ...
    WA_AutoAdjust - a Boolean attribute which says that it's OK
        ...
        if you call OpenWindowTags() or [OpenWindowTagList()](autodocs-2.0/intuition-library-openwindowtaglist.md)
        with a NULL [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md) pointer, this attribute defaults
        to TRUE).
    ...
    WA_PubScreen - Open as a visitor window on the public screen
        whose address if provided as (struct [Screen](autodocs-2.0/includes-intuition-screens-h.md) *) ti_Data.
        ...
        must either:
            ...
            3) use [LockPubScreen()](autodocs-2.0/intuition-library-lockpubscreen.md)
        Using [exec.library/Forbid()](autodocs-2.0/exec-library-forbid.md) is not sufficient.
    ...
    WA_MouseQueue - This tag specifies a limit for the number
        ...
        limit after the window is open using [SetMouseQueue()](autodocs-2.0/intuition-library-setmousequeue.md).
    ...
    WA_BackFill - ti_Data is a pointer to a [Hook](autodocs-2.0/includes-utility-hooks-h.md) structure that
        the Layers library will call when your window needs
        "backfilling."  See [layers.library/InstallLayerHook()](autodocs-2.0/layers-library-installlayerhook.md).
...
```c
    ...
    In each case, you must be sure not to specify a [NewWindow](autodocs-2.0/includes-intuition-intuition-h.md)
    ...
    you want a visitor window to be opened on:
        ...
        - Use [LockPubScreen()](autodocs-2.0/intuition-library-lockpubscreen.md) to prevent the screen from closing.
        ...
        [LockPubScreen()](autodocs-2.0/intuition-library-lockpubscreen.md) - obtain a pointer and a promise
        layout window       - adapt your window to the screen you will use
        OpenWindow()        - using the pointer you specify
        [UnlockPubScreen()](autodocs-2.0/intuition-library-unlockpubscreen.md)     - once your window is open, you can let go
    ...
    You should call [UnlockPubScreen()](autodocs-2.0/intuition-library-unlockpubscreen.md) after your visitor window is open.
...
```c
    If all is well, returns the pointer to your new [Window](autodocs-2.0/includes-intuition-intuition-h.md)
...
```c
    ...
    the window's [RastPort](autodocs-2.0/includes-graphics-rastport-h.md) to the font of the window's screen.
    This does not work right for GimmeZeroZero windows: the
    BorderRPort [RastPort](autodocs-2.0/includes-graphics-rastport-h.md) has the font set correctly, but
    ...
    default font of your window's [RastPort](autodocs-2.0/includes-graphics-rastport-h.md) if the screen's
    font is "fancy."  See the SA_SysFont attribute described
    under [OpenScreen()](autodocs-2.0/intuition-library-openscreen.md).
...
```
SEE ALSO
   [OpenWindowTagList()](autodocs-2.0/intuition-library-openwindowtaglist.md), [OpenScreen()](autodocs-2.0/intuition-library-openscreen.md), [ModifyIDCMP()](autodocs-2.0/intuition-library-modifyidcmp.md), [SetWindowTitles()](autodocs-2.0/intuition-library-setwindowtitles.md),

```c
    [LockPubScreen()](autodocs-2.0/intuition-library-lockpubscreen.md), [SetDefaultPubScreen()](autodocs-2.0/intuition-library-setdefaultpubscreen.md), [ZipWindow()](autodocs-2.0/intuition-library-zipwindow.md),
    [layers.library/InstallLayerHook()](autodocs-2.0/layers-library-installlayerhook.md), [SetPubScreenModes()](autodocs-2.0/intuition-library-setpubscreenmodes.md)
```
