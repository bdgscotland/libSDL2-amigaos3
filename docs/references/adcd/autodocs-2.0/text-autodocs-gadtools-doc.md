---
title: Text_Autodocs/gadtools.doc
manual: autodocs-2.0
chapter: autodocs-2.0
section: text-autodocs-gadtools-doc
functions: [AddGList, BeginRefresh, CloseScreen, CloseWindow, CreateGadgetA, CreateMenusA, DrawBevelBoxA, EndRefresh, FreeGadgets, FreeMenus, FreeVisualInfo, GT_BeginRefresh, GT_EndRefresh, GT_FilterIMsg, GT_GetIMsg, GT_PostFilterIMsg, GT_ReplyIMsg, GT_SetGadgetAttrsA, GetMsg, GetVisualInfoA, LayoutMenuItemsA, LayoutMenusA, LockPubScreen, OpenFont, RawDoFmt, RefreshGList, ReplyMsg, UnlockPubScreen]
libraries: [exec.library, gadtools.library, graphics.library, intuition.library]
---
