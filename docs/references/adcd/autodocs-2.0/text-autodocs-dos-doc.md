---
title: Text_Autodocs/dos.doc
manual: autodocs-2.0
chapter: autodocs-2.0
section: text-autodocs-dos-doc
functions: [AddDosEntry, AddPart, AddSegment, AllocDosObject, AssignAdd, AssignLate, AssignLock, AssignPath, AttemptLockDosList, ChangeMode, Cli, CliInitNewcli, CliInitRun, Close, CompareDates, CreateDir, CreateNewProc, DateStamp, DateToStr, Delay, DeleteVar, DoPkt, DupLock, DupLockFromFH, EndNotify, FGetC, FGets, FPrintf, FPutC, FPuts, FRead, FWrite, Fault, FilePart, FindArg, FindCliProc, FindDosEntry, FindSegment, FindVar, Forbid, Format, FreeArgs, FreeDeviceProc, FreeDosObject, GetArgStr, GetDeviceProc, GetMsg, GetProgramDir, GetVar, Info, Input, IoErr, IsFileSystem, LoadSeg, Lock, LockDosList, LockRecord, LockRecords, MakeLink, MatchEnd, MatchFirst, MatchNext, MatchPattern, MatchPatternNoCase, MaxCli, NameFromFH, NameFromLock, NextDosEntry, Open, OpenFromLock, Output, ParentDir, ParentOfFH, ParsePattern, ParsePatternNoCase, PathPart, Permit, PrintFault, Printf, PutMsg, PutStr, RawDoFmt, Read, ReadArgs, Relabel, RemAssignList, RemDosEntry, RemSegment, Rename, ReplyPkt, RunCommand, SameDevice, SelectInput, SelectOutput, SendPkt, SetArgStr, SetComment, SetIoErr, SetMode, SetProgramDir, SetProtection, SetVar, StartNotify, StrToDate, SystemTagList, UnGetC, UnLoadSeg, UnLock, UnLockDosList, UnLockRecord, UnLockRecords, VFPrintf, VPrintf, WaitForChar, WaitPkt, WaitPort, Write, WriteChars]
