...
```c
    ...
    more advanced programmers.  See exec's [DoIO()](autodocs-2.0/exec-library-doio.md) and [SendIO()](autodocs-2.0/exec-library-sendio.md) for
    ...
    Completion is signalled via the standard [ReplyMsg](autodocs-2.0/exec-library-replymsg.md) routine.
    ...
    [ReplyMsg](autodocs-2.0/exec-library-replymsg.md) or signal bit activity in this case.
```
INPUTS
