...
```c
    len -   Size of environment variable.  -1 indicates that the
            variable was not defined (if [IoErr()](autodocs-2.0/dos-library-ioerr.md) returns
            ...
            including '0') is returned, and [IoErr()](autodocs-2.0/dos-library-ioerr.md) will return the
...
```c
    ...
    of the variable is put in [IoErr()](autodocs-2.0/dos-library-ioerr.md).
```
SEE ALSO

```c
    [SetVar()](autodocs-2.0/dos-library-setvar.md), [DeleteVar()](autodocs-2.0/dos-library-deletevar.md), [FindVar()](autodocs-2.0/dos-library-findvar.md), [<dos/var.h>](autodocs-2.0/includes-dos-var-h.md)
```
