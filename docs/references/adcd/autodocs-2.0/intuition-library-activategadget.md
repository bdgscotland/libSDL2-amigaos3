...
```c
    Success = ActivateGadget( [Gadget](autodocs-2.0/includes-intuition-intuition-h.md), [Window](autodocs-2.0/includes-intuition-intuition-h.md), Request )
    D0                        A0      A1      A2

    BOOL ActivateGadget( struct [Gadget](autodocs-2.0/includes-intuition-intuition-h.md) *, struct [Window](autodocs-2.0/includes-intuition-intuition-h.md) *,
...
```c
    ...
    -   The window must be active.  If you are opening a new window
        ...
        [OpenWindow()](autodocs-2.0/intuition-library-openwindow.md) returns, even if you insert a delay of some
        finite amount of time.  Use the IDCMP_ACTIVEWINDOW [IntuiMessage](autodocs-2.0/includes-intuition-intuition-h.md)
...
```c
    [Gadget](autodocs-2.0/includes-intuition-intuition-h.md) = pointer to the gadget that you want activated.
    [Window](autodocs-2.0/includes-intuition-intuition-h.md) = pointer to a window structure containing the gadget.
