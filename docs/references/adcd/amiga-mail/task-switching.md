...
first task's time was not up.  The second bug allowed a task who's time
...
effect of these bugs was masked out for low priority tasks.  Because of
the bugs, the ExecBase->Quantum field had little effect.
