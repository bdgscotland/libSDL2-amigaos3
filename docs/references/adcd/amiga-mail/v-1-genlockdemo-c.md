---
title: V-1/genlockdemo.c
manual: amiga-mail
chapter: amiga-mail
section: v-1-genlockdemo-c
functions: [GetVPModeID, MakeScreen, RethinkDisplay, ViewAddress]
...
sc DATA=NEAR NMINC STRMERGE STREQ NOSTKCHK IGNORE=73 genlockdemo.c
slink FROM LIB:c.o,genlockdemo.o TO genlockdemo LIBRARY LIB:sc.lib,LIB:amiga.lib
quit
*/
/*
