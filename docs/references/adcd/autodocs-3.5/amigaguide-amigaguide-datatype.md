---
title: amigaguide/amigaguide.datatype
manual: autodocs-3.5
...
```c
    ...
    METHODS
        ...
        GM_RENDER -- [Cause](autodocs-3.5/exec-library-cause-2.md) the AmigaGuide database to render.

        DTM_GOTO -- [Cause](autodocs-3.5/exec-library-cause-2.md) the AmigaGuide database to load and display
            document.
    ...
    TAGS
        DTA_TriggerMethods -- [List](autodocs-3.5/include-exec-lists-h.md) of the trigger methods supported.

            Applicability is (G).

        DTA_Methods -- [List](autodocs-3.5/include-exec-lists-h.md) of the methods supported.
