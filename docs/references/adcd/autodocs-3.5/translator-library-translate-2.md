...
section: translator-library-translate-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
	...
	[LONG](autodocs-3.5/include-exec-types-h.md) Translate( [STRPTR](autodocs-3.5/include-exec-types-h.md) inString, [LONG](autodocs-3.5/include-exec-types-h.md) inLength, [STRPTR](autodocs-3.5/include-exec-types-h.md) outBuffer,
	    [LONG](autodocs-3.5/include-exec-types-h.md) outlen );
    ...
    SEE ALSO
	[narrator.device/CMD_WRITE](autodocs-3.5/trackdisk-device-cmd-write-2.md)
