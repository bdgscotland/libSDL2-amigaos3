---
title: animation.datatype/animation.datatype
manual: autodocs-3.5
chapter: autodocs-3.5
section: animation-datatype-animation-datatype
functions: [SetRGB32CM]
...
```c
    ...
    METHODS
        ...
        GM_RENDER -- [Cause](autodocs-3.5/exec-library-cause-2.md) the current frame to render.

        DTM_FRAMEBOX -- Obtain the display environment that the animation
            requires.

        DTM_TRIGGER -- [Cause](autodocs-3.5/exec-library-cause-2.md) an event to occur.  Currently the only
        ...
        DTM_WRITE -- [Write](autodocs-3.5/dos-library-write-2.md) the current frame to a file as an IFF ILBM.

        DTM_PRINT -- Print the current frame.

        ADTM_LOADFRAME -- Load a frame of the animation.

        ADTM_UNLOADFRAME -- [Deallocate](autodocs-3.5/exec-library-deallocate-2.md) any memory allocated by
            ADTM_LOADFRAME.
        ...
        ADTM_LOADNEWFORMATFRAME -- Load a new format frame of the animation,
            for more information, see [<datatypes/animationclass.h>](autodocs-3.5/include-datatypes-animationclass-h.md). (V44)

        ADTM_UNLOADNEWFORMATFRAME -- [Deallocate](autodocs-3.5/exec-library-deallocate-2.md) any memory allocated by
    ...
    TAGS
        ...
        ADTA_KeyFrame (struct [BitMap](autodocs-3.5/include-graphics-gfx-h.md) *) -- Pointer to the key
            frame.
        ...
        ADTA_ColorRegisters (struct [ColorRegister](autodocs-3.5/include-datatypes-pictureclass-h.md) *) -- Color table; its
            contents should match the colours in the ADTA_CRegs table.

            Applicability is (G).

        ADTA_CRegs (ULONG *) -- Color table to use with [SetRGB32CM()](autodocs-3.5/graphics-library-setrgb32cm.md).
        ...
        ADTA_BitMapHeader (struct [BitMapHeader](autodocs-3.5/include-datatypes-pictureclass-h.md) *) -- Set and get the
            base information for the animation.  [BitMapHeader](autodocs-3.5/include-datatypes-pictureclass-h.md) is defined in
            [<datatypes/pictureclass.h>](autodocs-3.5/include-datatypes-pictureclass-h.md)
        ...
        OBP_Precision (ULONG) -- Precision to use when obtaining colors.
            See the PRECISION_[..] defines in [<graphics/view.h>](autodocs-3.5/include-graphics-view-h.md).
    ...
    NOTES
        ...
        operate on struct [adtNewFormatFrame](autodocs-3.5/include-datatypes-animationclass-h.md) format messages. The
        [adtNewFormatFrame](autodocs-3.5/include-datatypes-animationclass-h.md) message is an extension of the [adtFrame](autodocs-3.5/include-datatypes-animationclass-h.md) message
        ...
        [adtNewFormatFrame](autodocs-3.5/include-datatypes-animationclass-h.md) format messages, it must say so by providing a
        ...
        subclass, you will receive [adtNewFormatFrame](autodocs-3.5/include-datatypes-animationclass-h.md) format messages instead
        of the compatible [adtFrame](autodocs-3.5/include-datatypes-animationclass-h.md) messages.
        ...
        Since the [adtNewFormatFrame](autodocs-3.5/include-datatypes-animationclass-h.md) message format may be enhanced in future
        ...
        the data structure (in bytes). [Remember](autodocs-3.5/include-intuition-intuition-h.md) which message length you
        ...
        compatible [adtFrame](autodocs-3.5/include-datatypes-animationclass-h.md) message data structure.
```
