---
title: bitmap_id/--datasheet--
manual: autodocs-3.5
chapter: autodocs-3.5
section: bitmap-id-datasheet
functions: []
libraries: []
---
...
```c
    ...
    ATTRIBUTES
        ...
        BITMAP_Screen (struct [Screen](autodocs-3.5/include-intuition-screens-h.md) *)
        ...
        BITMAP_Precision (ULONG)
            ...
            defines in [<graphics/view.h>](autodocs-3.5/include-graphics-view-h.md)
        ...
        BITMAP_BitMap (struct [BitMap](autodocs-3.5/include-graphics-gfx-h.md) *)
        ...
        BITMAP_SelectBitMap (struct [BitMap](autodocs-3.5/include-graphics-gfx-h.md) *)
