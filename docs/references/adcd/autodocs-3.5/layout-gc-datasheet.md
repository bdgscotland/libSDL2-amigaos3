---
title: layout_gc/--datasheet--
manual: autodocs-3.5
chapter: autodocs-3.5
section: layout-gc-datasheet
functions: [AddHead, AddTail, DrawImageState, NewObject, StackSwap]
...
```
	PRIVATE METHODS
		LAYOUT_ACTIVATEOBJECT -- Used by [ActivateLayoutGadget()](autodocs-3.5/layout-gc-activatelayoutgadget.md), sets
...
```c
      ...
      LAYOUT_BevelState (ULONG)
          ...
          [DrawImageState()](autodocs-3.5/intuition-library-drawimagestate-2.md) the bevel.image.
      ...
      LAYOUT_RelAddress (struct [Gadget](autodocs-3.5/include-intuition-intuition-h.md) *)
      ...
      LAYOUT_DeferLayout (BOOL)
          ...
          of input.device. [Input](autodocs-3.5/dos-library-input-2.md) handling will be retained in input.device
      ...
      LAYOUT_RequestLayout (Object *)
          ...
          [RethinkLayout](autodocs-3.5/layout-gc-rethinklayout.md) with FALSE for refresh flag when receiving one.
      ...
      LAYOUT_RequestRefresh (Object *)
          ...
          its IC target with this tag. You should be listening to it in
          your application IDCMP handler (IDCMP_IDCMPUPDATE) and calling
          [RefreshGList](autodocs-3.5/intuition-library-refreshglist-2.md) when receiving one.
      ...
      GA_BackFill (struct [Hook](autodocs-3.5/include-utility-hooks-h.md) *)
      ...
      LAYOUT_Inversed (BOOL) (V42.27)
          ...
          [AddHead()](autodocs-3.5/exec-library-addhead-2.md) vs [AddTail()](autodocs-3.5/exec-library-addtail-2.md).
...
```c
      ...
      automatically rerender the display! Call [RethinkLayout()](autodocs-3.5/layout-gc-rethinklayout.md) to
      ...
      include file defines a set of macros that hide [NewObject()](autodocs-3.5/intuition-library-newobject-2.md)
      ...
      too small, you can use the V37 Exec [StackSwap()](autodocs-3.5/exec-library-stackswap-2.md) call to replace
