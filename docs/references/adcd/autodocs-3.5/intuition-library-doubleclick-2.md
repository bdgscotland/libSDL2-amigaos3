...
section: intuition-library-doubleclick-2
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
	...
	[BOOL](autodocs-3.5/include-exec-types-h.md) DoubleClick( ULONG, ULONG, ULONG, ULONG );
...
```
	...
	double-click time range in the current set of [Preferences](autodocs-3.5/include-intuition-preferences-h.md), this
