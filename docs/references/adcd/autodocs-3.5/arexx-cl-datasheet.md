---
title: arexx_cl/--datasheet--
manual: autodocs-3.5
chapter: autodocs-3.5
section: arexx-cl-datasheet
functions: [ReadArgs, Wait]
...
```c
    ...
    METHODS
        ...
        [AM_EXECUTE](autodocs-3.5/arexx-cl-am-execute.md) -- Executes an ARexx command or macro.

        [AM_HANDLEINPUT](autodocs-3.5/arexx-cl-am-handleinput.md) -- Handles ARexx messages.
    ...
    ATTRIBUTES
        ...
        AREXX_Commands (struct [ARexxCmd](autodocs-3.5/include-classes-arexx-h.md) *)
            The table of the commands supported by your ARexx interface.
            This will be a pointer to an array of struct [ARexxCmd](autodocs-3.5/include-classes-arexx-h.md).  If this
            ...
            OM_NEW:
                ...
                ac_Func (*()(struct [ARexxCmd](autodocs-3.5/include-classes-arexx-h.md) *, struct [RexxMsg](autodocs-3.5/include-rexx-storage-h.md) *))
                A pointer to the function that will be called when this
                command is received by your programme.  The function will
                get past a pointer to its [ARexxCmd](autodocs-3.5/include-classes-arexx-h.md) entry and the [RexxMsg](autodocs-3.5/include-rexx-storage-h.md)
            ...
            when calling the ac_Func command callback.
                ...
                ac_ArgList (ULONG *)
                Result of [ReadArgs()](autodocs-3.5/dos-library-readargs-2.md) using the arguments received with the
        ...
        AREXX_SigMask (ULONG)
            ...
            signal you will want to [Wait()](autodocs-3.5/exec-library-wait-2.md) on so you know when there is
            activity at the ARexx port.

            Applicability is (OM_GET)

        AREXX_ReplyHook (struct [Hook](autodocs-3.5/include-utility-hooks-h.md) *)
            ...
            commands sent via [AM_EXECUTE](autodocs-3.5/arexx-cl-am-execute.md).

            The object parameter in the hook function will point to the
            [Object](autodocs-3.5/include-intuition-classusr-h.md) * that is yur host, and the message parameter will be
