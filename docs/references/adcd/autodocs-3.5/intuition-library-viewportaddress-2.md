...
section: intuition-library-viewportaddress-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
    ...
    SYNOPSIS
	[ViewPort](autodocs-3.5/include-graphics-view-h.md) = ViewPortAddress( [Window](autodocs-3.5/include-intuition-intuition-h.md) )
	D0                          A0

	struct [ViewPort](autodocs-3.5/include-graphics-view-h.md) *ViewPortAddress( struct [Window](autodocs-3.5/include-intuition-intuition-h.md) * );
    ...
    INPUTS
	[Window](autodocs-3.5/include-intuition-intuition-h.md) = pointer to the window for which you want the viewport address

    RESULT
	Returns the address of the Intuition [ViewPort](autodocs-3.5/include-graphics-view-h.md) structure for
