...
section: exec-library-alloctrap-2
functions: [FreeTrap]
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   SYNOPSIS
	...
	[LONG](autodocs-3.5/include-exec-types-h.md) AllocTrap(LONG);

   FUNCTION
	[Allocate](autodocs-3.5/exec-library-allocate-2.md) a trap number from the current task's pool.  These trap
