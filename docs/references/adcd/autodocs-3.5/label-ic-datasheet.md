---
title: label_ic/--datasheet--
manual: autodocs-3.5
chapter: autodocs-3.5
section: label-ic-datasheet
functions: [GetScreenDrawInfo]
...
```c
    NAME
        label_ic -- [Image](autodocs-3.5/include-intuition-intuition-h.md) class for creating idenification labels
    ...
    ATTRIBUTES
        IA_Font (struct [TextAttr](autodocs-3.5/include-graphics-text-h.md) *)
        ...
        IA_Mode (UBYTE)
            [Draw](autodocs-3.5/graphics-library-draw-2.md) mode for rendering text.  Only affects text passed AFTER
            this tag is given.
        ...
        LABEL_DrawInfo (struct [DrawInfo](autodocs-3.5/include-intuition-screens-h.md) *)
            ...
            then you MUST pass the screen [DrawInfo](autodocs-3.5/include-intuition-screens-h.md) before you give the
            LABEL_Text tag.
        ...
        LABEL_Image (struct [Image](autodocs-3.5/include-intuition-intuition-h.md) *)
        ...
        LABEL_Mapping (UWORD *)
            ...
            might use the following mapping:
                ...
                [UWORD](autodocs-3.5/include-exec-types-h.md) mapping[4];
                struct [DrawInfo](autodocs-3.5/include-intuition-screens-h.md) *drinfo;

                /* Before hand we'll have obtained the screen's [DrawInfo](autodocs-3.5/include-intuition-screens-h.md).
                 */
