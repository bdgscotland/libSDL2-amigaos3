---
title: include/intuition/intuition.h
manual: autodocs-3.5
chapter: autodocs-3.5
section: include-intuition-intuition-h
functions: [AutoRequest, CreateUpfrontHookLayer, DisplayAlert, HelpControl, LockPubScreen, ModifyProp, OffGadget, OpenWindow, OpenWindowTagList, ReplyMsg, Request, ScrollWindowRaster, SetPointer]
