...
section: potgo-resource-writepotgo-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   NAME
	WritePotgo -- [Write](autodocs-3.5/dos-library-write-2.md) to the hardware potgo register.

   SYNOPSIS
	WritePotgo(word, mask)
	           D0    D1

	void WritePotgo( [UWORD](autodocs-3.5/include-exec-types-h.md), [UWORD](autodocs-3.5/include-exec-types-h.md) );
