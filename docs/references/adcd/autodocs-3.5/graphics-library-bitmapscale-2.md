---
title: graphics.library/BitMapScale
manual: autodocs-3.5
chapter: autodocs-3.5
section: graphics-library-bitmapscale-2
functions: [ScalerDiv]
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   SYNOPSIS
	...
	void BitMapScale(struct [BitScaleArgs](autodocs-3.5/include-graphics-scale-h.md) *);
   ...
   NOTES
	...
	o   No check is made to ensure destBitMap is big enough: use
	    [ScalerDiv](autodocs-3.5/graphics-library-scalerdiv-2.md) to calculate a destination dimension.
   ...
   SEE ALSO
	[ScalerDiv()](autodocs-3.5/graphics-library-scalerdiv-2.md)  [graphics/scale.h](autodocs-3.5/include-graphics-scale-h.md)
