---
title: exec.library/AllocMem
manual: autodocs-3.5
chapter: autodocs-3.5
section: exec-library-allocmem-2
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   INPUTS
	...
	attributes -
		...
		MEMF_LOCAL:	This is memory that will not go away
				after the CPU [RESET](autodocs-3.5/sad-reset.md) instruction.  Normally,
				autoconfig memory boards become unavailable
				after [RESET](autodocs-3.5/sad-reset.md) while motherboard memory
		...
		MEMF_NO_EXPUNGE	This will prevent an expunge to happen on
				...
				any expunge operations.  (See [AddMemHandler()](autodocs-3.5/exec-library-addmemhandler.md))
   ...
   EXAMPLES
	AllocMem(64,0L)		- [Allocate](autodocs-3.5/exec-library-allocate-2.md) the best available memory
	AllocMem(25,MEMF_CLEAR) - [Allocate](autodocs-3.5/exec-library-allocate-2.md) the best available memory, and
				  clear it before returning.
	AllocMem(128,MEMF_CHIP) - [Allocate](autodocs-3.5/exec-library-allocate-2.md) chip memory
	AllocMem(128,MEMF_CHIP|MEMF_CLEAR) - [Allocate](autodocs-3.5/exec-library-allocate-2.md) cleared chip memory
	AllocMem(821,MEMF_CHIP|MEMF_PUBLIC|MEMF_CLEAR) - [Allocate](autodocs-3.5/exec-library-allocate-2.md) cleared,
		public, chip memory.
