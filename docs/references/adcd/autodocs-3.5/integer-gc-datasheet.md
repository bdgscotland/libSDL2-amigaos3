    ...
    REQUIRES
     ...
     ATTRIBUTES
        ...
        INTEGER_Number (LONG)
            ...
            values of size [LONG](autodocs-3.5/include-exec-types-h.md), the value returned in IntuiMessage.Code
            will only be valid if the ranges you are allowing fit into a
            WORD value.  Otherwise you will have to use [GetAttr()](autodocs-3.5/intuition-library-getattr-2.md).
