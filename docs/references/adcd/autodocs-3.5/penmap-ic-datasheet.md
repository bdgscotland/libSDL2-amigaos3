...
```c
    ...
    METHODS
        ...
        IM_DRAW -- Renders the image. Supports IDS_NORMAL and
            ...
            a [DrawInfo](autodocs-3.5/include-intuition-screens-h.md) structure. The graphics.library function
            [BitMapScale](autodocs-3.5/graphics-library-bitmapscale-2.md) () to scale the image if required.

        IM_DRAWFRAME -- Renders the image scaled to the frame size
            specified. Supports IDS_NORMAL and IDS_SELECTED drawing
            states, and does not require a [DrawInfo](autodocs-3.5/include-intuition-screens-h.md) structure.
            The graphics.library function [BitMapScale](autodocs-3.5/graphics-library-bitmapscale-2.md) () to scale
            the image.
    ...
    ATTRIBUTES
        ...
        IA_Width (WORD)
        IA_Height (WORD)
            Set size of the image, scaling via [BitMapScale()](autodocs-3.5/graphics-library-bitmapscale-2.md) if different
        ...
        IA_Data
           ...
           The data format is a [UBYTE](autodocs-3.5/include-exec-types-h.md) array of chunky pen numbers.
        ...
        PENMAP_Screen (struct [Screen](autodocs-3.5/include-intuition-screens-h.md) *)
        ...
        PENMAP_ColorMap (struct [ColorMap](autodocs-3.5/include-graphics-view-h.md) *)
