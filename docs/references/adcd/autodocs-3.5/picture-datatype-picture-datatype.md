---
title: picture.datatype/picture.datatype
manual: autodocs-3.5
chapter: autodocs-3.5
section: picture-datatype-picture-datatype
functions: [BltMaskBitMapRastPort, SetRGB32CM]
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   METHODS
	...
	GM_RENDER -- [Cause](autodocs-3.5/exec-library-cause-2.md) the graphic to render.
	...
	DTM_WRITE -- [Write](autodocs-3.5/dos-library-write-2.md) the selected area of the picture to a file as an
   ...
   TAGS
	...
	PDTA_ModeID (ULONG) -- Set and get the graphic mode id of the
	    picture (see [<graphics/modeid.h>](autodocs-3.5/include-graphics-modeid-h.md)).

	    Applicability is (ISG).

	PDTA_BitMapHeader (struct [BitMapHeader](autodocs-3.5/include-datatypes-pictureclass-h.md) *) -- Get the
	    base information for the picture.  [BitMapHeader](autodocs-3.5/include-datatypes-pictureclass-h.md) is defined in
	    [<datatypes/pictureclass.h>](autodocs-3.5/include-datatypes-pictureclass-h.md)

	    Applicability is (G).

	PDTA_BitMap (struct [BitMap](autodocs-3.5/include-graphics-gfx-h.md) *) -- Pointer to a class-allocated
	    bitmap, that will end up being freed by the picture class in the
	    OM_DISPOSE method.

	    Applicability is (ISG).

	PDTA_ColorRegisters (struct [ColorRegister](autodocs-3.5/include-datatypes-pictureclass-h.md) *) -- Color table; its
	    contents should match the colours in the PDTA_CRegs table.

	    Applicability is (G).

	PDTA_CRegs (ULONG *) -- Color table to use with [SetRGB32CM()](autodocs-3.5/graphics-library-setrgb32cm.md).
	...
	PDTA_Screen (struct [Screen](autodocs-3.5/include-intuition-screens-h.md) *) -- Pointer to the screen to remap
	...
	PDTA_DestBitMap (struct [BitMap](autodocs-3.5/include-graphics-gfx-h.md) *) -- Pointer to the remapped
	    bitmap.

	    Applicability is (G).

	PDTA_ClassBitMap (struct [BitMap](autodocs-3.5/include-graphics-gfx-h.md) *) -- Pointer to the [BitMap](autodocs-3.5/include-graphics-gfx-h.md)
	...
	PDTA_DestMode (LONG) -- Used by application software writers only;
	    ...
	    examine the contents of the [BitMap](autodocs-3.5/include-graphics-gfx-h.md) you receive from
	    picture.datatype.

	    Applicability is (ISG). Defaults to PMODE_V43. (V43)

	PDTA_UseFriendBitMap (BOOL) -- If set to TRUE, all [BitMap](autodocs-3.5/include-graphics-gfx-h.md)
	    allocations done by picture.datatype will be done with
	    a friend [BitMap](autodocs-3.5/include-graphics-gfx-h.md) as a reference (see graphics.library/AllocBitMap).

	    Applicability is (ISG). Defaults to TRUE. (V43)

	PDTA_MaskPlane (PLANEPTR) -- Pointer to a bit plane suitable
	    for use with [BltMaskBitMapRastPort()](autodocs-3.5/graphics-library-bltmaskbitmaprastport-2.md), or NULL if the
	...
	PDTA_WhichPicture (ULONG) -- Index number of the picture to load.
	    ...
	    picture and also to count the number of pictures, like this:
	        ...
	        [Object](autodocs-3.5/include-intuition-classusr-h.md) * picture;
	        ULONG numPictures;
	        ...
	        if(numPictures != PDTANUMPICTURES_Unknown &&
	           numPictures > 1)
	        {
	            [Object](autodocs-3.5/include-intuition-classusr-h.md) * secondPicture;
