---
title: colorwheel.gadget/colorwheel.gadget
manual: autodocs-3.5
chapter: autodocs-3.5
section: colorwheel-gadget-colorwheel-gadget
functions: [DisposeObject, NewObject, ObtainPen]
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   TAGS
	...
	WHEEL_HSB (struct [ColorWheelHSB](autodocs-3.5/include-gadgets-colorwheel-h.md) *) -- Set and get the hue, saturation,
		...
		When setting this tag, initialize a [ColorWheelHSB](autodocs-3.5/include-gadgets-colorwheel-h.md) structure,
		and provide a pointer to it. When getting this tag, pass a
		pointer to a [ColorWheelHSB](autodocs-3.5/include-gadgets-colorwheel-h.md) structure, and the color wheel
	...
	WHEEL_RGB (struct [ColorWheelRGB](autodocs-3.5/include-gadgets-colorwheel-h.md) *) -- Set and get the red, green,
		and brightness components of a color wheel. This is a buik
		version of the separate WHEEL_Red, WHEEL_Green, and
		WHEEL_Blue tags.

		When setting this tag, initialize a [ColorWheelRGB](autodocs-3.5/include-gadgets-colorwheel-h.md) structure,
		and provide a pointer to it. When getting this tag, pass a
		pointer to a [ColorWheelRGB](autodocs-3.5/include-gadgets-colorwheel-h.md) structure, and the color wheel
		object will fill it in with the current values.
	...
	WHEEL_Screen (struct [Screen](autodocs-3.5/include-intuition-screens-h.md) *) - Indicate the screen the color
		wheel is to open on. This is a required tag and must be
		provided when the wheel is created via [NewObject()](autodocs-3.5/intuition-library-newobject-2.md).
	...
	WHEEL_Donation (UWORD *) - Specifies an array of pens donated by
		...
		option of the [graphics.library/ObtainPen()](autodocs-3.5/graphics-library-obtainpen.md) function.
	...
	WHEEL_GradientSlider (struct [Gadget](autodocs-3.5/include-intuition-intuition-h.md) *) - This tag lets you do simple
		linking of a gradient slider object to a color wheel object.
		You give this tag a pointer to a gradient slider object
		obtained previously from [NewObject()](autodocs-3.5/intuition-library-newobject-2.md). Once this is done,
   ...
   WARNING
	...
	object must be deleted using [DisposeObject()](autodocs-3.5/intuition-library-disposeobject-2.md) prior to closing the
