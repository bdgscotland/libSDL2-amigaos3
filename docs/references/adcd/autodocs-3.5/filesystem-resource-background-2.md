---
title: FileSystem.resource/--background--
manual: autodocs-3.5
chapter: autodocs-3.5
section: filesystem-resource-background-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   CONTENTS
	...
	[resources/filesysres.h](autodocs-3.5/include-resources-filesysres-h.md).  The nodes on it describe how to
	algorithmically convert the result of [MakeDosNode](autodocs-3.5/expansion-library-makedosnode-2.md) (from the
	expansion.library) to a node appropriate for the dos type.

	[FileSysEntry](autodocs-3.5/include-resources-filesysres-h.md)
	    ...
	    fse_Startup		startup msg: [FileSysStartupMsg](autodocs-3.5/include-dos-filehandler-h.md) for disks
