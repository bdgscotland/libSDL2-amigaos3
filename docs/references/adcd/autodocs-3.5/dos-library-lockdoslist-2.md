---
title: dos.library/LockDosList
manual: autodocs-3.5
chapter: autodocs-3.5
section: dos-library-lockdoslist-2
functions: [AttemptLockDosList, Forbid, LockDosList, NextDosEntry, Permit, UnLockDosList]
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   SYNOPSIS
	...
	struct [DosList](autodocs-3.5/include-dos-dosextens-h.md) *LockDosList(ULONG)
   ...
   FUNCTION
	...
	for 1.3 compatibility, it also does a [Forbid()](autodocs-3.5/exec-library-forbid-2.md) - this will probably
	be removed at some future time.  The 1.3 [Forbid()](autodocs-3.5/exec-library-forbid-2.md) locking of this
	list had some race conditions.  The pointer returned by this is NOT
	an actual [DosList](autodocs-3.5/include-dos-dosextens-h.md) pointer - you should use on of the other DosEntry
	calls to get actual pointers to [DosList](autodocs-3.5/include-dos-dosextens-h.md) structures (such as
	[NextDosEntry()](autodocs-3.5/dos-library-nextdosentry-2.md)), passing the value returned by LockDosList()
	as the dlist value.
	...
	and they're trying to send you a packet).  Use [AttemptLockDosList()](autodocs-3.5/dos-library-attemptlockdoslist-2.md)
	...
	1.3/2.0 way:
		...
		* must not use dl after this! *
		...
		struct [DosList](autodocs-3.5/include-dos-dosextens-h.md) *
		yourfindentry (struct [DosList](autodocs-3.5/include-dos-dosextens-h.md) *dl, STRPTRname, type)
		{
   ...
   SEE ALSO
	[AttemptLockDosList()](autodocs-3.5/dos-library-attemptlockdoslist-2.md), [UnLockDosList()](autodocs-3.5/dos-library-unlockdoslist-2.md), [Forbid()](autodocs-3.5/exec-library-forbid-2.md), [NextDosEntry()](autodocs-3.5/dos-library-nextdosentry-2.md)
