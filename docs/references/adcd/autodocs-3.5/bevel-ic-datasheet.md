...
```c
    ...
    ATTRIBUTES
        ...
        IA_Font (struct [TextAttr](autodocs-3.5/include-graphics-text-h.md) *)
            [Text](autodocs-3.5/graphics-library-text-2.md) Attribute to use for any label text.
        ...
        BEVEL_FillPen (WORD)
            Inner bevel area [RectFill()](autodocs-3.5/graphics-library-rectfill-2.md) pen number, ~0 means to
            ignore, and not to [RectFill()](autodocs-3.5/graphics-library-rectfill-2.md).
        ...
        BEVEL_ColorMap (struct [ColorMap](autodocs-3.5/include-graphics-view-h.md) *)
            [Screen](autodocs-3.5/include-intuition-screens-h.md) viewport colormap pointer, use to obtain additional
