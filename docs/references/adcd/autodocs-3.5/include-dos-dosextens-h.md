---
title: include/dos/dosextens.h
manual: autodocs-3.5
chapter: autodocs-3.5
section: include-dos-dosextens-h
functions: [AddSegment, AllocVec, DupLock, ErrorReport, GetDeviceProc, IoErr, Lock, LockDosList, Open, PutMsg]
