---
title: dos.library/Execute
manual: autodocs-3.5
chapter: autodocs-3.5
section: dos-library-execute-2
functions: [SystemTagList]
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
	...
	[BOOL](autodocs-3.5/include-exec-types-h.md) Execute(STRPTR, [BPTR](autodocs-3.5/include-dos-dos-h.md), BPTR)
	...
	to [SystemTagList()](autodocs-3.5/dos-library-systemtaglist-2.md)).
    ...
    SEE ALSO
	[SystemTagList()](autodocs-3.5/dos-library-systemtaglist-2.md), NewShell, EndCLI, Run
