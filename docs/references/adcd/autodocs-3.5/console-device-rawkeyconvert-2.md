...
section: console-device-rawkeyconvert-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
    ...
    INPUTS
	event -  an [InputEvent](autodocs-3.5/include-devices-inputevent-h.md) structure pointer.
    ...
    SEE ALSO
	[exec/io.h](autodocs-3.5/include-exec-io-h.md), [devices/inputevent.h](autodocs-3.5/include-devices-inputevent-h.md), [devices/keymap.h](autodocs-3.5/include-devices-keymap-h.md)
