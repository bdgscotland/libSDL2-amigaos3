---
title: exec.library/InitStruct
manual: autodocs-3.5
chapter: autodocs-3.5
section: exec-library-initstruct-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   SYNOPSIS
	...
	void InitStruct(struct InitStruct *, [APTR](autodocs-3.5/include-exec-types-h.md), ULONG);
   ...
   FUNCTION
	...
	24 bit [APTR](autodocs-3.5/include-exec-types-h.md) not supported for 68020 compatibility -- use long.
