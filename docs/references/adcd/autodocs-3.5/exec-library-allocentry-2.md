...
section: exec-library-allocentry-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   SYNOPSIS
	...
	struct [MemList](autodocs-3.5/include-exec-memory-h.md) *AllocEntry(struct [MemList](autodocs-3.5/include-exec-memory-h.md) *);

   FUNCTION
	This function takes a memList structure and allocates enough memory
	to hold the required memory as well as a [MemList](autodocs-3.5/include-exec-memory-h.md) structure to keep
	track of it.

	These [MemList](autodocs-3.5/include-exec-memory-h.md) structures may be linked together in a task control
	block to keep track of the total memory usage of this task. (See
	the description of TC_MEMENTRY under RemTask).

   INPUTS
	memList -- A [MemList](autodocs-3.5/include-exec-memory-h.md) structure filled in with [MemEntry](autodocs-3.5/include-exec-memory-h.md) structures.

   RESULTS
	memList -- A different [MemList](autodocs-3.5/include-exec-memory-h.md) filled in with the actual memory
