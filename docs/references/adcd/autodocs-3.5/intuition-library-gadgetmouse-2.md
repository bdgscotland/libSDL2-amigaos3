...
section: intuition-library-gadgetmouse-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
    ...
    SYNOPSIS
	GadgetMouse( [Gadget](autodocs-3.5/include-intuition-intuition-h.md), GInfo, MousePoint )
		     A0      A1     A2

	VOID GadgetMouse( struct [GadgetInfo](autodocs-3.5/include-intuition-cghooks-h.md) *, WORD * );
    ...
    INPUTS
	GInfo = A pointer to a [GadgetInfo](autodocs-3.5/include-intuition-cghooks-h.md) structure as passed to the
