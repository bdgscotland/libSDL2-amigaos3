---
title: exec.library/CacheClearE
manual: autodocs-3.5
chapter: autodocs-3.5
section: exec-library-cachecleare-2
functions: [CacheClearU, CacheControl, LoadSeg, SetFunction]
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   FUNCTION
	[Flush](autodocs-3.5/dos-library-flush-2.md) out the contents of the CPU instruction and/or data caches.
   ...
   NOTES
	...
	conflicts with the blitter or other custom chip DMA.  [Custom](autodocs-3.5/include-hardware-custom-h.md) chip
	...
	modify instructions, including [LoadSeg()](autodocs-3.5/dos-library-loadseg-2.md), [MakeLibrary()](autodocs-3.5/exec-library-makelibrary-2.md) and
	[SetFunction()](autodocs-3.5/exec-library-setfunction-2.md).

   SEE ALSO
	exec/execbase.i, [CacheControl()](autodocs-3.5/exec-library-cachecontrol-2.md), [CacheClearU()](autodocs-3.5/exec-library-cacheclearu-2.md)
