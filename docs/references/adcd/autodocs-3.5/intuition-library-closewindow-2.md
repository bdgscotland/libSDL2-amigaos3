...
section: intuition-library-closewindow-2
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
    ...
    NAME
	CloseWindow -- [Close](autodocs-3.5/dos-library-close-2.md) an Intuition window.

    SYNOPSIS
	CloseWindow( [Window](autodocs-3.5/include-intuition-intuition-h.md) )
		     A0

	VOID CloseWindow( struct [Window](autodocs-3.5/include-intuition-intuition-h.md) * );
	...
	NOTE:  If you have added a [Menu](autodocs-3.5/include-intuition-intuition-h.md) strip to this [Window](autodocs-3.5/include-intuition-intuition-h.md) (via
	a call to [SetMenuStrip()](autodocs-3.5/intuition-library-setmenustrip-2.md)) you must be sure to remove that [Menu](autodocs-3.5/include-intuition-intuition-h.md) strip
	(via a call to [ClearMenuStrip()](autodocs-3.5/intuition-library-clearmenustrip-2.md)) before closing your [Window](autodocs-3.5/include-intuition-intuition-h.md).
    ...
    SEE ALSO
	[OpenWindow()](autodocs-3.5/intuition-library-openwindow-2.md), [OpenScreen()](autodocs-3.5/intuition-library-openscreen-2.md), [CloseScreen()](autodocs-3.5/intuition-library-closescreen-2.md)
	...
	struct [Window](autodocs-3.5/include-intuition-intuition-h.md) *win;
	{
	...
	struct [MsgPort](autodocs-3.5/include-exec-ports-h.md) *mp;
	struct [Window](autodocs-3.5/include-intuition-intuition-h.md) *win;
	{
	    struct [IntuiMessage](autodocs-3.5/include-intuition-intuition-h.md) *msg;
	    struct [Node](autodocs-3.5/include-exec-nodes-h.md) *succ;

	    msg = (struct [IntuiMessage](autodocs-3.5/include-intuition-intuition-h.md) *) mp->mp_MsgList.lh_Head;
		...
		msg = (struct [IntuiMessage](autodocs-3.5/include-intuition-intuition-h.md) *) succ;
	    }
	}
