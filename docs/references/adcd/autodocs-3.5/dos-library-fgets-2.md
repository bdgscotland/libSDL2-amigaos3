...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   SYNOPSIS
	...
	[STRPTR](autodocs-3.5/include-exec-types-h.md) FGets(BPTR, [STRPTR](autodocs-3.5/include-exec-types-h.md), ULONG)
   ...
   RESULT
	buffer - Pointer to buffer passed in, or NULL for immediate EOF or for
		 an error.  If NULL is returnd for an EOF, [IoErr()](autodocs-3.5/dos-library-ioerr-2.md) will return
		 0.
   ...
   SEE ALSO
	[FRead()](autodocs-3.5/dos-library-fread-2.md), [FPuts()](autodocs-3.5/dos-library-fputs-2.md), [FGetC()](autodocs-3.5/dos-library-fgetc-2.md)
