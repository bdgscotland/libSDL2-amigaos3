...
```c
       ...
       [CMD_WRITE](autodocs-3.5/audio-device-cmd-write-2.md) queues up writes to a stopped channel until [CMD_START](autodocs-3.5/audio-device-cmd-start-2.md) starts
       the channel or [CMD_RESET](autodocs-3.5/audio-device-cmd-reset-2.md) resets the channel. CMD_STOP is synchronous
