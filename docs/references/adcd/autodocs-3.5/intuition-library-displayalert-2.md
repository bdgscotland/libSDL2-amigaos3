---
title: intuition.library/DisplayAlert
manual: autodocs-3.5
chapter: autodocs-3.5
section: intuition-library-displayalert-2
functions: [Alert, TimedDisplayAlert]
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
	...
	[BOOL](autodocs-3.5/include-exec-types-h.md) DisplayAlert( ULONG, [UBYTE](autodocs-3.5/include-exec-types-h.md) *, [UWORD](autodocs-3.5/include-exec-types-h.md) );
	...
	[BOOL](autodocs-3.5/include-exec-types-h.md) value is returned by this routine to specify whether or not
	...
	AlertNumber is a [LONG](autodocs-3.5/include-exec-types-h.md) value, historically related to the value
	sent to the [Alert()](autodocs-3.5/exec-library-alert-2.md) routine.  But the only bits that are pertinent to
