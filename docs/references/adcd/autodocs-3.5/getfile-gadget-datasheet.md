---
title: getfile.gadget/--datasheet--
manual: autodocs-3.5
...
```c
    ...
    ATTRIBUTES
       ...
       GETFILE_TopEdge  (WORD)
          [Requester](autodocs-3.5/include-intuition-intuition-h.md) placement coordinates.
       ...
       GETFILE_Width  (WORD)
       GETFILE_Height (WORD)
          [Requester](autodocs-3.5/include-intuition-intuition-h.md) dimensions.
       ...
       GETFILE_FullFileExpand (BOOL)
          ...
          [NameFromLock()](autodocs-3.5/dos-library-namefromlock-2.md) to remove relative paths.
       ...
       GETFILE_FilterFunc (struct [Hook](autodocs-3.5/include-utility-hooks-h.md) *)
       ...
       GETFILE_Filelist (struct [List](autodocs-3.5/include-exec-lists-h.md) *)
       ...
       GETFILE_LBNodeStruct (BOOL)
          ...
          normal struct [Node](autodocs-3.5/include-exec-nodes-h.md) node structures. NOTE: This tag requires that
