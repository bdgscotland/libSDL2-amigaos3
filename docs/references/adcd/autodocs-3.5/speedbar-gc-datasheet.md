...
```c
    ...
    DESCRIPTION
        ...
        "Speed Bars", also commonly called Button Bars, [Tool](autodocs-3.5/include-datatypes-datatypes-h.md) Docs, etc.
        ...
        An advantages that this class provides:
         ...
         > [Custom](autodocs-3.5/include-hardware-custom-h.md) centered images.
    ...
    ATTRIBUTES
        SPEEDBAR_Buttons (struct [List](autodocs-3.5/include-exec-lists-h.md) *)
            An Exec list.  Nodes in this list must be allocated with
            [AllocSpeedButtonNodeA()](autodocs-3.5/speedbar-gc-allocspeedbuttonnodea.md).
        ...
        SPEEDBAR_Orientation (WORD)
            ...
            Accepted values as defined in [<gadgets/speedbar.h>](autodocs-3.5/include-gadgets-speedbar-h.md) are:
        ...
        SPEEDBAR_Window (struct [Window](autodocs-3.5/include-intuition-intuition-h.md) *)
        ...
        SPEEDBAR_StrumBar (BOOL)
            [Enable](autodocs-3.5/exec-library-enable-2.md) "strumming" mode, where by you can drag the mouse
