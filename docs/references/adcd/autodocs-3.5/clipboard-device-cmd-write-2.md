...
section: clipboard-device-cmd-write-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   NAME
	CMD_WRITE -- [Write](autodocs-3.5/dos-library-write-2.md) to a clip on the clipboard.
   ...
   FUNCTION
	...
	If this write is in response to a [SatisfyMsg](autodocs-3.5/include-devices-clipboard-h.md) for a pending
	post, then the io_ClipID returned by the [CBD_POST](autodocs-3.5/clipboard-device-cbd-post-2.md) command must
