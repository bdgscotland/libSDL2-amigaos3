---
title: window_cl/WM_HANDLEINPUT
manual: autodocs-3.5
...
```c
       ...
       WMHI_CLOSEWINDOW    [Close](autodocs-3.5/dos-library-close-2.md) gadget hit
       WMHI_GADGETUP        [Gadget](autodocs-3.5/include-intuition-intuition-h.md) hit.
       WMHI_INACTIVE        [Window](autodocs-3.5/include-intuition-intuition-h.md) went inactive.
       WMHI_ACTIVE            [Window](autodocs-3.5/include-intuition-intuition-h.md) was activated.
       WMHI_NEWSIZE        [Window](autodocs-3.5/include-intuition-intuition-h.md) was resized.
       ...
       WMHI_ICONIFY        [Window](autodocs-3.5/include-intuition-intuition-h.md) should be iconified.
       WMHI_UNICONIFY        [Window](autodocs-3.5/include-intuition-intuition-h.md) was deiconified.
       WMHI_RAWKEY            Raw key code
       WMHI_VANILLAKEY        Vanilla key code
       WMHI_CHANGEWINDOW    [Window](autodocs-3.5/include-intuition-intuition-h.md) moved (or depth arranged)
       ...
       click of the zoom gadget or a call to [ZipWindow()](autodocs-3.5/intuition-library-zipwindow-2.md).
...
```c
       code -- A pointer to a WORD that should be set to contain the
               Code value from the [IntuiMessage](autodocs-3.5/include-intuition-intuition-h.md).
```
   RESULTS
