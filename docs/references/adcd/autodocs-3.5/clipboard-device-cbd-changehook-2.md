...
section: clipboard-device-cbd-changehook-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   IO REQUEST
	...
	io_Data -       struct [Hook](autodocs-3.5/include-utility-hooks-h.md) *, the clip change hook

   HOOK ENVIRONMENT

```c
       hook message - a [ClipHookMsg](autodocs-3.5/include-devices-clipboard-h.md), as defined in [devices/clipboard.h](autodocs-3.5/include-devices-clipboard-h.md)
