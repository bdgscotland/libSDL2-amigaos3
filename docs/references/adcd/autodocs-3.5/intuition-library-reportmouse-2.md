---
title: intuition.library/ReportMouse
manual: autodocs-3.5
chapter: autodocs-3.5
section: intuition-library-reportmouse-2
functions: [Forbid, OpenWindow, Permit, ReportMouse]
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
    ...
    SYNOPSIS
	ReportMouse( Boolean, [Window](autodocs-3.5/include-intuition-intuition-h.md) )
		     D0       A0	<-note

	VOID ReportMouse( [BOOL](autodocs-3.5/include-exec-types-h.md), struct [Window](autodocs-3.5/include-intuition-intuition-h.md) * );
	...
	From assembler the interface has always been:
		Boolean in D0, [Window](autodocs-3.5/include-intuition-intuition-h.md) in A0
	...
	an atomic operation when faced with:
			...
			Window->Flags &=~WFLG_REPORTMOUSE;
	or else bracket the operation between [Forbid()/Permit()](autodocs-3.5/exec-library-permit-2.md).
	...
	The ReportMouse() function is first performed when [OpenWindow()](autodocs-3.5/intuition-library-openwindow-2.md)
    ...
    INPUTS
	[Window](autodocs-3.5/include-intuition-intuition-h.md) = pointer to a [Window](autodocs-3.5/include-intuition-intuition-h.md) structure associated with this request
    ...
    SEE ALSO
	The [Input](autodocs-3.5/dos-library-input-2.md) and [Output](autodocs-3.5/dos-library-output-2.md) section of the Intuition Reference Manual
