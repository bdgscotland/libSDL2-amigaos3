...
section: intuition-library-sysreqhandler-2
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
    ...
    SYNOPSIS
	num = SysReqHandler( [Window](autodocs-3.5/include-intuition-intuition-h.md), IDCMPFlagsPtr, WaitInput )
	D0                   A0      A1             D0

	[LONG](autodocs-3.5/include-exec-types-h.md) SysReqHandler( struct [Window](autodocs-3.5/include-intuition-intuition-h.md) *, ULONG *, [BOOL](autodocs-3.5/include-exec-types-h.md) );

    FUNCTION
	Handles input for a window returned by either [BuildSysRequest()](autodocs-3.5/intuition-library-buildsysrequest-2.md)
	or BuildEasyRequest().  These functions with SysReqHandler()
	you can perform an "asynchronous" EasyRequest() or [AutoRequest()](autodocs-3.5/intuition-library-autorequest-2.md).
	...
	(by calling [WaitPort()](autodocs-3.5/exec-library-waitport-2.md)) if there are no IDCMP messages.
	...
	Not only must you call [FreeSysRequest()](autodocs-3.5/intuition-library-freesysrequest-2.md) to eliminate the request,
    ...
    EXAMPLE
	[Request](autodocs-3.5/intuition-library-request-2.md) a volume, but don't remove the requester when the
    ...
    INPUTS
	[Window](autodocs-3.5/include-intuition-intuition-h.md) = [Window](autodocs-3.5/include-intuition-intuition-h.md) pointer returned from [BuildSysRequest()](autodocs-3.5/intuition-library-buildsysrequest-2.md) or
	...
	IDCMPFlagsPtr = If you passed application specific IDCMP
		flags to [BuildSysRequest()](autodocs-3.5/intuition-library-buildsysrequest-2.md) or BuildEasyRequest(),
