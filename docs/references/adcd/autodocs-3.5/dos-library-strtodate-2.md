...
section: dos-library-strtodate-2
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   NAME
	StrToDate -- Converts a string to a [DateStamp](autodocs-3.5/include-dos-dos-h.md) (V36)

   SYNOPSIS
	success = StrToDate( datetime )
	D0                      D1

	[BOOL](autodocs-3.5/include-exec-types-h.md) StrToDate( struct [DateTime](autodocs-3.5/include-dos-datetime-h.md) * )

   FUNCTION
	Converts a human readable ASCII string into an AmigaDOS
	[DateStamp](autodocs-3.5/include-dos-dos-h.md).
   ...
   INPUTS
	...
	dat_StrDate -	pointer	to valid string	representing the date.
		  ...
		  converted to the ds_Days portion of the [DateStamp](autodocs-3.5/include-dos-dos-h.md).
	...
	dat_StrTime -	Pointer	to a buffer which contains the time in
		  ...
		  [DateStamp](autodocs-3.5/include-dos-dos-h.md).  If this pointer is NULL, ds_Minutes and
   ...
   SEE ALSO
	[DateStamp()](autodocs-3.5/dos-library-datestamp-2.md), [DateToStr()](autodocs-3.5/dos-library-datetostr-2.md), [<dos/datetime.h>](autodocs-3.5/include-dos-datetime-h.md)
