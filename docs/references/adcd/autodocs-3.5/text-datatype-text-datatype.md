---
title: text.datatype/text.datatype
manual: autodocs-3.5
chapter: autodocs-3.5
section: text-datatype-text-datatype
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
	...
	GM_RENDER -- [Cause](autodocs-3.5/exec-library-cause-2.md) the text to render.
	...
	DTM_WRITE -- [Write](autodocs-3.5/dos-library-write-2.md) the selected area of the text to a file.
	    If no area is selected, then the entire text is saved.

    TAGS
	DTA_TextAttr (struct [TextAttr](autodocs-3.5/include-graphics-text-h.md) *) -- [Text](autodocs-3.5/graphics-library-text-2.md) attribute to use for
	    the text.

	    Applicability is (ISG).

	DTA_TextFont (struct [TextFont](autodocs-3.5/include-graphics-text-h.md) *) -- [Text](autodocs-3.5/graphics-library-text-2.md) font to use for
	    the text.
	...
	TDTA_LineList (struct [List](autodocs-3.5/include-exec-lists-h.md) *) -- [List](autodocs-3.5/include-exec-lists-h.md) of lines.  The elements
	    of the list are [Line](autodocs-3.5/include-datatypes-textclass-h.md) structures (see <datatype/textclass.h>
