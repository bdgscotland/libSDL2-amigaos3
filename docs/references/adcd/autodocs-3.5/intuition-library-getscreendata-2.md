...
section: intuition-library-getscreendata-2
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
    ...
    SYNOPSIS 
	Success = GetScreenData( Buffer, Size, Type, [Screen](autodocs-3.5/include-intuition-screens-h.md) )
	D0                       A0      D0    D1    A1

	[BOOL](autodocs-3.5/include-exec-types-h.md) GetScreenData( [APTR](autodocs-3.5/include-exec-types-h.md), [UWORD](autodocs-3.5/include-exec-types-h.md), [UWORD](autodocs-3.5/include-exec-types-h.md), struct [Screen](autodocs-3.5/include-intuition-screens-h.md) * );

    FUNCTION 
	This function copies into the caller's buffer data from a [Screen](autodocs-3.5/include-intuition-screens-h.md)
	...
	in V36.  [Read](autodocs-3.5/dos-library-read-2.md) carefully the somewhat involved exceptions we
	elected to implement ...

	Changes as of V36:

	For V36 and later, the function [LockPubScreen()](autodocs-3.5/intuition-library-lockpubscreen-2.md) is an improvement
	...
	[SetPubScreenModes()](autodocs-3.5/intuition-library-setpubscreenmodes-2.md) ), this function will actually report on
	...
	display mode ID by inquiring of the actual [ViewPort](autodocs-3.5/include-graphics-view-h.md) (using
	...
	Type   = the screen type, as specified in [OpenWindow()](autodocs-3.5/intuition-library-openwindow-2.md) (WBENCHSCREEN,
	    CUSTOMSCREEN, ...)
	[Screen](autodocs-3.5/include-intuition-screens-h.md) = ignored, unless type is CUSTOMSCREEN, which results only in
    ...
    SEE ALSO 
	[OpenWindow()](autodocs-3.5/intuition-library-openwindow-2.md), [LockPubScreen()](autodocs-3.5/intuition-library-lockpubscreen-2.md), [graphics.library/GetVPModeID()](autodocs-3.5/graphics-library-getvpmodeid-2.md),
	[SetPubScreenModes()](autodocs-3.5/intuition-library-setpubscreenmodes-2.md), [OpenScreen()](autodocs-3.5/intuition-library-openscreen-2.md)
