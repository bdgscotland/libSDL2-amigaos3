...
section: exec-library-allocate-2
functions: [AllocMem]
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   SYNOPSIS
	...
	void *Allocate(struct [MemHeader](autodocs-3.5/include-exec-memory-h.md) *, ULONG);

   FUNCTION
	This function is used to allocate blocks of memory from a given
	private free memory pool (as specified by a [MemHeader](autodocs-3.5/include-exec-memory-h.md) and its
	...
	memory.  Note that no arbitration of the [MemHeader](autodocs-3.5/include-exec-memory-h.md) and associated
   ...
   EXAMPLE
	...
	void main()
	{
	struct [MemHeader](autodocs-3.5/include-exec-memory-h.md) *mh;
	struct [MemChunk](autodocs-3.5/include-exec-memory-h.md)  *mc;
	[APTR](autodocs-3.5/include-exec-types-h.md)   block1;
	[APTR](autodocs-3.5/include-exec-types-h.md)   block2;

	    /* Get the [MemHeader](autodocs-3.5/include-exec-memory-h.md) needed to keep track of our new block */
	    mh = (struct [MemHeader](autodocs-3.5/include-exec-memory-h.md) *)
		 AllocMem((long)sizeof(struct MemHeader), MEMF_CLEAR );
	    if( !mh )
		exit(10);

	    /* Get the actual block the above [MemHeader](autodocs-3.5/include-exec-memory-h.md) will manage */
	    mc = (struct [MemChunk](autodocs-3.5/include-exec-memory-h.md) *)AllocMem( BLOCKSIZE, 0L );
	    if( !mc )
		{
   ...
   SEE ALSO
	[Deallocate()](autodocs-3.5/exec-library-deallocate-2.md), [exec/memory.h](autodocs-3.5/include-exec-memory-h.md)
