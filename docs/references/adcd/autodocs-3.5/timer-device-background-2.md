...
section: timer-device-background-2
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   TIMER REQUEST
	A time request is a non standard IO [Request](autodocs-3.5/intuition-library-request-2.md).  It has an [IORequest](autodocs-3.5/include-exec-io-h.md)
	followed by a [timeval](autodocs-3.5/include-devices-timer-h.md) structure or an eclockval structure.

   TIMEVAL
	A [timeval](autodocs-3.5/include-devices-timer-h.md) structure consists of two longwords.  The first is
   ...
   ECLOCKVAL
	...
	[ReadEClock()](autodocs-3.5/timer-device-readeclock-2.md) library like call.
   ...
   UNIT_MICROHZ
	...
	uses a [timeval](autodocs-3.5/include-devices-timer-h.md) in its [timerequest](autodocs-3.5/include-devices-timer-h.md).
   ...
   UNIT_VBLANK
	...
	(typically 1/2 second or more).  This unit uses a [timeval](autodocs-3.5/include-devices-timer-h.md) in its
	[timerequest](autodocs-3.5/include-devices-timer-h.md).

   UNIT_ECLOCK
	This unit is exacly the same as UNIT_MICROHZ except that it uses
	an eclockval instead of a [timeval](autodocs-3.5/include-devices-timer-h.md) in its [timerequest](autodocs-3.5/include-devices-timer-h.md).

   UNIT_WAITUNTIL
	This unit waits until the systime is greater than or equal to the
	time in the [timeval](autodocs-3.5/include-devices-timer-h.md) in the [timerequest](autodocs-3.5/include-devices-timer-h.md).  This unit has the same
	resolution and accuracy as that of UNIT_VBLANK.

   UNIT_WAITECLOCK
	This unit waits until the E-Clock value as returned by [ReadEClock()](autodocs-3.5/timer-device-readeclock-2.md)
	is greater than or equal to the eclockval in the [timerequest](autodocs-3.5/include-devices-timer-h.md). This
