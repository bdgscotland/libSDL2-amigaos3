...
section: gameport-device-gpd-readevent-2
functions: []
libraries: []
---
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   FUNCTION
	[Read](autodocs-3.5/dos-library-read-2.md) game port events from the game port and put them in the
   ...
   SEE ALSO
	[gameport.device/GPD_SETCTYPE](autodocs-3.5/gameport-device-gpd-setctype-2.md), [gameport.device/GPD_SETTRIGGER](autodocs-3.5/gameport-device-gpd-settrigger-2.md)
