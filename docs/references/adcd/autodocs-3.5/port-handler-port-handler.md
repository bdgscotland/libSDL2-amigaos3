---
title: port-handler/port_handler
manual: autodocs-3.5
chapter: autodocs-3.5
section: port-handler-port-handler
   ...
   MOUNTLIST ENTRIES
	...
	and units. The form of these mount entries is:
	   ...
	   SER0:   EHandler  = L:Port-Handler
	           ...
	           StackSize = 800
	           GlobVec   = 1
	           [Device](autodocs-3.5/include-exec-devices-h.md)    = serial.device
	           [Unit](autodocs-3.5/include-exec-devices-h.md)      = 0
	           Flags     = 0
	           Control   = "8N1"
	           Baud      = 9600
	#
	...
	that the handler uses for [OpenDevice()](autodocs-3.5/serial-device-opendevice-2.md). "Baud" and "Control"
