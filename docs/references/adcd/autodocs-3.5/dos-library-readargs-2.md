...
section: dos-library-readargs-2
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   SYNOPSIS
	...
	struct [RDArgs](autodocs-3.5/include-dos-rdargs-h.md) * ReadArgs(STRPTR, [LONG](autodocs-3.5/include-exec-types-h.md) *, struct [RDArgs](autodocs-3.5/include-dos-rdargs-h.md) *)

   FUNCTION
	Parses and argument string according to a template.  Normally gets
	the arguments by reading buffered IO from [Input()](autodocs-3.5/dos-library-input-2.md), but also can be
	made to parse a string.  MUST be matched by a call to [FreeArgs()](autodocs-3.5/dos-library-freeargs-2.md).
	...
	ReadArgs() returns a struct [RDArgs](autodocs-3.5/include-dos-rdargs-h.md) if it succeeds.  This serves as an
	"anchor" to allow [FreeArgs()](autodocs-3.5/dos-library-freeargs-2.md) to free the associated memory.  You can
	also pass in a struct [RDArgs](autodocs-3.5/include-dos-rdargs-h.md) to control the operation of ReadArgs()
	...
	storage, and extended help text.  See [<dos/rdargs.h>](autodocs-3.5/include-dos-rdargs-h.md) for more
	information on this.  Note: if you pass in a struct [RDArgs](autodocs-3.5/include-dos-rdargs-h.md), you must
	still call [FreeArgs()](autodocs-3.5/dos-library-freeargs-2.md) to release storage that gets attached to it,
	but you are responsible for freeing the [RDArgs](autodocs-3.5/include-dos-rdargs-h.md) yourself.

	If you pass in a [RDArgs](autodocs-3.5/include-dos-rdargs-h.md) structure, you MUST reset (clear or set)
	RDA_Buffer for each new call to [RDArgs](autodocs-3.5/include-dos-rdargs-h.md).  The exact behavior if you
   ...
   INPUTS
	...
	rdargs   - optional rdargs structure for options.  [AllocDosObject](autodocs-3.5/dos-library-allocdosobject-2.md)
		   should be used for allocating them if you pass one in.

   RESULT
	result   - a struct [RDArgs](autodocs-3.5/include-dos-rdargs-h.md) or NULL for failure.
   ...
   SEE ALSO
	[FindArg()](autodocs-3.5/dos-library-findarg-2.md), [ReadItem()](autodocs-3.5/dos-library-readitem-2.md), [FreeArgs()](autodocs-3.5/dos-library-freeargs-2.md), [AllocDosObject()](autodocs-3.5/dos-library-allocdosobject-2.md)
