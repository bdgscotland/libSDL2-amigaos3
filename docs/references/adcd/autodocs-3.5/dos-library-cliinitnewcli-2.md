...
section: dos-library-cliinitnewcli-2
...
> *Source: Amiga Developer CD v2.1. (C) Commodore-Amiga / Amiga Inc.*
   ...
   SYNOPSIS
	...
	[LONG](autodocs-3.5/include-exec-types-h.md) CliInitNewcli( struct [DosPacket](autodocs-3.5/include-dos-dosextens-h.md) * )
   ...
   FUNCTION
	...
	This function is very similar to [CliInitRun()](autodocs-3.5/dos-library-cliinitrun-2.md).
   ...
   SEE ALSO
	[CliInitRun()](autodocs-3.5/dos-library-cliinitrun-2.md), [ReplyPkt()](autodocs-3.5/dos-library-replypkt-2.md), [WaitPkt()](autodocs-3.5/dos-library-waitpkt-2.md), [IoErr()](autodocs-3.5/dos-library-ioerr-2.md)
