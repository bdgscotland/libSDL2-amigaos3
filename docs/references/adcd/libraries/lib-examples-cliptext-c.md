---
title: Lib_examples/cliptext.c
manual: libraries
chapter: libraries
section: lib-examples-cliptext-c
functions: [GetScreenDrawInfo, ModifyIDCMP, NewRegion, ReadArgs, WaitBlit]
libraries: [dos.library, graphics.library, intuition.library]
---
