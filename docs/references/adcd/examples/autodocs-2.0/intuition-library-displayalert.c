/* Source: ADCD 2.1
 * Section: intuition-library-displayalert
 * Library: autodocs-2.0
 * ADCD reference: autodocs-2.0/intuition-library-displayalert.md
 */
    ...
    sent to the [Alert()](../Includes_and_Autodocs_2._guide/node032E.html) routine.  But the only bits that are pertinent to
