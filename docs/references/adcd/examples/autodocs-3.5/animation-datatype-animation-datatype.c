 ...
 * ADCD reference: autodocs-3.5/animation-datatype-animation-datatype.md
 */
    ...
    METHODS
        ...
        GM_RENDER -- [Cause](../Includes_and_Autodocs_3._guide/node01F4.html) the current frame to render.
        ...
        DTM_WRITE -- [Write](../Includes_and_Autodocs_3._guide/node01D1.html) the current frame to a file as an IFF ILBM.

        DTM_PRINT -- Print the current frame.

        ADTM_LOADFRAME -- Load a frame of the animation.

        ADTM_UNLOADFRAME -- [Deallocate](../Includes_and_Autodocs_3._guide/node01FE.html) any memory allocated by
            ADTM_LOADFRAME.
        ...
        ADTM_LOADNEWFORMATFRAME -- Load a new format frame of the animation,
            for more information, see [<datatypes/animationclass.h>](../Includes_and_Autodocs_3._guide/node05D1.html). (V44)

        ADTM_UNLOADNEWFORMATFRAME -- [Deallocate](../Includes_and_Autodocs_3._guide/node01FE.html) any memory allocated by
    ...
    TAGS
        ...
        ADTA_KeyFrame (struct [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) *) -- Pointer to the key
            frame.
        ...
        ADTA_ColorRegisters (struct [ColorRegister](../Includes_and_Autodocs_3._guide/node05DD.html#line223) *) -- Color table; its
            contents should match the colours in the ADTA_CRegs table.

            Applicability is (G).

        ADTA_CRegs (ULONG *) -- Color table to use with [SetRGB32CM()](../Includes_and_Autodocs_3._guide/node0329.html).
        ...
        ADTA_BitMapHeader (struct [BitMapHeader](../Includes_and_Autodocs_3._guide/node05DD.html#line203) *) -- Set and get the
            base information for the animation.  [BitMapHeader](../Includes_and_Autodocs_3._guide/node05DD.html#line203) is defined in
            [<datatypes/pictureclass.h>](../Includes_and_Autodocs_3._guide/node05DD.html)
        ...
        OBP_Precision (ULONG) -- Precision to use when obtaining colors.
            See the PRECISION_[..] defines in [<graphics/view.h>](../Includes_and_Autodocs_3._guide/node05ED.html).
    ...
    NOTES
        ...
        operate on struct [adtNewFormatFrame](../Includes_and_Autodocs_3._guide/node05D1.html#line228) format messages. The
        [adtNewFormatFrame](../Includes_and_Autodocs_3._guide/node05D1.html#line228) message is an extension of the [adtFrame](../Includes_and_Autodocs_3._guide/node05D1.html#line206) message
        ...
        [adtNewFormatFrame](../Includes_and_Autodocs_3._guide/node05D1.html#line228) format messages, it must say so by providing a
        ...
        subclass, you will receive [adtNewFormatFrame](../Includes_and_Autodocs_3._guide/node05D1.html#line228) format messages instead
        of the compatible [adtFrame](../Includes_and_Autodocs_3._guide/node05D1.html#line206) messages.
        ...
        Since the [adtNewFormatFrame](../Includes_and_Autodocs_3._guide/node05D1.html#line228) message format may be enhanced in future
        ...
        the data structure (in bytes). [Remember](../Includes_and_Autodocs_3._guide/node05E0.html#line1429) which message length you
        ...
        compatible [adtFrame](../Includes_and_Autodocs_3._guide/node05D1.html#line206) message data structure.
