/* Source: ADCD 2.1
 * Section: integer-gc-datasheet
 * Library: autodocs-3.5
 * ADCD reference: autodocs-3.5/integer-gc-datasheet.md
 */
    ...
    REQUIRES
     ...
     ATTRIBUTES
        ...
        INTEGER_Number (LONG)
            ...
            values of size [LONG](../Includes_and_Autodocs_3._guide/node0654.html#line39), the value returned in IntuiMessage.Code
            will only be valid if the ranges you are allowing fit into a
            WORD value.  Otherwise you will have to use [GetAttr()](../Includes_and_Autodocs_3._guide/node03B5.html).
