 ...
 * ADCD reference: autodocs-3.5/audio-device-adcmd-lock-2.md
 */
       ...
       Unlike setting the precedence (ADCMD_SETPREC, [ADCMD_ALLOCATE](../Includes_and_Autodocs_3._guide/node0061.html) or
