 ...
 * ADCD reference: autodocs-3.5/getfont-gadget-datasheet.md
 */
    ...
    ATTRIBUTES
       ...
       GETFONT_TextAttr (struct [TextAttr](../Includes_and_Autodocs_3._guide/node05EC.html#line64) *)
       ...
       GETFONT_DrawMode (UBYTE)
          [Draw](../Includes_and_Autodocs_3._guide/node02CD.html) mode.
