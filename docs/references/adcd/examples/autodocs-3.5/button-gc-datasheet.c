 ...
 * ADCD reference: autodocs-3.5/button-gc-datasheet.md
 */
    ...
    DESCRIPTION
     ...
     ATTRIBUTES
        ...
        GA_Text (STRPTR)
            ...
            for the gadget.  The [Text()](../Includes_and_Autodocs_3._guide/node0332.html) function is used to draw the text.
            NULL is valid input. Changing the label will invoke GM_RENDER.
            [Text](../Includes_and_Autodocs_3._guide/node0332.html) string is clipped to fit inside the button via the
            [TextLength()](../Includes_and_Autodocs_3._guide/node0335.html) function. The text string may contain varargs
        ...
        GA_Image (struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *)
            Used to specify the image to use for the label of the gadget.
            The [DrawImageState()](../Includes_and_Autodocs_3._guide/node03AA.html) function is used to draw the image.
        ...
        GA_SelectImage (struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *)
            Used to specify the image to use for the label of the gadget
            in the selected state. The [DrawImageState()](../Includes_and_Autodocs_3._guide/node03AA.html) function is used
        ...
        GA_TextAttr (struct [TextAttr](../Includes_and_Autodocs_3._guide/node05EC.html#line64) *)
            [Text](../Includes_and_Autodocs_3._guide/node0332.html) attribute for the font to use for the text labels.
        ...
        BUTTON_Transparent (BOOL)
            ...
            [EraseRect()](../Includes_and_Autodocs_3._guide/node02D0.html) is used rather than [RectFill()](../Includes_and_Autodocs_3._guide/node0313.html) so that
        ...
        BUTTON_SoftStyle (WORD)
            ...
            See [<graphics/text.h>](../Includes_and_Autodocs_3._guide/node05EC.html) SoftStyle definitions.
        ...
        BUTTON_BitMap (struct [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) *)  (V42)
            Specify a [BitMap](../Includes_and_Autodocs_3._guide/node05DC.html#line45) to render in button, rather than image or
        ...
        BUTTON_AnimImages (struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *)  (V42)
        ...
        BUTTON_SelAnimImages (struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *)  (V42)
