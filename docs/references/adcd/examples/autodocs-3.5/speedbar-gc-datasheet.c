/* Source: ADCD 2.1
 * Section: speedbar-gc-datasheet
 * Library: autodocs-3.5
 * ADCD reference: autodocs-3.5/speedbar-gc-datasheet.md
 */
    ...
    DESCRIPTION
        ...
        "Speed Bars", also commonly called Button Bars, [Tool](../Includes_and_Autodocs_3._guide/node05F7.html#line144) Docs, etc.
        ...
        An advantages that this class provides:
         ...
         > [Custom](../Includes_and_Autodocs_3._guide/node05F6.html#line24) centered images.
    ...
    ATTRIBUTES
        SPEEDBAR_Buttons (struct [List](../Includes_and_Autodocs_3._guide/node0628.html#line19) *)
            An Exec list.  Nodes in this list must be allocated with
            [AllocSpeedButtonNodeA()](../Includes_and_Autodocs_3._guide/node0569.html).
        ...
        SPEEDBAR_Orientation (WORD)
            ...
            Accepted values as defined in [<gadgets/speedbar.h>](../Includes_and_Autodocs_3._guide/node0669.html) are:
        ...
        SPEEDBAR_Window (struct [Window](../Includes_and_Autodocs_3._guide/node05E0.html#line908) *)
        ...
        SPEEDBAR_StrumBar (BOOL)
            [Enable](../Includes_and_Autodocs_3._guide/node0205.html) "strumming" mode, where by you can drag the mouse
