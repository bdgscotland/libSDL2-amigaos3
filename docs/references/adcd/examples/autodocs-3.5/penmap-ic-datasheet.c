/* Source: ADCD 2.1
 * Section: penmap-ic-datasheet
 * Library: autodocs-3.5
 * ADCD reference: autodocs-3.5/penmap-ic-datasheet.md
 */
    ...
    METHODS
        ...
        IM_DRAW -- Renders the image. Supports IDS_NORMAL and
            ...
            a [DrawInfo](../Includes_and_Autodocs_3._guide/node0602.html#line65) structure. The graphics.library function
            [BitMapScale](../Includes_and_Autodocs_3._guide/node02B1.html) () to scale the image if required.

        IM_DRAWFRAME -- Renders the image scaled to the frame size
            specified. Supports IDS_NORMAL and IDS_SELECTED drawing
            states, and does not require a [DrawInfo](../Includes_and_Autodocs_3._guide/node0602.html#line65) structure.
            The graphics.library function [BitMapScale](../Includes_and_Autodocs_3._guide/node02B1.html) () to scale
            the image.
    ...
    ATTRIBUTES
        ...
        IA_Width (WORD)
        IA_Height (WORD)
            Set size of the image, scaling via [BitMapScale()](../Includes_and_Autodocs_3._guide/node02B1.html) if different
        ...
        IA_Data
           ...
           The data format is a [UBYTE](../Includes_and_Autodocs_3._guide/node0654.html#line50) array of chunky pen numbers.
        ...
        PENMAP_Screen (struct [Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) *)
        ...
        PENMAP_ColorMap (struct [ColorMap](../Includes_and_Autodocs_3._guide/node05ED.html#line142) *)
