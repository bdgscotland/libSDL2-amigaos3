/* Source: ADCD 2.1
 * Section: audio-device-opendevice-2
 * Library: autodocs-3.5
 * ADCD reference: autodocs-3.5/audio-device-opendevice-2.md
 */
       ...
       iORequest - pointer to audio request block (struct IOAudio)
               ...
               ioa_AllocKey- allocation key; zero to generate new key.
                             ...
                             function or [ADCMD_ALLOCATE](../Includes_and_Autodocs_3._guide/node0061.html) command (non-zero
                             length)
