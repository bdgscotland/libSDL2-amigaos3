/* Source: ADCD 2.1
 * Section: amigaguide-amigaguide-datatype
 * Library: autodocs-3.5
 * ADCD reference: autodocs-3.5/amigaguide-amigaguide-datatype.md
 */
    ...
    METHODS
        ...
        GM_RENDER -- [Cause](../Includes_and_Autodocs_3._guide/node01F4.html) the AmigaGuide database to render.

        DTM_GOTO -- [Cause](../Includes_and_Autodocs_3._guide/node01F4.html) the AmigaGuide database to load and display
            document.
        ...
        DTM_WRITE -- [Write](../Includes_and_Autodocs_3._guide/node01D1.html) the selected area of the text to a file.
            If no area is selected, then the entire text is saved.

    TAGS
        DTA_TriggerMethods -- [List](../Includes_and_Autodocs_3._guide/node0628.html#line19) of the trigger methods supported.

            Applicability is (G).

        DTA_Methods -- [List](../Includes_and_Autodocs_3._guide/node0628.html#line19) of the methods supported.

            Applicability is (G).

        DTA_TextAttr (struct [TextAttr](../Includes_and_Autodocs_3._guide/node05EC.html#line64) *) -- [Text](../Includes_and_Autodocs_3._guide/node0332.html) attribute to use for
