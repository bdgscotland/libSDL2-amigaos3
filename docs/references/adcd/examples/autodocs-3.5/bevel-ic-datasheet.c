/* Source: ADCD 2.1
 * Section: bevel-ic-datasheet
 * Library: autodocs-3.5
 * ADCD reference: autodocs-3.5/bevel-ic-datasheet.md
 */
    ...
    ATTRIBUTES
        ...
        IA_Font (struct [TextAttr](../Includes_and_Autodocs_3._guide/node05EC.html#line64) *)
            [Text](../Includes_and_Autodocs_3._guide/node0332.html) Attribute to use for any label text.
        ...
        BEVEL_FillPen (WORD)
            Inner bevel area [RectFill()](../Includes_and_Autodocs_3._guide/node0313.html) pen number, ~0 means to
            ignore, and not to [RectFill()](../Includes_and_Autodocs_3._guide/node0313.html).
        ...
        BEVEL_ColorMap (struct [ColorMap](../Includes_and_Autodocs_3._guide/node05ED.html#line142) *)
            [Screen](../Includes_and_Autodocs_3._guide/node0602.html#line132) viewport colormap pointer, use to obtain additional
