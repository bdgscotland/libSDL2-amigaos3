 ...
 * ADCD reference: autodocs-3.5/listbrowser-gc-setlistbrowsernodeattrsa.md
 */
    ...
    SYNOPSIS
        VOID SetListBrowserNodeAttrs(struct [Node](../Includes_and_Autodocs_3._guide/node062F.html#line21) *, [Tag](../Includes_and_Autodocs_3._guide/node064C.html#line29), ...)
        SetListBrowserNodeAttrs(node, firsttag, ...)

        VOID SetListBrowserNodeAttrsA(struct [Node](../Includes_and_Autodocs_3._guide/node062F.html#line21) *, struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *)
    ...
    TAGS
        ...
        [Text](../Includes_and_Autodocs_3._guide/node0332.html) that is to appear in the corresponding column for
        ...
        LBNCA_Image, LBNA_SelImage (struct [Image](../Includes_and_Autodocs_3._guide/node05E0.html#line704) *)
        ...
        LBNCA_EditTags (struct [TagItem](../Includes_and_Autodocs_3._guide/node064C.html#line31) *) (V41)
        ...
        LBNCA_RenderHook (struct [Hook](../Includes_and_Autodocs_3._guide/node0617.html#line27) *) (V41)

        A custom render hook for this node column.  You hook will
        receive a pointer to struct [Node](../Includes_and_Autodocs_3._guide/node062F.html#line21) of the node in question as its
        object, and the following structure in the message pointer:

          struct [LBDrawMsg](../Includes_and_Autodocs_3._guide/node05EF.html#line247)
          {
              ULONG lbdm_MethodID;            /* LV_DRAW */
              struct [RastPort](../Includes_and_Autodocs_3._guide/node05D7.html#line53) *lbdm_RastPort; /* Where to render to */
              struct [DrawInfo](../Includes_and_Autodocs_3._guide/node0602.html#line65) *lbdm_DrawInfo; /* Useful to have around */
              struct [Rectangle](../Includes_and_Autodocs_3._guide/node05DC.html#line26) lbdm_Bounds;   /* Limits of where to render */
    ...
    SEE ALSO
        [GetListBrowserNodeAttrsA()](../Includes_and_Autodocs_3._guide/node0447.html)
