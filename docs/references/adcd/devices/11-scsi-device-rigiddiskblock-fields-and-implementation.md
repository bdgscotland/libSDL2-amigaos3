---
title: 11 SCSI Device / RigidDiskBlock - Fields and Implementation
manual: devices
chapter: devices
...
The following is a listing of devices/[hardblocks.h](autodocs-2.0/includes-devices-hardblocks-h.md) that describes all the
...
#define IDNAME_LOADSEG
 ...
 [How A Driver Uses RDB](devices/11-rigiddiskblock-fields-and-implementation-how-a-driver.md) 
 [Alien Filing Systems](devices/11-rigiddiskblock-fields-and-implementation-alien-filing.md) 
