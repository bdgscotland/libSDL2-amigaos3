---
title: ANIM.doc / Introduction
manual: devices
chapter: devices
section: anim-doc-introduction
functions: []
libraries: []
---
...
developed by Jim Kent.
 ...
 [ANIM Format Overview](devices/introduction-anim-format-overview.md) 
 [Recording ANIMs](devices/introduction-recording-anims.md) 
 [Playing ANIMs](devices/introduction-playing-anims.md) 
