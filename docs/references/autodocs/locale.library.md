# locale.library — Autodoc Reference
...
- **--rexxhost--** — 
- **--structures--** — 
- **CloseCatalog** (V38) — close a message catalog.
- **CloseLocale** (V38) — close a locale.
- **ConvToLower** (V38) — convert a character to lower case.
- **ConvToUpper** (V38) — convert a character to upper case.
- **FormatDate** (V38) — generate a date string based on a date formatting
- **FormatString** (V38) — format data into a character stream,
- **GetCatalogStr** (V38) — get a string from a message catalog.
- **GetLocaleStr** (V38) — get a standard string from a locale.
- **IsXXXX** (V38) — determine whether a character is of a certain type.
- **OpenCatalog** (V38) — open a message catalog. (V38)
- **OpenLocale** (V38) — open a locale.
- **ParseDate** (V38) — interpret a string according to the date formatting
- **StrConvert** (V38) — transform a string according to collation information.
- **StrnCmp** (V38) — localized string comparison.
...
### locale.library/CloseCatalog (V38)
...
### locale.library/CloseLocale (V38)
...
### locale.library/ConvToLower (V38)
...
### locale.library/ConvToUpper (V38)
...
### locale.library/FormatString (V38)

**format data into a character stream,
           assume 16bit-aligned data.FormatString32 -- format data into a character stream,
...
### locale.library/GetCatalogStr (V38)

**get a string from a message catalog.**
...
### locale.library/GetLocaleStr (V38)

**get a standard string from a locale.**
...
### locale.library/IsXXXX (V38)

**determine whether a character is of a certain type.**
...
### locale.library/OpenCatalog (V38)

**open a message catalog.OpenCatalog -- varargs stub for OpenCatalogA().**
...
**See also:** CloseCatalog(), GetCatalogStr()

---

### locale.library/OpenLocale (V38)
...
### locale.library/ParseDate (V38)

**interpret a string according to the date formatting
      template and convert it into a DateStamp.**
