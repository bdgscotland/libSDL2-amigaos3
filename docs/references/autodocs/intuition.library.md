# intuition.library — Autodoc Reference
...
- **AllocScreenBuffer** (V39) — Get a ScreenBuffer for double-buffering.
- **AutoRequest** — Automatically build and get response from a requester.
- **BeginRefresh** — Sets up a window for optimized refreshing.
- **BuildEasyRequestArgs** (V36) — Simple creation of system request. (V36)
- **BuildSysRequest** — Build and display a system requester.
- **ChangeScreenBuffer** (V39) — Swap the screen's BitMap.
- **ChangeWindowBox** (V36) — Change window position and dimensions.
...
- **DisposeObject** (V36) — Deletes a BOOPSI object.
- **DoGadgetMethodA** (V39) — Invoke method on a BOOPSI gadget. (V39)
...
- **DrawImageState** (V36) — Draw an (extended) Intuition Image with
- **EasyRequestArgs** (V36) — Easy alternative to AutoRequest(). (V36)
- **EndRefresh** — End the optimized refresh state of the window.
- **EndRequest** — Remove a currently active requester.
- **EraseImage** (V36) — Erases an Image.
- **FreeClass** (V36) — Frees a BOOPSI class created by MakeClass().
- **FreeRemember** — Free memory allocated by calls to AllocRemember().
- **FreeScreenBuffer** (V39) — Free a ScreenBuffer structure.
- **FreeScreenDrawInfo** (V36) — Finish using a DrawInfo structure.
- **FreeSysRequest** — Free resources gotten by a call to BuildSysRequest().
- **GadgetMouse** (V36) — Calculate gadget-relative mouse position.
- **GetAttr** (V36) — Inquire the value of some attribute of an object.
- **GetDefaultPubScreen** (V36) — Get name of default public screen.
...
- **GetScreenDrawInfo** (V36) — Get pointer to rendering information.
- **HelpControl** (V39) — Enable/disable Gadget-Help feature.
...
- **LendMenus** (V39) — Lend window's menu action to another window.
- **LockIBase** — Invoke semaphore arbitration of IntuitionBase.
- **LockPubScreen** (V36) — Prevent a public screen from closing.
- **LockPubScreenList** (V36) — Prevent changes to the system list.
- **MakeClass** (V36) — Create and initialize a boopsi class.
...
- **MoveWindowInFrontOf** (V36) — Arrange the relative depth of a window.
- **NewModifyProp** — ModifyProp(), but with selective refresh.
- **NewObject** (V36) — Create an object from a class. (V36)
- **NextObject** (V36) — iterate through the object on an Exec list.
- **NextPubScreen** (V36) — Identify next public screen in the cycle.
- **ObtainGIRPort** (V36) — Set up a RastPort for a custom gadget.
...
- **OpenScreenTagList** (V36) — OpenScreen() with TagItem extension array. (V36)
- **OpenWindow** — Open an Intuition window.
- **OpenWindowTagList** (V36) — OpenWindow() with TagItem extension. (V36)
- **OpenWorkBench** — Open the Workbench screen.
- **PointInImage** (V36) — Tests whether an image "contains" a point.
- **PrintIText** — Print text described by the IntuiText argument.
- **PubScreenStatus** (V36) — Change status flags for a public screen.
- **QueryOverscan** (V36) — Inquire about a standard overscan region.
...
- **ReleaseGIRPort** (V36) — Release a custom gadget RastPort.
- **RemakeDisplay** — Remake the entire Intuition display.
- **RemoveClass** (V36) — Make a public boopsi class unavailable.
...
- **ResetMenuStrip** (V36) — Re-attach a menu strip to a window.
- **RethinkDisplay** — Grand manipulation of the entire Intuition display.
- **ScreenDepth** (V39) — Depth arrange a screen with extra control.
- **ScreenPosition** (V39) — Move screens with greater control.
- **ScreenToBack** — Send the specified screen to the back of the display.
- **ScreenToFront** — Make the specified screen the frontmost.
- **ScrollWindowRaster** (V39) — Intuition-friendly ScrollRasterBF()
- **SetAttrsA** (V36) — Specify attribute values for an object. (V36)
- **SetDefaultPubScreen** (V36) — Choose a new default public screen.
- **SetDMRequest** — Set the DMRequest of a window.
- **SetEditHook** (V36) — Set global processing for string gadgets.
- **SetGadgetAttrsA** (V36) — Specify attribute values for a BOOPSI gadget. (V36)
- **SetMenuStrip** — Attach a menu strip to a window.
- **SetMouseQueue** (V36) — Change limit on pending mouse messages.
- **SetPointer** — Specify a pointer sprite image for a window.
- **SetPrefs** — Set Intuition preferences data.
- **SetPubScreenModes** (V36) — Establish global public screen behavior.
- **SetWindowPointerA** (V39) — Select a pointer for your window. (V39)
...
- **SysReqHandler** (V36) — Handle system requester input.
- **TimedDisplayAlert** (V39) — Display an alert with automatic time-out.
- **UnlockIBase** — Surrender an Intuition lock gotten by LockIBase().
- **UnlockPubScreen** (V36) — Release lock on a public screen.
- **UnlockPubScreenList** (V36) — Release public screen list semaphore.
...
- **ZipWindow** (V36) — Change window to "alternate" position and
...
**See also:** OpenWindow(), and the WFLG_ACTIVATE window flag

---

### intuition.library/AddClass (V36)
...
**See also:** MakeClass(), FreeClass(), RemoveClass()
...
**AllocMem() with tracking to make freeing easy.**
...
**See also:** FreeRemember(), exec.library/AllocMem()

---

### intuition.library/AllocScreenBuffer (V39)
...
**See also:** FreeScreenBuffer(), ChangeScreenBuffer(),
...
**See also:** EasyRequestArgs(), BuildSysRequest(), SysReqHandler()
...
**See also:** EndRefresh(), layers.library/BeginUpdate(), OpenWindow()
layer.library/InstallClipRegion(), layers.library/LockLayerInfo()
The "Windows" chapter of the Intuition Reference Manual

---

### intuition.library/BuildEasyRequestArgs (V36)

**Simple creation of system request.BuildEasyRequest -- Varargs stub for BuildEasyRequestArgs().**
...
**See also:** EasyRequestArgs(), FreeSysRequest(), SysReqHandler(),
...
**See also:** FreeSysRequest(), DisplayAlert(), ModifyIDCMP(), exec.library/Wait(),
Request(), AutoRequest(), EasyRequestArgs(), BuildEasyRequestArgs()

---

### intuition.library/ChangeScreenBuffer (V39)
...
**See also:** AllocScreenBuffer(), FreeScreenBuffer(),
graphics.library/ChangeVPBitMap()

---

### intuition.library/ChangeWindowBox (V36)
...
**See also:** MoveWindow(), SizeWindow(), ZipWindow(),
...
**See also:** SetMenuStrip(), ResetMenuStrip()
...
**See also:** SetWindowPointerA(), SetPointer()
...
**See also:** OpenWindow(), OpenScreen(), CloseScreen()
...
### intuition.library/DisposeObject (V36)
...
**See also:** NewObject(), SetAttrs(), GetAttr(), MakeClass(),
Document "Basic Object-Oriented Programming System for Intuition"
and the --boopsi-- section of the intuition.doc autodoc.

---

### intuition.library/DoGadgetMethodA (V39)

**Invoke method on a BOOPSI gadget.DoGadgetMethod -- Varargs stub for DoGadgetMethodA().**
...
**See also:** NewObject(), DisposeObject(), GetAttr(), MakeClass(), IDoMethod(),
Document "Basic Object-Oriented Programming System for Intuition"
and the --boopsi-- section of the intuition.doc autodoc.
...
### intuition.library/DrawImageState (V36)

**Draw an (extended) Intuition Image with
...
**See also:** DrawImage(), GetScreenDrawInfo(), intuition/imageclass.h

---

### intuition.library/EasyRequestArgs (V36)

**Easy alternative to AutoRequest().EasyRequest -- Varargs stub for EasyRequestArgs().**
...
**See also:** exec.library/RawDoFmt(), BuildEasyRequestArgs(), SysReqHandler(),
...
**See also:** BeginRefresh(), layers.library/EndUpdate(),
...
### intuition.library/EraseImage (V36)
...
**See also:** graphics.library/EraseRect().

---

### intuition.library/FreeClass (V36)
...
**See also:** AllocRemember(), exec.library/FreeMem()

---

### intuition.library/FreeScreenBuffer (V39)
...
**See also:** AllocScreenBuffer(), ChangeScreenBuffer(),
graphics.library/ChangeVPBitMap()

---

### intuition.library/FreeScreenDrawInfo (V36)
...
**See also:** BuildSysRequest(), AutoRequest(), CloseWindow()

---

### intuition.library/GadgetMouse (V36)
...
**See also:** NewObject(), DisposeObject(), SetAttrs(), MakeClass(),
Document "Basic Object-Oriented Programming System for Intuition"
and the --boopsi-- section of the intuition.doc autodoc.

---

### intuition.library/GetDefaultPubScreen (V36)
...
**See also:** SetDefaultPubScreen(), OpenWindow()
...
**See also:** OpenWindow(), LockPubScreen(), graphics.library/GetVPModeID(),
SetPubScreenModes(), OpenScreen()

---

### intuition.library/GetScreenDrawInfo (V36)
...
**See also:** FreeScreenDrawInfo(), LockPubScreen(), intuition/screens.h

---

### intuition.library/HelpControl (V39)
...
**See also:** The "Menus" chapter of the Intuition Reference Manual,
or the Amiga ROM Kernel Manual

---

### intuition.library/LendMenus (V39)
...
**See also:** SetMenuStrip(), ClearMenuStrip()
...
**See also:** UnlockIBase(), layers.library/LockLayerInfo(),
exec.library/ObtainSemaphore()

---

### intuition.library/LockPubScreen (V36)
...
### intuition.library/LockPubScreenList (V36)
...
**See also:** UnlockPubScreenList(), OpenScreen(), Intuition V36 update documentation

---

### intuition.library/MakeClass (V36)
...
**See also:** FreeClass(), AddClass(), RemoveClass(), NewObject(),
Document "Basic Object-Oriented Programming System for Intuition"
and the --boopsi-- section of the intuition.doc autodoc.
...
**See also:** RethinkDisplay(), RemakeDisplay(), graphics.library/MakeVPort()
...
**See also:** OpenWindowTagList(), OpenWindow(), CloseWindow()
...
**See also:** ScreenPosition(), RethinkDisplay()
...
**See also:** ChangeWindowBox(), SizeWindow(), WindowToFront(), WindowToBack()

---

### intuition.library/MoveWindowInFrontOf (V36)
...
**See also:** WindowToFront(), WindowToBack(), layers.library/MoveLayerInFrontOf()
...
### intuition.library/NewObject (V36)

**Create an object from a class.NewObject -- Varargs stub for NewObjectA().**
...
**See also:** DisposeObject(), SetAttrs(), GetAttr(), MakeClass(),
Document "Basic Object-Oriented Programming System for Intuition"
and the --boopsi-- section of the intuition.doc autodoc.

---

### intuition.library/NextObject (V36)
...
### intuition.library/NextPubScreen (V36)
...
### intuition.library/ObtainGIRPort (V36)
...
**See also:** ReleaseGIRPort(), Custom Gadget documentation
...
**See also:** OnGadget(), AddGadget(), RefreshGadgets()
...
**See also:** OffMenu(), ResetMenuStrip()
...
**See also:** OpenScreenTagList(), OpenWindow(), PrintIText(), CloseScreen(),
...
### intuition.library/OpenScreenTagList (V36)

**OpenScreen() with TagItem extension array.OpenScreenTags -- Varargs stub for OpenScreenTagList.**
...
**See also:** OpenWindowTagList(), OpenScreen(), ModifyIDCMP(), SetWindowTitles(),
LockPubScreen(), SetDefaultPubScreen(), ZipWindow(),
layers.library/InstallLayerHook(), SetPubScreenModes()

---

### intuition.library/OpenWindowTagList (V36)

**OpenWindow() with TagItem extension.OpenWindowTags -- Varargs stub for OpenWindowTagList**
...
### intuition.library/PointInImage (V36)
...
### intuition.library/PubScreenStatus (V36)
...
### intuition.library/QueryOverscan (V36)
...
### intuition.library/ReleaseGIRPort (V36)
...
**See also:** ObtainGIRPort(), Custom Gadget documentation
...
**See also:** MakeScreen(), RethinkDisplay(), graphics.library/MakeVPort()
graphics.library/MrgCop(), graphics.library/LoadView()

---

### intuition.library/RemoveClass (V36)
...
**See also:** MakeClass(), FreeClass(), AddClass()
Document "Basic Object-Oriented Programming System for Intuition"
and the --boopsi-- section of the intuition.doc autodoc.
...
**See also:** The Input and Output section of the Intuition Reference Manual
...
**See also:** The Requesters section of the Intuition Reference Manual

---

### intuition.library/ResetMenuStrip (V36)
...
**See also:** RemakeDisplay(), graphics.library/MakeVPort(), graphics.library/MrgCop(),
graphics.library/LoadView(), MakeScreen()

---

### intuition.library/ScreenDepth (V39)
...
**See also:** ScreenToFront(), ScreenToBack(),
SA_Parent, SA_FrontChild, SA_BackChild

---

### intuition.library/ScreenPosition (V39)
...
**See also:** MoveScreen(), RethinkDisplay()
...
**See also:** ScreenDepth(), ScreenToFront()
...
**See also:** ScreenDepth(), ScreenToBack()

---

### intuition.library/ScrollWindowRaster (V39)

**Intuition-friendly ScrollRasterBF()**
...
**See also:** graphics.library/ScrollRaster(), graphics.library/ScrollRasterBF()
graphics.library/EraseRect(), WA_BackFill

---

### intuition.library/SetAttrsA (V36)

**Specify attribute values for an object.SetAttrs -- Varargs stub for SetAttrsA().**
...
**See also:** NewObject(), DisposeObject(), GetAttr(), MakeClass(),
...
### intuition.library/SetDefaultPubScreen (V36)
...
**See also:** OpenWindow(), OpenScreen(), Intuition V36 update documentation
...
**See also:** ClearDMRequest(), Request()

---

### intuition.library/SetEditHook (V36)
...
### intuition.library/SetGadgetAttrsA (V36)

**Specify attribute values for a BOOPSI gadget.SetGadgetAttrs -- Varargs stub for SetGadgetAttrsA().**
...
**See also:** ClearMenuStrip(), ResetMenuStrip()

---

### intuition.library/SetMouseQueue (V36)
...
**See also:** SetWindowPointerA(), ClearPointer(), ROM Kernel Manual: Libraries
...
### intuition.library/SetPubScreenModes (V36)
...
### intuition.library/SetWindowPointerA (V39)

**Select a pointer for your window.SetWindowPointer -- Varargs stub for SetWindowPointerA().**
...
**See also:** SetPointer(), ClearPointer(), ROM Kernel Manual: Libraries
...
**See also:** ChangeWindowBox(), MoveWindow(), WindowToFront(), WindowToBack()

---

### intuition.library/SysReqHandler (V36)
...
**See also:** exec.library/WaitPort()

---

### intuition.library/TimedDisplayAlert (V39)
...
### intuition.library/UnlockPubScreen (V36)
...
### intuition.library/UnlockPubScreenList (V36)
...
**See also:** WBenchToFront(), ScreenToFront()
...
**See also:** WBenchToBack(), ScreenToBack()
...
**See also:** MoveWindow(), SizeWindow(), WindowToFront(), MoveWindowInFrontOf()
...
**See also:** MoveWindow(), SizeWindow(), WindowToBack(), MoveWindowInFrontOf()

---

### intuition.library/ZipWindow (V36)

**Change window to "alternate" position and
      dimensions.**
...
**See also:** ChangeWindowBox(), MoveWindow(), SizeWindow()
